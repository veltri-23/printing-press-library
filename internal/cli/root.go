...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "theclose-pp-cli",
		Short: "Manage theclose resources via the theclose API",
		Long: `Manage theclose resources via the theclose API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'theclose-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("theclose-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'theclose-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAgentActionsCmd(flags))
	rootCmd.AddCommand(newAgentTokensCmd(flags))
	rootCmd.AddCommand(newActionsCmd(flags))
	rootCmd.AddCommand(newBillingCmd(flags))
	rootCmd.AddCommand(newCalloutsCmd(flags))
	rootCmd.AddCommand(newCloseDeveloperProfileCmd(flags))
	rootCmd.AddCommand(newConnectorActionsCmd(flags))
	...
	rootCmd.AddCommand(newFUBCmd(flags))
	rootCmd.AddCommand(newIntakeCmd(flags))
	...
	rootCmd.AddCommand(newWorkQueueCmd(flags))
	...
	rootCmd.AddCommand(newCloseDeveloperHealthPromotedCmd(flags))
	rootCmd.AddCommand(newEmailsPromotedCmd(flags))
	rootCmd.AddCommand(newEventsPromotedCmd(flags))
	rootCmd.AddCommand(newPortalPromotedCmd(flags))
