...
func newTemplatesCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  theclose-pp-cli templates create --data example-value",
		Annotations: map[string]string{"pp:endpoint": "templates.create", "pp:method": "POST", "pp:path": "/api/templates"},
