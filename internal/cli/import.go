...
but do not stop the import.`,
  ...
  theclose-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  theclose-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | theclose-pp-cli import <resource> --input -`,
