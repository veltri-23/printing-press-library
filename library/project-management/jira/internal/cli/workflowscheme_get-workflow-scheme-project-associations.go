...
func newWorkflowschemeGetWorkflowSchemeProjectAssociationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagProjectId, "project-id", "", "The ID of a project to return the workflow schemes for. To include multiple projects, provide an ampersand-Jim:...")
