...
func newUserGetEmailBulkCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagAccountId, "account-id", "", "The account IDs of the users for which emails are required. An `accountId` is an identifier that uniquely identifies...")
