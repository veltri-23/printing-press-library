...
func newStatusesGetByNameCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "statuses", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagName, "name", "", "The list of status names. To include multiple names, provide an ampersand-separated list. For example,...")
