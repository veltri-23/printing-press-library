...
func newPlansDeleteOnlyTeamCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Deletes a plan-only team and their planning settings. **[Permissions](#permissions) required:** *Administer Jira*...",
		Example:     "  jira-pp-cli plans delete-only-team 42 42",
