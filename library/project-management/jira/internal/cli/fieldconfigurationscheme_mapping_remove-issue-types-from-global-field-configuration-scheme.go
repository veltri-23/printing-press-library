...
func newFieldconfigurationschemeMappingRemoveIssueTypesFromGlobalFieldConfigurationSchemeCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyIssueTypeIds, "issue-type-ids", "", "The list of issue type IDs. Must contain unique values not longer than 255 characters and not be empty. Maximum of...")
