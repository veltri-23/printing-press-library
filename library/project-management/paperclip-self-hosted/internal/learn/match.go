...
const (
	...
	// candidate row or table write backs the warning itself â€” the text
	...
	// lookups)" â€” one per unresolvable entity â€” and disappears on its
...
//
// Returns both Entities and Tickers in a single flat slice â€” a query
