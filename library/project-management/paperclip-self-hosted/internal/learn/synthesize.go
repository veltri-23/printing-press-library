...
// the recall command â€” the episode anchor and the interleave signal.
...
// candidate: (class, query_family). One family, one synthesis row â€”
...
// teach itself is never in the window â€” its journal entry is written
...
// the fresh episode has strictly fewer steps than the stored one â€” a
...
//
// Returns the candidate row and whether this call recorded anything â€”
