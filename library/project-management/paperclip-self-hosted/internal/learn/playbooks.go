...
//
// Today the family is simply NonEntityNormalized â€” Normalize +
...
// multiword variant's tokens may be non-adjacent â€” folding uses bag
...
//  2. Exact hit on rawFamily â€” the key a pre-fold build would have
...
// never select it again. The rekey UPDATE is best-effort â€” a write
...
//
// Slots that don't match any query entity stay absent from the map â€”
...
func ResolveSlots(p Playbook, normalized NormalizedQuery, r EntityResolver) map[string]map[string]any {
	...
	// that the playbook author intended for a real entity â€” e.g. a
