...
// order. Cleanup only ever deletes whole oldest segments â€” never
// in-place truncation, which would race concurrent appenders and
// invalidate the (segment, byte) derivation offset â€” and never the
...
const (
	journalSessionEnvVar   = "PAPERCLIP_LEARN_SESSION"
	journalNoLearnEnvVar   = "PAPERCLIP_NO_LEARN"
	journalNoCaptureEnvVar = "PAPERCLIP_LEARN_NO_CAPTURE"
)
...
// see a valid record. Cmd is the resolved subcommand verb chain only â€”
...
// disappears entirely â€” reads then resume at the oldest surviving
...
// oldest segments. The newest segment â€” the only one appenders touch â€”
...
// surviving segment from byte 0 â€” offsets survive rollover by
