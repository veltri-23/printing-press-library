...
// against the quarantined candidate store â€” nothing here touches the
...
// derived flag corrections. Example is a sanitized invocation string â€”
...
// the batch is reprocessed whole on the next post-run pass â€” every
