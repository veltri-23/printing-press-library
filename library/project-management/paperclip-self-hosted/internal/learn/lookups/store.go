...
// and ignores the error. Local-only â€” a single SQLite handle, never
// the network.
...
// function â€” by construction it performs no network I/O.
//
...
//
// Derived rows are self-canonical â€” (kind=resource_type,
// canonical=entity, value=entity) â€” which is exactly what the recall
