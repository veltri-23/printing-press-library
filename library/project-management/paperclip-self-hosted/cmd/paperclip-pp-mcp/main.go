...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/project-management/paperclip-self-hosted/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("PAPERCLIP_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "paperclip-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
