...
but do not stop the import.`,
  ...
  clickup-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  clickup-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | clickup-pp-cli import <resource> --input -`,
