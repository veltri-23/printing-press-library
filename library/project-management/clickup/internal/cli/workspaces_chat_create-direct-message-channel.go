...
func newWorkspacesChatCreateDirectMessageChannelCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/v3/workspaces/{workspace_id}/chat/channels/direct_message"
	...
	cmd.Flags().StringVar(&bodyUserIds, "user-ids", "", "The unique user IDs of participants in the direct message Chat, up to 15. A Self DM is created when no user IDs are...")
