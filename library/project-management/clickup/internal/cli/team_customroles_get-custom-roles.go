...
func newTeamCustomrolesGetCustomRolesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "customroles", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().BoolVar(&flagIncludeMembers, "include-members", false, "Include members")
