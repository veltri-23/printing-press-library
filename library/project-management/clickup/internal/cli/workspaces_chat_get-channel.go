...
func newWorkspacesChatGetChannelCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagDescriptionFormat != "" {
				params["description_format"] = fmt.Sprintf("%v", flagDescriptionFormat)
			}
