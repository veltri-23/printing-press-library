...
but do not stop the import.`,
  ...
  linear-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  linear-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | linear-pp-cli import <resource> --input -`,
