...
large datasets as it has no memory pressure.`,
  ...
  linear-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  linear-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  linear-pp-cli export <resource> --format jsonl | jq '.id'`,
