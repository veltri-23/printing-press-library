# Plane Printed CLI Agent Guide

This directory is a generated `plane-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
plane-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
plane-pp-cli which "<capability>" --json
plane-pp-cli <command> --help
```
...
```bash
plane-pp-cli <command> --help
plane-pp-cli <command> --dry-run --agent
```
