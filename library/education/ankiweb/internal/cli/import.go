...
but do not stop the import.`,
  ...
  ankiweb-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ankiweb-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ankiweb-pp-cli import <resource> --input -`,
