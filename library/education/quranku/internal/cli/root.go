...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "quranku-pp-cli",
		Short: `Quranku CLI — Every Al-Qur'an feature the app has, plus the Indonesian Tarjamah Tafsiriyah offline, a local database, offline…`,
		Long: `Quranku CLI — Every Al-Qur'an feature the app has, plus the Indonesian Tarjamah Tafsiriyah offline, a local database, offline search, a khatam plan, and a hifz tracker no other Qur'an tool has.
...
Health check: run 'quranku-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("quranku-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'quranku-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSurahCmd(flags))
	...
	rootCmd.AddCommand(newNovelBookmarkCmd(flags))
	rootCmd.AddCommand(newNovelDailyCmd(flags))
	rootCmd.AddCommand(newNovelFindCmd(flags))
	rootCmd.AddCommand(newNovelHifzCmd(flags))
	rootCmd.AddCommand(newNovelPlanCmd(flags))
	rootCmd.AddCommand(newNovelRandomCmd(flags))
	rootCmd.AddCommand(newNovelVerseCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAudioPromotedCmd(flags))
	rootCmd.AddCommand(newJuzPromotedCmd(flags))
	rootCmd.AddCommand(newRecitationPromotedCmd(flags))
	rootCmd.AddCommand(newTafsirsPromotedCmd(flags))
	rootCmd.AddCommand(newUthmaniPromotedCmd(flags))
	rootCmd.AddCommand(newVersesPromotedCmd(flags))
