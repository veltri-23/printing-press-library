...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "erank-pp-cli",
		Short: `Erank CLI — Keyword Tool data from eRank, plus local scoring, drift, and listing-gap analysis for Etsy sellers.`,
		Long: `Erank CLI — Keyword Tool data from eRank, plus local scoring, drift, and listing-gap analysis for Etsy sellers.
...
Health check: run 'erank-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("erank-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'erank-pp-cli profile list')")
	...
	rootCmd.AddCommand(newKeywordToolCmd(flags))
	rootCmd.AddCommand(newKeywordlistCmd(flags))
	rootCmd.AddCommand(newDoctorCmd(flags))
	rootCmd.AddCommand(newBrowserSessionProofCmd(flags))
	...
	rootCmd.AddCommand(newNovelAnglesCmd(flags))
	rootCmd.AddCommand(newNovelListingCmd(flags))
	rootCmd.AddCommand(newNovelListsCmd(flags))
	rootCmd.AddCommand(newNovelOpportunityCmd(flags))
	rootCmd.AddCommand(newNovelSaturationCmd(flags))
	rootCmd.AddCommand(newNovelTagsCmd(flags))
	rootCmd.AddCommand(newNovelWatchCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newBuildPromotedCmd(flags))
	rootCmd.AddCommand(newCheckPaddleRestrictionPromotedCmd(flags))
	rootCmd.AddCommand(newIntercomPromotedCmd(flags))
	rootCmd.AddCommand(newMemberShopsPromotedCmd(flags))
	rootCmd.AddCommand(newMotdV3PromotedCmd(flags))
	rootCmd.AddCommand(newOauthPromotedCmd(flags))
	rootCmd.AddCommand(newQuotaPromotedCmd(flags))
	rootCmd.AddCommand(newRefreshDataPromotedCmd(flags))
