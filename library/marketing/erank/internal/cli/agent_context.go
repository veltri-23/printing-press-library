...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://members.erank.com/keyword-tool/top-listings",
		EntryCount:    233,
		APIEntryCount: 61,
		...
		CandidateCommands: []string{
			"create_competition — Derived from observed POST /api/keyword-tool/competition traffic.",
			"create_google_data — Derived from observed POST /api/keyword-tool/google-data traffic.",
			"create_keyword_difficulty — Derived from observed POST /api/keyword-tool/keyword-difficulty traffic.",
			"create_save_history — Derived from observed POST /api/keyword-tool/save-history traffic.",
			"get_user_preferences — Derived from observed GET /api/account/user-preferences/{user_preference_id} traffic.",
			"list_check_paddle_restriction — Derived from observed GET /api/check-paddle-restriction traffic.",
			"list_check_token_validity — Derived from observed GET /api/oauth/check-token-validity traffic.",
			"list_customer — Derived from observed GET /dotjs/v1/quests/customer/ traffic.",
		},
	}
}
