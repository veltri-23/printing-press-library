# eRank Printed CLI Agent Guide

This directory is a generated `erank-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
erank-pp-cli which "<capability>" --json
erank-pp-cli <command> --help
```
...
```bash
erank-pp-cli <command> --help
erank-pp-cli <command> --dry-run --agent
```
