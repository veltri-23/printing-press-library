...
large datasets as it has no memory pressure.`,
  ...
  dub-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  dub-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  dub-pp-cli export <resource> --format jsonl | jq '.id'`,
