...
but do not stop the import.`,
  ...
  customer-io-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  customer-io-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | customer-io-pp-cli import <resource> --input -`,
