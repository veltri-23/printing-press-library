...
Exit codes & warnings:
  ...
  klaviyo-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  klaviyo-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  klaviyo-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  klaviyo-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  klaviyo-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/klaviyo-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "catalog_category_bulk_update_jobs":
		return db.UpsertCatalogCategoryBulkUpdateJobs(data)
	case "metrics":
		return db.UpsertMetrics(data)
	case "relationships":
		return db.UpsertRelationships(data)
	case "catalog_category_bulk_delete_jobs":
		return db.UpsertCatalogCategoryBulkDeleteJobs(data)
	case "forms":
		return db.UpsertForms(data)
	case "form_versions":
		return db.UpsertFormVersions(data)
	case "flow_triggers":
		return db.UpsertFlowTriggers(data)
	case "metric_properties":
		return db.UpsertMetricProperties(data)
	case "profile_suppression_bulk_delete_jobs":
		return db.UpsertProfileSuppressionBulkDeleteJobs(data)
	case "web_feeds":
		return db.UpsertWebFeeds(data)
	case "catalog_variant_bulk_delete_jobs":
		return db.UpsertCatalogVariantBulkDeleteJobs(data)
	case "image_upload":
		return db.UpsertImageUpload(data)
	case "images":
	...
	case "profile_suppression_bulk_create_jobs":
		return db.UpsertProfileSuppressionBulkCreateJobs(data)
	case "coupon_codes":
		return db.UpsertCouponCodes(data)
	case "coupon":
		return db.UpsertCoupon(data)
	case "segments":
	...
	case "catalog_variant_bulk_update_jobs":
		return db.UpsertCatalogVariantBulkUpdateJobs(data)
	case "coupon_code_bulk_create_jobs":
		return db.UpsertCouponCodeBulkCreateJobs(data)
	case "data_sources":
		return db.UpsertDataSources(data)
	case "push_tokens":
	...
	case "catalog_categories":
		return db.UpsertCatalogCategories(data)
	case "items":
		return db.UpsertItems(data)
	case "coupons":
		return db.UpsertCoupons(data)
	case "lists":
		return db.UpsertLists(data)
	case "conversation":
		return db.UpsertConversation(data)
	case "catalog_variants":
		return db.UpsertCatalogVariants(data)
	case "profile_bulk_import_jobs":
		return db.UpsertProfileBulkImportJobs(data)
	case "import_errors":
		return db.UpsertImportErrors(data)
	case "tag_group":
		return db.UpsertTagGroup(data)
	case "tag_groups":
		return db.UpsertTagGroups(data)
	case "flow":
		return db.UpsertFlow(data)
	case "flow_messages":
		return db.UpsertFlowMessages(data)
	case "catalog_item_bulk_update_jobs":
		return db.UpsertCatalogItemBulkUpdateJobs(data)
	case "events":
		return db.UpsertEvents(data)
	case "metric":
		return db.UpsertMetric(data)
	case "flows":
		return db.UpsertFlows(data)
	case "custom_metric":
		return db.UpsertCustomMetric(data)
	case "template_universal_content":
		return db.UpsertTemplateUniversalContent(data)
	case "catalog_item_bulk_delete_jobs":
		return db.UpsertCatalogItemBulkDeleteJobs(data)
	case "catalog_items":
		return db.UpsertCatalogItems(data)
	case "categories":
		return db.UpsertCategories(data)
	case "variants":
		return db.UpsertVariants(data)
	case "campaigns":
		return db.UpsertCampaigns(data)
	case "campaign_messages":
		return db.UpsertCampaignMessages(data)
	case "catalog_item_bulk_create_jobs":
		return db.UpsertCatalogItemBulkCreateJobs(data)
	case "client":
		return db.UpsertClient(data)
	case "form":
		return db.UpsertForm(data)
	case "catalog_category_bulk_create_jobs":
		return db.UpsertCatalogCategoryBulkCreateJobs(data)
	case "catalog_variant_bulk_create_jobs":
		return db.UpsertCatalogVariantBulkCreateJobs(data)
	case "campaign":
		return db.UpsertCampaign(data)
	case "image":
		return db.UpsertImage(data)
	case "template":
		return db.UpsertTemplate(data)
	case "flow_action":
		return db.UpsertFlowAction(data)
	default:
...
func syncResourcePath(resource string) string {
	paths := map[string]string{
		...
		"catalog-category-bulk-create-jobs":    "/api/catalog-category-bulk-create-jobs",
		"catalog-category-bulk-delete-jobs":    "/api/catalog-category-bulk-delete-jobs",
		"catalog-category-bulk-update-jobs":    "/api/catalog-category-bulk-update-jobs",
		"catalog-item-bulk-create-jobs":        "/api/catalog-item-bulk-create-jobs",
		"catalog-item-bulk-delete-jobs":        "/api/catalog-item-bulk-delete-jobs",
		"catalog-item-bulk-update-jobs":        "/api/catalog-item-bulk-update-jobs",
		"catalog-items":                        "/api/catalog-items",
		"catalog-variant-bulk-create-jobs":     "/api/catalog-variant-bulk-create-jobs",
		"catalog-variant-bulk-delete-jobs":     "/api/catalog-variant-bulk-delete-jobs",
		"catalog-variant-bulk-update-jobs":     "/api/catalog-variant-bulk-update-jobs",
		"catalog-variants":                     "/api/catalog-variants",
		"client":                               "/client/reviews",
		"coupon-code-bulk-create-jobs":         "/api/coupon-code-bulk-create-jobs",
		"coupon-codes":                         "/api/coupon-codes",
		"coupons":                              "/api/coupons",
		"custom-metrics":                       "/api/custom-metrics",
		...
		"images":                               "/api/images",
		"lists":                                "/api/lists",
		"mapped-metrics":                       "/api/mapped-metrics",
		"metrics":                              "/api/metrics",
		"profile-bulk-import-jobs":             "/api/profile-bulk-import-jobs",
		"profile-suppression-bulk-create-jobs": "/api/profile-suppression-bulk-create-jobs",
		"profile-suppression-bulk-delete-jobs": "/api/profile-suppression-bulk-delete-jobs",
		...
		"tags":                                 "/api/tags",
		"template-universal-content":           "/api/template-universal-content",
		"templates":                            "/api/templates",
		"tracking-settings":                    "/api/tracking-settings",
		"web-feeds":                            "/api/web-feeds",
		"webhook-topics":                       "/api/webhook-topics",
