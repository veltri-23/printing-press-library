...
but do not stop the import.`,
  ...
  klaviyo-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  klaviyo-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | klaviyo-pp-cli import <resource> --input -`,
