...
large datasets as it has no memory pressure.`,
  ...
  klaviyo-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  klaviyo-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  klaviyo-pp-cli export <resource> --format jsonl | jq '.id'`,
