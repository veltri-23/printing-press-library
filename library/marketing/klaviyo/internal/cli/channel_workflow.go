...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  klaviyo-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  klaviyo-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"accounts", "campaigns", "catalog-categories", "catalog-category-bulk-create-jobs", "catalog-category-bulk-delete-jobs", "catalog-category-bulk-update-jobs", "catalog-item-bulk-create-jobs", "catalog-item-bulk-delete-jobs", "catalog-item-bulk-update-jobs", "catalog-items", "catalog-variant-bulk-create-jobs", "catalog-variant-bulk-delete-jobs", "catalog-variant-bulk-update-jobs", "catalog-variants", "client", "coupon-code-bulk-create-jobs", "coupon-codes", "coupons", "custom-metrics", "data-sources", "events", "flows", "forms", "images", "lists", "mapped-metrics", "metrics", "profile-bulk-import-jobs", "profile-suppression-bulk-create-jobs", "profile-suppression-bulk-delete-jobs", "profiles", "push-tokens", "reviews", "segments", "tag-groups", "tags", "template-universal-content", "templates", "tracking-settings", "web-feeds", "webhook-topics", "webhooks"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  klaviyo-pp-cli workflow status

  # Show status as JSON
  klaviyo-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("klaviyo-pp-cli")
			}
