...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "beehiiv-pp-cli",
		Short: "Manage beehiiv resources via the beehiiv API",
		Long: `Manage beehiiv resources via the beehiiv API.
...
Run 'beehiiv-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("beehiiv-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'beehiiv-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBulkSubscriptionUpdatesCmd(flags))
	rootCmd.AddCommand(newConditionSetsCmd(flags))
	rootCmd.AddCommand(newCustomFieldsCmd(flags))
	rootCmd.AddCommand(newDataPrivacyCmd(flags))
	rootCmd.AddCommand(newEmailBlastsCmd(flags))
	rootCmd.AddCommand(newNewsletterListsCmd(flags))
	rootCmd.AddCommand(newPollsCmd(flags))
	rootCmd.AddCommand(newPostsCmd(flags))
	rootCmd.AddCommand(newPublicationsCmd(flags))
	rootCmd.AddCommand(newSegmentsCmd(flags))
	rootCmd.AddCommand(newSubscriptionsCmd(flags))
	rootCmd.AddCommand(newTiersCmd(flags))
	...
	rootCmd.AddCommand(newAdvertisementOpportunitiesPromotedCmd(flags))
	rootCmd.AddCommand(newBulkSubscriptionsPromotedCmd(flags))
	rootCmd.AddCommand(newEngagementsPromotedCmd(flags))
	rootCmd.AddCommand(newPostTemplatesPromotedCmd(flags))
	rootCmd.AddCommand(newReferralProgramPromotedCmd(flags))
