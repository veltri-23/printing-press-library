...
large datasets as it has no memory pressure.`,
  ...
  beehiiv-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  beehiiv-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  beehiiv-pp-cli export <resource> --format jsonl | jq '.id'`,
