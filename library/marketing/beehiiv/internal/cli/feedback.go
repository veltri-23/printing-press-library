...
func FeedbackEndpointConfigured() bool {
	return os.Getenv("BEEHIIV_FEEDBACK_ENDPOINT") != ""
}
...
func feedbackAutoSend() bool {
	v := strings.ToLower(strings.TrimSpace(os.Getenv("BEEHIIV_FEEDBACK_AUTO_SEND")))
...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "beehiiv-pp-cli/feedback")
