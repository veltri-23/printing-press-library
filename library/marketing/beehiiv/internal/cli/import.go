...
but do not stop the import.`,
  ...
  beehiiv-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  beehiiv-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | beehiiv-pp-cli import <resource> --input -`,
