...
large datasets as it has no memory pressure.`,
  ...
  trendhunter-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  trendhunter-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  trendhunter-pp-cli export <resource> --format jsonl | jq '.id'`,
