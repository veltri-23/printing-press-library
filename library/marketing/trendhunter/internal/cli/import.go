...
but do not stop the import.`,
  ...
  trendhunter-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  trendhunter-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | trendhunter-pp-cli import <resource> --input -`,
