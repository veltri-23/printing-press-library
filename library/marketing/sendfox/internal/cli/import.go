...
but do not stop the import.`,
  ...
  sendfox-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sendfox-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sendfox-pp-cli import <resource> --input -`,
