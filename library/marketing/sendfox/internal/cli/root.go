...
Run 'sendfox-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("sendfox-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'sendfox-pp-cli profile list')")
