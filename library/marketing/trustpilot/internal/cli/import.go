...
but do not stop the import.`,
  ...
  trustpilot-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  trustpilot-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | trustpilot-pp-cli import <resource> --input -`,
