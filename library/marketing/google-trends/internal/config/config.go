...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("GOOGLE_TRENDS_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("GOOGLE_TRENDS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "google-trends-pp-cli", "config.toml"), nil
}
