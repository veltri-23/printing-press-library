...
func resetCredentialEnv(t *testing.T) (home, configPath string) {
	...
	for _, name := range []string{
		...
		"GOOGLE_TRENDS_CONFIG_DIR",
		"GOOGLE_TRENDS_DATA_DIR",
		"GOOGLE_TRENDS_STATE_DIR",
		"GOOGLE_TRENDS_CACHE_DIR",
		"GOOGLE_TRENDS_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
	...
	return home, filepath.Join(home, ".config", "google-trends-pp-cli", "config.toml")
}
...
func TestCorruptCredentialsFallsBackToLegacyConfig(t *testing.T) {
	...
	credentialsPath := filepath.Join(home, ".local", "share", "google-trends-pp-cli", "credentials.toml")
...
func TestAuthWriteScrubsLegacyConfigWhenRelocated(t *testing.T) {
	...
	activeConfigPath := filepath.Join(newConfigDir, "google-trends-pp-cli", "config.toml")
	...
	credsPath := filepath.Join(newDataDir, "google-trends-pp-cli", "credentials.toml")
