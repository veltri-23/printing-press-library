...
func newMyBusinessLodgingLocationsGetGoogleUpdatedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagReadMask != "" {
				params["readMask"] = fmt.Sprintf("%v", flagReadMask)
			}
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "my-business-lodging-locations", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
	...
	cmd.Flags().StringVar(&flagReadMask, "read-mask", "", "Required. The specific fields to return. Use '*' to include all fields.")
