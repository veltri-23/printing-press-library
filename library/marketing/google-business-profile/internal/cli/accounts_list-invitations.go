...
func newAccountsListInvitationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagFilter, "filter", "", "Optional. Filtering the response is supported via the Invitation.target_type field.")
