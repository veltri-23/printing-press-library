...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
  ...
  google-business-profile-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if os.Getenv("GOOGLE_BUSINESS_PROFILE_OAUTH2") != "" {
				authEnvSet = append(authEnvSet, "GOOGLE_BUSINESS_PROFILE_OAUTH2")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "GOOGLE_BUSINESS_PROFILE_OAUTH2")
			}
			switch {
			...
			if keyURL, ok := report["auth_key_url"]; ok {
				fmt.Fprintf(w, "  Create OAuth credentials at: %v\n", keyURL)
			}
