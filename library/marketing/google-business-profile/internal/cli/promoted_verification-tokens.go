...
func newVerificationTokensPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "verification_tokens", data, "")
			}
	...
	cmd.Flags().StringVar(&bodyLocationId, "location-id", "", "The location identifier associated with an unverified listing.")
