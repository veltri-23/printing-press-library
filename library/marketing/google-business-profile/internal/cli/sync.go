...
func resourceSupportsPagination(resource string) bool {
	...
	case "chains":
		return true
	case "place_action_type_metadata":
		return true
	}
	return false
}
...
func syncResourceFieldSelector(resource string) (string, string) {
	switch resource {
	case "accounts":
		return "filter", "accountName,accountNumber,name,permissionLevel,primaryOwner,role,type,verificationState,vettedState"
	case "attributes":
		return "showAll", "deprecated,displayName,groupDisplayName,parent,repeatable,valueType"
	}
	return "", ""
}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "business-profile-performance-locations":
		return db.UpsertBusinessProfilePerformanceLocations(data)
	case "categories":
		return db.UpsertCategories(data)
	case "chains":
		return db.UpsertChains(data)
	case "google_locations":
		return db.UpsertGoogleLocations(data)
	case "my-business-business-accounts":
		return db.UpsertMyBusinessBusinessAccounts(data)
	case "my-business-business-locations":
		return db.UpsertMyBusinessBusinessLocations(data)
	case "my-business-lodging-locations":
		return db.UpsertMyBusinessLodgingLocations(data)
	case "my-business-place-locations":
		return db.UpsertMyBusinessPlaceLocations(data)
	case "my-business-q-locations":
		return db.UpsertMyBusinessQLocations(data)
	case "my-business-verifications-locations":
		return db.UpsertMyBusinessVerificationsLocations(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"attributes",
		"categories",
		"categories-categories:batch-get",
		"chains",
