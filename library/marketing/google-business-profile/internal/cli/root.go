...
Run 'google-business-profile-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.AddCommand(newBusinessProfilePerformanceLocationsCmd(flags))
	rootCmd.AddCommand(newCategoriesCmd(flags))
	rootCmd.AddCommand(newChainsCmd(flags))
	rootCmd.AddCommand(newGoogleLocationsCmd(flags))
	rootCmd.AddCommand(newMyBusinessBusinessAccountsCmd(flags))
	rootCmd.AddCommand(newMyBusinessBusinessLocationsCmd(flags))
	rootCmd.AddCommand(newMyBusinessLodgingLocationsCmd(flags))
	rootCmd.AddCommand(newMyBusinessNotificationsAccountsCmd(flags))
	rootCmd.AddCommand(newMyBusinessPlaceLocationsCmd(flags))
	rootCmd.AddCommand(newMyBusinessQLocationsCmd(flags))
	rootCmd.AddCommand(newMyBusinessVerificationsLocationsCmd(flags))
	...
	rootCmd.AddCommand(newAttributesPromotedCmd(flags))
	rootCmd.AddCommand(newLocationsPromotedCmd(flags))
	rootCmd.AddCommand(newPlaceActionTypeMetadataPromotedCmd(flags))
	rootCmd.AddCommand(newVerificationTokensPromotedCmd(flags))
