...
func newLocationsPromotedCmd(flags *rootFlags) *cobra.Command {
	var bodyDestinationAccount string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			body := map[string]any{}
			if bodyDestinationAccount != "" {
				body["destinationAccount"] = bodyDestinationAccount
			}
	...
	cmd.Flags().StringVar(&bodyDestinationAccount, "destination-account", "", "Required. Name of the account resource to transfer the location to (for example, 'accounts/{account}').")
