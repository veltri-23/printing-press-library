# Google Business Profile Printed CLI Agent Guide

This directory is a generated `google-business-profile-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
google-business-profile-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
google-business-profile-pp-cli which "<capability>" --json
google-business-profile-pp-cli <command> --help
```
...
```bash
google-business-profile-pp-cli <command> --agent
```
...
```bash
google-business-profile-pp-cli <command> --help
google-business-profile-pp-cli <command> --dry-run --agent
```
