...
but do not stop the import.`,
  ...
  ahrefs-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ahrefs-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ahrefs-pp-cli import <resource> --input -`,
