...
large datasets as it has no memory pressure.`,
  ...
  ahrefs-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  ahrefs-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  ahrefs-pp-cli export <resource> --format jsonl | jq '.id'`,
