...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "amplitude-pp-cli",
		Short: "Manage amplitude resources via the amplitude API",
		Long: `Manage amplitude resources via the amplitude API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'amplitude-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("amplitude-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'amplitude-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCohortsCmd(flags))
	...
	rootCmd.AddCommand(newAnnotationsPromotedCmd(flags))
	rootCmd.AddCommand(newEventExportsPromotedCmd(flags))
	rootCmd.AddCommand(newEventsPromotedCmd(flags))
	rootCmd.AddCommand(newFunnelsPromotedCmd(flags))
	rootCmd.AddCommand(newRetentionPromotedCmd(flags))
	rootCmd.AddCommand(newRevenuePromotedCmd(flags))
	rootCmd.AddCommand(newSegmentationPromotedCmd(flags))
	rootCmd.AddCommand(newUsersPromotedCmd(flags))
	rootCmd.AddCommand(newUsersearchPromotedCmd(flags))
