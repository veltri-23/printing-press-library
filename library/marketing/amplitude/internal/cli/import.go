...
but do not stop the import.`,
  ...
  amplitude-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  amplitude-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | amplitude-pp-cli import <resource> --input -`,
