...
large datasets as it has no memory pressure.`,
  ...
  amplitude-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  amplitude-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  amplitude-pp-cli export <resource> --format jsonl | jq '.id'`,
