...
but do not stop the import.`,
  ...
  google-search-console-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  google-search-console-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | google-search-console-pp-cli import <resource> --input -`,
