...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/marketing/google-search-console/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "google-search-console-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
