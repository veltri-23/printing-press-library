# Judge Me Printed CLI Agent Guide

This directory is a generated `judge-me-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
judge-me-pp-cli doctor --json
judge-me-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
judge-me-pp-cli which "<capability>" --json
judge-me-pp-cli <command> --help
```
...
```bash
judge-me-pp-cli <command> --help
judge-me-pp-cli <command> --dry-run --agent
```
