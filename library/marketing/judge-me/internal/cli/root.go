...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "judge-me-pp-cli",
		Short: "Manage judge-me resources via the judge-me API",
		Long: `Manage judge-me resources via the judge-me API.
...
Run 'judge-me-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("judge-me-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'judge-me-pp-cli profile list')")
	...
	rootCmd.AddCommand(newReviewersCmd(flags))
	...
	rootCmd.AddCommand(newReputationCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newPrivateRepliesPromotedCmd(flags))
	rootCmd.AddCommand(newRepliesPromotedCmd(flags))
