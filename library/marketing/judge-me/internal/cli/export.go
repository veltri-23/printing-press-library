...
large datasets as it has no memory pressure.`,
  ...
  judge-me-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  judge-me-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  judge-me-pp-cli export <resource> --format jsonl | jq '.id'`,
