...
Resource scoping:
  ...
  judge-me-pp-cli sync

  # Sync specific resources only
  judge-me-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  judge-me-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  judge-me-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  judge-me-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  judge-me-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/judge-me-pp-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "widgets":
		return true
	case "widgets-all-reviews-page":
		return true
	case "widgets-product-review":
		return true
	}
	return false
}
...
func defaultSyncResources() []string {
	return []string{
		...
		"webhooks",
		"widgets",
		"widgets-all-reviews-count",
		"widgets-all-reviews-page",
		"widgets-all-reviews-rating",
		"widgets-product-review",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"settings":                   "/settings",
		"webhooks":                   "/webhooks",
		"widgets":                    "/widgets/reviews_tab",
		"widgets-all-reviews-count":  "/widgets/all_reviews_count",
		"widgets-all-reviews-page":   "/widgets/all_reviews_page",
		"widgets-all-reviews-rating": "/widgets/all_reviews_rating",
		"widgets-product-review":     "/widgets/product_review",
	}
