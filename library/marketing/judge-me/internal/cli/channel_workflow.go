...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  judge-me-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  judge-me-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"reviews", "webhooks", "widgets", "widgets-all-reviews-count", "widgets-all-reviews-page", "widgets-all-reviews-rating", "widgets-product-review"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  judge-me-pp-cli workflow status

  # Show status as JSON
  judge-me-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("judge-me-pp-cli")
			}
