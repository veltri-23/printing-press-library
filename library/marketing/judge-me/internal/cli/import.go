...
but do not stop the import.`,
  ...
  judge-me-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  judge-me-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | judge-me-pp-cli import <resource> --input -`,
