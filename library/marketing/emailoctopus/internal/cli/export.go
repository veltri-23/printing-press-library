...
large datasets as it has no memory pressure.`,
  ...
  emailoctopus-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  emailoctopus-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  emailoctopus-pp-cli export <resource> --format jsonl | jq '.id'`,
