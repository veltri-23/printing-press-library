...
Resource scoping:
  ...
  emailoctopus-pp-cli sync

  # Sync specific resources only
  emailoctopus-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  emailoctopus-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  emailoctopus-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  emailoctopus-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  emailoctopus-pp-cli sync --latest-only`,
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "contacts", ParentTable: "lists", ParentIDParam: "list_id", PathTemplate: "/lists/{list_id}/contacts", KeyField: ""},
		{Name: "reports", ParentTable: "campaigns", ParentIDParam: "campaign_id", PathTemplate: "/campaigns/{campaign_id}/reports", KeyField: ""},
		{Name: "tags", ParentTable: "lists", ParentIDParam: "list_id", PathTemplate: "/lists/{list_id}/tags", KeyField: ""},
	}
}
