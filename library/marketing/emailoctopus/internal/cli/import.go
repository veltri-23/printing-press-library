...
but do not stop the import.`,
  ...
  emailoctopus-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  emailoctopus-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | emailoctopus-pp-cli import <resource> --input -`,
