...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/marketing/kit/internal/mcp"
)
...
// streamable HTTP when hosted in a container or remote sandbox, matching
// the Anthropic guidance that production agents need a remote option.
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "kit-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
