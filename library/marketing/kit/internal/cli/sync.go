...
Resource scoping:
  ...
  kit-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  kit-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  kit-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  kit-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  kit-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "clicks":
		return db.UpsertClicks(data)
	case "broadcasts_stats":
		return db.UpsertBroadcastsStats(data)
	case "forms_subscribers":
		return db.UpsertFormsSubscribers(data)
	case "emails":
		return db.UpsertEmails(data)
	case "sequences_subscribers":
		return db.UpsertSequencesSubscribers(data)
	case "subscribers_stats":
		return db.UpsertSubscribersStats(data)
	case "subscribers_tags":
		return db.UpsertSubscribersTags(data)
	case "unsubscribe":
		return db.UpsertUnsubscribe(data)
	case "tags_subscribers":
		return db.UpsertTagsSubscribers(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"account":                 "/v4/account",
		"account-colors":          "/v4/account/colors",
		"account-creator-profile": "/v4/account/creator_profile",
		"account-email-stats":     "/v4/account/email_stats",
		"account-growth-stats":    "/v4/account/growth_stats",
		"broadcasts":              "/v4/broadcasts",
		"broadcasts-stats":        "/v4/broadcasts/stats",
		"custom-fields":           "/v4/custom_fields",
		"email-templates":         "/v4/email_templates",
		"forms":                   "/v4/forms",
		"posts":                   "/v4/posts",
		"purchases":               "/v4/purchases",
		"segments":                "/v4/segments",
		"sequences":               "/v4/sequences",
		"snippets":                "/v4/snippets",
		"subscribers":             "/v4/subscribers",
		"tags":                    "/v4/tags",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "emails", ParentTable: "sequences", ParentIDParam: "sequence_id", PathTemplate: "/v4/sequences/{sequence_id}/emails", KeyField: ""},
		{Name: "forms_subscribers", ParentTable: "forms", ParentIDParam: "form_id", PathTemplate: "/v4/forms/{form_id}/subscribers", KeyField: ""},
		{Name: "sequences_subscribers", ParentTable: "sequences", ParentIDParam: "sequence_id", PathTemplate: "/v4/sequences/{sequence_id}/subscribers", KeyField: ""},
		{Name: "subscribers_tags", ParentTable: "subscribers", ParentIDParam: "subscriber_id", PathTemplate: "/v4/subscribers/{subscriber_id}/tags", KeyField: ""},
		{Name: "tags_subscribers", ParentTable: "tags", ParentIDParam: "tag_id", PathTemplate: "/v4/tags/{tag_id}/subscribers", KeyField: ""},
	}
}
