...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "kit-pp-cli",
		Short: "Manage kit resources via the kit API",
		Long: `Manage kit resources via the kit API.
...
Run 'kit-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("kit-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'kit-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSequencesCmd(flags))
	...
	rootCmd.AddCommand(newSegmentsPromotedCmd(flags))
