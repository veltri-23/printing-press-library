...
Resource scoping:
  ...
  google-play-pp-cli sync

  # Sync specific resources only
  google-play-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  google-play-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  google-play-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  google-play-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  google-play-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/google-play-pp-cli/data.db)")
