...
but do not stop the import.`,
  ...
  google-play-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  google-play-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | google-play-pp-cli import <resource> --input -`,
