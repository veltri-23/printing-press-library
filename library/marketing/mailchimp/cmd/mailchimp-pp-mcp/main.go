...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/marketing/mailchimp/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "mailchimp-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
