...
Resource scoping:
  ...
  mailchimp-pp-cli sync

  # Sync specific resources only
  mailchimp-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  mailchimp-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  mailchimp-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  mailchimp-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  mailchimp-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("mailchimp-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/mailchimp-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "account-exports":
		return db.UpsertAccountExports(data)
	case "audiences":
		return db.UpsertAudiences(data)
	case "contacts":
		return db.UpsertContacts(data)
	case "authorized-apps":
		return db.UpsertAuthorizedApps(data)
	case "automations":
		return db.UpsertAutomations(data)
	case "automations_actions":
		return db.UpsertAutomationsActions(data)
	case "emails":
		return db.UpsertEmails(data)
	case "removed_subscribers":
		return db.UpsertRemovedSubscribers(data)
	case "batch-webhooks":
		return db.UpsertBatchWebhooks(data)
	case "batches":
		return db.UpsertBatches(data)
	case "campaign-folders":
		return db.UpsertCampaignFolders(data)
	case "campaigns":
		return db.UpsertCampaigns(data)
	case "campaigns_actions":
		return db.UpsertCampaignsActions(data)
	case "campaigns_content":
		return db.UpsertCampaignsContent(data)
	case "feedback":
		return db.UpsertFeedback(data)
	case "send_checklist":
		return db.UpsertSendChecklist(data)
	case "connected-sites":
		return db.UpsertConnectedSites(data)
	case "connected_sites_actions":
		return db.UpsertConnectedSitesActions(data)
	case "conversations":
		return db.UpsertConversations(data)
	case "messages":
		return db.UpsertMessages(data)
	case "ecommerce":
		return db.UpsertEcommerce(data)
	case "facebook-ads":
		return db.UpsertFacebookAds(data)
	case "file-manager":
		return db.UpsertFileManager(data)
	case "landing-pages":
		return db.UpsertLandingPages(data)
	case "landing_pages_actions":
		return db.UpsertLandingPagesActions(data)
	case "landing_pages_content":
		return db.UpsertLandingPagesContent(data)
	case "lists":
		return db.UpsertLists(data)
	case "lists_abuse_reports":
		return db.UpsertListsAbuseReports(data)
	case "activity":
		return db.UpsertActivity(data)
	case "clients":
		return db.UpsertClients(data)
	case "growth_history":
		return db.UpsertGrowthHistory(data)
	case "interest_categories":
		return db.UpsertInterestCategories(data)
	case "lists_locations":
		return db.UpsertListsLocations(data)
	case "members":
		return db.UpsertMembers(data)
	case "merge_fields":
		return db.UpsertMergeFields(data)
	case "segments":
		return db.UpsertSegments(data)
	case "signup_forms":
		return db.UpsertSignupForms(data)
	case "surveys":
		return db.UpsertSurveys(data)
	case "tag_search":
		return db.UpsertTagSearch(data)
	case "webhooks":
	...
	case "reports_abuse_reports":
		return db.UpsertReportsAbuseReports(data)
	case "advice":
		return db.UpsertAdvice(data)
	case "click_details":
		return db.UpsertClickDetails(data)
	case "domain_performance":
		return db.UpsertDomainPerformance(data)
	case "ecommerce_product_activity":
		return db.UpsertEcommerceProductActivity(data)
	case "eepurl":
		return db.UpsertEepurl(data)
	case "email_activity":
		return db.UpsertEmailActivity(data)
	case "reports_locations":
		return db.UpsertReportsLocations(data)
	case "open_details":
		return db.UpsertOpenDetails(data)
	case "sent_to":
		return db.UpsertSentTo(data)
	case "sub_reports":
		return db.UpsertSubReports(data)
	case "unsubscribed":
		return db.UpsertUnsubscribed(data)
	case "sms-campaigns":
		return db.UpsertSmsCampaigns(data)
	case "sms_campaigns_actions":
		return db.UpsertSmsCampaignsActions(data)
	case "sms_campaigns_content":
		return db.UpsertSmsCampaignsContent(data)
	case "template-folders":
		return db.UpsertTemplateFolders(data)
	case "templates":
		return db.UpsertTemplates(data)
	case "default_content":
		return db.UpsertDefaultContent(data)
	case "verified-domains":
		return db.UpsertVerifiedDomains(data)
	case "verified_domains_actions":
		return db.UpsertVerifiedDomainsActions(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"activity-feed":           "/activity-feed/chimp-chatter",
		"audiences":               "/audiences",
		"authorized-apps":         "/authorized-apps",
		"automations":             "/automations",
		"batch-webhooks":          "/batch-webhooks",
		"batches":                 "/batches",
		...
		"file-manager-folders":    "/file-manager/folders",
		"landing-pages":           "/landing-pages",
		"lists":                   "/lists",
		"reporting":               "/reporting/surveys",
		"reporting-facebook-ads":  "/reporting/facebook-ads",
		"reporting-landing-pages": "/reporting/landing-pages",
		"reports":                 "/reports",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "activity", ParentTable: "lists", ParentIDParam: "list_id", PathTemplate: "/lists/{list_id}/activity", KeyField: ""},
		{Name: "click_details", ParentTable: "reports", ParentIDParam: "campaign_id", PathTemplate: "/reports/{campaign_id}/click-details/{link_id}/members", KeyField: ""},
		{Name: "contacts", ParentTable: "audiences", ParentIDParam: "audience_id", PathTemplate: "/audiences/{audience_id}/contacts", KeyField: ""},
		{Name: "ecommerce_product_activity", ParentTable: "reports", ParentIDParam: "campaign_id", PathTemplate: "/reports/{campaign_id}/ecommerce-product-activity", KeyField: ""},
		{Name: "email_activity", ParentTable: "reports", ParentIDParam: "campaign_id", PathTemplate: "/reports/{campaign_id}/email-activity", KeyField: ""},
		{Name: "growth_history", ParentTable: "lists", ParentIDParam: "list_id", PathTemplate: "/lists/{list_id}/growth-history", KeyField: ""},
		{Name: "interest_categories", ParentTable: "lists", ParentIDParam: "list_id", PathTemplate: "/lists/{list_id}/interest-categories", KeyField: ""},
		{Name: "lists_abuse_reports", ParentTable: "lists", ParentIDParam: "list_id", PathTemplate: "/lists/{list_id}/abuse-reports", KeyField: ""},
		{Name: "members", ParentTable: "lists", ParentIDParam: "list_id", PathTemplate: "/lists/{list_id}/members/{subscriber_hash}/activity-feed", KeyField: ""},
		{Name: "merge_fields", ParentTable: "lists", ParentIDParam: "list_id", PathTemplate: "/lists/{list_id}/merge-fields", KeyField: ""},
		{Name: "open_details", ParentTable: "reports", ParentIDParam: "campaign_id", PathTemplate: "/reports/{campaign_id}/open-details", KeyField: ""},
		{Name: "reports_locations", ParentTable: "reports", ParentIDParam: "campaign_id", PathTemplate: "/reports/{campaign_id}/locations", KeyField: ""},
		{Name: "segments", ParentTable: "lists", ParentIDParam: "list_id", PathTemplate: "/lists/{list_id}/segments", KeyField: ""},
		{Name: "sent_to", ParentTable: "reports", ParentIDParam: "campaign_id", PathTemplate: "/reports/{campaign_id}/sent-to", KeyField: ""},
		{Name: "unsubscribed", ParentTable: "reports", ParentIDParam: "campaign_id", PathTemplate: "/reports/{campaign_id}/unsubscribed", KeyField: ""},
	}
}
