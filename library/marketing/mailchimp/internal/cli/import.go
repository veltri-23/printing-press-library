...
but do not stop the import.`,
  ...
  mailchimp-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  mailchimp-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | mailchimp-pp-cli import <resource> --input -`,
