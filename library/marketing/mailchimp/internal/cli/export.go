...
large datasets as it has no memory pressure.`,
  ...
  mailchimp-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  mailchimp-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  mailchimp-pp-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.MinimumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				"account-exports":  true,
				"audiences":        true,
				"authorized-apps":  true,
				"automations":      true,
				"batch-webhooks":   true,
				"batches":          true,
				"campaign-folders": true,
				"campaigns":        true,
				"connected-sites":  true,
				"conversations":    true,
				"facebook-ads":     true,
				"landing-pages":    true,
				"lists":            true,
				"ping":             true,
				"reports":          true,
				"search-campaigns": true,
				"search-members":   true,
				"sms-campaigns":    true,
				"template-folders": true,
				"templates":        true,
