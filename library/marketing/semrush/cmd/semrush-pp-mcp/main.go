...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/marketing/semrush/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "semrush-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
