...
but do not stop the import.`,
  ...
  semrush-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  semrush-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | semrush-pp-cli import <resource> --input -`,
