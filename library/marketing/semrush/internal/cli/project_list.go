...
func newProjectListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List all projects on your account. Free (no API units).",
		Example:     "  semrush-pp-cli project list",
		Annotations: map[string]string{"pp:endpoint": "project.list", "pp:method": "GET", "pp:path": "/management/v1/projects", "mcp:read-only": "true"},
