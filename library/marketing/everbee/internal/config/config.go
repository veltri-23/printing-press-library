...
func Load(configPath string) (*Config, error) {
	...
	path := configPath
	if path == "" {
		path = os.Getenv("EVERBEE_CONFIG")
	}
	if path == "" {
		home, _ := os.UserHomeDir()
		path = filepath.Join(home, ".config", "github.com/mvanhorn/printing-press-library/library/marketing/everbee", "config.toml")
	}
	cfg.Path = path
	...
	// Env var overrides
	if v := os.Getenv("EVERBEE_ACCESS_TOKEN"); v != "" {
		cfg.AccessToken = v
		cfg.AuthSource = "env:EVERBEE_ACCESS_TOKEN"
	}
	...
	if v := os.Getenv("EVERBEE_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
