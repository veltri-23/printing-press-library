...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "github.com/mvanhorn/printing-press-library/library/marketing/everbee",
		Short: `Research Etsy product, shop, and keyword opportunities from EverBee data.`,
		Long: `Research Etsy product, shop, and keyword opportunities from EverBee data.
...
Health check: run 'everbee-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("everbee-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'everbee-pp-cli profile list')")
	...
	rootCmd.AddCommand(newKeywordResearchPromotedCmd(flags))
	rootCmd.AddCommand(newManagementModalsPromotedCmd(flags))
	rootCmd.AddCommand(newProductAnalyticsPromotedCmd(flags))
	rootCmd.AddCommand(newShopsPromotedCmd(flags))
	rootCmd.AddCommand(newOpportunityCmd(flags))
	rootCmd.AddCommand(newNicheCmd(flags))
	rootCmd.AddCommand(newShopInsightsCmd(flags))
	rootCmd.AddCommand(newTagsInsightsCmd(flags))
	rootCmd.AddCommand(newKeywordsInsightsCmd(flags))
	rootCmd.AddCommand(newTrendsInsightsCmd(flags))
	rootCmd.AddCommand(newCompetitorsInsightsCmd(flags))
	rootCmd.AddCommand(newListingInsightsCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "version",
		Short: "Print the EverBee CLI version",
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("everbee-pp-cli %s\n", version)
		},
	}
}
