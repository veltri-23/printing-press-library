...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/marketing/everbee/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "everbee-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
