...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  google-ad-manager-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  google-ad-manager-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  google-ad-manager-pp-cli workflow status

  # Show status as JSON
  google-ad-manager-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("google-ad-manager-pp-cli")
			}
