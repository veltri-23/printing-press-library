...
but do not stop the import.`,
  ...
  google-ad-manager-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  google-ad-manager-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | google-ad-manager-pp-cli import <resource> --input -`,
