...
Resource scoping:
  ...
  google-ad-manager-pp-cli sync

  # Sync specific resources only
  google-ad-manager-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  google-ad-manager-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  google-ad-manager-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  google-ad-manager-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  google-ad-manager-pp-cli sync --latest-only`,
