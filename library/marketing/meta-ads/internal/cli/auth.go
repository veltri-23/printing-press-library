...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Meta Marketing",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  meta-ads-pp-cli auth setup\n  meta-ads-pp-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			w := cmd.OutOrStdout()
			fmt.Fprintln(w, "Get a key at: https://developers.facebook.com/docs/marketing-api/access")
			fmt.Fprintln(w, "")
			fmt.Fprintln(w, "Then set:")
			fmt.Fprintln(w, "  export META_ACCESS_TOKEN=\"<your-token>\"")
			fmt.Fprintln(w, "  meta-ads-pp-cli auth set-token <token>")
			if !launch {
				return nil
			}
			launchURL := "https://developers.facebook.com/docs/marketing-api/access"
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  meta-ads-pp-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("META_ACCESS_TOKEN") != "" {
				envStillSet = "META_ACCESS_TOKEN"
			}
