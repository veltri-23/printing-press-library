...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://kdpnichefinder.com/dashboard",
		EntryCount:    273,
		APIEntryCount: 60,
		...
		CandidateCommands: []string{
			"create_folders — Derived from observed POST /api/folders traffic.",
			"create_toggle_save — Derived from observed POST /api/books/{book_id}/toggle-save traffic.",
			"list_categories — Derived from observed GET /api/categories traffic.",
			"list_evergreen — Derived from observed GET /app/category/evergreen traffic.",
			"list_folders — Derived from observed GET /api/folders traffic.",
			"list_fresh_money — Derived from observed GET /app/category/fresh_money traffic.",
			"list_hidden_gems — Derived from observed GET /app/category/hidden_gems traffic.",
			"list_high_ticket — Derived from observed GET /app/category/high_ticket traffic.",
		},
	}
}
