...
but do not stop the import.`,
  ...
  kdpnichefinder-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  kdpnichefinder-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | kdpnichefinder-pp-cli import <resource> --input -`,
