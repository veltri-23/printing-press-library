...
Resource scoping:
  ...
  kdpnichefinder-pp-cli sync

  # Sync specific resources only
  kdpnichefinder-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  kdpnichefinder-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  kdpnichefinder-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  kdpnichefinder-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  kdpnichefinder-pp-cli sync --latest-only`,
