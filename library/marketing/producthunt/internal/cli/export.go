...
large datasets as it has no memory pressure.`,
  ...
  producthunt-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  producthunt-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  producthunt-pp-cli export <resource> --format jsonl | jq '.id'`,
