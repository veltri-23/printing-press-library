...
Exit codes & warnings:
  ...
  producthunt-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  producthunt-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  producthunt-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  producthunt-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  producthunt-pp-cli sync --latest-only`,
