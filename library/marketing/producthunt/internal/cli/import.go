...
but do not stop the import.`,
  ...
  producthunt-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  producthunt-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | producthunt-pp-cli import <resource> --input -`,
