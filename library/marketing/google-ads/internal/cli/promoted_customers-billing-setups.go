...
func newCustomersBillingSetupsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyOperation, "operation", "", "JSON object for operation. Required. The operation to perform.")
