...
func newCustomersStartIdentityVerificationCmd(flags *rootFlags) *cobra.Command {
	var bodyVerificationProgram string
	var stdinBody bool
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				body = map[string]any{}
				if bodyVerificationProgram != "" {
					body["verificationProgram"] = bodyVerificationProgram
				}
			}
	...
	cmd.Flags().StringVar(&bodyVerificationProgram, "verification-program", "", "Required. The verification program type for which we want to start the verification.")
