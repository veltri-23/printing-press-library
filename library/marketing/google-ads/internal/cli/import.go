...
but do not stop the import.`,
  ...
  google-ads-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  google-ads-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | google-ads-pp-cli import <resource> --input -`,
