...
func newCustomersKeywordPlanAdGroupsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyOperations, "operations", "", "JSON array for operations. Required. The list of operations to perform on individual Keyword Plan ad groups.")
