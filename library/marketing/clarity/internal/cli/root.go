...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "clarity-pp-cli",
		Short: `Generate PP Clarity snippets, audit instrumentation, and export Microsoft Clarity insights.`,
		Long: `Generate PP Clarity snippets, audit instrumentation, and export Microsoft Clarity insights.
...
Health check: run 'clarity-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("clarity-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'clarity-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSnippetCmd(flags))
	rootCmd.AddCommand(newAuditCmd(flags))
	rootCmd.AddCommand(newInsightsCmd(flags))
	rootCmd.AddCommand(newTagPromotedCmd(flags))
