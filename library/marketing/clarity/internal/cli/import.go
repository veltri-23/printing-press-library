...
but do not stop the import.`,
  ...
  clarity-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  clarity-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | clarity-pp-cli import <resource> --input -`,
