...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "braze-pp-cli",
		Short: "Manage braze resources via the braze API",
		Long: `Manage braze resources via the braze API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'braze-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("braze-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'braze-pp-cli profile list')")
	...
	rootCmd.AddCommand(newContentBlocksCmd(flags))
	rootCmd.AddCommand(newEventsCmd(flags))
	rootCmd.AddCommand(newKpiCmd(flags))
	rootCmd.AddCommand(newPreferenceCenterCmd(flags))
	...
	rootCmd.AddCommand(newCustomAttributesPromotedCmd(flags))
	rootCmd.AddCommand(newSessionsPromotedCmd(flags))
