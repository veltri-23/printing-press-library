...
func newTemplatesListEmailCmd(flags *rootFlags) *cobra.Command {
	var flagPage string
	var flagAll bool
	...
	cmd := &cobra.Command{
		...
		Example:     "  braze-pp-cli templates list-email",
		Annotations: map[string]string{"pp:endpoint": "templates.list-email", "pp:method": "GET", "pp:path": "/templates/email/list", "mcp:read-only": "true"},
