...
large datasets as it has no memory pressure.`,
  ...
  braze-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  braze-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  braze-pp-cli export <resource> --format jsonl | jq '.id'`,
