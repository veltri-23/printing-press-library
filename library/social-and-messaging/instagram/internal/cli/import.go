...
but do not stop the import.`,
  ...
  instagram-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  instagram-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | instagram-pp-cli import <resource> --input -`,
