...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Instagram CLI — Every Instagram Business metric across all your brand accounts, with the cross-account comparison and follower-growth h…`,
		Long: `Instagram CLI — Every Instagram Business metric across all your brand accounts, with the cross-account comparison and follower-growth h…
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newAccountInsightsCmd(flags))
	rootCmd.AddCommand(newAccountsCmd(flags))
	rootCmd.AddCommand(newCommentsCmd(flags))
	rootCmd.AddCommand(newHashtagsCmd(flags))
	...
	rootCmd.AddCommand(newNovelBestTimeCmd(flags))
	rootCmd.AddCommand(newNovelCompareCmd(flags))
	rootCmd.AddCommand(newNovelFormatsCmd(flags))
	rootCmd.AddCommand(newNovelGrowthCmd(flags))
	rootCmd.AddCommand(newNovelHashtagPerfCmd(flags))
	rootCmd.AddCommand(newNovelRivalsCmd(flags))
	rootCmd.AddCommand(newNovelTopPostsCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newBusinessDiscoveryPromotedCmd(flags))
