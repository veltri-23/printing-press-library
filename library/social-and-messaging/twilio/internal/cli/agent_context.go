	...
	envVars := []agentContextAuthEnvVar{
		{
			...
			Required:    true,
			Sensitive:   true,
			Description: "Twilio Account SID (starts with AC). Required because the URL path includes it.",
		},
		{
			...
			Required:    false,
			Sensitive:   true,
			Description: "Master Auth Token. Set this OR both TWILIO_API_KEY_SID and TWILIO_API_KEY_SECRET.",
		},
		{
			...
			Required:    false,
			Sensitive:   false,
			Description: "Scoped API Key SID (starts with SK). Pair with TWILIO_API_KEY_SECRET.",
		},
		{
			...
			Required:    false,
			Sensitive:   true,
			Description: "Scoped API Key Secret. Pair with TWILIO_API_KEY_SID.",
		},
	}
	authMode := "api_key"
	if authMode == "" {
