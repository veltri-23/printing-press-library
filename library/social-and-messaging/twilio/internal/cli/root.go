...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "twilio-pp-cli",
		Short: `Twilio CLI — Every Twilio Core feature, plus offline message and call history, FTS, and SQL-grade analytics no other Twilio tool shi…`,
		Long: `Twilio CLI — Every Twilio Core feature, plus offline message and call history, FTS, and SQL-grade analytics no other Twilio tool shi…
...
Health check: run 'twilio-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("twilio-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'twilio-pp-cli profile list')")
	...
	rootCmd.AddCommand(newV20100401Cmd(flags))
	rootCmd.AddCommand(newAddressesCmd(flags))
	rootCmd.AddCommand(newAddressesJsonCmd(flags))
	rootCmd.AddCommand(newApplicationsCmd(flags))
	rootCmd.AddCommand(newApplicationsJsonCmd(flags))
	rootCmd.AddCommand(newCallsCmd(flags))
	rootCmd.AddCommand(newCallsJsonCmd(flags))
	rootCmd.AddCommand(newConferencesCmd(flags))
	rootCmd.AddCommand(newConnectAppsCmd(flags))
	rootCmd.AddCommand(newIncomingPhoneNumbersCmd(flags))
	rootCmd.AddCommand(newIncomingPhoneNumbersJsonCmd(flags))
	rootCmd.AddCommand(newKeysCmd(flags))
	rootCmd.AddCommand(newKeysJsonCmd(flags))
	rootCmd.AddCommand(newMessagesCmd(flags))
	rootCmd.AddCommand(newMessagesJsonCmd(flags))
	rootCmd.AddCommand(newOutgoingCallerIdsCmd(flags))
	rootCmd.AddCommand(newOutgoingCallerIdsJsonCmd(flags))
	rootCmd.AddCommand(newQueuesCmd(flags))
	rootCmd.AddCommand(newQueuesJsonCmd(flags))
	rootCmd.AddCommand(newRecordingsCmd(flags))
	rootCmd.AddCommand(newSigningKeysCmd(flags))
	rootCmd.AddCommand(newSigningKeysJsonCmd(flags))
	rootCmd.AddCommand(newSipCmd(flags))
	rootCmd.AddCommand(newSmsCmd(flags))
	rootCmd.AddCommand(newTranscriptionsCmd(flags))
	...
	// Transcendence commands — features unique to twilio-pp-cli, built on the
	// local SQLite store. Each scored >=6/10 in the absorb manifest.
	rootCmd.AddCommand(newSyncStatusCmd(flags))
	rootCmd.AddCommand(newDeliveryFailuresCmd(flags))
	rootCmd.AddCommand(newMessageStatusFunnelCmd(flags))
	rootCmd.AddCommand(newCallDispositionCmd(flags))
	rootCmd.AddCommand(newIdleNumbersCmd(flags))
	rootCmd.AddCommand(newConversationCmd(flags))
	rootCmd.AddCommand(newOptOutViolationsCmd(flags))
	rootCmd.AddCommand(newErrorCodeExplainCmd(flags))
	rootCmd.AddCommand(newWebhookAuditCmd(flags))
	rootCmd.AddCommand(newCallTraceCmd(flags))
	rootCmd.AddCommand(newTailMessagesCmd(flags))
	rootCmd.AddCommand(newSubaccountSpendCmd(flags))
	...
	rootCmd.AddCommand(newAuthorizedConnectAppsPromotedCmd(flags))
	rootCmd.AddCommand(newAuthorizedConnectAppsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newAvailablePhoneNumbersPromotedCmd(flags))
	rootCmd.AddCommand(newAvailablePhoneNumbersJsonPromotedCmd(flags))
	rootCmd.AddCommand(newBalanceJsonPromotedCmd(flags))
	rootCmd.AddCommand(newConferencesJsonPromotedCmd(flags))
	rootCmd.AddCommand(newConnectAppsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newNotificationsPromotedCmd(flags))
	rootCmd.AddCommand(newNotificationsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newRecordingsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newTokensJsonPromotedCmd(flags))
	rootCmd.AddCommand(newTranscriptionsJsonPromotedCmd(flags))
