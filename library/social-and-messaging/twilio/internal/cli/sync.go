...
Exit codes & warnings:
  ...
  twilio-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  twilio-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  twilio-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  twilio-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  twilio-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/twilio-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "2010_04_01":
		return db.UpsertV20100401(data)
	case "dependent_phone_numbers_json":
		return db.UpsertDependentPhoneNumbersJson(data)
	case "addresses_json":
		return db.UpsertAddressesJson(data)
	case "applications_json":
		return db.UpsertApplicationsJson(data)
	case "authorized_connect_apps_json":
		return db.UpsertAuthorizedConnectAppsJson(data)
	case "local_json":
		return db.UpsertLocalJson(data)
	case "machine_to_machine_json":
		return db.UpsertMachineToMachineJson(data)
	case "mobile_json":
		return db.UpsertMobileJson(data)
	case "national_json":
		return db.UpsertNationalJson(data)
	case "shared_cost_json":
		return db.UpsertSharedCostJson(data)
	case "toll_free_json":
		return db.UpsertTollFreeJson(data)
	case "voip_json":
		return db.UpsertVoipJson(data)
	case "events_json":
		return db.UpsertEventsJson(data)
	case "calls_notifications":
		return db.UpsertCallsNotifications(data)
	case "calls_notifications_json":
		return db.UpsertCallsNotificationsJson(data)
	case "payments":
		return db.UpsertPayments(data)
	case "payments_json":
		return db.UpsertPaymentsJson(data)
	case "calls_recordings":
		return db.UpsertCallsRecordings(data)
	case "calls_recordings_json":
		return db.UpsertCallsRecordingsJson(data)
	case "siprec":
		return db.UpsertSiprec(data)
	case "siprec_json":
		return db.UpsertSiprecJson(data)
	case "streams":
		return db.UpsertStreams(data)
	case "streams_json":
		return db.UpsertStreamsJson(data)
	case "calls_transcriptions":
		return db.UpsertCallsTranscriptions(data)
	case "calls_transcriptions_json":
		return db.UpsertCallsTranscriptionsJson(data)
	case "user_defined_message_subscriptions":
		return db.UpsertUserDefinedMessageSubscriptions(data)
	case "user_defined_message_subscriptions_json":
		return db.UpsertUserDefinedMessageSubscriptionsJson(data)
	case "user_defined_messages_json":
		return db.UpsertUserDefinedMessagesJson(data)
	case "calls_json":
		return db.UpsertCallsJson(data)
	case "participants":
		return db.UpsertParticipants(data)
	case "participants_json":
		return db.UpsertParticipantsJson(data)
	case "conferences_recordings":
		return db.UpsertConferencesRecordings(data)
	case "conferences_recordings_json":
		return db.UpsertConferencesRecordingsJson(data)
	case "conferences_json":
		return db.UpsertConferencesJson(data)
	case "connect_apps_json":
		return db.UpsertConnectAppsJson(data)
	case "incoming_phone_numbers":
		return db.UpsertIncomingPhoneNumbers(data)
	case "assigned_add_ons":
		return db.UpsertAssignedAddOns(data)
	case "assigned_add_ons_json":
		return db.UpsertAssignedAddOnsJson(data)
	case "incoming_phone_numbers_json":
		return db.UpsertIncomingPhoneNumbersJson(data)
	case "keys_json":
		return db.UpsertKeysJson(data)
	case "feedback_json":
		return db.UpsertFeedbackJson(data)
	case "media":
		return db.UpsertMedia(data)
	case "media_json":
		return db.UpsertMediaJson(data)
	case "messages_json":
		return db.UpsertMessagesJson(data)
	case "notifications_json":
		return db.UpsertNotificationsJson(data)
	case "outgoing_caller_ids_json":
		return db.UpsertOutgoingCallerIdsJson(data)
	case "members":
		return db.UpsertMembers(data)
	case "members_json":
		return db.UpsertMembersJson(data)
	case "queues_json":
		return db.UpsertQueuesJson(data)
	case "add_on_results":
		return db.UpsertAddOnResults(data)
	case "add_on_results_json":
		return db.UpsertAddOnResultsJson(data)
	case "recordings_transcriptions":
		return db.UpsertRecordingsTranscriptions(data)
	case "recordings_transcriptions_json":
		return db.UpsertRecordingsTranscriptionsJson(data)
	case "recordings_json":
		return db.UpsertRecordingsJson(data)
	case "signing_keys_json":
		return db.UpsertSigningKeysJson(data)
	case "sip":
		return db.UpsertSip(data)
	case "sms":
		return db.UpsertSms(data)
	case "transcriptions_json":
		return db.UpsertTranscriptionsJson(data)
	case "usage":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"2010-04-01": "/2010-04-01/Accounts.json",
	}
