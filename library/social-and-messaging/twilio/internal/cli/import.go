...
but do not stop the import.`,
  ...
  twilio-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  twilio-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | twilio-pp-cli import <resource> --input -`,
