...
large datasets as it has no memory pressure.`,
  ...
  bird-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  bird-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  bird-pp-cli export <resource> --format jsonl | jq '.id'`,
