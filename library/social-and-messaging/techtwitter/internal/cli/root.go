...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "techtwitter-pp-cli",
		Short: `Techtwitter CLI — Every Tech Twitter read endpoint, plus an offline-searchable local mirror and cited evidence bundles no other tool has.`,
		Long: `Techtwitter CLI — Every Tech Twitter read endpoint, plus an offline-searchable local mirror and cited evidence bundles no other tool has.
...
Health check: run 'techtwitter-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("techtwitter-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'techtwitter-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelAuthorRankCmd(flags))
	rootCmd.AddCommand(newNovelDigestCmd(flags))
	rootCmd.AddCommand(newNovelEvidenceCmd(flags))
	rootCmd.AddCommand(newNovelMomentumCmd(flags))
	rootCmd.AddCommand(newNovelNarrativeCmd(flags))
	rootCmd.AddCommand(newNovelSinceCmd(flags))
	rootCmd.AddCommand(newNovelTimeTravelCmd(flags))
	rootCmd.AddCommand(newTrendingCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAgentPromotedCmd(flags))
	rootCmd.AddCommand(newArticlesPromotedCmd(flags))
	rootCmd.AddCommand(newNewslettersPromotedCmd(flags))
