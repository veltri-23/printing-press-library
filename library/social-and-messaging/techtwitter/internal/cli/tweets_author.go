...
func newTweetsAuthorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "author",
		Short:       "Curated tweets for a specific author handle",
		Example:     "  techtwitter-pp-cli tweets author --handle example-value",
		Annotations: map[string]string{"pp:endpoint": "tweets.author", "pp:method": "GET", "pp:path": "/api/tweets/author", "mcp:read-only": "true"},
	...
	cmd.Flags().StringVar(&flagHandle, "handle", "", "Author handle without the @, e.g. karpathy")
