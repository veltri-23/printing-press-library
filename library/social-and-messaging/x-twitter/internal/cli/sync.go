...
func resourceSupportsPagination(resource string) bool {
	...
	case "timelines":
		return true
	case "tweets-search-stream-rules":
		return true
	case "tweets_retweets":
		return true
	case "users-reposts-of-me":
		return true
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "account-activity":
		return db.UpsertAccountActivity(data)
	case "activity":
	...
	case "evaluate-note":
		return db.UpsertEvaluateNote(data)
	case "likes":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"tweets":                            "/2/tweets/search/webhooks",
		"tweets-search-stream-rules":        "/2/tweets/search/stream/rules",
		"tweets-search-stream-rules-counts": "/2/tweets/search/stream/rules/counts",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "affiliates", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/affiliates", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		...
		{Name: "followed_lists", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/followed_lists", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "following", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/following", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "liked_tweets", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/liked_tweets", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "liking_users", ParentTable: "tweets", ParentIDParam: "id", PathTemplate: "/2/tweets/{id}/liking_users", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "list_memberships", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/list_memberships", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "mentions", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/mentions", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "muting", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/muting", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "owned_lists", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/owned_lists", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "quote_tweets", ParentTable: "tweets", ParentIDParam: "id", PathTemplate: "/2/tweets/{id}/quote_tweets", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "retweeted_by", ParentTable: "tweets", ParentIDParam: "id", PathTemplate: "/2/tweets/{id}/retweeted_by", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "timelines", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/timelines/reverse_chronological", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "tweets_retweets", ParentTable: "tweets", ParentIDParam: "id", PathTemplate: "/2/tweets/{id}/retweets", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "users_followers", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/followers", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "users_tweets", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/2/users/{id}/tweets", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
	}
}
