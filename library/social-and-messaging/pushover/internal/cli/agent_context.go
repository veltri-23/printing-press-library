...
func buildAgentContext(rootCmd *cobra.Command) agentContext {
	envVars := []agentContextAuthEnvVar{
		{Name: "PUSHOVER_APP_TOKEN", Kind: "body-or-query-param", Required: true, Sensitive: true, Description: "Application API token used when --app-token is omitted."},
		{Name: "PUSHOVER_USER_KEY", Kind: "body-param", Required: true, Sensitive: true, Description: "Recipient user or group key used when --user-key is omitted."},
		{Name: "PUSHOVER_TOKEN", Kind: "compat-body-or-query-param", Required: false, Sensitive: true, Description: "Legacy compatibility alias for PUSHOVER_APP_TOKEN."},
		{Name: "PUSHOVER_USER", Kind: "compat-body-param", Required: false, Sensitive: true, Description: "Legacy compatibility alias for PUSHOVER_USER_KEY."},
		{Name: "PUSHOVER_CLIENT_SECRET", Kind: "open-client-param", Required: false, Sensitive: true, Description: "Open Client session secret used when --client-secret is omitted."},
		{Name: "PUSHOVER_DEVICE_ID", Kind: "open-client-param", Required: false, Sensitive: false, Description: "Open Client device id used when --device-id is omitted."},
	}
	authMode := "parameter"
