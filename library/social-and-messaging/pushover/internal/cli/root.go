...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "pushover-pp-cli",
		Short: `Pushover CLI — Pushover from the terminal: send alerts, watch emergency receipts, inspect quota, and keep a redacted local notificatio…`,
		Long: `Manage pushover resources via the pushover API.
...
Run 'pushover-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("pushover-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'pushover-pp-cli profile list')")
	...
	rootCmd.AddCommand(newEmergencyCmd(flags))
	...
	rootCmd.AddCommand(newAppsPromotedCmd(flags))
	rootCmd.AddCommand(newGlancesPromotedCmd(flags))
	rootCmd.AddCommand(newSoundsPromotedCmd(flags))
