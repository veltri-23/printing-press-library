...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/social-and-messaging/linq/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "linq-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
