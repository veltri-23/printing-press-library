...
large datasets as it has no memory pressure.`,
  ...
  multimail-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  multimail-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  multimail-pp-cli export <resource> --format jsonl | jq '.id'`,
