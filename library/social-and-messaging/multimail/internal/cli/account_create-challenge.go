...
func newAccountCreateChallengeCmd(flags *rootFlags) *cobra.Command {
	var bodyOversightEmail string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-challenge",
		Short:       "Returns an ALTCHA challenge. Solve it and include the solution as pow_solution in POST /v1/account.",
