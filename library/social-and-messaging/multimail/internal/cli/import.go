...
but do not stop the import.`,
  ...
  multimail-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  multimail-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | multimail-pp-cli import <resource> --input -`,
