...
func newAccountCreateResendconfirmationCmd(flags *rootFlags) *cobra.Command {
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-resendconfirmation",
		Short:       "Public endpoint (no auth required). Resends the activation email with a new code for unconfirmed accounts.",
