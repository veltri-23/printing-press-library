...
func newWebhooksCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyEvents, "events", "", "Event types to subscribe to")
	cmd.Flags().StringVar(&bodyMailboxId, "mailbox-id", "", "Optional: scope to a specific mailbox")
	cmd.Flags().StringVar(&bodyUrl, "url", "", "HTTPS URL to receive events")
