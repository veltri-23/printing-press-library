	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			if cmd.Flags().Changed("breakdown") {
				...
				if !validBreakdown {
					return fmt.Errorf("invalid value %q for --%s: must be one of %v", flagBreakdown, "breakdown", allowedBreakdown)
				}
			}
