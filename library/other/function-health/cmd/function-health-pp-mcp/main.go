...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/function-health/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "function-health-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
