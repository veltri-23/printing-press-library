...
func newUserPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "user",
		Short:       "Get the authenticated member profile. Used by doctor for reachability + auth check.",
		Long:        "Get the authenticated member profile. Used by doctor for reachability + auth check.",
		Example:     "  function-health-pp-cli user",
