...
native streaming instead of polling.`,
  ...
  function-health-pp-cli tail --interval 10s

  # Tail a specific resource
  function-health-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  function-health-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
