...
func newNotificationsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "notifications",
		Short:       "Read all unread/read notifications about result changes.",
		Long:        "Read all unread/read notifications about result changes.",
		Example:     "  function-health-pp-cli notifications",
