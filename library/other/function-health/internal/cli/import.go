...
but do not stop the import.`,
  ...
  function-health-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  function-health-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | function-health-pp-cli import <resource> --input -`,
