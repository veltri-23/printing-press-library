...
large datasets as it has no memory pressure.`,
  ...
  function-health-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  function-health-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  function-health-pp-cli export <resource> --format jsonl | jq '.id'`,
