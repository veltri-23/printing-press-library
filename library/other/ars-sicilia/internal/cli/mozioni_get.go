...
func newMozioniGetCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:     "get <legisl> <numero>",
		Short:   "Scarica un singolo documento da mozioni.",
		Example: "  ars-sicilia-pp-cli mozioni get 18 1500 --json",
		Args:    cobra.MaximumNArgs(2),
		Annotations: map[string]string{
			"pp:endpoint":   "mozioni.get",
			"mcp:read-only": "true",
		},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return runGet(cmd, flags, "mozioni", legisl, numero)
		},
	}
	return cmd
}
