...
func newInterpellanzeGetCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:     "get <legisl> <numero>",
		Short:   "Scarica un singolo documento da interpellanze.",
		Example: "  ars-sicilia-pp-cli interpellanze get 18 1500 --json",
		Args:    cobra.MaximumNArgs(2),
		Annotations: map[string]string{
			"pp:endpoint":   "interpellanze.get",
			"mcp:read-only": "true",
		},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return runGet(cmd, flags, "interpellanze", legisl, numero)
		},
	}
	return cmd
}
