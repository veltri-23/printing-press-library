...
func newPareriGetCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:     "get <legisl> <numero>",
		Short:   "Scarica un singolo documento da pareri.",
		Example: "  ars-sicilia-pp-cli pareri get 18 1500 --json",
		Args:    cobra.MaximumNArgs(2),
		Annotations: map[string]string{
			"pp:endpoint":   "pareri.get",
			"mcp:read-only": "true",
		},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return runGet(cmd, flags, "pareri", legisl, numero)
		},
	}
	return cmd
}
