...
func newDdlGetCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:     "get <legisl> <numero>",
		Short:   "Scarica un singolo documento da ddl.",
		Example: "  ars-sicilia-pp-cli ddl get 18 1500 --json",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return runGet(cmd, flags, "ddl", legisl, numero)
		},
	}
	return cmd
}
