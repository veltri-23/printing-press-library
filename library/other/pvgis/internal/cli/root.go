...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "pvgis-pp-cli",
		Short: `The free, single-binary PVGIS CLI — fetch JRC solar-radiation and PV-yield estimates with offline cache, multi-site batch, and agent-native JSON.`,
		Long: `The free, single-binary PVGIS CLI — fetch JRC solar-radiation and PV-yield estimates with offline cache, multi-site batch, and agent-native JSON.
...
Health check: run 'pvgis-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("pvgis-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'pvgis-pp-cli profile list')")
	...
	rootCmd.AddCommand(newProductionCmd(flags))
	...
	rootCmd.AddCommand(newHorizonPromotedCmd(flags))
	rootCmd.AddCommand(newRadiationPromotedCmd(flags))
	rootCmd.AddCommand(newWeatherPromotedCmd(flags))
