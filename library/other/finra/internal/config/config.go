...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("FINRA_CLIENT_ID"); v != "" {
		cfg.ClientID = v
		cfg.markEnvOverride("ClientID")
		cfg.AuthSource = "env:FINRA_CLIENT_ID"
		cfg.CredentialSource = "env:FINRA_CLIENT_ID"
	}
	if v := os.Getenv("FINRA_CLIENT_SECRET"); v != "" {
		cfg.ClientSecret = v
		cfg.markEnvOverride("ClientSecret")
		cfg.AuthSource = "env:FINRA_CLIENT_SECRET"
		cfg.CredentialSource = "env:FINRA_CLIENT_SECRET"
	}
	...
	if v := os.Getenv("FINRA_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := os.Getenv("FINRA_TOKEN_URL"); v != "" {
		cfg.TokenURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("FINRA_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "finra-pp-cli", "config.toml"), nil
}
