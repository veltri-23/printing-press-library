...
but do not stop the import.`,
  ...
  lda-gov-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  lda-gov-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | lda-gov-pp-cli import <resource> --input -`,
