...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "lda-gov-pp-cli",
		Short: `Lda Gov CLI — Lobbying disclosure records with local sync, entity resolution, and evidence-grade exports.`,
		Long: `Lda Gov CLI — Lobbying disclosure records with local sync, entity resolution, and evidence-grade exports.
...
Health check: run 'lda-gov-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("lda-gov-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'lda-gov-pp-cli profile list')")
	...
	rootCmd.AddCommand(newConstantsCmd(flags))
	rootCmd.AddCommand(newContributionsCmd(flags))
	rootCmd.AddCommand(newFilingsCmd(flags))
	rootCmd.AddCommand(newLobbyistsCmd(flags))
	rootCmd.AddCommand(newRegistrantsCmd(flags))
	...
	rootCmd.AddCommand(newNovelEntitiesCmd(flags))
	rootCmd.AddCommand(newNovelGraphCmd(flags))
	rootCmd.AddCommand(newNovelReportsCmd(flags))
