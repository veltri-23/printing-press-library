...
large datasets as it has no memory pressure.`,
  ...
  numista-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  numista-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  numista-pp-cli export <resource> --format jsonl | jq '.id'`,
