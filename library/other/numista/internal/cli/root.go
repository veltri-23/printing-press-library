...
See README.md or the bundled SKILL.md for recipes.`,
	...
	// PATCH(amend-2026-05-18: catalogue-discovery + issuer-discovery +
	// types-search-help): Decorate generated commands with hand-written
	// amendments AFTER all generated AddCommand calls have run so the
	// children are present when the attach helpers walk the tree. Each
	// helper no-ops cleanly if a future regeneration removes its target
	// subcommand, so this wiring is safe to leave in place across
	// generator versions.
	attachCatalogueAmendments(rootCmd, flags)
	attachIssuerAmendments(rootCmd, flags)
	attachTypesSearchAmendments(rootCmd, flags)
