...
but do not stop the import.`,
  ...
  numista-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  numista-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | numista-pp-cli import <resource> --input -`,
