...
but do not stop the import.`,
  ...
  weather-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  weather-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | weather-goat-pp-cli import <resource> --input -`,
