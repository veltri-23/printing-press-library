...
large datasets as it has no memory pressure.`,
  ...
  weather-goat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  weather-goat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  weather-goat-pp-cli export <resource> --format jsonl | jq '.id'`,
