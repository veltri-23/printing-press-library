...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "nhc-pp-cli",
		Short: `Nhc CLI — Credible, real-time National Hurricane Center data for AI agents: active storms, parsed advisories, and tropical outloo…`,
		Long: `Nhc CLI — Credible, real-time National Hurricane Center data for AI agents: active storms, parsed advisories, and tropical outloo…
...
Health check: run 'nhc-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("nhc-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'nhc-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelAdvisoryCmd(flags))
	rootCmd.AddCommand(newNovelBriefCmd(flags))
	rootCmd.AddCommand(newNovelCreditsCmd(flags))
	rootCmd.AddCommand(newNovelGisCmd(flags))
	rootCmd.AddCommand(newNovelGraphicsCmd(flags))
	rootCmd.AddCommand(newNovelOutlookCmd(flags))
	rootCmd.AddCommand(newNovelStormCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAlertsPromotedCmd(flags))
	rootCmd.AddCommand(newStormsPromotedCmd(flags))
