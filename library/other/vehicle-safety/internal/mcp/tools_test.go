...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("VEHICLE_SAFETY_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "vehicle-safety-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "vehicle-safety-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"VEHICLE_SAFETY_CONFIG",
		"VEHICLE_SAFETY_CONFIG_DIR",
		"VEHICLE_SAFETY_DATA_DIR",
		"VEHICLE_SAFETY_STATE_DIR",
		"VEHICLE_SAFETY_CACHE_DIR",
		"VEHICLE_SAFETY_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("vehicle-safety", "test")
	RegisterTools(s)
