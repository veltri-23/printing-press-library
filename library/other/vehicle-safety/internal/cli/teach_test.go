...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("VEHICLE_SAFETY_STATE_DIR", "")
	t.Setenv("VEHICLE_SAFETY_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"vehicle-safety-pp-cli auth login",
		"vehicle-safety-pp-cli doctor",
		"vehicle-safety-pp-cli help items",
		"vehicle-safety-pp-cli sync",
		"vehicle-safety-pp-cli profile list",
		"vehicle-safety-pp-cli feedback list",
		"vehicle-safety-pp-cli which",
		"vehicle-safety-pp-cli agent-context",
		"vehicle-safety-pp-cli completion bash",
		"vehicle-safety-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"vehicle-safety-pp-cli recall",
		"vehicle-safety-pp-cli learnings",
		"vehicle-safety-pp-cli teach-pattern",
		"vehicle-safety-pp-cli teach-lookup",
		"vehicle-safety-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("vehicle-safety-pp-cli")); err == nil {
