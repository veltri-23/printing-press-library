...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("VEHICLE_SAFETY_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("VEHICLE_SAFETY_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "vehicle-safety-pp-cli", "config.toml"), nil
}
