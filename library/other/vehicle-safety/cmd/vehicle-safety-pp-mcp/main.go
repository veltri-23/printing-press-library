...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/vehicle-safety/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("VEHICLE_SAFETY_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "vehicle-safety-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
