...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "fred-pp-cli",
		Short: `Fred CLI — Every FRED endpoint, plus a local SQLite store, offline search, and macro commands no other FRED tool has.`,
		Long: `Fred CLI — Every FRED endpoint, plus a local SQLite store, offline search, and macro commands no other FRED tool has.
...
Health check: run 'fred-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("fred-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'fred-pp-cli profile list')")
