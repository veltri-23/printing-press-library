...
large datasets as it has no memory pressure.`,
  ...
  openalex-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  openalex-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  openalex-pp-cli export <resource> --format jsonl | jq '.id'`,
