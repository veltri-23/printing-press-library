...
func newChangefilesGetCmd(flags *rootFlags) *cobra.Command {
	var flagDate string
	...
	cmd.Flags().StringVar(&flagDate, "date", "", "The changefile date in YYYY-MM-DD format")
