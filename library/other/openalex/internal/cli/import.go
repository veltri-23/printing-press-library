...
but do not stop the import.`,
  ...
  openalex-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  openalex-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | openalex-pp-cli import <resource> --input -`,
