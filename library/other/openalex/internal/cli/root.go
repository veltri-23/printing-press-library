...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "openalex-pp-cli",
		Short: "Manage openalex resources via the openalex API",
		Long: `Openalex CLI
...
Health check: run 'openalex-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("openalex-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'openalex-pp-cli profile list')")
	...
	rootCmd.AddCommand(newChangefilesCmd(flags))
	rootCmd.AddCommand(newConceptsCmd(flags))
	rootCmd.AddCommand(newContinentsCmd(flags))
	rootCmd.AddCommand(newCountriesCmd(flags))
	rootCmd.AddCommand(newDomainsCmd(flags))
	rootCmd.AddCommand(newFieldsCmd(flags))
	rootCmd.AddCommand(newFundersCmd(flags))
	...
	rootCmd.AddCommand(newSdgsCmd(flags))
	rootCmd.AddCommand(newSourcesCmd(flags))
	rootCmd.AddCommand(newSubfieldsCmd(flags))
	...
	rootCmd.AddCommand(newInstitutionTypesPromotedCmd(flags))
	rootCmd.AddCommand(newLicensesPromotedCmd(flags))
	rootCmd.AddCommand(newRateLimitPromotedCmd(flags))
	rootCmd.AddCommand(newSourceTypesPromotedCmd(flags))
	rootCmd.AddCommand(newTextPromotedCmd(flags))
	rootCmd.AddCommand(newWorkTypesPromotedCmd(flags))
