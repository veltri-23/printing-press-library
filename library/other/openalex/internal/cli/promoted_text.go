...
func newTextPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagAbstract != "" {
				params["abstract"] = fmt.Sprintf("%v", flagAbstract)
			}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "text", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagTitle, "title", "", "Title text to classify")
	cmd.Flags().StringVar(&flagAbstract, "abstract", "", "Abstract text to classify")
