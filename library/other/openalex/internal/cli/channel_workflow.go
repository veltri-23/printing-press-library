...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  openalex-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  openalex-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"authors", "awards", "changefiles", "concepts", "continents", "countries", "domains", "fields", "funders", "institution-types", "institutions", "keywords", "languages", "licenses", "publishers", "rate-limit", "sdgs", "source-types", "sources", "subfields", "text", "topics", "work-types", "works"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  openalex-pp-cli workflow status

  # Show status as JSON
  openalex-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("openalex-pp-cli")
			}
