# Nypl Digital Collections Printed CLI Agent Guide

This directory is a generated `nypl-digital-collections-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
nypl-digital-collections-pp-cli doctor --json
nypl-digital-collections-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
nypl-digital-collections-pp-cli which "<capability>" --json
nypl-digital-collections-pp-cli <command> --help
```
...
```bash
nypl-digital-collections-pp-cli <command> --agent
```
...
```bash
nypl-digital-collections-pp-cli <command> --help
nypl-digital-collections-pp-cli <command> --dry-run --agent
```
