...
large datasets as it has no memory pressure.`,
  ...
  nypl-digital-collections-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  nypl-digital-collections-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  nypl-digital-collections-pp-cli export <resource> --format jsonl | jq '.id'`,
