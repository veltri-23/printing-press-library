...
but do not stop the import.`,
  ...
  nypl-digital-collections-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  nypl-digital-collections-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | nypl-digital-collections-pp-cli import <resource> --input -`,
