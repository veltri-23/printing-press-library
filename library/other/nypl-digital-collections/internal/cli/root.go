...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "nypl-digital-collections-pp-cli",
		Short: "Manage nypl-digital-collections resources via the nypl-digital-collections API",
		Long: `Manage nypl-digital-collections resources via the nypl-digital-collections API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'nypl-digital-collections-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("nypl-digital-collections-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'nypl-digital-collections-pp-cli profile list')")
	...
	rootCmd.AddCommand(newModsPromotedCmd(flags))
