...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  nypl-digital-collections-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  nypl-digital-collections-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"collections", "items", "items-recent"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  nypl-digital-collections-pp-cli workflow status

  # Show status as JSON
  nypl-digital-collections-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("nypl-digital-collections-pp-cli")
			}
