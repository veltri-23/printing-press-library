...
but do not stop the import.`,
  ...
  rechtspraak-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  rechtspraak-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | rechtspraak-pp-cli import <resource> --input -`,
