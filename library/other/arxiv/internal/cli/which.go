...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  arxiv-pp-cli which "stale tickets"
  arxiv-pp-cli which "bottleneck"
  arxiv-pp-cli which --limit 1 "send message"
  arxiv-pp-cli which                                # list the full capability index`,
