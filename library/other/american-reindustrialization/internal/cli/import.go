...
but do not stop the import.`,
  ...
  american-reindustrialization-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  american-reindustrialization-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | american-reindustrialization-pp-cli import <resource> --input -`,
