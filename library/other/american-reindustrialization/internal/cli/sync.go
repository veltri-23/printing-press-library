...
Resource scoping:
  ...
  american-reindustrialization-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  american-reindustrialization-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  american-reindustrialization-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  american-reindustrialization-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  american-reindustrialization-pp-cli sync --latest-only`,
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"news":                "/news",
		"openings":            "/jobs",
		"openings-categories": "/jobs/categories",
		"openings-companies":  "/jobs/companies",
		"openings-tags":       "/jobs/tags",
		"openings-titles":     "/jobs/titles",
		"tags":                "/tags",
	}
