...
large datasets as it has no memory pressure.`,
  ...
  american-reindustrialization-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  american-reindustrialization-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  american-reindustrialization-pp-cli export <resource> --format jsonl | jq '.id'`,
