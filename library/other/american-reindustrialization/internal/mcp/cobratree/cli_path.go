...
// AMERICAN_REINDUSTRIALIZATION_CLI_PATH env var, then PATH.
func SiblingCLIPath() (string, error) {
	const cliName = "american-reindustrialization-pp-cli"
	...
	if v := os.Getenv("AMERICAN_REINDUSTRIALIZATION_CLI_PATH"); v != "" {
		return v, nil
	}
