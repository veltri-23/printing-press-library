...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: "Manage defillama resources via the defillama API",
		Long: `Manage defillama resources via the defillama API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'defillama-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("defillama-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'defillama-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBridgesCmd(flags))
	rootCmd.AddCommand(newChartCmd(flags))
	rootCmd.AddCommand(newDatCmd(flags))
	rootCmd.AddCommand(newEquitiesCmd(flags))
	rootCmd.AddCommand(newEtfsCmd(flags))
	rootCmd.AddCommand(newHistoricalChainTvlCmd(flags))
	rootCmd.AddCommand(newMetricsCmd(flags))
	rootCmd.AddCommand(newOverviewCmd(flags))
	rootCmd.AddCommand(newPricesCmd(flags))
	rootCmd.AddCommand(newRwaCmd(flags))
	rootCmd.AddCommand(newStablecoinchartsCmd(flags))
	rootCmd.AddCommand(newStablecoinsCmd(flags))
	rootCmd.AddCommand(newSummaryCmd(flags))
	rootCmd.AddCommand(newYieldsCmd(flags))
	...
	rootCmd.AddCommand(newBatchHistoricalPromotedCmd(flags))
	rootCmd.AddCommand(newBlockPromotedCmd(flags))
	rootCmd.AddCommand(newCategoriesPromotedCmd(flags))
	rootCmd.AddCommand(newChainAssetsPromotedCmd(flags))
	rootCmd.AddCommand(newChainsPromotedCmd(flags))
	rootCmd.AddCommand(newEmissionPromotedCmd(flags))
	rootCmd.AddCommand(newEmissionsPromotedCmd(flags))
	rootCmd.AddCommand(newEntitiesPromotedCmd(flags))
	rootCmd.AddCommand(newFdvPromotedCmd(flags))
	rootCmd.AddCommand(newForksPromotedCmd(flags))
	rootCmd.AddCommand(newHacksPromotedCmd(flags))
	rootCmd.AddCommand(newHistoricalLiquidityPromotedCmd(flags))
	rootCmd.AddCommand(newInflowsPromotedCmd(flags))
	rootCmd.AddCommand(newOraclesPromotedCmd(flags))
	rootCmd.AddCommand(newPercentagePromotedCmd(flags))
	rootCmd.AddCommand(newPoolsPromotedCmd(flags))
	rootCmd.AddCommand(newProtocolPromotedCmd(flags))
	rootCmd.AddCommand(newProtocolsPromotedCmd(flags))
	rootCmd.AddCommand(newRaisesPromotedCmd(flags))
	rootCmd.AddCommand(newStablecoinPromotedCmd(flags))
	rootCmd.AddCommand(newStablecoinchainsPromotedCmd(flags))
	rootCmd.AddCommand(newStablecoinpricesPromotedCmd(flags))
	rootCmd.AddCommand(newTokenProtocolsPromotedCmd(flags))
	rootCmd.AddCommand(newTreasuriesPromotedCmd(flags))
	rootCmd.AddCommand(newTvlPromotedCmd(flags))
