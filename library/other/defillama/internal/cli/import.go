...
but do not stop the import.`,
  ...
  defillama-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  defillama-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | defillama-pp-cli import <resource> --input -`,
