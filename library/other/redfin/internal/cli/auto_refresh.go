...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/other/redfin/internal/cliutil"
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "REDFIN_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale redfin-pp-cli cache (refresh failed: %v)\n", err)
