...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://www.redfin.com",
		EntryCount:    0,
		APIEntryCount: 0,
		Reachability:  "browser_http (70% confidence)",
		Protocols: []string{
			"stingray-json-api (95% confidence)",
		},
		AuthCandidates: []string{},
		Protections: []string{
			"aws-cloudfront-waf (85% confidence)",
		},
		...
		CandidateCommands: []string{
			"homes — Stingray gis search is the primary entry point",
			"listing — Listing detail composes initialInfo + aboveTheFold + belowTheFold",
			"market — aggregate-trends endpoint exposes neighborhood medians",
		},
	}
}
