...
but do not stop the import.`,
  ...
  redfin-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  redfin-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | redfin-pp-cli import <resource> --input -`,
