...
but do not stop the import.`,
  ...
  shelters-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  shelters-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | shelters-pp-cli import <resource> --input -`,
