...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  greatclips-pp-cli doctor
  greatclips-pp-cli doctor --json
  greatclips-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export GREATCLIPS_TOKEN=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("GREATCLIPS_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "GREATCLIPS_TOKEN")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "GREATCLIPS_TOKEN")
			}
			switch {
