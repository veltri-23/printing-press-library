...
but do not stop the import.`,
  ...
  greatclips-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  greatclips-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | greatclips-pp-cli import <resource> --input -`,
