...
func newListingsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <id>",
		Short:       "Fetch a single listing detail page",
		Example:     "  motohunt-pp-cli listings get 13256655",
		Annotations: map[string]string{"pp:endpoint": "listings.get", "pp:method": "GET", "pp:path": "/l/{id}", "mcp:read-only": "true", "pp:no-error-path-probe": "true"},
