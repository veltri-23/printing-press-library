...
but do not stop the import.`,
  ...
  motohunt-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  motohunt-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | motohunt-pp-cli import <resource> --input -`,
