...
native streaming instead of polling.`,
  ...
  intervals-icu-pp-cli tail --interval 10s

  # Tail a specific resource
  intervals-icu-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  intervals-icu-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
