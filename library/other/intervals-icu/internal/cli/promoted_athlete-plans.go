...
func newAthletePlansPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string

	cmd := &cobra.Command{
		Use:         "athlete-plans",
		Short:       "Change training plans for a list of athletes",
		Long:        "Change training plans for a list of athletes",
		Example:     "  intervals-icu-pp-cli athlete-plans",
		Annotations: map[string]string{"pp:endpoint": "athlete-plans.update", "pp:method": "PUT", "pp:path": "/api/v1/athlete-plans"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "athlete-plans", data, "")
			}
