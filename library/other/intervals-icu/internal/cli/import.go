...
but do not stop the import.`,
  ...
  intervals-icu-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  intervals-icu-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | intervals-icu-pp-cli import <resource> --input -`,
