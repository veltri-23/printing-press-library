...
but do not stop the import.`,
  ...
  open-meteo-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  open-meteo-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | open-meteo-pp-cli import <resource> --input -`,
