...
func newMeDeleteVariableCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "delete-variable <name>",
		Aliases:     []string{"delete"},
		Short:       "Delete a service variable",
		Example:     "  here-now-pp-cli me delete-variable example-resource",
		Annotations: map[string]string{"pp:endpoint": "me.delete-variable", "pp:method": "DELETE", "pp:path": "/api/v1/me/variables/{name}"},
