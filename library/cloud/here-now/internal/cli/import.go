...
but do not stop the import.`,
  ...
  here-now-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  here-now-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | here-now-pp-cli import <resource> --input -`,
