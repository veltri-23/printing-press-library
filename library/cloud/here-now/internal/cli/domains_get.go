...
func newDomainsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <domain>",
		Short:       "Get custom domain status",
		Example:     "  here-now-pp-cli domains get example-value",
		Annotations: map[string]string{"pp:endpoint": "domains.get", "pp:method": "GET", "pp:path": "/api/v1/domains/{domain}", "mcp:read-only": "true"},
