...
Run 'airbyte-admin-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("airbyte-admin-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'airbyte-admin-pp-cli profile list')")
