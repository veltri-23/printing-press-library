...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  airbyte-admin-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  airbyte-admin-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"public", "public-v1-applications", "public-v1-connector-definitions", "public-v1-destinations", "public-v1-organizations", "public-v1-permissions", "public-v1-sources", "public-v1-tags", "public-v1-workspaces"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  airbyte-admin-pp-cli workflow status

  # Show status as JSON
  airbyte-admin-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("airbyte-admin-pp-cli")
			}
