...
Resource scoping:
  ...
  airbyte-admin-pp-cli sync

  # Sync specific resources only
  airbyte-admin-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  airbyte-admin-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  airbyte-admin-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  airbyte-admin-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  airbyte-admin-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/airbyte-admin-pp-cli/data.db)")
...
func defaultSyncResources() []string {
	return []string{
		...
		"public-v1-connector-definitions",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"public":                          "/public/v1/jobs",
		"public-v1-applications":          "/public/v1/applications",
		"public-v1-connector-definitions": "/public/v1/connector_definitions",
		"public-v1-destinations":          "/public/v1/destinations",
		"public-v1-oauth-callback":        "/public/v1/oauth/callback",
		"public-v1-organizations":         "/public/v1/organizations",
		"public-v1-permissions":           "/public/v1/permissions",
		"public-v1-sources":               "/public/v1/sources",
		"public-v1-tags":                  "/public/v1/tags",
		"public-v1-workspaces":            "/public/v1/workspaces",
	}
