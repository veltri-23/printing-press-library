...
large datasets as it has no memory pressure.`,
  ...
  airbyte-admin-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  airbyte-admin-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  airbyte-admin-pp-cli export <resource> --format jsonl | jq '.id'`,
