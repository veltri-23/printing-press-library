...
but do not stop the import.`,
  ...
  airbyte-admin-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  airbyte-admin-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | airbyte-admin-pp-cli import <resource> --input -`,
