...
native streaming instead of polling.`,
  ...
  airbyte-admin-pp-cli tail --interval 10s

  # Tail a specific resource
  airbyte-admin-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  airbyte-admin-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
