...
func newServicesRevisionsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().IntVar(&flagPageSize, "page-size", 0, "Maximum number of revisions to return in this call.")
	cmd.Flags().StringVar(&flagPageToken, "page-token", "", "A page token received from a previous call to ListRevisions. All other parameters must match.")
