...
type Config struct {
	...
	CloudflareApiToken string            `toml:"api_token"`
}
...
func Load(configPath string) (*Config, error) {
	...
	path := configPath
	if path == "" {
		path = os.Getenv("CLOUDFLARE_CONFIG")
	}
	if path == "" {
		home, _ := os.UserHomeDir()
		path = filepath.Join(home, ".config", "cloudflare-pp-cli", "config.toml")
	}
	cfg.Path = path
	...
	if v := os.Getenv("CLOUDFLARE_API_TOKEN"); v != "" {
		...
		cfg.markEnvOverride("CloudflareApiToken")
	...
	if cfg.AuthSource == "" && cfg.CloudflareApiToken != "" {
		cfg.AuthSource = "config"
	}
	...
	if v := os.Getenv("CLOUDFLARE_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.CloudflareApiToken != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:CLOUDFLARE_API_TOKEN"
		}
		return "Bearer " + c.CloudflareApiToken
	}
	if c.AccessToken != "" {
...
func (c *Config) ClearTokens() error {
	...
	delete(c.envOverrides, "CloudflareApiToken")
	return c.save()
}
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["CloudflareApiToken"] {
			out.CloudflareApiToken = c.fileConfig.CloudflareApiToken
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "CloudflareApiToken":
		c.fileConfig.CloudflareApiToken = c.CloudflareApiToken
	}
}
