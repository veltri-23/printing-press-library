...
func newZonesFiltersCreateCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create <zone_id>",
		Short:       "Creates one or more filters.",
		Example:     "  cloudflare-pp-cli zones filters create 023e105f4ecef8ad9ca31a8372d0c353",
		Annotations: map[string]string{"pp:endpoint": "filters.create", "pp:method": "POST", "pp:path": "/zones/{zone_id}/filters"},
