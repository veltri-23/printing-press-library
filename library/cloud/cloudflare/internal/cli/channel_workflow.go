...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  cloudflare-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"accounts", "live", "memberships", "oauth", "ready", "signed-url", "user", "user-audit-logs", "user-billing-history", "user-billing-profile", "user-firewall-access-rules-rules", "user-invites", "user-load-balancers-monitors", "user-load-balancers-pools", "user-load-balancing-analytics-events", "user-organizations", "user-subscriptions", "user-tokens", "user-tokens-permission-groups", "user-tokens-verify"}
			totalSynced := 0
