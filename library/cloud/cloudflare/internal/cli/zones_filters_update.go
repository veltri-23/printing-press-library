...
func newZonesFiltersUpdateCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "update <zone_id>",
		Short:       "Updates one or more existing filters.",
		Example:     "  cloudflare-pp-cli zones filters update 023e105f4ecef8ad9ca31a8372d0c353",
		Annotations: map[string]string{"pp:endpoint": "filters.update", "pp:method": "PUT", "pp:path": "/zones/{zone_id}/filters"},
