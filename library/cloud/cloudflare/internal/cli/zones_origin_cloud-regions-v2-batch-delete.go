...
func newZonesOriginCloudRegionsV2BatchDeleteCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "cloud-regions-v2-batch-delete <zone_id>",
		Aliases:     []string{"delete"},
		Short:       "Removes up to 100 IP-to-cloud-region mappings in a single request.",
		Example:     "  cloudflare-pp-cli zones origin cloud-regions-v2-batch-delete 023e105f4ecef8ad9ca31a8372d0c353",
		Annotations: map[string]string{"pp:endpoint": "origin.cloud-regions-v2-batch-delete", "pp:method": "DELETE", "pp:path": "/zones/{zone_id}/origin/cloud_regions/batch"},
