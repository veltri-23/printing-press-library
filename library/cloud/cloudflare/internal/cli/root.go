...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cloudflare-pp-cli",
		Short: "Manage cloudflare resources via the cloudflare API",
		Long: `Manage cloudflare resources via the cloudflare API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'cloudflare-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("cloudflare-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'cloudflare-pp-cli profile list')")
	...
	rootCmd.AddCommand(newMembershipsCmd(flags))
	...
	rootCmd.AddCommand(newZonesCmd(flags))
	rootCmd.AddCommand(newDoctorCmd(flags))
	rootCmd.AddCommand(newAuthCmd(flags))
	rootCmd.AddCommand(newTokenWorkflowCmd(flags))
	rootCmd.AddCommand(newProjectWorkflowCmd(flags))
	rootCmd.AddCommand(newTunnelWorkflowCmd(flags))
	rootCmd.AddCommand(newSiteWorkflowCmd(flags))
	rootCmd.AddCommand(newZoneWorkflowCmd(flags))
	rootCmd.AddCommand(newDomainWorkflowCmd(flags))
	rootCmd.AddCommand(newWorkerWorkflowCmd(flags))
	rootCmd.AddCommand(newAIWorkflowCmd(flags))
	rootCmd.AddCommand(newCostWorkflowCmd(flags))
	rootCmd.AddCommand(newDeployWorkflowCmd(flags))
	rootCmd.AddCommand(newRAGWorkflowCmd(flags))
	rootCmd.AddCommand(newMCPWorkflowCmd(flags))
	rootCmd.AddCommand(newR2WorkflowCmd(flags))
	rootCmd.AddCommand(newEmailWorkflowCmd(flags))
	rootCmd.AddCommand(newAgentWorkflowCmd(flags))
	...
	rootCmd.AddCommand(newIpsPromotedCmd(flags))
	rootCmd.AddCommand(newLivePromotedCmd(flags))
	rootCmd.AddCommand(newOauthPromotedCmd(flags))
	rootCmd.AddCommand(newReadyPromotedCmd(flags))
	rootCmd.AddCommand(newSignedUrlPromotedCmd(flags))
	rootCmd.AddCommand(newTenantsPromotedCmd(flags))
	rootCmd.AddCommand(newWorkersPromotedCmd(flags))
