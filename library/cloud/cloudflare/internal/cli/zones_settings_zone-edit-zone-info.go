...
func newZonesSettingsZoneEditZoneInfoCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "zone-edit-zone-info <zone_id>",
		Short:       "Edit multiple zone settings",
		Example:     "  cloudflare-pp-cli zones settings zone-edit-zone-info 023e105f4ecef8ad9ca31a8372d0c353",
		Annotations: map[string]string{"pp:endpoint": "settings.zone-edit-zone-info", "pp:method": "PATCH", "pp:path": "/zones/{zone_id}/settings"},
