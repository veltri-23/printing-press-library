...
large datasets as it has no memory pressure.`,
  ...
  cloudflare-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cloudflare-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cloudflare-pp-cli export <resource> --format jsonl | jq '.id'`,
