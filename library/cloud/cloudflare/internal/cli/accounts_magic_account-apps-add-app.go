...
func newAccountsMagicAccountAppsAddAppCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "account-apps-add-app <account_id>",
		Aliases:     []string{"create"},
		Short:       "Creates a new App for an account",
		Example:     "  cloudflare-pp-cli accounts magic account-apps-add-app 023e105f4ecef8ad9ca31a8372d0c353",
		Annotations: map[string]string{"pp:endpoint": "magic.account-apps-add-app", "pp:method": "POST", "pp:path": "/accounts/{account_id}/magic/apps"},
