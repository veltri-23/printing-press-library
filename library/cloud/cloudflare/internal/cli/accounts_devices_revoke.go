...
func newAccountsDevicesRevokeCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "revoke <account_id>",
		Short:       "Revokes a list of devices. Not supported when [multi-user mode](https://developers.cloudflare.",
		Example:     "  cloudflare-pp-cli accounts devices revoke 699d98642c564d2e855e9661899b7252",
		Annotations: map[string]string{"pp:endpoint": "devices.revoke", "pp:method": "POST", "pp:path": "/accounts/{account_id}/devices/revoke"},
