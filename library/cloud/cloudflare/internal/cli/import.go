...
but do not stop the import.`,
  ...
  cloudflare-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cloudflare-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cloudflare-pp-cli import <resource> --input -`,
