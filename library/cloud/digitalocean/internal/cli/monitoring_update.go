...
func newMonitoringUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "update",
		Short:       "Update",
		Example:     "  digitalocean-pp-cli monitoring update",
		Annotations: map[string]string{"pp:endpoint": "monitoring.update", "pp:method": "PUT", "pp:path": "/v2/monitoring/alerts/{alert_uuid}"},
