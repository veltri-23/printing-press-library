...
but do not stop the import.`,
  ...
  digitalocean-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  digitalocean-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | digitalocean-pp-cli import <resource> --input -`,
