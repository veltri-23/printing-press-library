...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://api.ht-ml.app/v1",
	}
	...
	if v := os.Getenv("HT_ML_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("HT_ML_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "ht-ml-pp-cli", "config.toml"), nil
}
