...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/cloud/azure-functions-admin/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "azure-functions-admin-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
