...
but do not stop the import.`,
  ...
  azure-functions-admin-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  azure-functions-admin-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | azure-functions-admin-pp-cli import <resource> --input -`,
