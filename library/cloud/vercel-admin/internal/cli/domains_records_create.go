...
func newDomainsRecordsCreateCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create <domain>",
		Short:       "Creates a DNS record for a domain.",
		Example:     "  vercel-admin-pp-cli domains records create example-value",
		Annotations: map[string]string{"pp:endpoint": "records.create", "pp:method": "POST", "pp:path": "/v2/domains/{domain}/records"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "records", data, "")
			}
