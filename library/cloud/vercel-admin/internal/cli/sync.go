...
Resource scoping:
  ...
  vercel-admin-pp-cli sync

  # Sync specific resources only
  vercel-admin-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  vercel-admin-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  vercel-admin-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  vercel-admin-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  vercel-admin-pp-cli sync --latest-only`,
...
func resourceSupportsPagination(resource string) bool {
	...
	case "sandboxes":
		return true
	case "sandboxes-drives":
		return true
	case "sandboxes-sessions":
		return true
	case "sandboxes-snapshots":
		return true
	case "teams":
		return true
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "access-groups":
		return db.UpsertAccessGroups(data)
	case "access_groups_members":
		return db.UpsertAccessGroupsMembers(data)
	case "access_groups_projects":
		return db.UpsertAccessGroupsProjects(data)
	case "aliases":
		return db.UpsertAliases(data)
	case "aliases_protection_bypass":
		return db.UpsertAliasesProtectionBypass(data)
	case "billing":
		return db.UpsertBilling(data)
	case "bulk-redirects":
		return db.UpsertBulkRedirects(data)
	case "connect":
		return db.UpsertConnect(data)
	case "deployments":
		return db.UpsertDeployments(data)
	case "deployments_aliases":
		return db.UpsertDeploymentsAliases(data)
	case "cancel":
		return db.UpsertCancel(data)
	case "check_runs":
		return db.UpsertCheckRuns(data)
	case "deployments_checks":
		return db.UpsertDeploymentsChecks(data)
	case "deployments_events":
		return db.UpsertDeploymentsEvents(data)
	case "deployments_feature_flags":
		return db.UpsertDeploymentsFeatureFlags(data)
	case "deployments_files":
		return db.UpsertDeploymentsFiles(data)
	case "deployments_integrations":
		return db.UpsertDeploymentsIntegrations(data)
	case "domains":
		return db.UpsertDomains(data)
	case "claim":
		return db.UpsertClaim(data)
	case "domains_config":
		return db.UpsertDomainsConfig(data)
	case "project_domains":
		return db.UpsertProjectDomains(data)
	case "records":
		return db.UpsertRecords(data)
	case "verification":
		return db.UpsertVerification(data)
	case "drains":
		return db.UpsertDrains(data)
	case "edge-config":
		return db.UpsertEdgeConfig(data)
	case "backups":
		return db.UpsertBackups(data)
	case "item":
		return db.UpsertItem(data)
	case "items":
		return db.UpsertItems(data)
	case "schema":
		return db.UpsertSchema(data)
	case "token":
		return db.UpsertToken(data)
	case "tokens":
		return db.UpsertTokens(data)
	case "env":
		return db.UpsertEnv(data)
	case "unlink":
		return db.UpsertUnlink(data)
	case "events":
		return db.UpsertEvents(data)
	case "account":
		return db.UpsertAccount(data)
	case "installations_billing":
		return db.UpsertInstallationsBilling(data)
	case "installations_events":
		return db.UpsertInstallationsEvents(data)
	case "member":
		return db.UpsertMember(data)
	case "products":
	...
	case "log-drains":
		return db.UpsertLogDrains(data)
	case "microfrontends":
		return db.UpsertMicrofrontends(data)
	case "microfrontends_config":
		return db.UpsertMicrofrontendsConfig(data)
	case "observability":
	...
	case "projects_checks":
		return db.UpsertProjectsChecks(data)
	case "custom_environments":
		return db.UpsertCustomEnvironments(data)
	case "projects_deployments":
		return db.UpsertProjectsDeployments(data)
	case "projects_domains":
		return db.UpsertProjectsDomains(data)
	case "projects_env":
		return db.UpsertProjectsEnv(data)
	case "projects_feature_flags":
		return db.UpsertProjectsFeatureFlags(data)
	case "projects_members":
		return db.UpsertProjectsMembers(data)
	case "projects_microfrontends":
		return db.UpsertProjectsMicrofrontends(data)
	case "pause":
		return db.UpsertPause(data)
	case "promote":
		return db.UpsertPromote(data)
	case "projects_protection_bypass":
		return db.UpsertProjectsProtectionBypass(data)
	case "rollback":
		return db.UpsertRollback(data)
	case "rolling_release":
		return db.UpsertRollingRelease(data)
	case "routes":
		return db.UpsertRoutes(data)
	case "shared_connect_links":
		return db.UpsertSharedConnectLinks(data)
	case "transfer_request":
		return db.UpsertTransferRequest(data)
	case "unpause":
		return db.UpsertUnpause(data)
	case "registrar":
		return db.UpsertRegistrar(data)
	case "sandboxes":
		return db.UpsertSandboxes(data)
	case "security":
		return db.UpsertSecurity(data)
	case "teams":
		return db.UpsertTeams(data)
	case "dsync_roles":
		return db.UpsertDsyncRoles(data)
	case "teams_feature_flags":
		return db.UpsertTeamsFeatureFlags(data)
	case "invites":
		return db.UpsertInvites(data)
	case "teams_members":
		return db.UpsertTeamsMembers(data)
	case "teams_microfrontends":
		return db.UpsertTeamsMicrofrontends(data)
	case "request":
		return db.UpsertRequest(data)
	case "user":
...
func defaultSyncResources() []string {
	return []string{
		...
		"events",
		"integrations",
		"integrations-git-namespaces",
		"integrations-search-repo",
		"log-drains",
		"microfrontends",
		"observability",
		"projects",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"access-groups":               "/v1/access-groups",
		"aliases":                     "/v4/aliases",
		"billing":                     "/v1/billing/contract-commitments",
		"connect":                     "/v1/connect/networks",
		"deployments":                 "/v7/deployments",
		"domains":                     "/v5/domains",
		"edge-config":                 "/v1/edge-config",
		"env":                         "/v1/env",
		"events":                      "/v3/events",
		"events-types":                "/v1/events/types",
		"integrations":                "/v2/integrations/log-drains",
		"integrations-git-namespaces": "/v1/integrations/git-namespaces",
		"integrations-search-repo":    "/v1/integrations/search-repo",
		"log-drains":                  "/v1/log-drains",
		"microfrontends":              "/v1/microfrontends/groups",
		"observability":               "/v1/observability/manage/configuration/projects",
		"projects":                    "/v10/projects",
		"registrar":                   "/v1/registrar/tlds/supported",
		"sandboxes":                   "/v2/sandboxes",
		"sandboxes-drives":            "/v2/sandboxes/drives",
		"sandboxes-sessions":          "/v2/sandboxes/sessions",
		"sandboxes-snapshots":         "/v2/sandboxes/snapshots",
		"teams":                       "/v2/teams",
		"user":                        "/v6/user/tokens",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "access_groups_members", ParentTable: "access-groups", ParentIDParam: "idOrName", PathTemplate: "/v1/access-groups/{idOrName}/members", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "idOrName", Field: "name"},
		}},
		{Name: "access_groups_projects", ParentTable: "access-groups", ParentIDParam: "idOrName", PathTemplate: "/v1/access-groups/{idOrName}/projects", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "idOrName", Field: "name"},
		}},
		{Name: "backups", ParentTable: "edge-config", ParentIDParam: "edgeConfigId", PathTemplate: "/v1/edge-config/{edgeConfigId}/backups", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "edgeConfigId", Field: "id"},
		}},
		{Name: "deployments_events", ParentTable: "deployments", ParentIDParam: "idOrUrl", PathTemplate: "/v3/deployments/{idOrUrl}/events", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "idOrUrl", Field: "id_or_url"},
		}},
		{Name: "project_domains", ParentTable: "domains", ParentIDParam: "domain", PathTemplate: "/v1/domains/{domain}/project-domains", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "domain", Field: "domain"},
		}},
		{Name: "projects_domains", ParentTable: "projects", ParentIDParam: "idOrName", PathTemplate: "/v9/projects/{idOrName}/domains", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "idOrName", Field: "name"},
		}},
		{Name: "projects_feature_flags", ParentTable: "projects", ParentIDParam: "projectIdOrName", PathTemplate: "/v2/projects/{projectIdOrName}/feature-flags/flags", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "projectIdOrName", Field: "name"},
		}},
		{Name: "projects_feature_flags", ParentTable: "projects", ParentIDParam: "projectIdOrName", PathTemplate: "/v1/projects/{projectIdOrName}/feature-flags/flags", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "projectIdOrName", Field: "name"},
		}},
		{Name: "projects_members", ParentTable: "projects", ParentIDParam: "idOrName", PathTemplate: "/v1/projects/{idOrName}/members", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "idOrName", Field: "name"},
		}},
		{Name: "projects_versions", ParentTable: "projects", ParentIDParam: "projectIdOrName", PathTemplate: "/v1/projects/{projectIdOrName}/feature-flags/flags/{flagIdOrSlug}/versions", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "projectIdOrName", Field: "projects_id"},
			{Param: "flagIdOrSlug", Field: "slug"},
		}},
		{Name: "promote", ParentTable: "projects", ParentIDParam: "projectId", PathTemplate: "/v1/projects/{projectId}/promote/aliases", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "projectId", Field: "id"},
		}},
		{Name: "records", ParentTable: "domains", ParentIDParam: "domain", PathTemplate: "/v5/domains/{domain}/records", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "domain", Field: "domain"},
		}},
		{Name: "teams_feature_flags", ParentTable: "teams", ParentIDParam: "teamId", PathTemplate: "/v1/teams/{teamId}/feature-flags/settings", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "teamId", Field: "id"},
		}},
		{Name: "teams_feature_flags", ParentTable: "teams", ParentIDParam: "teamId", PathTemplate: "/v1/teams/{teamId}/feature-flags/flags", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "teamId", Field: "id"},
		}},
		{Name: "teams_feature_flags", ParentTable: "teams", ParentIDParam: "teamId", PathTemplate: "/v2/teams/{teamId}/feature-flags/flags", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "teamId", Field: "id"},
		}},
		{Name: "teams_members", ParentTable: "teams", ParentIDParam: "teamId", PathTemplate: "/v3/teams/{teamId}/members", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "teamId", Field: "id"},
		}},
	}
}
