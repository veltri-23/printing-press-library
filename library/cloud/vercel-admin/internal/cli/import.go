...
but do not stop the import.`,
  ...
  vercel-admin-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  vercel-admin-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | vercel-admin-pp-cli import <resource> --input -`,
