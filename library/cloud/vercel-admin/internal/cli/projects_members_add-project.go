...
func newProjectsMembersAddProjectCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Adds a new member to the project.",
		Example:     "  vercel-admin-pp-cli projects members add-project example-resource",
		Annotations: map[string]string{"pp:endpoint": "members.add-project", "pp:method": "POST", "pp:path": "/v1/projects/{idOrName}/members"},
