...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "vercel-admin-pp-cli",
		Short: "Manage vercel-admin resources via the vercel-admin API",
		Long: `Manage vercel-admin resources via the vercel-admin API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'vercel-admin-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("vercel-admin-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'vercel-admin-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAccessGroupsCmd(flags))
	rootCmd.AddCommand(newAliasesCmd(flags))
	rootCmd.AddCommand(newArtifactsCmd(flags))
	rootCmd.AddCommand(newBillingCmd(flags))
	rootCmd.AddCommand(newBulkRedirectsCmd(flags))
	rootCmd.AddCommand(newCertsCmd(flags))
	rootCmd.AddCommand(newConnectCmd(flags))
	rootCmd.AddCommand(newDeploymentsCmd(flags))
	rootCmd.AddCommand(newDomainsCmd(flags))
	rootCmd.AddCommand(newDrainsCmd(flags))
	rootCmd.AddCommand(newEdgeCacheCmd(flags))
	rootCmd.AddCommand(newEdgeConfigCmd(flags))
	rootCmd.AddCommand(newEnvCmd(flags))
	rootCmd.AddCommand(newEventsCmd(flags))
	rootCmd.AddCommand(newIntegrationsCmd(flags))
	rootCmd.AddCommand(newLogDrainsCmd(flags))
	rootCmd.AddCommand(newMicrofrontendsCmd(flags))
	rootCmd.AddCommand(newObservabilityCmd(flags))
	rootCmd.AddCommand(newProjectsCmd(flags))
	rootCmd.AddCommand(newRegistrarCmd(flags))
	rootCmd.AddCommand(newSandboxesCmd(flags))
	...
	rootCmd.AddCommand(newInstallationsPromotedCmd(flags))
	rootCmd.AddCommand(newStoragePromotedCmd(flags))
