...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/cloud/vercel-admin/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "vercel-admin-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
