...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cf-domain-pp-cli",
		Short: "Manage cf-domain resources via the cf-domain API",
		Long: `Manage cf-domain resources via the cf-domain API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'cf-domain-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("cf-domain-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'cf-domain-pp-cli profile list')")
...
func resolveAccountID(args []string) (string, error) {
