...
but do not stop the import.`,
  ...
  cf-domain-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cf-domain-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cf-domain-pp-cli import <resource> --input -`,
