...
func newRegistrarDomainCheckCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				body = map[string]any{}
				if bodyDomainName != "" {
					// PATCH: Cloudflare domain-check expects {"domains":[...]} not {"domain_name":"..."}.
					body["domains"] = []string{bodyDomainName}
				}
			}
	...
	cmd.Flags().StringVar(&bodyDomainName, "domain-name", "", "Fully qualified domain name to check, e.g. example.dev.")
