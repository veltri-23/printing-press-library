...
but do not stop the import.`,
  ...
  supermemory-admin-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  supermemory-admin-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | supermemory-admin-pp-cli import <resource> --input -`,
