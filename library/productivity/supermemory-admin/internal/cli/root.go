...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "supermemory-admin-pp-cli",
		Short: "Manage supermemory-admin resources via the supermemory-admin API",
		Long: `Manage supermemory-admin resources via the supermemory-admin API.
...
Run 'supermemory-admin-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("supermemory-admin-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'supermemory-admin-pp-cli profile list')")
	...
	rootCmd.AddCommand(newContainerTagsCmd(flags))
	rootCmd.AddCommand(newDocumentsCmd(flags))
	rootCmd.AddCommand(newMemoriesCmd(flags))
	...
	rootCmd.AddCommand(newConnectionResourcesPromotedCmd(flags))
	rootCmd.AddCommand(newConversationsPromotedCmd(flags))
	rootCmd.AddCommand(newProfilesPromotedCmd(flags))
	rootCmd.AddCommand(newSupermemoryRecallPromotedCmd(flags))
