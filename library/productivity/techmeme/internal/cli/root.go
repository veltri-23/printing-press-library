...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "techmeme-pp-cli",
		Short: `Techmeme CLI — Every Techmeme headline, searchable and cached locally — plus topic tracking, trending analysis, and catch-up workflows…`,
		Long: `Techmeme CLI — Every Techmeme headline, searchable and cached locally — plus topic tracking, trending analysis, and catch-up workflows…
...
Health check: run 'techmeme-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("techmeme-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'techmeme-pp-cli profile list')")
	...
	rootCmd.AddCommand(newTechmemeSearchCmd(flags))
	...
	rootCmd.AddCommand(newFeedXmlPromotedCmd(flags))
	rootCmd.AddCommand(newLbOpmlPromotedCmd(flags))
	rootCmd.AddCommand(newRiverPromotedCmd(flags))
	...
	rootCmd.AddCommand(newAuthorCmd(flags))
