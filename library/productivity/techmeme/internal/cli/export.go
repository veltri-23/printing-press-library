...
large datasets as it has no memory pressure.`,
  ...
  techmeme-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  techmeme-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  techmeme-pp-cli export <resource> --format jsonl | jq '.id'`,
