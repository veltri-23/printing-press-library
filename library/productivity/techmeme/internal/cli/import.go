...
but do not stop the import.`,
  ...
  techmeme-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  techmeme-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | techmeme-pp-cli import <resource> --input -`,
