...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/zoho-expense/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "zoho-expense-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
