...
but do not stop the import.`,
  ...
  zoho-expense-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  zoho-expense-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | zoho-expense-pp-cli import <resource> --input -`,
