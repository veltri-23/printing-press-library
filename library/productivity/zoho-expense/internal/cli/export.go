...
large datasets as it has no memory pressure.`,
  ...
  zoho-expense-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  zoho-expense-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  zoho-expense-pp-cli export <resource> --format jsonl | jq '.id'`,
