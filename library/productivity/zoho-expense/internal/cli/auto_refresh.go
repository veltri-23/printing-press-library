...
var readCommandResources = map[string][]string{
	"zoho-expense-pp-cli currencies":                {"currencies"},
	"zoho-expense-pp-cli currencies list":           {"currencies"},
	"zoho-expense-pp-cli currencies get":            {"currencies"},
	"zoho-expense-pp-cli currencies search":         {"currencies"},
	"zoho-expense-pp-cli customers":                 {"customers"},
	"zoho-expense-pp-cli customers list":            {"customers"},
	"zoho-expense-pp-cli customers get":             {"customers"},
	"zoho-expense-pp-cli customers search":          {"customers"},
	"zoho-expense-pp-cli expense_categories":        {"expense_categories"},
	"zoho-expense-pp-cli expense_categories list":   {"expense_categories"},
	"zoho-expense-pp-cli expense_categories get":    {"expense_categories"},
	"zoho-expense-pp-cli expense_categories search": {"expense_categories"},
	"zoho-expense-pp-cli expense_reports":           {"expense_reports"},
	"zoho-expense-pp-cli expense_reports list":      {"expense_reports"},
	"zoho-expense-pp-cli expense_reports get":       {"expense_reports"},
	"zoho-expense-pp-cli expense_reports search":    {"expense_reports"},
	"zoho-expense-pp-cli expenses":                  {"expenses"},
	"zoho-expense-pp-cli expenses list":             {"expenses"},
	"zoho-expense-pp-cli expenses get":              {"expenses"},
	"zoho-expense-pp-cli expenses search":           {"expenses"},
	"zoho-expense-pp-cli organizations":             {"organizations"},
	"zoho-expense-pp-cli organizations list":        {"organizations"},
	"zoho-expense-pp-cli organizations get":         {"organizations"},
	"zoho-expense-pp-cli organizations search":      {"organizations"},
	"zoho-expense-pp-cli projects":                  {"projects"},
	"zoho-expense-pp-cli projects list":             {"projects"},
	"zoho-expense-pp-cli projects get":              {"projects"},
	"zoho-expense-pp-cli projects search":           {"projects"},
	"zoho-expense-pp-cli reporting_tags":            {"reporting_tags"},
	"zoho-expense-pp-cli reporting_tags list":       {"reporting_tags"},
	"zoho-expense-pp-cli reporting_tags get":        {"reporting_tags"},
	"zoho-expense-pp-cli reporting_tags search":     {"reporting_tags"},
	"zoho-expense-pp-cli taxes":                     {"taxes"},
	"zoho-expense-pp-cli taxes list":                {"taxes"},
	"zoho-expense-pp-cli taxes get":                 {"taxes"},
	"zoho-expense-pp-cli taxes search":              {"taxes"},
	"zoho-expense-pp-cli trips":                     {"trips"},
	"zoho-expense-pp-cli trips list":                {"trips"},
	"zoho-expense-pp-cli trips get":                 {"trips"},
	"zoho-expense-pp-cli trips search":              {"trips"},
	"zoho-expense-pp-cli users":                     {"users"},
	"zoho-expense-pp-cli users list":                {"users"},
	"zoho-expense-pp-cli users get":                 {"users"},
	"zoho-expense-pp-cli users search":              {"users"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "ZOHO_EXPENSE_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale zoho-expense-pp-cli cache (refresh failed: %v)\n", err)
