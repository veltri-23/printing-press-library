...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "giustizia-amministrativa-pp-cli",
		Short: `Giustizia Amministrativa CLI — La giurisprudenza amministrativa italiana (TAR, Consiglio di Stato) da terminale: ricerca, testo integrale in Markdown,…`,
		Long: `Giustizia Amministrativa CLI — La giurisprudenza amministrativa italiana (TAR, Consiglio di Stato) da terminale: ricerca, testo integrale in Markdown,…
...
Health check: run 'giustizia-amministrativa-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("giustizia-amministrativa-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'giustizia-amministrativa-pp-cli profile list')")
	...
	rootCmd.AddCommand(newProvvedimentiCmd(flags))
	...
	rootCmd.AddCommand(newNovelGetCmd(flags))
	rootCmd.AddCommand(newNovelGrepCmd(flags))
	rootCmd.AddCommand(newNovelMassimeCmd(flags))
