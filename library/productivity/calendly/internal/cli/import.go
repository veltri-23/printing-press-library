...
but do not stop the import.`,
  ...
  calendly-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  calendly-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | calendly-pp-cli import <resource> --input -`,
