...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "calendly-pp-cli",
		Short: "Manage calendly resources via the calendly API",
		Long: `Manage calendly resources via the calendly API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'calendly-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("calendly-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'calendly-pp-cli profile list')")
	...
	rootCmd.AddCommand(newOrganizationMembershipsCmd(flags))
	rootCmd.AddCommand(newRoutingFormsCmd(flags))
	rootCmd.AddCommand(newScheduledEventsCmd(flags))
	rootCmd.AddCommand(newUsersCmd(flags))
	rootCmd.AddCommand(newWebhookSubscriptionsCmd(flags))
	...
	rootCmd.AddCommand(newEventTypeAvailableTimesPromotedCmd(flags))
	rootCmd.AddCommand(newEventTypeMembershipsPromotedCmd(flags))
	rootCmd.AddCommand(newOrganizationsPromotedCmd(flags))
	rootCmd.AddCommand(newUserBusyTimesPromotedCmd(flags))
