...
but do not stop the import.`,
  ...
  cal-com-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cal-com-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cal-com-pp-cli import <resource> --input -`,
