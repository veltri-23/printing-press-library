...
large datasets as it has no memory pressure.`,
  ...
  cal-com-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cal-com-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cal-com-pp-cli export <resource> --format jsonl | jq '.id'`,
