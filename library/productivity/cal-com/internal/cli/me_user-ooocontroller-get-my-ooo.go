...
func newMeUserOoocontrollerGetMyOooCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "user-ooocontroller-get-my-ooo",
		Short:       "If accessed using an OAuth access token, the `SCHEDULE_READ` scope is required.",
		Example:     "  cal-com-pp-cli me user-ooocontroller-get-my-ooo",
		Annotations: map[string]string{"pp:endpoint": "me.user-ooocontroller-get-my-ooo", "mcp:read-only": "true"},
