...
large datasets as it has no memory pressure.`,
  ...
  freshservice-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  freshservice-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  freshservice-pp-cli export <resource> --format jsonl | jq '.id'`,
