...
but do not stop the import.`,
  ...
  freshservice-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  freshservice-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | freshservice-pp-cli import <resource> --input -`,
