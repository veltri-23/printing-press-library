...
func newAgentsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  freshservice-pp-cli agents create --email user@example.com",
		Annotations: map[string]string{"pp:endpoint": "agents.create", "pp:method": "POST", "pp:path": "/agents"},
