...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  freshservice-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  freshservice-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"agent-fields", "agents", "assets", "canned-responses", "change-form-fields", "changes", "contracts", "departments", "groups", "locations", "products", "requester-fields", "requesters", "service-catalog", "solutions", "ticket-form-fields", "tickets", "vendors", "workspaces"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  freshservice-pp-cli workflow status

  # Show status as JSON
  freshservice-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("freshservice-pp-cli")
			}
