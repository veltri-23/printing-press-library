...
but do not stop the import.`,
  ...
  etherpad-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  etherpad-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | etherpad-pp-cli import <resource> --input -`,
