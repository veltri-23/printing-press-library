...
func newCopyPadWithoutHistoryPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagSourceID string
	var flagDestinationID string
	...
	cmd.Flags().StringVar(&flagDestinationID, "destination-id", "", "Destination id")
