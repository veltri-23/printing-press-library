...
func newCreateDiffHtmlPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagPadID string
	var flagStartRev string
	...
	cmd.Flags().StringVar(&flagStartRev, "start-rev", "", "Start rev")
	cmd.Flags().StringVar(&flagEndRev, "end-rev", "", "End rev")
