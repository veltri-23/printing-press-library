...
func newCreateAuthorIfNotExistsForPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagAuthorMapper string
	var flagName string
	...
	cmd.Flags().StringVar(&flagAuthorMapper, "author-mapper", "", "Author mapper")
