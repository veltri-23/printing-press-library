...
but do not stop the import.`,
  ...
  opensnow-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  opensnow-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | opensnow-pp-cli import <resource> --input -`,
