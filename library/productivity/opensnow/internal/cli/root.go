...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "opensnow-pp-cli",
		Short: `Opensnow CLI — Every OpenSnow forecast, snow report, and Daily Snow post — plus powder scoring, storm tracking, and historical trends …`,
		Long: `Opensnow CLI — Every OpenSnow forecast, snow report, and Daily Snow post — plus powder scoring, storm tracking, and historical trends …
...
Health check: run 'opensnow-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("opensnow-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'opensnow-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDailyReadsCmd(flags))
	...
	rootCmd.AddCommand(newSnowReportPromotedCmd(flags))
	rootCmd.AddCommand(newFavoritesCmd(flags))
	rootCmd.AddCommand(newDashboardCmd(flags))
	rootCmd.AddCommand(newOvernightCmd(flags))
	rootCmd.AddCommand(newCompareCmd(flags))
	rootCmd.AddCommand(newPowderScoreCmd(flags))
	rootCmd.AddCommand(newPowderRankCmd(flags))
	rootCmd.AddCommand(newStormTrackCmd(flags))
