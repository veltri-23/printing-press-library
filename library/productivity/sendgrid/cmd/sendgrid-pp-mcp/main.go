...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/sendgrid/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "sendgrid-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
