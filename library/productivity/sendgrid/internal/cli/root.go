...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "sendgrid-pp-cli",
		Short: `Sendgrid CLI — Every Twilio SendGrid endpoint, plus offline suppression diffs, stats time-series rollups, and a template-variable lint…`,
		Long: `Sendgrid CLI — Every Twilio SendGrid endpoint, plus offline suppression diffs, stats time-series rollups, and a template-variable lint…
...
Health check: run 'sendgrid-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("sendgrid-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'sendgrid-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAccessSettingsCmd(flags))
	rootCmd.AddCommand(newAlertsCmd(flags))
	rootCmd.AddCommand(newApiKeysCmd(flags))
	rootCmd.AddCommand(newAsmCmd(flags))
	rootCmd.AddCommand(newCampaignsCmd(flags))
	rootCmd.AddCommand(newCategoriesCmd(flags))
	rootCmd.AddCommand(newContactdbCmd(flags))
	rootCmd.AddCommand(newDesignsCmd(flags))
	rootCmd.AddCommand(newEngagementqualityCmd(flags))
	rootCmd.AddCommand(newIpsCmd(flags))
	rootCmd.AddCommand(newLogsCmd(flags))
	rootCmd.AddCommand(newMailCmd(flags))
	rootCmd.AddCommand(newMailSettingsCmd(flags))
	rootCmd.AddCommand(newMarketingCmd(flags))
	rootCmd.AddCommand(newMessagesCmd(flags))
	rootCmd.AddCommand(newPartnersCmd(flags))
	rootCmd.AddCommand(newSendIpsCmd(flags))
	rootCmd.AddCommand(newSendersCmd(flags))
	rootCmd.AddCommand(newSsoCmd(flags))
	rootCmd.AddCommand(newSubusersCmd(flags))
	rootCmd.AddCommand(newSuppressionCmd(flags))
	rootCmd.AddCommand(newTeammatesCmd(flags))
	...
	rootCmd.AddCommand(newValidationsCmd(flags))
	rootCmd.AddCommand(newVerifiedSendersCmd(flags))
	rootCmd.AddCommand(newWhitelabelCmd(flags))
	...
	rootCmd.AddCommand(newClientsPromotedCmd(flags))
	rootCmd.AddCommand(newDevicesPromotedCmd(flags))
	rootCmd.AddCommand(newGeoPromotedCmd(flags))
	rootCmd.AddCommand(newMailboxProvidersPromotedCmd(flags))
	rootCmd.AddCommand(newPartnerSettingsPromotedCmd(flags))
	rootCmd.AddCommand(newRecipientsPromotedCmd(flags))
	rootCmd.AddCommand(newScopesPromotedCmd(flags))
	rootCmd.AddCommand(newStatsPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	rootCmd.AddCommand(newBounceCmd(flags))
