...
but do not stop the import.`,
  ...
  sendgrid-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sendgrid-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sendgrid-pp-cli import <resource> --input -`,
