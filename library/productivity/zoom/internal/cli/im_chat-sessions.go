...
func newImChatSessionsCmd(flags *rootFlags) *cobra.Command {
	var flagFrom string
	var flagTo string
	...
	cmd := &cobra.Command{
		Use:         "chat-sessions",
		Aliases:     []string{"list"},
		Short:       "Retrieve IM Chat sessions for a specified period <aside>This API only supports oauth2.</aside>",
		Example:     "  zoom-pp-cli im chat-sessions --from example-value --to example-value",
		Annotations: map[string]string{"pp:endpoint": "im.chat-sessions", "pp:method": "GET", "pp:path": "/im/chat/sessions", "mcp:read-only": "true"},
