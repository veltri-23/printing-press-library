...
func newMetricsDashboardImCmd(flags *rootFlags) *cobra.Command {
	var flagFrom string
	var flagTo string
	...
	cmd := &cobra.Command{
		Use:         "dashboard-im",
		Short:       "Retrieve metrics of Zoom IM",
		Example:     "  zoom-pp-cli metrics dashboard-im --from example-value --to example-value",
		Annotations: map[string]string{"pp:endpoint": "metrics.dashboard-im", "pp:method": "GET", "pp:path": "/metrics/im", "mcp:read-only": "true"},
