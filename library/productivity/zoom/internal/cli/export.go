...
large datasets as it has no memory pressure.`,
  ...
  zoom-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  zoom-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  zoom-pp-cli export <resource> --format jsonl | jq '.id'`,
