...
func newMetricsDashboardWebinarsCmd(flags *rootFlags) *cobra.Command {
	var flagType string
	var flagFrom string
	var flagTo string
	...
	cmd := &cobra.Command{
		Use:         "dashboard-webinars",
		Short:       "List live webinars or past webinars for a specified period",
		Example:     "  zoom-pp-cli metrics dashboard-webinars --from example-value --to example-value",
		Annotations: map[string]string{"pp:endpoint": "metrics.dashboard-webinars", "pp:method": "GET", "pp:path": "/metrics/webinars", "mcp:read-only": "true"},
