...
but do not stop the import.`,
  ...
  granola-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  granola-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | granola-pp-cli import <resource> --input -`,
