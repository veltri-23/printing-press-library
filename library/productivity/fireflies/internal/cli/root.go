...
Health check: run 'fireflies-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("fireflies-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'fireflies-pp-cli profile list')")
	...
	// Transcript commands (replaces generated REST stubs)
	rootCmd.AddCommand(newTranscriptsCmd(flags))

	// Derived analysis commands
	...
	// Supporting resource commands (using generated promoted commands where they work)
