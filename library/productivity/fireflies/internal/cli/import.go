...
but do not stop the import.`,
  ...
  fireflies-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  fireflies-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | fireflies-pp-cli import <resource> --input -`,
