...
large datasets as it has no memory pressure.`,
  ...
  morgen-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  morgen-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  morgen-pp-cli export <resource> --format jsonl | jq '.id'`,
