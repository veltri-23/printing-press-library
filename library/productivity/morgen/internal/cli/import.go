...
but do not stop the import.`,
  ...
  morgen-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  morgen-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | morgen-pp-cli import <resource> --input -`,
