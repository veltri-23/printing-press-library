...
large datasets as it has no memory pressure.`,
  ...
  fathom-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  fathom-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  fathom-pp-cli export <resource> --format jsonl | jq '.id'`,
