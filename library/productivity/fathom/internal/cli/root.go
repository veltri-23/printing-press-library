...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "fathom-pp-cli",
		Short: `Fathom CLI — Sync your Fathom meetings once, then search, analyze, and act on them forever — offline, at scale, without burning API …`,
		Long: `Fathom CLI — Sync your Fathom meetings once, then search, analyze, and act on them forever — offline, at scale, without burning API …
...
Health check: run 'fathom-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("fathom-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'fathom-pp-cli profile list')")
	...
	rootCmd.AddCommand(newMeetingsPromotedCmd(flags))
	rootCmd.AddCommand(newTeamMembersPromotedCmd(flags))
	rootCmd.AddCommand(newTeamsPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	// Novel feature commands
	rootCmd.AddCommand(newDBCmd(flags))
	rootCmd.AddCommand(newCommitmentsCmd(flags))
	...
	rootCmd.AddCommand(newCRMGapsCmd(flags))
