...
but do not stop the import.`,
  ...
  fathom-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  fathom-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | fathom-pp-cli import <resource> --input -`,
