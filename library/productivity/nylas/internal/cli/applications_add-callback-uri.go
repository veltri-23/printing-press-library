...
func newApplicationsAddCallbackUriCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "add-callback-uri",
		Aliases:     []string{"create"},
		Short:       "Adds a callback URI to the specified Nylas application. Nylas uses callback URIs to redirect users to your project...",
		Example:     "  nylas-pp-cli applications add-callback-uri",
		Annotations: map[string]string{"pp:endpoint": "applications.add-callback-uri", "pp:method": "POST", "pp:path": "/v3/applications/redirect-uris"},
