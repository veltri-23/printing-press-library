...
func newWebhooksGetDestinationsApplicationCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "get-destinations-application",
		Aliases:     []string{"list"},
		Short:       "Get a list of all webhook destinations for an application id.",
