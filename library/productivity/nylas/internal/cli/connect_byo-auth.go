...
func newConnectByoAuthCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Manually creates a grant using the Bring Your Own (BYO) Authentication flow. If you're handling the OAuth flow in...",
		Example:     "  nylas-pp-cli connect byo-auth",
		Annotations: map[string]string{"pp:endpoint": "connect.byo-auth", "pp:method": "POST", "pp:path": "/v3/connect/custom"},
