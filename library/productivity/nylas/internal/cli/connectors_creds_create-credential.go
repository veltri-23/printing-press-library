...
func newConnectorsCredsCreateCredentialCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Manually create a credential record.",
		Example:     "  nylas-pp-cli connectors creds create-credential",
		Annotations: map[string]string{"pp:endpoint": "creds.create-credential", "pp:method": "POST", "pp:path": "/v3/connectors/{provider}/creds"},
