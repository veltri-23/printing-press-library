...
func newWorkspacesCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  nylas-pp-cli workspaces create --domain example-value",
		Annotations: map[string]string{"pp:endpoint": "workspaces.create", "pp:method": "POST", "pp:path": "/v3/workspaces"},
	...
	cmd.Flags().BoolVar(&bodyAutoGroup, "auto-group", true, "When `true`, specifies that newly created grants in the application are automatically assigned to the workspace if...")
