...
func newListsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Creates a list for your application. Lists are typed collections of values (domains, TLDs, or email addresses) that...",
		Example:     "  nylas-pp-cli lists create --name example-resource",
		Annotations: map[string]string{"pp:endpoint": "lists.create", "pp:method": "POST", "pp:path": "/v3/lists"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if asyncJobID := ExtractJobID(data, "request_id"); asyncJobID != "" {
				...
				if flagWait {
					...
					final, werr := WaitForJob(ctx, c, "/v3/lists/{list_id}", asyncJobID, WaitOptions{
	...
	cmd.Flags().StringVar(&bodyType, "type", "", "The kind of values the list holds. Immutable after creation.")
