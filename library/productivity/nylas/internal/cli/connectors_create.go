...
func newConnectorsCreateCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create a connector in your Nylas application. Connectors are how your Nylas application stores information it needs...",
		Example:     "  nylas-pp-cli connectors create",
		Annotations: map[string]string{"pp:endpoint": "connectors.create", "pp:method": "POST", "pp:path": "/v3/connectors"},
