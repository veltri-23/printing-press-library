...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "expensify-pp-cli",
		Short: "Manage expensify resources via the expensify API",
		Long: `Manage expensify resources via the expensify API.
...
Run 'expensify-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("expensify-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newExportResourceCmd(flags))
	...
	rootCmd.AddCommand(newReconPromotedCmd(flags))
	rootCmd.AddCommand(newTagPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCmd())

	// Novel layer (local-store powered + orchestrators)
