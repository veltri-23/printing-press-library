...
but do not stop the import.`,
  ...
  expensify-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  expensify-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | expensify-pp-cli import <resource> --input -`,
