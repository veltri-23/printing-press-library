...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Expensify",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  expensify-pp-cli auth setup\n  expensify-pp-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			w := cmd.OutOrStdout()
			fmt.Fprintln(w, "Get a key at: https://www.expensify.com/tools/integrations/")
			fmt.Fprintln(w, "")
			fmt.Fprintln(w, "Then set:")
			fmt.Fprintln(w, "  export EXPENSIFY_AUTH_TOKEN=\"your-token-here\"")
			fmt.Fprintln(w, "  export EXPENSIFY_PARTNER_USER_ID=\"your-token-here\"")
			fmt.Fprintln(w, "  export EXPENSIFY_PARTNER_USER_SECRET=\"your-token-here\"")
			if !launch {
				return nil
			}
			launchURL := "https://www.expensify.com/tools/integrations/"
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  expensify-pp-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("EXPENSIFY_AUTH_TOKEN") != "" {
				envStillSet = "EXPENSIFY_AUTH_TOKEN"
			}
			if envStillSet == "" && os.Getenv("EXPENSIFY_PARTNER_USER_ID") != "" {
				envStillSet = "EXPENSIFY_PARTNER_USER_ID"
			}
			if envStillSet == "" && os.Getenv("EXPENSIFY_PARTNER_USER_SECRET") != "" {
				envStillSet = "EXPENSIFY_PARTNER_USER_SECRET"
			}
