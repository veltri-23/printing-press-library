...
type Credentials struct {
	...
	ExpensifyAuthToken         string    `toml:"auth_token,omitempty"`
	ExpensifyPartnerUserId     string    `toml:"partner_user_id,omitempty"`
	ExpensifyPartnerUserSecret string    `toml:"partner_user_secret,omitempty"`
}
