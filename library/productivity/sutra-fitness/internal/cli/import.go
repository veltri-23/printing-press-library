...
but do not stop the import.`,
  ...
  sutra-fitness-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sutra-fitness-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sutra-fitness-pp-cli import <resource> --input -`,
