...
large datasets as it has no memory pressure.`,
  ...
  ticktick-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  ticktick-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  ticktick-pp-cli export <resource> --format jsonl | jq '.id'`,
