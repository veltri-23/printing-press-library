...
but do not stop the import.`,
  ...
  ticktick-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ticktick-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ticktick-pp-cli import <resource> --input -`,
