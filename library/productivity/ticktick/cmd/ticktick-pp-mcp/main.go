...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/ticktick/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "ticktick-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
