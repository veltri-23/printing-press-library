...
func newConversationsMembersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  slack-pp-cli conversations members",
	...
	cmd.Flags().StringVar(&flagLimit, "limit", "", "Maximum members to return")
