...
func newMessagesScheduleMessageCmd(flags *rootFlags) *cobra.Command {
	var flagChannel string
	var flagText string
	var flagPostAt string
	var stdinBody bool
	...
	cmd.Flags().StringVar(&flagChannel, "channel", "", "Channel to send the scheduled message to")
	cmd.Flags().StringVar(&flagText, "text", "", "Message text")
	cmd.Flags().StringVar(&flagPostAt, "post-at", "", "Unix timestamp for when to send the message")
