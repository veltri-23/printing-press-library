...
func newMessagesUpdateMessageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagTs, "ts", "", "Timestamp of the message to update")
	cmd.Flags().StringVar(&flagText, "text", "", "New message text")
