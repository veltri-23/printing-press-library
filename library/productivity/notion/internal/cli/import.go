...
but do not stop the import.`,
  ...
  notion-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  notion-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | notion-pp-cli import <resource> --input -`,
