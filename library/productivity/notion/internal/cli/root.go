...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "notion-pp-cli",
		Short: `Notion CLI — manage pages, blocks, and sync your workspace to a local SQLite store for offline queries.`,
		Long: `Notion CLI — manage pages, blocks, and sync your workspace to a local SQLite store for offline queries.
...
Health check: run 'notion-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'notion-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBlocksCmd(flags))
	...
	rootCmd.AddCommand(newFileUploadsCmd(flags))
	...
	rootCmd.AddCommand(newCustomEmojisPromotedCmd(flags))
