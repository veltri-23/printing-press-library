...
func newOauthIntrospectTokenCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  notion-pp-cli oauth introspect-token --token your-token-here",
		Annotations: map[string]string{"pp:endpoint": "oauth.introspect-token", "pp:method": "POST", "pp:path": "/v1/oauth/introspect"},
