...
func FeedbackEndpointConfigured() bool {
	return os.Getenv("NOTION_FEEDBACK_ENDPOINT") != ""
}
...
func feedbackAutoSend() bool {
	v := strings.ToLower(strings.TrimSpace(os.Getenv("NOTION_FEEDBACK_AUTO_SEND")))
...
func newFeedbackCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Feedback is captured locally first at ~/.notion-pp-cli/feedback.jsonl.
...
func newFeedbackListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  notion-pp-cli feedback list
  notion-pp-cli feedback list --limit 5
  notion-pp-cli feedback list --json`,
