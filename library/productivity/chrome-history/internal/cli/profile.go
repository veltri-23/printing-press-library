...
func newProfileCmd(opts *RootOptions) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "profile",
		Short:       "Summarize your browsing self over --since: peak hours, busiest weekday, top domains and search terms, productivity split",
		Example:     strings.Trim("chrome-history-pp-cli profile --since 30d --json", "\n"),
