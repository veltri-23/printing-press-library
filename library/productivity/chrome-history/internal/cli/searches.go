...
func newSearchesCmd(opts *RootOptions) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "searches",
		Short:       "List the keyword search-engine queries in your history over --since, optionally filtered by --domain",
		Example:     strings.Trim("chrome-history-pp-cli searches --since 14d --limit 20", "\n"),
