...
Exit codes & warnings:
  ...
  resend-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  resend-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  resend-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  resend-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  resend-pp-cli sync --latest-only`,
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"domains":            "/domains",
		"emails":             "/emails",
		"emails-receiving":   "/emails/receiving",
		"events":             "/events",
		"logs":               "/logs",
		"segments":           "/segments",
		"templates":          "/templates",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "attachments", ParentTable: "emails", ParentIDParam: "email_id", PathTemplate: "/emails/{email_id}/attachments", KeyField: ""},
		{Name: "contacts_segments", ParentTable: "contacts", ParentIDParam: "contact_id", PathTemplate: "/contacts/{contact_id}/segments", KeyField: ""},
		{Name: "contacts_topics", ParentTable: "contacts", ParentIDParam: "contact_id", PathTemplate: "/contacts/{contact_id}/topics", KeyField: ""},
		{Name: "emails", ParentTable: "emails", ParentIDParam: "email_id", PathTemplate: "/emails/receiving/{email_id}/attachments", KeyField: ""},
		{Name: "runs", ParentTable: "automations", ParentIDParam: "automation_id", PathTemplate: "/automations/{automation_id}/runs", KeyField: ""},
	}
}
