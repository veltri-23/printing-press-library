...
func newEventsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  resend-pp-cli events get example-value",
		Annotations: map[string]string{"pp:endpoint": "events.get", "pp:method": "GET", "pp:path": "/events/{identifier}", "mcp:read-only": "true"},
