...
but do not stop the import.`,
  ...
  resend-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  resend-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | resend-pp-cli import <resource> --input -`,
