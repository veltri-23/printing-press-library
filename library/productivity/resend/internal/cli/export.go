...
large datasets as it has no memory pressure.`,
  ...
  resend-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  resend-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  resend-pp-cli export <resource> --format jsonl | jq '.id'`,
