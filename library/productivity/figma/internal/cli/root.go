...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "figma-pp-cli",
		Short: `Figma CLI — Every Figma endpoint, plus codegen-ready frame extracts, comments audit, orphans finder, tokens diff, and webhook repla…`,
		Long: `Figma CLI — Every Figma endpoint, plus codegen-ready frame extracts, comments audit, orphans finder, tokens diff, and webhook repla…
...
Health check: run 'figma-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("figma-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'figma-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDevResourcesCmd(flags))
	rootCmd.AddCommand(newFigmaAnalyticsCmd(flags))
	...
	rootCmd.AddCommand(newActivityLogsPromotedCmd(flags))
	rootCmd.AddCommand(newComponentSetsPromotedCmd(flags))
	rootCmd.AddCommand(newComponentsPromotedCmd(flags))
	rootCmd.AddCommand(newDeveloperLogsPromotedCmd(flags))
