...
func newFigmaAnalyticsGetLibraryVariableUsagesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("group-by") {
				allowedGroupBy := []string{"variable", "file"}
				validGroupBy := false
	...
	cmd.Flags().StringVar(&flagGroupBy, "group-by", "", "A dimension to group returned analytics data by. (one of: variable, file)")
