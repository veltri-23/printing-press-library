...
func newFigmaAnalyticsGetLibraryComponentActionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-library-component-actions <file_key>",
		Aliases:     []string{"get"},
		Short:       "Returns a list of library analytics component actions data broken down by the requested dimension.",
		Example:     "  figma-pp-cli figma-analytics get-library-component-actions your-token-here --group-by example-value",
		Annotations: map[string]string{"pp:endpoint": "figma-analytics.get-library-component-actions", "pp:method": "GET", "pp:path": "/v1/analytics/libraries/{file_key}/component/actions", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("group-by") {
				allowedGroupBy := []string{"component", "team"}
				validGroupBy := false
	...
	cmd.Flags().StringVar(&flagGroupBy, "group-by", "", "A dimension to group returned analytics data by. (one of: component, team)")
