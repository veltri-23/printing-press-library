...
func newDraftsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List drafts",
		Example:     "  superhuman-pp-cli drafts list",
		Annotations: map[string]string{"pp:endpoint": "drafts.list", "pp:method": "POST", "pp:path": "/v3/userdata.getThreads", "mcp:read-only": "true"},
