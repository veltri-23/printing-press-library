...
but do not stop the import.`,
  ...
  superhuman-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  superhuman-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | superhuman-pp-cli import <resource> --input -`,
