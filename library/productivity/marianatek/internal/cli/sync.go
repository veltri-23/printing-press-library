...
Exit codes & warnings:
  ...
  marianatek-pp-cli sync

  # Sync specific resources only
  marianatek-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  marianatek-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  marianatek-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  marianatek-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  marianatek-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/marianatek-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "app-version-metadatas":
		return db.UpsertAppVersionMetadatas(data)
	case "classes":
		return db.UpsertClasses(data)
	case "payment_options":
		return db.UpsertPaymentOptions(data)
	case "config":
		return db.UpsertConfig(data)
	case "countries":
		return db.UpsertCountries(data)
	case "legal":
		return db.UpsertLegal(data)
	case "locations":
		return db.UpsertLocations(data)
	case "add_ons_buy_page":
		return db.UpsertAddOnsBuyPage(data)
	case "buy_page":
		return db.UpsertBuyPage(data)
	case "cart":
		return db.UpsertCart(data)
	case "locations_schedule_filters":
		return db.UpsertLocationsScheduleFilters(data)
	case "me":
		return db.UpsertMe(data)
	case "regions":
		return db.UpsertRegions(data)
	case "regions_schedule_filters":
		return db.UpsertRegionsScheduleFilters(data)
	case "schedule-locations":
		return db.UpsertScheduleLocations(data)
	case "schedule-regions":
		return db.UpsertScheduleRegions(data)
	case "theme":
		return db.UpsertTheme(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"locations",
		"me",
		"me-account-renewals-failed",
		"me-appointments-bookings",
		"me-credit-cards",
		"me-credits",
		"me-memberships",
		"me-memberships-membership-cancellation-reasons",
		"me-metrics-class-count",
		"me-metrics-longest-weekly-streak",
		"me-metrics-most-active-month",
		"me-metrics-most-popular-weekday",
		"me-metrics-most-recent-completed-challenge",
		"me-metrics-top-instructors",
		"me-metrics-top-time-of-day",
		"me-metrics-total-minutes-in-class",
		"me-reservations",
		"regions",
		"schedule-locations",
		"schedule-regions",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"app-version-metadatas":      "/app_version_metadatas",
		"appointments":               "/appointments/categories",
		"classes":                    "/classes",
		"countries":                  "/countries",
		"customer-feedback":          "/feedback/show_csat",
		"locations":                  "/locations",
		"me":                         "/me/orders",
		"me-account-renewals-failed": "/me/account/renewals/failed",
		"me-appointments-bookings":   "/me/appointments/bookings",
		"me-credit-cards":            "/me/credit_cards",
		"me-credits":                 "/me/credits",
		"me-memberships":             "/me/memberships",
		"me-memberships-membership-cancellation-reasons": "/me/memberships/membership_cancellation_reasons",
		"me-metrics-class-count":                         "/me/metrics/class_count",
		"me-metrics-longest-weekly-streak":               "/me/metrics/longest_weekly_streak",
		"me-metrics-most-active-month":                   "/me/metrics/most_active_month",
		"me-metrics-most-popular-weekday":                "/me/metrics/most_popular_weekday",
		"me-metrics-most-recent-completed-challenge":     "/me/metrics/most_recent_completed_challenge",
		"me-metrics-top-instructors":                     "/me/metrics/top_instructors",
		"me-metrics-top-time-of-day":                     "/me/metrics/top_time_of_day",
		"me-metrics-total-minutes-in-class":              "/me/metrics/total_minutes_in_class",
		"me-reservations":                                "/me/reservations",
		"regions":                                        "/regions",
		"schedule-locations":                             "/schedule_locations",
		"schedule-regions":                               "/schedule_regions",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "add_ons_buy_page", ParentTable: "locations", ParentIDParam: "parent_lookup_addons_locations", PathTemplate: "/locations/{parent_lookup_addons_locations}/add_ons_buy_page", KeyField: ""},
		{Name: "buy_page", ParentTable: "locations", ParentIDParam: "parent_lookup_default_locations", PathTemplate: "/locations/{parent_lookup_default_locations}/buy-page", KeyField: ""},
		{Name: "cart", ParentTable: "locations", ParentIDParam: "parent_lookup_fulfillment_partner__location", PathTemplate: "/locations/{parent_lookup_fulfillment_partner__location}/cart", KeyField: ""},
	}
}
