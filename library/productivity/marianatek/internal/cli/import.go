...
but do not stop the import.`,
  ...
  marianatek-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  marianatek-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | marianatek-pp-cli import <resource> --input -`,
