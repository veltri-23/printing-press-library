...
large datasets as it has no memory pressure.`,
  ...
  marianatek-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  marianatek-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  marianatek-pp-cli export <resource> --format jsonl | jq '.id'`,
