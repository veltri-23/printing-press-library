...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  marianatek-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  marianatek-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"app-version-metadatas", "appointments", "classes", "countries", "customer-feedback", "locations", "me", "me-account-renewals-failed", "me-appointments-bookings", "me-credit-cards", "me-credits", "me-memberships", "me-memberships-membership-cancellation-reasons", "me-metrics-class-count", "me-metrics-longest-weekly-streak", "me-metrics-most-active-month", "me-metrics-most-popular-weekday", "me-metrics-most-recent-completed-challenge", "me-metrics-top-instructors", "me-metrics-top-time-of-day", "me-metrics-total-minutes-in-class", "me-reservations", "regions", "schedule-locations", "schedule-regions"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  marianatek-pp-cli workflow status

  # Show status as JSON
  marianatek-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("marianatek-pp-cli")
			}
