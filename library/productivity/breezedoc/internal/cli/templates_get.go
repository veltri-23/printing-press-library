...
func newTemplatesGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  breezedoc-pp-cli templates get 42",
		Annotations: map[string]string{"pp:endpoint": "templates.get", "pp:method": "GET", "pp:path": "/templates/{template}", "mcp:read-only": "true"},
