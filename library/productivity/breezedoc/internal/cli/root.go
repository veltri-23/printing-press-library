...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "breezedoc-pp-cli",
		Short: "Manage breezedoc resources via the breezedoc API",
		Long: `Manage breezedoc resources via the breezedoc API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'breezedoc-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("breezedoc-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'breezedoc-pp-cli profile list')")
