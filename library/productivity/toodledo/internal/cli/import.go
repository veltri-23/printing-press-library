...
but do not stop the import.`,
  ...
  toodledo-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  toodledo-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | toodledo-pp-cli import <resource> --input -`,
