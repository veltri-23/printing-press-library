...
Resource scoping:
  ...
  toodledo-pp-cli sync

  # Sync specific resources only
  toodledo-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  toodledo-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  toodledo-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  toodledo-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  toodledo-pp-cli sync --latest-only`,
...
func syncResource(ctx context.Context, c interface {
	...
	for {
		...
		// Spec-derived per-resource default params the syncer would otherwise
		// omit. Toodledo's tasks endpoint returns only id/title/modified/
		// completed unless `fields` requests the optional columns the local
		// mirror and GTD commands depend on. User overrides below still win.
		for k, v := range syncResourceDefaultParams(resource) {
			params[k] = v
		}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"contexts":             "/contexts/get.php",
		"folders":              "/folders/get.php",
		"goals":                "/goals/get.php",
		"lists":                "/lists/get.php",
		"lists-deleted-php":    "/lists/deleted.php",
		"locations":            "/locations/get.php",
		"notes":                "/notes/get.php",
		"notes-deleted-php":    "/notes/deleted.php",
		"outlines":             "/outlines/get.php",
		"outlines-deleted-php": "/outlines/deleted.php",
		"tasks":                "/tasks/get.php",
		"tasks-deleted-php":    "/tasks/deleted.php",
	}
