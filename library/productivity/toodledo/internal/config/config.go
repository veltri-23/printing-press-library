...
func Load(configPath string) (*Config, error) {
	...
	if path == "" {
		...
		path = filepath.Join(home, ".config", "toodledo-pp-cli", "config.toml")
	}
	cfg.Path = path
	...
	// Env var overrides
	if v := os.Getenv("TOODLEDO_CLIENT_ID"); v != "" {
		cfg.ClientID = v
		cfg.markEnvOverride("ClientID")
		cfg.AuthSource = "env:TOODLEDO_CLIENT_ID"
	}
	if v := os.Getenv("TOODLEDO_CLIENT_SECRET"); v != "" {
		cfg.ClientSecret = v
		cfg.markEnvOverride("ClientSecret")
		cfg.AuthSource = "env:TOODLEDO_CLIENT_SECRET"
	}
	...
	if v := os.Getenv("TOODLEDO_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := os.Getenv("TOODLEDO_AUTHORIZATION_URL"); v != "" {
		cfg.AuthorizationURL = v
	}
	if v := os.Getenv("TOODLEDO_TOKEN_URL"); v != "" {
		cfg.TokenURL = v
	}
	return cfg, nil
}
