...
but do not stop the import.`,
  ...
  myfitnesspal-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  myfitnesspal-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | myfitnesspal-pp-cli import <resource> --input -`,
