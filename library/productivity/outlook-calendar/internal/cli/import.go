...
but do not stop the import.`,
  ...
  outlook-calendar-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  outlook-calendar-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | outlook-calendar-pp-cli import <resource> --input -`,
