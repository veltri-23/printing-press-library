...
Exit codes & warnings:
  ...
  outlook-calendar-pp-cli sync

  # Sync specific resources only
  outlook-calendar-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  outlook-calendar-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  outlook-calendar-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  outlook-calendar-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  outlook-calendar-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/outlook-calendar-pp-cli/data.db)")
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "events", ParentTable: "events", ParentIDParam: "event_id", PathTemplate: "/me/events/{event_id}/instances"},
	}
}
