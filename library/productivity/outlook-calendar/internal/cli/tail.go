...
native streaming instead of polling.`,
  ...
  outlook-calendar-pp-cli tail --interval 10s

  # Tail a specific resource
  outlook-calendar-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  outlook-calendar-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
