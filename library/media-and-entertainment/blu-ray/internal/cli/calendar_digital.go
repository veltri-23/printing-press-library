...
func newCalendarDigitalCmd(flags *rootFlags) *cobra.Command {
	var flagYear int

	cmd := &cobra.Command{
		Use:         "digital",
		Short:       "Digital release calendar (streaming/rental window opens).",
		Example:     "  blu-ray-pp-cli calendar digital",
		Annotations: map[string]string{"pp:endpoint": "calendar.digital", "pp:method": "GET", "pp:path": "/digital/releasedates.php", "mcp:read-only": "true"},
