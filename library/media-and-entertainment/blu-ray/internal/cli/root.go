...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "blu-ray-pp-cli",
		Short: `Blu-ray.com disc database CLI — local catalog, listings, deals, news, and price-drop watchlist for every Blu-ray, 4K, DVD, and digital release.`,
...
Health check: run 'blu-ray-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("blu-ray-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newSitemapCmd(flags))
