...
func newNewsIndexCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "index",
		Short:       "News index page (latest stories on top). Hand-parser extracts headline + posted-date + body link.",
		Example:     "  blu-ray-pp-cli news index",
		Annotations: map[string]string{"pp:endpoint": "news.index", "pp:method": "GET", "pp:path": "/news/", "mcp:read-only": "true"},
