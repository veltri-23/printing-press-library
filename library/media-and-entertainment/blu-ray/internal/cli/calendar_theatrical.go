...
func newCalendarTheatricalCmd(flags *rootFlags) *cobra.Command {
	var flagYear int

	cmd := &cobra.Command{
		Use:         "theatrical",
		Short:       "Theatrical release calendar.",
		Example:     "  blu-ray-pp-cli calendar theatrical",
		Annotations: map[string]string{"pp:endpoint": "calendar.theatrical", "pp:method": "GET", "pp:path": "/theatrical/releasedates.php", "mcp:read-only": "true"},
	...
	cmd.Flags().IntVar(&flagYear, "year", 0, "Calendar year.")
