...
large datasets as it has no memory pressure.`,
  ...
  archive-is-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  archive-is-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  archive-is-pp-cli export <resource> --format jsonl | jq '.id'`,
