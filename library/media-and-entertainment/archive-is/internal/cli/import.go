...
but do not stop the import.`,
  ...
  archive-is-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  archive-is-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | archive-is-pp-cli import <resource> --input -`,
