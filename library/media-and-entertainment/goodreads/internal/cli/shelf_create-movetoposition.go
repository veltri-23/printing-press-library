...
func newShelfCreateMovetopositionCmd(flags *rootFlags) *cobra.Command {
	var bodyAuthenticityToken string
	var bodyId int
	var bodyPosition int

	cmd := &cobra.Command{
		Use:         "create-movetoposition",
		Short:       "Move one shelf/book row to a specific position.",
		Example:     "  goodreads-pp-cli shelf create-movetoposition",
		Annotations: map[string]string{"pp:endpoint": "shelf.create-movetoposition", "pp:method": "POST", "pp:path": "/shelf/move_to_position"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if bodyPosition != 0 {
				fields.Set("position", fmt.Sprintf("%v", bodyPosition))
			}
