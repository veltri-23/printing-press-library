...
func newShelfCreateRemovebookCmd(flags *rootFlags) *cobra.Command {
	var bodyAuthenticityToken string
	var bodyBookId int
	var bodyName string

	cmd := &cobra.Command{
		Use:         "create-removebook",
		Short:       "Remove one book from a shelf from the button helper.",
		Example:     "  goodreads-pp-cli shelf create-removebook",
		Annotations: map[string]string{"pp:endpoint": "shelf.create-removebook", "pp:method": "POST", "pp:path": "/shelf/remove_book"},
