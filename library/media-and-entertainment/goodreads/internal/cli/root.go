...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "goodreads-pp-cli",
		Short: "Manage goodreads resources via the goodreads API",
		Long: `Manage goodreads resources via the goodreads API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'goodreads-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("goodreads-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'goodreads-pp-cli profile list')")
	...
	rootCmd.AddCommand(newFriendCmd(flags))
	rootCmd.AddCommand(newGenresCmd(flags))
	rootCmd.AddCommand(newMessageCmd(flags))
	...
	rootCmd.AddCommand(newRatingCmd(flags))
	rootCmd.AddCommand(newFeedCmd(flags))
	rootCmd.AddCommand(newGiveawayCmd(flags))
	...
	rootCmd.AddCommand(newAmazonPurchasesPromotedCmd(flags))
	rootCmd.AddCommand(newBookPromotedCmd(flags))
	rootCmd.AddCommand(newCommentPromotedCmd(flags))
	rootCmd.AddCommand(newGoodreadsWebUndocumentedSearchPromotedCmd(flags))
	rootCmd.AddCommand(newListPromotedCmd(flags))
	rootCmd.AddCommand(newOpensearchXmlPromotedCmd(flags))
	rootCmd.AddCommand(newTooltipsPromotedCmd(flags))
	rootCmd.AddCommand(newTopicPromotedCmd(flags))
	rootCmd.AddCommand(newUserFollowingPromotedCmd(flags))
	rootCmd.AddCommand(newUserShelvesPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "version",
		Short: "Print the goodreads-pp CLI version",
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("goodreads-pp-cli %s\n", version)
		},
	}
}
