...
but do not stop the import.`,
  ...
  goodreads-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  goodreads-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | goodreads-pp-cli import <resource> --input -`,
