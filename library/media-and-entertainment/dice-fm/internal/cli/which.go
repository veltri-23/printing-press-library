...
var whichIndex = []whichEntry{
	{Command: "door list", Description: "Generate a valid-ticket-holder list for any event, with transferred tickets showing the new holder's name — ready for door access management.", Group: "Access management", WhyItMatters: "Use this before every show to get the definitive 'who can enter' list including all transfers and minus all returns."},
	{Command: "revenue summary", Description: "Aggregate gross revenue, Dice fees, and net earnings per event or across a date range — ready for CFO reports.", Group: "Financial intelligence", WhyItMatters: "Use this for weekly financial reporting without manually totaling per-event dashboards in a spreadsheet."},
	{Command: "velocity show", Description: "Show cumulative ticket sales by day or hour relative to the on-sale date — see whether an event is tracking fast or slow.", Group: "Financial intelligence", WhyItMatters: "Use within the first 72 hours after an on-sale to decide whether an event needs promotional push."},
	{Command: "fans repeat", Description: "Find fans who bought tickets to two or more of your events — your most loyal audience, ready for VIP outreach.", Group: "Audience intelligence", WhyItMatters: "Use weekly to build re-engagement lists before announcing new events to warm audiences first."},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  dice-fm-pp-cli which "stale tickets"
  dice-fm-pp-cli which "bottleneck"
  dice-fm-pp-cli which --limit 1 "send message"
  dice-fm-pp-cli which                                # list the full capability index`,
