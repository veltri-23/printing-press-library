...
type Config struct {
	...
	PexelsApiKey     string          `toml:"api_key"`
}
...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("PEXELS_API_KEY"); v != "" {
		cfg.PexelsApiKey = v
		cfg.markEnvOverride("PexelsApiKey")
		cfg.AuthSource = "env:PEXELS_API_KEY"
		cfg.CredentialSource = "env:PEXELS_API_KEY"
	}
	...
	if v := os.Getenv("PEXELS_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "pexels-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	replacements := map[string]string{
		"token":          token,
		"api_key":        c.PexelsApiKey,
		"PEXELS_API_KEY": c.PexelsApiKey,
	}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.PexelsApiKey = creds.PexelsApiKey
}
...
func (c *Config) SaveCredential(token string) error {
	...
	c.updateFileConfigField("AccessToken")
	c.PexelsApiKey = token
	delete(c.envOverrides, "PexelsApiKey")
	c.updateFileConfigField("PexelsApiKey")
	if err := c.saveCredentialsFirst(); err != nil {
		return err
	}
	return c.save()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["PexelsApiKey"] {
			out.PexelsApiKey = c.fileConfig.PexelsApiKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "PexelsApiKey":
		c.fileConfig.PexelsApiKey = c.PexelsApiKey
	}
}
