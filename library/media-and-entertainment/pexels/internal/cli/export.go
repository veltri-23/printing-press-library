...
large datasets as it has no memory pressure.`,
  ...
  pexels-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pexels-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pexels-pp-cli export <resource> --format jsonl | jq '.id'`,
