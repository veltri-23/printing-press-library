...
but do not stop the import.`,
  ...
  pexels-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pexels-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pexels-pp-cli import <resource> --input -`,
