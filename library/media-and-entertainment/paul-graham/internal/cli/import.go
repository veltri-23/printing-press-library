...
but do not stop the import.`,
  ...
  paul-graham-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  paul-graham-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | paul-graham-pp-cli import <resource> --input -`,
