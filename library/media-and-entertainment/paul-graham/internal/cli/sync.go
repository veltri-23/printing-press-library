...
Resource scoping:
  ...
  paul-graham-pp-cli sync

  # Sync specific resources only
  paul-graham-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  paul-graham-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  paul-graham-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  paul-graham-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  paul-graham-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/paul-graham-pp-cli/data.db)")
