...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "paul-graham-pp-cli",
		Short: "Manage paul-graham resources via the paul-graham API",
		Long: `Manage paul-graham resources via the paul-graham API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'paul-graham-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("paul-graham-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'paul-graham-pp-cli profile list')")
	...
	rootCmd.AddCommand(newArticlesHtmlPromotedCmd(flags))
	rootCmd.AddCommand(newLatestCmd(flags))
	rootCmd.AddCommand(newListCmd(flags))
	rootCmd.AddCommand(newSearchCmd(flags))
	rootCmd.AddCommand(newReadEssayCmd(flags))
	rootCmd.AddCommand(newLinksCmd(flags))
	rootCmd.AddCommand(newRandomEssayCmd(flags))
