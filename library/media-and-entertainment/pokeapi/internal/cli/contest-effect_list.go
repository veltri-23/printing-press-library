...
func newContestEffectListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Contest effects refer to the effects of moves when used in contests.",
		Example:     "  pokeapi-pp-cli contest-effect list",
		Annotations: map[string]string{"pp:endpoint": "contest-effect.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "contest-effect", path, map[string]string{
