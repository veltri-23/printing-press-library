...
func newRegionListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "A region is an organized area of the Pokémon world. Most often, the main difference between regions is the species...",
		Example:     "  pokeapi-pp-cli region list",
		Annotations: map[string]string{"pp:endpoint": "region.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/region/"
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "region", path, map[string]string{
