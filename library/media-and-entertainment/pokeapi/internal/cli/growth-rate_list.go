...
func newGrowthRateListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Growth rates are the speed with which Pokémon gain levels through experience. Check out...",
		Example:     "  pokeapi-pp-cli growth-rate list",
		Annotations: map[string]string{"pp:endpoint": "growth-rate.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "growth-rate", path, map[string]string{
