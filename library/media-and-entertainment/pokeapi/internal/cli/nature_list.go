...
func newNatureListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "nature.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/nature/"
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "nature", path, map[string]string{
