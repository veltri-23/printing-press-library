...
func newGenerationListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "A generation is a grouping of the Pokémon games that separates them based on the Pokémon they include. In each...",
		Example:     "  pokeapi-pp-cli generation list",
		Annotations: map[string]string{"pp:endpoint": "generation.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "generation", path, map[string]string{
