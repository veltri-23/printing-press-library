...
func newBerryListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Berries are small fruits that can provide HP and status condition restoration, stat enhancement, and even damage...",
		Example:     "  pokeapi-pp-cli berry list",
		Annotations: map[string]string{"pp:endpoint": "berry.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/berry/"
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "berry", path, map[string]string{
