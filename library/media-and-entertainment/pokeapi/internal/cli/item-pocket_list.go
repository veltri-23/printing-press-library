...
func newItemPocketListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Pockets within the players bag used for storing items by category.",
		Example:     "  pokeapi-pp-cli item-pocket list",
		Annotations: map[string]string{"pp:endpoint": "item-pocket.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "item-pocket", path, map[string]string{
