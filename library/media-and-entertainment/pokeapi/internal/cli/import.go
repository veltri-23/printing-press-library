...
but do not stop the import.`,
  ...
  pokeapi-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pokeapi-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pokeapi-pp-cli import <resource> --input -`,
