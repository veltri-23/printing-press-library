...
func newVersionGroupListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Version groups categorize highly similar versions of the games.",
		Example:     "  pokeapi-pp-cli version-group list",
		Annotations: map[string]string{"pp:endpoint": "version-group.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "version-group", path, map[string]string{
