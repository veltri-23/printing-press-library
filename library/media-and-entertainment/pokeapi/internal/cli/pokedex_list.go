...
func newPokedexListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "A Pokédex is a handheld electronic encyclopedia device; one which is capable of recording and retaining information...",
		Example:     "  pokeapi-pp-cli pokedex list",
		Annotations: map[string]string{"pp:endpoint": "pokedex.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/pokedex/"
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "pokedex", path, map[string]string{
