...
large datasets as it has no memory pressure.`,
  ...
  pokeapi-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pokeapi-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pokeapi-pp-cli export <resource> --format jsonl | jq '.id'`,
