...
func newBerryFlavorListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Flavors determine whether a Pokémon will benefit or suffer from eating a berry based on their **nature**. Check out...",
		Example:     "  pokeapi-pp-cli berry-flavor list",
		Annotations: map[string]string{"pp:endpoint": "berry-flavor.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "berry-flavor", path, map[string]string{
