...
func newStatListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Stats determine certain aspects of battles. Each Pokémon has a value for each stat which grows as they gain levels...",
		Example:     "  pokeapi-pp-cli stat list",
		Annotations: map[string]string{"pp:endpoint": "stat.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/stat/"
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "stat", path, map[string]string{
