...
func newGenderListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "gender.list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/gender/"
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "gender", path, map[string]string{
