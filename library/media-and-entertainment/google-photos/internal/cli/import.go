...
but do not stop the import.`,
  ...
  google-photos-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  google-photos-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | google-photos-pp-cli import <resource> --input -`,
