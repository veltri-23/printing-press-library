...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "google-photos-pp-cli",
		Short: `Manage Google Photos app-created albums and media, upload files, and work with Picker sessions from the terminal.`,
		Long: `Manage Google Photos app-created albums and media, upload files, and work with Picker sessions from the terminal.

Add --agent to any command for JSON output + non-interactive mode.
Run 'google-photos-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("google-photos-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newMediaItemsCmd(flags))
	rootCmd.AddCommand(newPickerCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("google-photos-pp-cli %s\n", version)
		},
	}
}
