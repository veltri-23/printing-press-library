...
func newIstoreServiceGetGamesFollowedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  steam-web-pp-cli istore-service get-games-followed --steamid 42",
		Annotations: map[string]string{"pp:endpoint": "istore-service.get-games-followed", "pp:method": "GET", "pp:path": "/IStoreService/GetGamesFollowed/v1", "mcp:read-only": "true"},
