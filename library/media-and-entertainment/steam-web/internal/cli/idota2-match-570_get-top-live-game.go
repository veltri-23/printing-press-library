...
func newIdota2Match570GetTopLiveGameCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  steam-web-pp-cli idota2-match-570 get-top-live-game --partner 42",
		Annotations: map[string]string{"pp:endpoint": "idota2-match-570.get-top-live-game", "pp:method": "GET", "pp:path": "/IDOTA2Match_570/GetTopLiveGame/v1", "mcp:read-only": "true"},
