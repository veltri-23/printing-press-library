...
func newIgameServersServiceGetAccountPublicInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  steam-web-pp-cli igame-servers-service get-account-public-info --key your-token-here --steamid 42",
		Annotations: map[string]string{"pp:endpoint": "igame-servers-service.get-account-public-info", "pp:method": "GET", "pp:path": "/IGameServersService/GetAccountPublicInfo/v1", "mcp:read-only": "true"},
