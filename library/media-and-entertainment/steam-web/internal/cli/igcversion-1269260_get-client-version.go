...
func newIgcversion1269260GetClientVersionCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "igcversion-1269260.get-client-version", "pp:method": "GET", "pp:path": "/IGCVersion_1269260/GetClientVersion/v1", "mcp:read-only": "true"},
