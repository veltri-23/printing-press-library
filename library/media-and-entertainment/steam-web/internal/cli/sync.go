...
Exit codes & warnings:
  ...
  steam-web-pp-cli sync --latest-only`,
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"icsgoservers-730":        "/ICSGOServers_730/GetGameServersStatus/v1",
		"idota2-match-570":        "/IDOTA2Match_570/GetMatchHistory/v1",
		"iecon-dota2-570":         "/IEconDOTA2_570/GetHeroes/v1",
		"iecon-items-440":         "/IEconItems_440/GetSchema/v1",
		"iecon-items-570":         "/IEconItems_570/GetStoreMetaData/v1",
		"iecon-items-620":         "/IEconItems_620/GetSchema/v1",
		"iecon-items-730":         "/IEconItems_730/GetSchema/v2",
		"iecon-service":           "/IEconService/GetTradeOffers/v1",
		"igame-servers-service":   "/IGameServersService/GetAccountList/v1",
		"igcversion-1046930":      "/IGCVersion_1046930/GetClientVersion/v1",
		"igcversion-1269260":      "/IGCVersion_1269260/GetClientVersion/v1",
		"igcversion-1422450":      "/IGCVersion_1422450/GetClientVersion/v1",
		"igcversion-440":          "/IGCVersion_440/GetServerVersion/v1",
		"igcversion-570":          "/IGCVersion_570/GetClientVersion/v1",
		"igcversion-583950":       "/IGCVersion_583950/GetClientVersion/v1",
		"igcversion-730":          "/IGCVersion_730/GetServerVersion/v1",
		"ipublished-file-service": "/IPublishedFileService/QueryFiles/v1",
		"isteam-directory":        "/ISteamDirectory/GetCMListForConnect/v1",
		"isteam-web-apiutil":      "/ISteamWebAPIUtil/GetServerInfo/v1",
		"istore-service":          "/IStoreService/GetAppList/v1",
		"itfitems-440":            "/ITFItems_440/GetGoldenWrenches/v1",
		"itfsystem-440":           "/ITFSystem_440/GetWorldStatus/v1",
		"iwishlist-service":       "/IWishlistService/GetWishlistSortedFiltered/v1",
	}
