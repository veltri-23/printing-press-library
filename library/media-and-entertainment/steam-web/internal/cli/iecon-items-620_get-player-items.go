...
func newIeconItems620GetPlayerItemsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  steam-web-pp-cli iecon-items-620 get-player-items --steamid 42",
		Annotations: map[string]string{"pp:endpoint": "iecon-items-620.get-player-items", "pp:method": "GET", "pp:path": "/IEconItems_620/GetPlayerItems/v1", "mcp:read-only": "true"},
