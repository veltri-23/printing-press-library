...
func newIsteamNewsGetNewsForAppCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  steam-web-pp-cli isteam-news get-news-for-app --appid 42",
		Annotations: map[string]string{"pp:endpoint": "isteam-news.get-news-for-app", "pp:method": "GET", "pp:path": "/ISteamNews/GetNewsForApp/v1", "mcp:read-only": "true"},
