...
func newIsteamUserStatsGetSchemaForGameCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  steam-web-pp-cli isteam-user-stats get-schema-for-game --key your-token-here --appid 42",
		Annotations: map[string]string{"pp:endpoint": "isteam-user-stats.get-schema-for-game", "pp:method": "GET", "pp:path": "/ISteamUserStats/GetSchemaForGame/v1", "mcp:read-only": "true"},
