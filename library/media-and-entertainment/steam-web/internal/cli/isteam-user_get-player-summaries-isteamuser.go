...
func newIsteamUserGetPlayerSummariesIsteamuserCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  steam-web-pp-cli isteam-user get-player-summaries-isteamuser --key your-token-here --steamids example-value",
		Annotations: map[string]string{"pp:endpoint": "isteam-user.get-player-summaries-isteamuser", "pp:method": "GET", "pp:path": "/ISteamUser/GetPlayerSummaries/v2", "mcp:read-only": "true"},
