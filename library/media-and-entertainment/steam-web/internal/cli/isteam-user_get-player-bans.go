...
func newIsteamUserGetPlayerBansCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  steam-web-pp-cli isteam-user get-player-bans --key your-token-here --steamids example-value",
		Annotations: map[string]string{"pp:endpoint": "isteam-user.get-player-bans", "pp:method": "GET", "pp:path": "/ISteamUser/GetPlayerBans/v1", "mcp:read-only": "true"},
