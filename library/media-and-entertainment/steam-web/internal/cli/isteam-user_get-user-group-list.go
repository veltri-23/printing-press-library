...
func newIsteamUserGetUserGroupListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  steam-web-pp-cli isteam-user get-user-group-list --key your-token-here --steamid 42",
		Annotations: map[string]string{"pp:endpoint": "isteam-user.get-user-group-list", "pp:method": "GET", "pp:path": "/ISteamUser/GetUserGroupList/v1", "mcp:read-only": "true"},
