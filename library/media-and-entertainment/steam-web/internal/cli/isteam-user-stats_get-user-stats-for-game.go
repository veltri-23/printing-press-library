...
func newIsteamUserStatsGetUserStatsForGameCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  steam-web-pp-cli isteam-user-stats get-user-stats-for-game --key your-token-here --steamid 42 --appid 42",
		Annotations: map[string]string{"pp:endpoint": "isteam-user-stats.get-user-stats-for-game", "pp:method": "GET", "pp:path": "/ISteamUserStats/GetUserStatsForGame/v1", "mcp:read-only": "true"},
