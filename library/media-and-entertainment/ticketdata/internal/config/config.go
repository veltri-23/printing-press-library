...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://data.ticketdata.com/api",
	}
	...
	if v := os.Getenv("TICKETDATA_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("TICKETDATA_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "ticketdata-pp-cli", "config.toml"), nil
}
