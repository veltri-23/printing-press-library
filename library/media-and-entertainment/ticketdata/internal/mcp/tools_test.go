...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "ticketdata-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "ticketdata-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"TICKETDATA_CONFIG",
		"TICKETDATA_CONFIG_DIR",
		"TICKETDATA_DATA_DIR",
		"TICKETDATA_STATE_DIR",
		"TICKETDATA_CACHE_DIR",
		"TICKETDATA_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("ticketdata", "test")
	RegisterTools(s)
