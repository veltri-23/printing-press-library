...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("TICKETDATA_STATE_DIR", "")
	t.Setenv("TICKETDATA_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"ticketdata-pp-cli auth login",
		"ticketdata-pp-cli doctor",
		"ticketdata-pp-cli help items",
		"ticketdata-pp-cli sync",
		"ticketdata-pp-cli profile list",
		"ticketdata-pp-cli feedback list",
		"ticketdata-pp-cli which",
		"ticketdata-pp-cli agent-context",
		"ticketdata-pp-cli completion bash",
		"ticketdata-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"ticketdata-pp-cli recall",
		"ticketdata-pp-cli learnings",
		"ticketdata-pp-cli teach-pattern",
		"ticketdata-pp-cli teach-lookup",
		"ticketdata-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("ticketdata-pp-cli")); err == nil {
