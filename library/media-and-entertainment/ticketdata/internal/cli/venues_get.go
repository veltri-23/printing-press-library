...
func newVenuesGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <slug>",
		Short:       "Get a venue's stats (upcoming events, location)",
		Example:     "  ticketdata-pp-cli venues get state-farm-arena",
		Annotations: map[string]string{"pp:endpoint": "venues.get", "pp:method": "GET", "pp:path": "/venues/{slug}", "mcp:read-only": "true", "pp:no-error-path-probe": "true"},
