...
const RecallFirstProtocol = `1. Recall first: before answering a domain query, run recall --query "<question>" --agent and apply any verified learnings, playbook steps, and notes it returns.
