...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "boardgamegeek-pp-cli",
		Short: "Manage boardgamegeek resources via the boardgamegeek API",
		Long: `Manage boardgamegeek resources via the boardgamegeek API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'boardgamegeek-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("boardgamegeek-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'boardgamegeek-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCollectionPromotedCmd(flags))
	rootCmd.AddCommand(newFamilyPromotedCmd(flags))
	rootCmd.AddCommand(newGuildPromotedCmd(flags))
	rootCmd.AddCommand(newHotPromotedCmd(flags))
	rootCmd.AddCommand(newPlaysPromotedCmd(flags))
	rootCmd.AddCommand(newSearchesPromotedCmd(flags))
	rootCmd.AddCommand(newThingPromotedCmd(flags))
