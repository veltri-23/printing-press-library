...
but do not stop the import.`,
  ...
  boardgamegeek-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  boardgamegeek-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | boardgamegeek-pp-cli import <resource> --input -`,
