...
native streaming instead of polling.`,
  ...
  boardgamegeek-pp-cli tail --interval 10s

  # Tail a specific resource
  boardgamegeek-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  boardgamegeek-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
