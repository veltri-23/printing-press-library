...
large datasets as it has no memory pressure.`,
  ...
  boardgamegeek-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  boardgamegeek-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  boardgamegeek-pp-cli export <resource> --format jsonl | jq '.id'`,
