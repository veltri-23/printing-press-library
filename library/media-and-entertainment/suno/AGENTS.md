# Suno Printed CLI Agent Guide

This directory is a generated `suno-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
suno-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
suno-pp-cli which "<capability>" --json
suno-pp-cli <command> --help
```
...
```bash
suno-pp-cli <command> --help
suno-pp-cli <command> --dry-run --agent
```
