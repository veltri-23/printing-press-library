...
func newPostsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path = replacePathParam(path, "post_name", fmt.Sprintf("%v", flagPostName))
	...
	cmd.Flags().StringVar(&flagPostName, "slug", "", "Post slug (URL fragment)")
	cmd.Flags().StringVar(&flagG, "g", "", "")
	cmd.Flags().StringVar(&flagP, "name-q", "", "")
