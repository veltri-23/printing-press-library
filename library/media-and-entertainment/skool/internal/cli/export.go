...
large datasets as it has no memory pressure.`,
  ...
  skool-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  skool-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  skool-pp-cli export <resource> --format jsonl | jq '.id'`,
