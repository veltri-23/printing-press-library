...
but do not stop the import.`,
  ...
  bandsintown-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  bandsintown-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | bandsintown-pp-cli import <resource> --input -`,
