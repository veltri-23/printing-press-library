...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: "Read and filter Marginal Revolution through its public RSS feed",
		Long: `Read and filter Marginal Revolution through its public RSS feed.
...
Run 'marginalrevolution-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("marginalrevolution-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'marginalrevolution-pp-cli profile list')")
	...
	// PATCH: Add RSS-native commands on top of the v4.2.1 generated /feed wrapper.
	rootCmd.AddCommand(newLatestCmd(flags))
	rootCmd.AddCommand(newSearchFeedCmd(flags))
	rootCmd.AddCommand(newReadPostCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("marginalrevolution-pp-cli %s\n", version)
		},
	}
}
