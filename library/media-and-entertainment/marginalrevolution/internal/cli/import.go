...
but do not stop the import.`,
  ...
  marginalrevolution-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  marginalrevolution-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | marginalrevolution-pp-cli import <resource> --input -`,
