...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  marginalrevolution-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  marginalrevolution-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  marginalrevolution-pp-cli workflow status

  # Show status as JSON
  marginalrevolution-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("marginalrevolution-pp-cli")
			}
