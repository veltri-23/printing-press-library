...
large datasets as it has no memory pressure.`,
  ...
  marginalrevolution-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  marginalrevolution-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  marginalrevolution-pp-cli export <resource> --format jsonl | jq '.id'`,
