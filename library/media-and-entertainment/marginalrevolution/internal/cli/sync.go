...
Exit codes & warnings:
  ...
  marginalrevolution-pp-cli sync

  # Sync specific resources only
  marginalrevolution-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  marginalrevolution-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  marginalrevolution-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  marginalrevolution-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  marginalrevolution-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/marginalrevolution-pp-cli/data.db)")
