...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("SOCCER_GOAT_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "soccer-goat-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "soccer-goat-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"SOCCER_GOAT_CONFIG",
		"SOCCER_GOAT_CONFIG_DIR",
		"SOCCER_GOAT_DATA_DIR",
		"SOCCER_GOAT_STATE_DIR",
		"SOCCER_GOAT_CACHE_DIR",
		"SOCCER_GOAT_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("soccer-goat", "test")
	RegisterTools(s)
