...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("SOCCER_GOAT_STATE_DIR", "")
	t.Setenv("SOCCER_GOAT_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"soccer-goat-pp-cli auth login",
		"soccer-goat-pp-cli doctor",
		"soccer-goat-pp-cli help items",
		"soccer-goat-pp-cli sync",
		"soccer-goat-pp-cli profile list",
		"soccer-goat-pp-cli feedback list",
		"soccer-goat-pp-cli which",
		"soccer-goat-pp-cli agent-context",
		"soccer-goat-pp-cli completion bash",
		"soccer-goat-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"soccer-goat-pp-cli recall",
		"soccer-goat-pp-cli learnings",
		"soccer-goat-pp-cli teach-pattern",
		"soccer-goat-pp-cli teach-lookup",
		"soccer-goat-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("soccer-goat-pp-cli")); err == nil {
