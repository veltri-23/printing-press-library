...
but do not stop the import.`,
  ...
  drudgereport-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  drudgereport-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | drudgereport-pp-cli import <resource> --input -`,
