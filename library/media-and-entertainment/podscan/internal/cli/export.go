...
large datasets as it has no memory pressure.`,
  ...
  podscan-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  podscan-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  podscan-pp-cli export <resource> --format jsonl | jq '.id'`,
