...
but do not stop the import.`,
  ...
  podscan-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  podscan-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | podscan-pp-cli import <resource> --input -`,
