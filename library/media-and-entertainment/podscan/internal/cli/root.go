...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "podscan-pp-cli",
		Short: "Manage podscan resources via the podscan API",
		Long: `Manage podscan resources via the podscan API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'podscan-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("podscan-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'podscan-pp-cli profile list')")
	...
	rootCmd.AddCommand(newGuestCmd(flags))
	rootCmd.AddCommand(newTopicCmd(flags))
	rootCmd.AddCommand(newAsksCmd(flags))
	rootCmd.AddCommand(newSponsorCmd(flags))
