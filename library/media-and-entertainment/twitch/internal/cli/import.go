...
but do not stop the import.`,
  ...
  twitch-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  twitch-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | twitch-pp-cli import <resource> --input -`,
