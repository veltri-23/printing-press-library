...
large datasets as it has no memory pressure.`,
  ...
  twitch-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  twitch-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  twitch-pp-cli export <resource> --format jsonl | jq '.id'`,
