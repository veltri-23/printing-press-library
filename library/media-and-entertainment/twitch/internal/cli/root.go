...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "twitch-pp-cli",
		Short: "Manage twitch resources via the twitch API",
		Long: `Manage twitch resources via the twitch API.
...
Run 'twitch-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("twitch-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'twitch-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBitsCmd(flags))
	rootCmd.AddCommand(newChannelPointsCmd(flags))
	rootCmd.AddCommand(newChannelsCmd(flags))
	rootCmd.AddCommand(newCharityCmd(flags))
	rootCmd.AddCommand(newChatCmd(flags))
	rootCmd.AddCommand(newClipsCmd(flags))
	rootCmd.AddCommand(newEntitlementsCmd(flags))
	rootCmd.AddCommand(newEventsubCmd(flags))
	rootCmd.AddCommand(newExtensionsCmd(flags))
	rootCmd.AddCommand(newGamesCmd(flags))
	rootCmd.AddCommand(newGuestStarCmd(flags))
	rootCmd.AddCommand(newModerationCmd(flags))
	rootCmd.AddCommand(newPollsCmd(flags))
	rootCmd.AddCommand(newPredictionsCmd(flags))
	rootCmd.AddCommand(newRaidsCmd(flags))
	rootCmd.AddCommand(newScheduleCmd(flags))
	rootCmd.AddCommand(newStreamsCmd(flags))
	rootCmd.AddCommand(newSubscriptionsCmd(flags))
	rootCmd.AddCommand(newTeamsCmd(flags))
	rootCmd.AddCommand(newTwitchHelixAnalyticsCmd(flags))
	rootCmd.AddCommand(newTwitchHelixSearchCmd(flags))
	...
	rootCmd.AddCommand(newAuthorizationPromotedCmd(flags))
	rootCmd.AddCommand(newContentClassificationLabelsPromotedCmd(flags))
	rootCmd.AddCommand(newGoalsPromotedCmd(flags))
	rootCmd.AddCommand(newHypetrainPromotedCmd(flags))
	rootCmd.AddCommand(newSharedChatPromotedCmd(flags))
	rootCmd.AddCommand(newTagsPromotedCmd(flags))
	rootCmd.AddCommand(newWhispersPromotedCmd(flags))
