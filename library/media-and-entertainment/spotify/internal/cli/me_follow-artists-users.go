...
func newMeFollowArtistsUsersCmd(flags *rootFlags) *cobra.Command {
	var flagType string
	var flagIds string
	var bodyIds2 string
	var stdinBody bool
	...
	cmd := &cobra.Command{
		Use:     "follow-artists-users",
		Aliases: []string{"update"},
		Short:   "Add the current user as a follower of one or more artists or other Spotify users. **Note:** This endpoint is deprecated.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  spotify-pp-cli me follow-artists-users --type artist --ids example-value",
		Annotations: map[string]string{"pp:endpoint": "me.follow-artists-users", "pp:method": "PUT", "pp:path": "/me/following"},
