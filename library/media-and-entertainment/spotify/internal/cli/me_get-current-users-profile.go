...
func newMeGetCurrentUsersProfileCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "get-current-users-profile",
		Short:       "Get detailed profile information about the current user (including the current user's username).",
