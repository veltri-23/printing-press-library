...
func newMeSaveAlbumsUserCmd(flags *rootFlags) *cobra.Command {
	var flagIds string
	var bodyIds2 string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:   "save-albums-user",
		Short: "Save one or more albums to the current user's 'Your Music' library. **Note:** This endpoint is deprecated.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  spotify-pp-cli me save-albums-user --ids example-value",
		Annotations: map[string]string{"pp:endpoint": "me.save-albums-user", "pp:method": "PUT", "pp:path": "/me/albums"},
