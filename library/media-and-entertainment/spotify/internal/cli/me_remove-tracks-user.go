...
func newMeRemoveTracksUserCmd(flags *rootFlags) *cobra.Command {
	var flagIds string
	var bodyIds2 string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:   "remove-tracks-user",
		Short: "Remove one or more tracks from the current user's 'Your Music' library. **Note:** This endpoint is deprecated.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  spotify-pp-cli me remove-tracks-user --ids example-value",
		Annotations: map[string]string{"pp:endpoint": "me.remove-tracks-user", "pp:method": "DELETE", "pp:path": "/me/tracks"},
