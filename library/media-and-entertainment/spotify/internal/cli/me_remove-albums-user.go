...
func newMeRemoveAlbumsUserCmd(flags *rootFlags) *cobra.Command {
	var flagIds string
	var bodyIds2 string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:     "remove-albums-user",
		Aliases: []string{"delete"},
		Short:   "Remove one or more albums from the current user's 'Your Music' library. **Note:** This endpoint is deprecated.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  spotify-pp-cli me remove-albums-user --ids example-value",
		Annotations: map[string]string{"pp:endpoint": "me.remove-albums-user", "pp:method": "DELETE", "pp:path": "/me/albums"},
