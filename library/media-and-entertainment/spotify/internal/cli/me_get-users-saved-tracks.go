...
func newMeGetUsersSavedTracksCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-users-saved-tracks",
		Short:       "Get a list of the songs saved in the current Spotify user's 'Your Music' library.",
