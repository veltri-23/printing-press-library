...
func newMeRemoveShowsUserCmd(flags *rootFlags) *cobra.Command {
	var flagIds string
	...
	cmd := &cobra.Command{
		Use:   "remove-shows-user",
		Short: "Delete one or more shows from current Spotify user's library. **Note:** This endpoint is deprecated.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  spotify-pp-cli me remove-shows-user --ids example-value",
		Annotations: map[string]string{"pp:endpoint": "me.remove-shows-user", "pp:method": "DELETE", "pp:path": "/me/shows"},
	...
	cmd.Flags().StringVar(&bodyIds2, "ids-2", "", "A JSON array of the [Spotify IDs](https://developer.spotify.com/documentation/web-api/#spotify-uris-and-ids).")
