...
func newPlaylistsTracksReorderOrReplacePlaylistsCmd(flags *rootFlags) *cobra.Command {
	var flagUris string
	...
	cmd := &cobra.Command{
		...
		Short:       "**Deprecated:** Use [Update Playlist Items](/documentation/web-api/reference/reorder-or-replace-playlists-items)",
		Example:     "  spotify-pp-cli playlists tracks reorder-or-replace-playlists 3cEYpjA9oz9GiPac4AsH4n",
		Annotations: map[string]string{"pp:endpoint": "tracks.reorder-or-replace-playlists", "pp:method": "PUT", "pp:path": "/playlists/{playlist_id}/tracks"},
