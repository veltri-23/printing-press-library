...
func newMeRemoveEpisodesUserCmd(flags *rootFlags) *cobra.Command {
	var flagIds string
	var bodyIds2 string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:   "remove-episodes-user",
		Short: "Remove one or more episodes from the current user's library. **Note:** This endpoint is deprecated.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  spotify-pp-cli me remove-episodes-user --ids example-value",
		Annotations: map[string]string{"pp:endpoint": "me.remove-episodes-user", "pp:method": "DELETE", "pp:path": "/me/episodes"},
