...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  spotify-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  spotify-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"me", "me-albums", "me-audiobooks", "me-episodes", "me-player-devices", "me-player-queue", "me-playlists", "me-shows", "me-top-artists", "me-top-tracks", "me-tracks"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  spotify-pp-cli workflow status

  # Show status as JSON
  spotify-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("spotify-pp-cli")
			}
