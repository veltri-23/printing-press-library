...
func newMeSaveLibraryItemsCmd(flags *rootFlags) *cobra.Command {
	var flagUris string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:   "save-library-items",
		Short: "Add one or more items to the current user's library.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  spotify-pp-cli me save-library-items --uris example-value",
		Annotations: map[string]string{"pp:endpoint": "me.save-library-items", "pp:method": "PUT", "pp:path": "/me/library"},
