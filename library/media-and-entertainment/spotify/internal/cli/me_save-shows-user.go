...
func newMeSaveShowsUserCmd(flags *rootFlags) *cobra.Command {
	var flagIds string
	var bodyIds2 string
	var stdinBody bool
	...
	cmd := &cobra.Command{
		Use:   "save-shows-user",
		Short: "Save one or more shows to current Spotify user's library. **Note:** This endpoint is deprecated.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  spotify-pp-cli me save-shows-user --ids example-value",
		Annotations: map[string]string{"pp:endpoint": "me.save-shows-user", "pp:method": "PUT", "pp:path": "/me/shows"},
