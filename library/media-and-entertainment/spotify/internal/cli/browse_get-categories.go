...
func newBrowseGetCategoriesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-categories",
		Aliases:     []string{"list"},
		Short:       "Get a list of categories used to tag items in Spotify (on, for example, the Spotify player’s “Browse” tab).",
