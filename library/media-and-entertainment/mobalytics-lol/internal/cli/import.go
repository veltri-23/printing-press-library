...
but do not stop the import.`,
  ...
  mobalytics-lol-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  mobalytics-lol-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | mobalytics-lol-pp-cli import <resource> --input -`,
