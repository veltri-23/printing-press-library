...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://ddragon.leagueoflegends.com/api/versions.json",
		EntryCount:    6,
		APIEntryCount: 6,
		...
		CandidateCommands: []string{
			"list_Aatrox.json — Derived from observed GET /cdn/16.10.1/data/en_US/champion/Aatrox.json traffic.",
			"list_champion.json — Derived from observed GET /cdn/16.10.1/data/en_US/champion.json traffic.",
			"list_item.json — Derived from observed GET /cdn/16.10.1/data/en_US/item.json traffic.",
			"list_runesReforged.json — Derived from observed GET /cdn/16.10.1/data/en_US/runesReforged.json traffic.",
			"list_summoner.json — Derived from observed GET /cdn/16.10.1/data/en_US/summoner.json traffic.",
			"list_versions.json — Derived from observed GET /api/versions.json traffic.",
		},
	}
}
