...
const (
	journalSessionEnvVar   = "SUBSTACK_READER_LEARN_SESSION"
	journalNoLearnEnvVar   = "SUBSTACK_READER_NO_LEARN"
	journalNoCaptureEnvVar = "SUBSTACK_READER_LEARN_NO_CAPTURE"
)
