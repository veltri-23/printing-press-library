...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("SUBSTACK_READER_HOME", root)
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"SUBSTACK_READER_CONFIG",
		"SUBSTACK_READER_CONFIG_DIR",
		"SUBSTACK_READER_DATA_DIR",
		"SUBSTACK_READER_STATE_DIR",
		"SUBSTACK_READER_CACHE_DIR",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("substack-reader", "test")
	RegisterTools(s)
