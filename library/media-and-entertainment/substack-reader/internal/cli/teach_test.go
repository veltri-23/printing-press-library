...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("SUBSTACK_READER_STATE_DIR", "")
	t.Setenv("SUBSTACK_READER_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"substack-reader-pp-cli auth login",
		"substack-reader-pp-cli doctor",
		"substack-reader-pp-cli help items",
		"substack-reader-pp-cli sync",
		"substack-reader-pp-cli profile list",
		"substack-reader-pp-cli feedback list",
		"substack-reader-pp-cli which",
		"substack-reader-pp-cli agent-context",
		"substack-reader-pp-cli completion bash",
		"substack-reader-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"substack-reader-pp-cli recall",
		"substack-reader-pp-cli learnings",
		"substack-reader-pp-cli teach-pattern",
		"substack-reader-pp-cli teach-lookup",
		"substack-reader-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("substack-reader-pp-cli")); err == nil {
