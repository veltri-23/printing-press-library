...
but do not stop the import.`,
  ...
  eventbrite-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  eventbrite-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | eventbrite-pp-cli import <resource> --input -`,
