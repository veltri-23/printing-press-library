...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "eventbrite-pp-cli",
		Short: `Eventbrite CLI — Every Eventbrite organizer endpoint, plus a local SQLite mirror of your events, orders, and attendees you can search of…`,
		Long: `Eventbrite CLI — Every Eventbrite organizer endpoint, plus a local SQLite mirror of your events, orders, and attendees you can search of…
...
Health check: run 'eventbrite-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("eventbrite-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'eventbrite-pp-cli profile list')")
	...
	rootCmd.AddCommand(newFormatsCmd(flags))
	...
	rootCmd.AddCommand(newSubcategoriesCmd(flags))
	rootCmd.AddCommand(newTicketGroupsCmd(flags))
	...
	rootCmd.AddCommand(newSalesVelocityCmd(flags))
	rootCmd.AddCommand(newRepeatAttendeesCmd(flags))
	rootCmd.AddCommand(newDiscountPerformanceCmd(flags))
	rootCmd.AddCommand(newOrgRollupCmd(flags))
	rootCmd.AddCommand(newRosterCmd(flags))
	rootCmd.AddCommand(newCapacityCmd(flags))
	rootCmd.AddCommand(newRefundRateCmd(flags))
	rootCmd.AddCommand(newTopBuyersCmd(flags))
	rootCmd.AddCommand(newFanExportCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("eventbrite-pp-cli %s\n", version)
		},
	}
}
