...
func newPeopleGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path = replacePathParam(path, "personId", args[0])
	...
	cmd.Flags().StringVar(&flagAppendToResponse, "append-to-response", "combined_credits,external_ids", "Additional data to include")
