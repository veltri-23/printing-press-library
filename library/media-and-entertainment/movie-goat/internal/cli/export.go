...
large datasets as it has no memory pressure.`,
  ...
  movie-goat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  movie-goat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  movie-goat-pp-cli export <resource> --format jsonl | jq '.id'`,
