...
func newTrendingAllCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  movie-goat-pp-cli trending all",
		Annotations: map[string]string{"pp:endpoint": "trending.all", "mcp:read-only": "true"},
