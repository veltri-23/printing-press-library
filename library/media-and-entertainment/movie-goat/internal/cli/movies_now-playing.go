...
func newMoviesNowPlayingCmd(flags *rootFlags) *cobra.Command {
	var flagPage string
	...
	cmd := &cobra.Command{
		Use:         "now-playing",
		Short:       "Get movies currently in theaters",
		Example:     "  movie-goat-pp-cli movies now-playing",
		Annotations: map[string]string{"pp:endpoint": "movies.now-playing", "mcp:read-only": "true"},
