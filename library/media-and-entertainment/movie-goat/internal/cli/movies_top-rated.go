...
func newMoviesTopRatedCmd(flags *rootFlags) *cobra.Command {
	var flagPage string
	...
	cmd := &cobra.Command{
		Use:         "top-rated",
		Short:       "Get the highest rated movies",
		Example:     "  movie-goat-pp-cli movies top-rated",
		Annotations: map[string]string{"pp:endpoint": "movies.top-rated", "mcp:read-only": "true"},
