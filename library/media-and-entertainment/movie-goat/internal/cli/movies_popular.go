...
func newMoviesPopularCmd(flags *rootFlags) *cobra.Command {
	var flagPage string
	...
	cmd := &cobra.Command{
		...
		Example:     "  movie-goat-pp-cli movies popular",
		Annotations: map[string]string{"pp:endpoint": "movies.popular", "mcp:read-only": "true"},
