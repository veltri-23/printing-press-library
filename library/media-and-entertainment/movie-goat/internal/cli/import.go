...
but do not stop the import.`,
  ...
  movie-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  movie-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | movie-goat-pp-cli import <resource> --input -`,
