...
but do not stop the import.`,
  ...
  nasa-images-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  nasa-images-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | nasa-images-pp-cli import <resource> --input -`,
