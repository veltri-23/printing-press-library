...
but do not stop the import.`,
  ...
  podcast-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  podcast-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | podcast-goat-pp-cli import <resource> --input -`,
