...
but do not stop the import.`,
  ...
  setlist-fm-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  setlist-fm-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | setlist-fm-pp-cli import <resource> --input -`,
