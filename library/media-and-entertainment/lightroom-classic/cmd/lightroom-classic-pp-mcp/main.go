...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/media-and-entertainment/lightroom-classic/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("LIGHTROOM_CLASSIC_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "lightroom-classic-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
