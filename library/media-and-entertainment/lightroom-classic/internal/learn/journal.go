...
const (
	journalSessionEnvVar   = "LIGHTROOM_CLASSIC_LEARN_SESSION"
	journalNoLearnEnvVar   = "LIGHTROOM_CLASSIC_NO_LEARN"
	journalNoCaptureEnvVar = "LIGHTROOM_CLASSIC_LEARN_NO_CAPTURE"
)
