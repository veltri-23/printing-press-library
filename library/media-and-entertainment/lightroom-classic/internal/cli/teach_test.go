...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("LIGHTROOM_CLASSIC_STATE_DIR", "")
	t.Setenv("LIGHTROOM_CLASSIC_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"lightroom-classic-pp-cli auth login",
		"lightroom-classic-pp-cli doctor",
		"lightroom-classic-pp-cli help items",
		"lightroom-classic-pp-cli sync",
		"lightroom-classic-pp-cli profile list",
		"lightroom-classic-pp-cli feedback list",
		"lightroom-classic-pp-cli which",
		"lightroom-classic-pp-cli agent-context",
		"lightroom-classic-pp-cli completion bash",
		"lightroom-classic-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"lightroom-classic-pp-cli recall",
		"lightroom-classic-pp-cli learnings",
		"lightroom-classic-pp-cli teach-pattern",
		"lightroom-classic-pp-cli teach-lookup",
		"lightroom-classic-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("lightroom-classic-pp-cli")); err == nil {
