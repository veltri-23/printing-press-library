...
large datasets as it has no memory pressure.`,
  ...
  lightroom-classic-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  lightroom-classic-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  lightroom-classic-pp-cli export <resource> --format jsonl | jq '.id'`,
