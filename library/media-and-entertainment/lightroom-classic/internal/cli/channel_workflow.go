...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  lightroom-classic-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  lightroom-classic-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  lightroom-classic-pp-cli workflow status

  # Show status as JSON
  lightroom-classic-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("lightroom-classic-pp-cli")
			}
