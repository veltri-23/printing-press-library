...
var whichIndex = []whichEntry{
	{Command: "streaks", Description: "See your current and longest daily-shooting streaks and every missed day in a range.", Group: "Daily practice", WhyItMatters: "Reach for this when asked about daily practice consistency or missed days."},
	{Command: "pick-of-day", Description: "Get exactly one image per day — flag beats rating beats recency — with its file path resolved for publishing.", Group: "Daily practice", WhyItMatters: "Use this when a build pipeline needs the day's photo, not a list of candidates."},
	{Command: "on-this-day", Description: "Everything shot on this calendar date across all years, grouped by year.", Group: "Daily practice", WhyItMatters: "Use for month/day browse pages and anniversary lookbacks; find only does date ranges."},
	{Command: "project", Description: "Progress report for a fixed-length photo project: day N of target, missed days, projected finish.", Group: "Daily practice", WhyItMatters: "Use when tracking a bounded series backed by a collection."},
	{Command: "stats", Description: "Histograms of your shooting by focal length, hour, weekday, month, camera, lens, or ISO.", Group: "Catalog intelligence", WhyItMatters: "Use for gear and habit questions; returns buckets, not image rows."},
	{Command: "doctor", Description: "Health sweep: masters missing on disk, images without capture time, orphan keywords, empty collections.", Group: "Catalog intelligence", WhyItMatters: "Run before backups or migrations to find catalog rot."},
	{Command: "funnel", Description: "Conversion rates from shot to picked to rated to developed to collected, optionally per year.", Group: "Catalog intelligence", WhyItMatters: "Use for selectivity and culling-discipline questions."},
	{Command: "backlog", Description: "Keepers you flagged or rated but never developed.", Group: "Catalog intelligence", WhyItMatters: "Use to surface workflow debt before publishing deadlines."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  lightroom-classic-pp-cli which "stale tickets"
  lightroom-classic-pp-cli which "bottleneck"
  lightroom-classic-pp-cli which --limit 1 "send message"
  lightroom-classic-pp-cli which                                # list the full capability index`,
