...
native streaming instead of polling.`,
  ...
  lightroom-classic-pp-cli tail --interval 10s

  # Tail a specific resource
  lightroom-classic-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  lightroom-classic-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
