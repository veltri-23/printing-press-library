...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("LIGHTROOM_CLASSIC_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("LIGHTROOM_CLASSIC_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "lightroom-classic-pp-cli", "config.toml"), nil
}
