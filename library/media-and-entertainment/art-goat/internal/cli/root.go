...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "art-goat-pp-cli",
		Short: `Art Goat CLI — A contemplative daily art practice with museum and astronomy APIs as your gallery.`,
		Long: `Art Goat CLI — A contemplative daily art practice with museum and astronomy APIs as your gallery.
...
Health check: run 'art-goat-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("art-goat-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'art-goat-pp-cli profile list')")
	...
	rootCmd.PersistentPreRunE = func(cmd *cobra.Command, args []string) error {
		...
		// Advisory freshness nudge — errors are intentionally swallowed
		// so a DB hiccup never blocks an otherwise-valid command.
		_, _ = autoRefreshIfStale(cmd.Context(), defaultDBPath("art-goat-pp-cli"))
		return nil
	}
	...
	rootCmd.AddCommand(newPlanetaryPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	// art-goat contemplative spine + cross-source surface.
	rootCmd.AddCommand(newSitCmd(flags))
