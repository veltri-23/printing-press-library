...
but do not stop the import.`,
  ...
  art-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  art-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | art-goat-pp-cli import <resource> --input -`,
