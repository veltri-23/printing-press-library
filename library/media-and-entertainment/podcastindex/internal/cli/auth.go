...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Podcastindex Org",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  podcastindex-pp-cli auth setup\n  podcastindex-pp-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			launchURL := "https://github.com/tbowers/python-podcastindex-org-lambda"
...
func newAuthStatusCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  podcastindex-pp-cli auth status",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  podcastindex-pp-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  podcastindex-pp-cli auth logout",
		RunE: func(cmd *cobra.Command, args []string) error {
			cfg, err := config.Load(flags.configPath)
			if err != nil {
				return configErr(err)
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("PODCASTINDEX_KEY") != "" {
				envStillSet = "PODCASTINDEX_KEY"
			}
			if envStillSet == "" && os.Getenv("PODCASTINDEX_ORG_API_KEY") != "" {
				envStillSet = "PODCASTINDEX_ORG_API_KEY"
			}
