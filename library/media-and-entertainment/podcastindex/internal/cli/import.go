...
but do not stop the import.`,
  ...
  podcastindex-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  podcastindex-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | podcastindex-pp-cli import <resource> --input -`,
