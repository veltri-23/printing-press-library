...
large datasets as it has no memory pressure.`,
  ...
  podcastindex-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  podcastindex-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  podcastindex-pp-cli export <resource> --format jsonl | jq '.id'`,
