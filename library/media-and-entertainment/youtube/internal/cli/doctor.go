		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export YOUTUBE_API_KEY=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("YOUTUBE_API_KEY") != "" {
				authEnvSet = append(authEnvSet, "YOUTUBE_API_KEY")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "YOUTUBE_API_KEY")
			}
			switch {
