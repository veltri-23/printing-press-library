...
but do not stop the import.`,
  ...
  metacritic-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  metacritic-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | metacritic-pp-cli import <resource> --input -`,
