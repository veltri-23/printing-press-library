...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "metacritic-pp-cli",
		Short: "Manage metacritic resources via the metacritic API",
		Long: `Manage metacritic resources via the metacritic API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'metacritic-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("metacritic-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'metacritic-pp-cli profile list')")
	...
	rootCmd.AddCommand(newFinderCmd(flags))
	...
	rootCmd.AddCommand(newComposerPromotedCmd(flags))
