...
but do not stop the import.`,
  ...
  hackernews-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  hackernews-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | hackernews-pp-cli import <resource> --input -`,
