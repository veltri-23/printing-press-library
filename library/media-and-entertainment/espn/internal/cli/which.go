...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  espn-pp-cli which "stale tickets"
  espn-pp-cli which "bottleneck"
  espn-pp-cli which --limit 1 "send message"
  espn-pp-cli which                                # list the full capability index`,
