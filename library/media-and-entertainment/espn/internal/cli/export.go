...
large datasets as it has no memory pressure.`,
  ...
  espn-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  espn-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  espn-pp-cli export <resource> --format jsonl | jq '.id'`,
