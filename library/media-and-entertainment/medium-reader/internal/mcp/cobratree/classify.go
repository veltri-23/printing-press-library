...
var frameworkCommands = map[string]bool{
	...
	"help":          true,
	"profile":       true,
	// NOTE: "search" is intentionally NOT skipped. In v2 the top-level
	// `search` command is the keyless GraphQL post-search surface and has
	// genuine agent value; no typed MCP tool covers free-text post search
	// (the medium-unofficial-search_* tools list tags/users/publications, a
	// different capability). It must mirror as a shell-out tool.
	"sql":     true,
	"version": true,
	"which":   true,
}
