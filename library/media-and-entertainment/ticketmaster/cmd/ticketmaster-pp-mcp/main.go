...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/media-and-entertainment/ticketmaster/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("TICKETMASTER_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "ticketmaster-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
