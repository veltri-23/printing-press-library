...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("TICKETMASTER_STATE_DIR", "")
	t.Setenv("TICKETMASTER_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"ticketmaster-pp-cli auth login",
		"ticketmaster-pp-cli doctor",
		"ticketmaster-pp-cli help items",
		"ticketmaster-pp-cli sync",
		"ticketmaster-pp-cli profile list",
		"ticketmaster-pp-cli feedback list",
		"ticketmaster-pp-cli which",
		"ticketmaster-pp-cli agent-context",
		"ticketmaster-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"ticketmaster-pp-cli recall",
		"ticketmaster-pp-cli learnings",
		"ticketmaster-pp-cli teach-pattern",
		"ticketmaster-pp-cli teach-lookup",
		"ticketmaster-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("ticketmaster-pp-cli")); err == nil {
