...
but do not stop the import.`,
  ...
  ticketmaster-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ticketmaster-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ticketmaster-pp-cli import <resource> --input -`,
