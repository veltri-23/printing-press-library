...
large datasets as it has no memory pressure.`,
  ...
  ticketmaster-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  ticketmaster-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  ticketmaster-pp-cli export <resource> --format jsonl | jq '.id'`,
