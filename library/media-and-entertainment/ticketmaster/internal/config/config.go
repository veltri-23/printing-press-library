...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("TICKETMASTER_API_KEY"); v != "" {
		cfg.TicketmasterApiKey = v
		cfg.markEnvOverride("TicketmasterApiKey")
		cfg.AuthSource = "env:TICKETMASTER_API_KEY"
		cfg.CredentialSource = "env:TICKETMASTER_API_KEY"
	}
	...
	if v := os.Getenv("TICKETMASTER_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("TICKETMASTER_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "ticketmaster-pp-cli", "config.toml"), nil
}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		TicketmasterApiKey: c.TicketmasterApiKey,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.TicketmasterApiKey = creds.TicketmasterApiKey
}
...
func (c *Config) SaveCredential(token string) error {
	...
	c.updateFileConfigField("AccessToken")
	c.TicketmasterApiKey = token
	delete(c.envOverrides, "TicketmasterApiKey")
	c.updateFileConfigField("TicketmasterApiKey")
	if err := c.saveCredentialsFirst(); err != nil {
		return err
	}
	return c.save()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["TicketmasterApiKey"] {
			out.TicketmasterApiKey = c.fileConfig.TicketmasterApiKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "TicketmasterApiKey":
		c.fileConfig.TicketmasterApiKey = c.TicketmasterApiKey
	}
}
