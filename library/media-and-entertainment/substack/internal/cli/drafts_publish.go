...
func newDraftsPublishCmd(flags *rootFlags) *cobra.Command {
	var bodySend bool
	var bodyShareAutomatically bool
	var stdinBody bool
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				if cmd.Flags().Changed("share-automatically") {
					body["share_automatically"] = bodyShareAutomatically
				}
			}
	...
	cmd.Flags().BoolVar(&bodySend, "send", false, "Send to email subscribers (default true)")
	cmd.Flags().BoolVar(&bodyShareAutomatically, "share-automatically", false, "Auto-share on social (default true)")
