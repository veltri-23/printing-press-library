...
func newFeedPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long:        "RSS XML feed (returns XML; use `--raw` to dump)",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "feed", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
