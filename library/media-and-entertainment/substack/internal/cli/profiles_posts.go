...
func newProfilesPostsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagProfileUserId != "" {
				params["profile_user_id"] = fmt.Sprintf("%v", flagProfileUserId)
			}
			if flagLimit != 0 {
	...
	cmd.Flags().StringVar(&flagProfileUserId, "user-id", "", "Author's numeric user ID")
