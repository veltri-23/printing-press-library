...
but do not stop the import.`,
  ...
  substack-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  substack-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | substack-pp-cli import <resource> --input -`,
