...
func newInboxHomeCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "inbox", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
	...
	cmd.Flags().StringVar(&flagTypes, "types", "", "Comma-separated content types to include (note, post)")
	cmd.Flags().StringVar(&flagCursor, "cursor", "", "Opaque cursor from prior response")
