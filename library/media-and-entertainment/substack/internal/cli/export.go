...
large datasets as it has no memory pressure.`,
  ...
  substack-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  substack-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  substack-pp-cli export <resource> --format jsonl | jq '.id'`,
