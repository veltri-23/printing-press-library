...
func newNotesListByProfileCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path = replacePathParam(path, "profile_user_id", args[0])
	...
	cmd.Flags().StringVar(&flagTypes, "types", "", "Comma-separated content types (default `note`)")
	cmd.Flags().StringVar(&flagCursor, "cursor", "", "Opaque cursor from prior response (for pagination)")
