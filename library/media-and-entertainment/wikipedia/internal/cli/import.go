...
but do not stop the import.`,
  ...
  wikipedia-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  wikipedia-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | wikipedia-pp-cli import <resource> --input -`,
