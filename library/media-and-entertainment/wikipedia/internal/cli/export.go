...
large datasets as it has no memory pressure.`,
  ...
  wikipedia-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  wikipedia-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  wikipedia-pp-cli export <resource> --format jsonl | jq '.id'`,
