	...
	envVars := []agentContextAuthEnvVar{
		{
			...
			Required:    true,
			Sensitive:   true,
			Description: "Robinhood Crypto API key.",
		},
		{
		...
		},
		{
			...
			Required:    false,
			Sensitive:   true,
			Description: "Optional bearer token for authenticated brokerage/account route-map execution.",
		},
		{
			...
			Required:    false,
			Sensitive:   true,
			Description: "Optional browser cookie header for authenticated brokerage/account route-map execution.",
		},
		{
