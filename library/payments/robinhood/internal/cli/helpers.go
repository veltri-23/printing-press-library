...
func classifyAPIError(err error, flags *rootFlags) error {
	...
	case strings.Contains(msg, "HTTP 400") && cliutil.LooksLikeAuthError(msg):
		return authErr(fmt.Errorf("%w\nhint: the API rejected the request — this usually means auth is missing or invalid."+
			...
			"\n      Set your private signing key: export ROBINHOOD_PRIVATE_KEY_B64=<your-private-key-base64>"+
			"\n      Get credentials at: https://robinhood.com/account/crypto"+
			"\n      Run 'robinhood-pp-cli doctor' to check auth status."+
			"\n      Response: "+cliutil.SanitizeErrorBody(msg), err))
	case strings.Contains(msg, "HTTP 401"):
		return authErr(fmt.Errorf("%w\nhint: check your API key and private signing key."+
			" Set it with: export ROBINHOOD_API_KEY=<your-key>"+
			"\n      Also set: export ROBINHOOD_PRIVATE_KEY_B64=<your-private-key-base64>"+
			"\n      Get credentials at: https://robinhood.com/account/crypto"+
			"\n      Run 'robinhood-pp-cli doctor' to check auth status.", err))
