...
but do not stop the import.`,
  ...
  robinhood-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  robinhood-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | robinhood-pp-cli import <resource> --input -`,
