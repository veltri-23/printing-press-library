...
Resource scoping:
  ...
  robinhood-pp-cli sync

  # Sync specific resources only
  robinhood-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  robinhood-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  robinhood-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  robinhood-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  robinhood-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/robinhood-pp-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "crypto":
		return true
	case "crypto-trading-accounts":
		return true
	case "crypto-trading-holdings":
		return true
	case "crypto-trading-trading-pairs":
		return true
	}
	return false
}
...
func defaultSyncResources() []string {
	return []string{
		"crypto",
		"crypto-marketdata-best-bid-ask",
		"crypto-trading-accounts",
		"crypto-trading-holdings",
		"crypto-trading-trading-pairs",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"crypto":                         "/api/v1/crypto/trading/orders/",
		"crypto-marketdata-best-bid-ask": "/api/v1/crypto/marketdata/best_bid_ask/",
		"crypto-trading-accounts":        "/api/v2/crypto/trading/accounts/",
		"crypto-trading-holdings":        "/api/v1/crypto/trading/holdings/",
		"crypto-trading-trading-pairs":   "/api/v1/crypto/trading/trading_pairs/",
	}
