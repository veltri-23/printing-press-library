...
func annotationIsTrue(cmd *cobra.Command, key string) bool {
	return annotationValue(cmd, key) == "true" || annotationValue(cmd, key) == "1" || annotationValue(cmd, key) == "yes"
}
...
func annotationValue(cmd *cobra.Command, key string) string {
	...
	return strings.ToLower(strings.TrimSpace(cmd.Annotations[key]))
}
