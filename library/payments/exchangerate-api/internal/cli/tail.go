...
native streaming instead of polling.`,
  ...
  exchangerate-api-pp-cli tail --interval 10s

  # Tail a specific resource
  exchangerate-api-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  exchangerate-api-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
