...
Resource scoping:
  ...
  exchangerate-api-pp-cli sync

  # Sync specific resources only
  exchangerate-api-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  exchangerate-api-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  exchangerate-api-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  exchangerate-api-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  exchangerate-api-pp-cli sync --latest-only`,
