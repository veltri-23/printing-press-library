...
but do not stop the import.`,
  ...
  exchangerate-api-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  exchangerate-api-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | exchangerate-api-pp-cli import <resource> --input -`,
