...
func newProjectsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "This endpoint requires the following permission(s): project_configuration:projects:read_write .",
		Example:     "  revenuecat-pp-cli projects create --name example-resource",
