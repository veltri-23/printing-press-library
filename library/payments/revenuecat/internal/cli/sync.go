...
Resource scoping:
  ...
  revenuecat-pp-cli sync

  # Sync specific resources only
  revenuecat-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  revenuecat-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  revenuecat-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  revenuecat-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  revenuecat-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/revenuecat-pp-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "customers":
		return true
	case "customers_active_entitlements":
		return true
	case "customers_aliases":
		return true
	case "customers_attributes":
		return true
	case "customers_invoices":
		return true
	...
	case "projects":
		return true
	case "projects_entitlements":
		return true
	case "projects_entitlements_products":
		return true
	case "projects_products":
		return true
	case "projects_transactions":
		return true
	case "projects_virtual_currencies":
		return true
	}
	return false
}
...
func syncResourceFieldSelector(resource string) (string, string) {
	switch resource {
	case "offerings":
		return "expand", "metadata,packages"
	case "paywalls":
		return "expand", "components,offering"
	case "projects_entitlements":
		return "expand", "products"
	case "projects_products":
		return "expand", "one_time,subscription"
	case "offerings_packages":
		return "expand", "products"
	}
	return "", ""
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "apps":
		return db.UpsertApps(data)
	case "public_api_keys":
		return db.UpsertPublicApiKeys(data)
	case "store_kit_config":
		return db.UpsertStoreKitConfig(data)
	case "audit-logs":
		return db.UpsertAuditLogs(data)
	case "charts":
		return db.UpsertCharts(data)
	case "options":
	...
	case "customers_actions":
		return db.UpsertCustomersActions(data)
	case "active_entitlements":
		return db.UpsertActiveEntitlements(data)
	case "aliases":
		return db.UpsertAliases(data)
	case "attributes":
		return db.UpsertAttributes(data)
	case "customer_center":
		return db.UpsertCustomerCenter(data)
	case "invoices":
		return db.UpsertInvoices(data)
	case "customers_purchases":
		return db.UpsertCustomersPurchases(data)
	case "customers_subscriptions":
		return db.UpsertCustomersSubscriptions(data)
	case "customers_virtual_currencies":
		return db.UpsertCustomersVirtualCurrencies(data)
	case "entitlements":
		return db.UpsertEntitlements(data)
	case "entitlements_actions":
		return db.UpsertEntitlementsActions(data)
	case "entitlements_products":
		return db.UpsertEntitlementsProducts(data)
	case "integrations":
		return db.UpsertIntegrations(data)
	case "media-assets":
		return db.UpsertMediaAssets(data)
	case "metrics":
		return db.UpsertMetrics(data)
	case "offerings":
		return db.UpsertOfferings(data)
	case "offerings_actions":
		return db.UpsertOfferingsActions(data)
	case "offerings_packages":
		return db.UpsertOfferingsPackages(data)
	case "packages":
		return db.UpsertPackages(data)
	case "packages_actions":
		return db.UpsertPackagesActions(data)
	case "packages_products":
		return db.UpsertPackagesProducts(data)
	case "paywalls":
		return db.UpsertPaywalls(data)
	case "products":
		return db.UpsertProducts(data)
	case "products_actions":
		return db.UpsertProductsActions(data)
	case "create_in_store":
		return db.UpsertCreateInStore(data)
	case "projects":
		return db.UpsertProjects(data)
	case "purchases":
		return db.UpsertPurchases(data)
	case "purchases_actions":
		return db.UpsertPurchasesActions(data)
	case "purchases_entitlements":
		return db.UpsertPurchasesEntitlements(data)
	case "subscriptions":
		return db.UpsertSubscriptions(data)
	case "subscriptions_actions":
		return db.UpsertSubscriptionsActions(data)
	case "authenticated_management_url":
		return db.UpsertAuthenticatedManagementUrl(data)
	case "subscriptions_entitlements":
		return db.UpsertSubscriptionsEntitlements(data)
	case "transactions":
		return db.UpsertTransactions(data)
	case "virtual-currencies":
		return db.UpsertVirtualCurrencies(data)
	case "virtual_currencies_actions":
		return db.UpsertVirtualCurrenciesActions(data)
	default:
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "apps", ParentTable: "projects", ParentIDParam: "project_id", PathTemplate: "/projects/{project_id}/apps", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "id"},
		}},
		{Name: "audit_logs", ParentTable: "projects", ParentIDParam: "project_id", PathTemplate: "/projects/{project_id}/audit_logs", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "id"},
		}},
		{Name: "collaborators", ParentTable: "projects", ParentIDParam: "project_id", PathTemplate: "/projects/{project_id}/collaborators", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "id"},
		}},
		{Name: "customers", ParentTable: "projects", ParentIDParam: "project_id", PathTemplate: "/projects/{project_id}/customers", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "id"},
		}},
		{Name: "integrations", ParentTable: "projects", ParentIDParam: "project_id", PathTemplate: "/projects/{project_id}/integrations/webhooks", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "id"},
		}},
		{Name: "offerings", ParentTable: "projects", ParentIDParam: "project_id", PathTemplate: "/projects/{project_id}/offerings", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "id"},
		}},
		{Name: "paywalls", ParentTable: "projects", ParentIDParam: "project_id", PathTemplate: "/projects/{project_id}/paywalls", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "id"},
		}},
		{Name: "projects_entitlements", ParentTable: "projects", ParentIDParam: "purchase_id", PathTemplate: "/projects/{project_id}/purchases/{purchase_id}/entitlements", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "purchase_id", Field: "id"},
		}},
		{Name: "projects_entitlements", ParentTable: "projects", ParentIDParam: "subscription_id", PathTemplate: "/projects/{project_id}/subscriptions/{subscription_id}/entitlements", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "subscription_id", Field: "id"},
		}},
		{Name: "projects_entitlements", ParentTable: "projects", ParentIDParam: "project_id", PathTemplate: "/projects/{project_id}/entitlements", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "id"},
		}},
		{Name: "projects_products", ParentTable: "projects", ParentIDParam: "project_id", PathTemplate: "/projects/{project_id}/products", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "id"},
		}},
		{Name: "projects_products", ParentTable: "projects", ParentIDParam: "package_id", PathTemplate: "/projects/{project_id}/packages/{package_id}/products", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "package_id", Field: "id"},
		}},
		{Name: "projects_transactions", ParentTable: "projects", ParentIDParam: "subscription_id", PathTemplate: "/projects/{project_id}/subscriptions/{subscription_id}/transactions", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "subscription_id", Field: "id"},
		}},
		{Name: "projects_virtual_currencies", ParentTable: "projects", ParentIDParam: "project_id", PathTemplate: "/projects/{project_id}/virtual_currencies", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "id"},
		}},
		{Name: "customers_active_entitlements", ParentTable: "customers", ParentIDParam: "customer_id", PathTemplate: "/projects/{project_id}/customers/{customer_id}/active_entitlements", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "customer_id", Field: "id"},
		}},
		{Name: "customers_aliases", ParentTable: "customers", ParentIDParam: "customer_id", PathTemplate: "/projects/{project_id}/customers/{customer_id}/aliases", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "customer_id", Field: "id"},
		}},
		{Name: "customers_attributes", ParentTable: "customers", ParentIDParam: "customer_id", PathTemplate: "/projects/{project_id}/customers/{customer_id}/attributes", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "customer_id", Field: "id"},
		}},
		{Name: "customers_invoices", ParentTable: "customers", ParentIDParam: "customer_id", PathTemplate: "/projects/{project_id}/customers/{customer_id}/invoices", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "customer_id", Field: "id"},
		}},
		{Name: "customers_purchases", ParentTable: "customers", ParentIDParam: "customer_id", PathTemplate: "/projects/{project_id}/customers/{customer_id}/purchases", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "customer_id", Field: "id"},
		}},
		{Name: "customers_subscriptions", ParentTable: "customers", ParentIDParam: "customer_id", PathTemplate: "/projects/{project_id}/customers/{customer_id}/subscriptions", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "customer_id", Field: "id"},
		}},
		{Name: "customers_virtual_currencies", ParentTable: "customers", ParentIDParam: "customer_id", PathTemplate: "/projects/{project_id}/customers/{customer_id}/virtual_currencies", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "customer_id", Field: "id"},
		}},
		{Name: "offerings_packages", ParentTable: "offerings", ParentIDParam: "offering_id", PathTemplate: "/projects/{project_id}/offerings/{offering_id}/packages", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "offering_id", Field: "id"},
		}},
		{Name: "projects_entitlements_products", ParentTable: "projects_entitlements", ParentIDParam: "entitlement_id", PathTemplate: "/projects/{project_id}/entitlements/{entitlement_id}/products", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "project_id", Field: "projects_id"},
			{Param: "entitlement_id", Field: "id"},
		}},
	}
}
