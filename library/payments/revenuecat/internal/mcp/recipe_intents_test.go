...
func TestRecipeIntentHandlerBuildsRecipeArgs(t *testing.T) {
	...
	result, err := handleFindEntitlementDesync(context.Background(), req)
	if err != nil {
...
func TestRecipeIntentHandlerOverridesAndRejectsArgs(t *testing.T) {
	...
	got := recipeToolText(t, result)
	if strings.Contains(got, "--flag-disagreements") {
		t.Fatalf("boolean false override should suppress --flag-disagreements: %q", got)
	}
}
