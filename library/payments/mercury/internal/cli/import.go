...
but do not stop the import.`,
  ...
  mercury-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  mercury-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | mercury-pp-cli import <resource> --input -`,
