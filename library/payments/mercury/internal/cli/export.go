...
large datasets as it has no memory pressure.`,
  ...
  mercury-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  mercury-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  mercury-pp-cli export <resource> --format jsonl | jq '.id'`,
