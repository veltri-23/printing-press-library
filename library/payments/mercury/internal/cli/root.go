...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "mercury-pp-cli",
		Short: "Manage mercury resources via the mercury API",
		Long: `Mercury CLI
...
Health check: run 'mercury-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("mercury-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'mercury-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBooksCmd(flags))
	rootCmd.AddCommand(newCardsCmd(flags))
	rootCmd.AddCommand(newCategoriesCmd(flags))
	rootCmd.AddCommand(newEventsCmd(flags))
	rootCmd.AddCommand(newRecipientCmd(flags))
	rootCmd.AddCommand(newRecipientsCmd(flags))
	rootCmd.AddCommand(newRequestSendMoneyCmd(flags))
	rootCmd.AddCommand(newSafesCmd(flags))
	rootCmd.AddCommand(newStatementsCmd(flags))
	rootCmd.AddCommand(newTransactionCmd(flags))
	...
	rootCmd.AddCommand(newCreditPromotedCmd(flags))
	rootCmd.AddCommand(newOrganizationPromotedCmd(flags))
