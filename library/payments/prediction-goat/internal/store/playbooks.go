...
// PATCH(learn-loop-backport U5): store layer for learning_playbooks,
// ported from ESPN's PR #851 cascade. Either PlaybookJSON or NotesText
// (or both) carries content; an all-empty row is rejected at upsert
// time.

// PlaybookRow is one row in the learning_playbooks table.
