...
but do not stop the import.`,
  ...
  prediction-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  prediction-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | prediction-goat-pp-cli import <resource> --input -`,
