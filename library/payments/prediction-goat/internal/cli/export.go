...
large datasets as it has no memory pressure.`,
  ...
  prediction-goat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  prediction-goat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  prediction-goat-pp-cli export <resource> --format jsonl | jq '.id'`,
