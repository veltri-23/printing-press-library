...
native streaming instead of polling.`,
  ...
  prediction-goat-pp-cli tail --interval 10s

  # Tail a specific resource
  prediction-goat-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  prediction-goat-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
