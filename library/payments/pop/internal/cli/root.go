...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "pop-pp-cli",
		Short: "Manage pop resources via the pop API",
		Long: `Manage pop resources via the pop API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'pop-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("pop-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'pop-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSdiViaPopCmd(flags))
	...
	rootCmd.AddCommand(newCreatePdfPromotedCmd(flags))
	rootCmd.AddCommand(newCreateUblPromotedCmd(flags))
	rootCmd.AddCommand(newCreateXmlPromotedCmd(flags))
	rootCmd.AddCommand(newPeppolPromotedCmd(flags))
