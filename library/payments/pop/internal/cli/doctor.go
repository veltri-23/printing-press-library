...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  pop-pp-cli doctor
  pop-pp-cli doctor --json
  pop-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export POP_API_KEY=<your-key>"
					report["auth_key_url"] = "https://popapi.io/en/prices/"
					report["auth_instructions"] = "Create a free POP account, generate an API key, and export it as POP_API_KEY before running the CLI."
				} else {
					authConfigured = true
			...
			authEnvInfo := []string{}
			if os.Getenv("POP_API_KEY") != "" {
				authEnvSet = append(authEnvSet, "POP_API_KEY")
			} else {
				authEnvInfo = append(authEnvInfo, "POP_API_KEY optional")
			}
			switch {
