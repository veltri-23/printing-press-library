...
var whichIndex = []whichEntry{
	{Command: "create-pdf invoice", Description: "Generate a branded PDF invoice. Depending on account setup and payload,\nPOP may return a direct file, a URL, or a JSON response.", Group: "create-pdf"},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  pop-pp-cli which "stale tickets"
  pop-pp-cli which "bottleneck"
  pop-pp-cli which --limit 1 "send message"
  pop-pp-cli which                                # list the full capability index`,
