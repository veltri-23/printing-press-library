...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/payments/lemonsqueezy/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "lemonsqueezy-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
