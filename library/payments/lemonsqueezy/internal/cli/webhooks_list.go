...
func newWebhooksListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Lemon Squeezy List all webhooks",
		Example:     "  lemonsqueezy-pp-cli webhooks list",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "webhooks", true, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
