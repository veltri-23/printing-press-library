...
func newCustomersListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Lemon Squeezy List all customers",
		Example:     "  lemonsqueezy-pp-cli customers list",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "customers", true, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
