...
func newUsersPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "users",
		Short:       "Lemon Squeezy Retrieve the authenticated user",
		Long:        "Lemon Squeezy Retrieve the authenticated user",
		Example:     "  lemonsqueezy-pp-cli users",
		Annotations: map[string]string{"pp:endpoint": "users.me", "pp:method": "GET", "pp:path": "/v1/users/me", "mcp:read-only": "true"},
