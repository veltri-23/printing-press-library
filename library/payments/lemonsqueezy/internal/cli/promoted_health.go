...
func newHealthPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "health",
		Short:       "Lemon Squeezy Health",
		Long:        "Lemon Squeezy Health",
		Example:     "  lemonsqueezy-pp-cli health",
		Annotations: map[string]string{"pp:endpoint": "health.check", "pp:method": "GET", "pp:path": "/v1/health", "mcp:read-only": "true"},
