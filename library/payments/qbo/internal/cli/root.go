...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "qbo-pp-cli",
		Short: `Interact with QuickBooks Online directly. Query ledger items, sync transactions locally, and run advanced reconciliation triage.`,
		Long: `Interact with QuickBooks Online directly. Query ledger items, sync transactions locally, and run advanced reconciliation triage.

Add --agent to any command for JSON output + non-interactive mode.
Run 'qbo-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'qbo-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCdcPromotedCmd(flags))
