...
func newCustomersCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create or update a customer",
		Example:     "  qbo-pp-cli customers create",
		Annotations: map[string]string{"pp:endpoint": "customers.create", "pp:method": "POST", "pp:path": "/customer"},
	...
	cmd.Flags().StringVar(&bodyCustomer, "customer", "", "Customer payload")
