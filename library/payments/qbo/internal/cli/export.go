...
large datasets as it has no memory pressure.`,
  ...
  qbo-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  qbo-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  qbo-pp-cli export <resource> --format jsonl | jq '.id'`,
