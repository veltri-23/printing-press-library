...
func newAccountsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  qbo-pp-cli accounts create",
		Annotations: map[string]string{"pp:endpoint": "accounts.create", "pp:method": "POST", "pp:path": "/account"},
	...
	cmd.Flags().StringVar(&bodyAccount, "account", "", "Account payload")
