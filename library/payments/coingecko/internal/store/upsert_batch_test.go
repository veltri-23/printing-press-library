...
func TestUpsertBatch_PopulatesCoinsTable(t *testing.T) {
	...
	if _, _, err := s.UpsertBatch("coins", items); err != nil {
		t.Fatalf("UpsertBatch: %v", err)
	}
...
func TestUpsertBatch_PopulatesMarketChartTable(t *testing.T) {
	...
	if _, _, err := s.UpsertBatch("market_chart", items); err != nil {
		t.Fatalf("UpsertBatch: %v", err)
	}
...
func TestUpsertBatch_PopulatesOhlcTable(t *testing.T) {
	...
	if _, _, err := s.UpsertBatch("ohlc", items); err != nil {
		t.Fatalf("UpsertBatch: %v", err)
	}
...
func TestUpsertBatch_PopulatesSimpleTable(t *testing.T) {
	...
	if _, _, err := s.UpsertBatch("simple", items); err != nil {
		t.Fatalf("UpsertBatch: %v", err)
	}
