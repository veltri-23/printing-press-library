...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "coingecko-pp-cli",
		Short: "Manage coingecko resources via the coingecko API",
		Long: `Manage coingecko resources via the coingecko API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'coingecko-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("coingecko-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'coingecko-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCoinsCmd(flags))
	rootCmd.AddCommand(newSimpleCmd(flags))
	...
	rootCmd.AddCommand(newCoingeckoSearchPromotedCmd(flags))
	rootCmd.AddCommand(newCoingeckoSearch2PromotedCmd(flags))
	rootCmd.AddCommand(newGlobalPromotedCmd(flags))
