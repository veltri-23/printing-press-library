...
func newCoinsMarketChartCoinCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "market-chart", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagDays, "days", "", "Number of days (1,7,14,30,90,365,max)")
