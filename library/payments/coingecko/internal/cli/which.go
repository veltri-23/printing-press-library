...
var whichIndex = []whichEntry{
	...
	{Command: "coins market-chart coin", Description: "Get market chart data", Group: "coins"},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  coingecko-pp-cli which "stale tickets"
  coingecko-pp-cli which "bottleneck"
  coingecko-pp-cli which --limit 1 "send message"
  coingecko-pp-cli which                                # list the full capability index`,
