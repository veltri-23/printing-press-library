...
but do not stop the import.`,
  ...
  coingecko-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  coingecko-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | coingecko-pp-cli import <resource> --input -`,
