...
large datasets as it has no memory pressure.`,
  ...
  coingecko-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  coingecko-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  coingecko-pp-cli export <resource> --format jsonl | jq '.id'`,
