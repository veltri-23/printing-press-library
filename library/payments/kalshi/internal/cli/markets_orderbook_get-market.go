...
func newMarketsOrderbookGetMarketCmd(flags *rootFlags) *cobra.Command {
	var flagDepth int
	...
	cmd.Flags().IntVar(&flagDepth, "depth", 0, "Depth of the orderbook to retrieve (0 or negative means all levels, 1-100 for specific depth)")
