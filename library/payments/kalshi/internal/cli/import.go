...
but do not stop the import.`,
  ...
  kalshi-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  kalshi-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | kalshi-pp-cli import <resource> --input -`,
