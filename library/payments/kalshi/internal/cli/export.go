...
large datasets as it has no memory pressure.`,
  ...
  kalshi-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  kalshi-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  kalshi-pp-cli export <resource> --format jsonl | jq '.id'`,
