...
but do not stop the import.`,
  ...
  lunch-money-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  lunch-money-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | lunch-money-pp-cli import <resource> --input -`,
