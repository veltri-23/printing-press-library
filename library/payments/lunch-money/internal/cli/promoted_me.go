...
func newMePromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "me",
		Short:       "Get details about the user associated with the supplied authorization token.",
		Long:        "Shortcut for 'me get'. Get details about the user associated with the supplied authorization token.",
		Example:     "  lunch-money-pp-cli me",
