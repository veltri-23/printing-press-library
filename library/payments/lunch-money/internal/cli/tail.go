...
native streaming instead of polling.`,
  ...
  lunch-money-pp-cli tail --interval 10s

  # Tail a specific resource
  lunch-money-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  lunch-money-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// PATCH: Honor root output routing (--deliver, tests) for streamed JSON events.
