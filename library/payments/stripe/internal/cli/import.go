...
but do not stop the import.`,
  ...
  stripe-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  stripe-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | stripe-pp-cli import <resource> --input -`,
