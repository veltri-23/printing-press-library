...
Exit codes & warnings:
  ...
  stripe-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  stripe-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  stripe-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  stripe-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  stripe-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("stripe-pp-cli")
			}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "capabilities":
		return db.UpsertCapabilities(data)
	case "external_accounts":
		return db.UpsertExternalAccounts(data)
	case "login_links":
		return db.UpsertLoginLinks(data)
	case "persons":
		return db.UpsertPersons(data)
	case "reject":
		return db.UpsertReject(data)
	case "application_fees_refunds":
		return db.UpsertApplicationFeesRefunds(data)
	case "charges_capture":
		return db.UpsertChargesCapture(data)
	case "charges_refunds":
		return db.UpsertChargesRefunds(data)
	case "credit_notes_lines":
		return db.UpsertCreditNotesLines(data)
	case "credit_notes_void":
		return db.UpsertCreditNotesVoid(data)
	case "customers_balance_transactions":
		return db.UpsertCustomersBalanceTransactions(data)
	case "cash_balance":
		return db.UpsertCashBalance(data)
	case "cash_balance_transactions":
		return db.UpsertCashBalanceTransactions(data)
	case "customers_discount":
		return db.UpsertCustomersDiscount(data)
	case "funding_instructions":
		return db.UpsertFundingInstructions(data)
	case "customers_payment_methods":
		return db.UpsertCustomersPaymentMethods(data)
	case "customers_sources":
		return db.UpsertCustomersSources(data)
	case "customers_tax_ids":
		return db.UpsertCustomersTaxIds(data)
	case "close":
		return db.UpsertClose(data)
	case "financial_connections":
		return db.UpsertFinancialConnections(data)
	case "archive":
		return db.UpsertArchive(data)
	case "unarchive":
		return db.UpsertUnarchive(data)
	case "add_lines":
		return db.UpsertAddLines(data)
	case "attach_payment":
		return db.UpsertAttachPayment(data)
	case "invoices_finalize":
		return db.UpsertInvoicesFinalize(data)
	case "invoices_lines":
		return db.UpsertInvoicesLines(data)
	case "mark_uncollectible":
		return db.UpsertMarkUncollectible(data)
	case "pay":
		return db.UpsertPay(data)
	case "remove_lines":
		return db.UpsertRemoveLines(data)
	case "send":
		return db.UpsertSend(data)
	case "update_lines":
		return db.UpsertUpdateLines(data)
	case "invoices_void":
		return db.UpsertInvoicesVoid(data)
	case "amount_details_line_items":
		return db.UpsertAmountDetailsLineItems(data)
	case "apply_customer_balance":
		return db.UpsertApplyCustomerBalance(data)
	case "payment_intents_cancel":
		return db.UpsertPaymentIntentsCancel(data)
	case "payment_intents_capture":
		return db.UpsertPaymentIntentsCapture(data)
	case "payment_intents_confirm":
		return db.UpsertPaymentIntentsConfirm(data)
	case "increment_authorization":
		return db.UpsertIncrementAuthorization(data)
	case "payment_intents_verify_microdeposits":
		return db.UpsertPaymentIntentsVerifyMicrodeposits(data)
	case "payment_links_line_items":
		return db.UpsertPaymentLinksLineItems(data)
	case "validate":
		return db.UpsertValidate(data)
	case "attach":
		return db.UpsertAttach(data)
	case "detach":
		return db.UpsertDetach(data)
	case "report_payment_attempt":
		return db.UpsertReportPaymentAttempt(data)
	case "report_payment_attempt_canceled":
		return db.UpsertReportPaymentAttemptCanceled(data)
	case "report_payment_attempt_failed":
		return db.UpsertReportPaymentAttemptFailed(data)
	case "report_payment_attempt_guaranteed":
		return db.UpsertReportPaymentAttemptGuaranteed(data)
	case "report_payment_attempt_informational":
		return db.UpsertReportPaymentAttemptInformational(data)
	case "report_refund":
		return db.UpsertReportRefund(data)
	case "payouts_cancel":
		return db.UpsertPayoutsCancel(data)
	case "reverse":
		return db.UpsertReverse(data)
	case "features":
		return db.UpsertFeatures(data)
	case "accept":
		return db.UpsertAccept(data)
	case "quotes_cancel":
		return db.UpsertQuotesCancel(data)
	case "computed_upfront_line_items":
		return db.UpsertComputedUpfrontLineItems(data)
	case "quotes_finalize":
		return db.UpsertQuotesFinalize(data)
	case "quotes_line_items":
		return db.UpsertQuotesLineItems(data)
	case "pdf":
		return db.UpsertPdf(data)
	case "refunds_cancel":
		return db.UpsertRefundsCancel(data)
	case "approve":
		return db.UpsertApprove(data)
	case "setup_intents_cancel":
		return db.UpsertSetupIntentsCancel(data)
	case "setup_intents_confirm":
		return db.UpsertSetupIntentsConfirm(data)
	case "setup_intents_verify_microdeposits":
		return db.UpsertSetupIntentsVerifyMicrodeposits(data)
	case "source_transactions":
		return db.UpsertSourceTransactions(data)
	case "verify":
		return db.UpsertVerify(data)
	case "subscription_schedules_cancel":
		return db.UpsertSubscriptionSchedulesCancel(data)
	case "release":
		return db.UpsertRelease(data)
	case "subscriptions_discount":
		return db.UpsertSubscriptionsDiscount(data)
	case "migrate":
		return db.UpsertMigrate(data)
	case "resume":
		return db.UpsertResume(data)
	case "topups_cancel":
		return db.UpsertTopupsCancel(data)
	case "reversals":
		return db.UpsertReversals(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"apple-pay":                           "/v1/apple_pay/domains",
		"application-fees":                    "/v1/application_fees",
		"balance-transactions":                "/v1/balance_transactions",
		"billing":                             "/v1/billing/alerts",
		"billing-credit-balance-transactions": "/v1/billing/credit_balance_transactions",
		"billing-credit-grants":               "/v1/billing/credit_grants",
		"billing-meters":                      "/v1/billing/meters",
		"billing-portal":                      "/v1/billing_portal/configurations",
		"charges":                             "/v1/charges",
		"checkout":                            "/v1/checkout/sessions",
		"climate":                             "/v1/climate/orders",
		"climate-products":                    "/v1/climate/products",
		"climate-suppliers":                   "/v1/climate/suppliers",
		"country-specs":                       "/v1/country_specs",
		"coupons":                             "/v1/coupons",
		"credit-notes":                        "/v1/credit_notes",
		"customers":                           "/v1/customers",
		"disputes":                            "/v1/disputes",
		"entitlements":                        "/v1/entitlements/features",
		"events":                              "/v1/events",
		"exchange-rates":                      "/v1/exchange_rates",
		"file-links":                          "/v1/file_links",
		"files":                               "/v1/files",
		"financial-connections":               "/v1/financial_connections/accounts",
		"forwarding":                          "/v1/forwarding/requests",
		"identity":                            "/v1/identity/verification_reports",
		"identity-verification-sessions":      "/v1/identity/verification_sessions",
		"invoice-payments":                    "/v1/invoice_payments",
		"invoice-rendering-templates":         "/v1/invoice_rendering_templates",
		"invoiceitems":                        "/v1/invoiceitems",
		"invoices":                            "/v1/invoices",
		"issuing":                             "/v1/issuing/cards",
		"issuing-authorizations":              "/v1/issuing/authorizations",
		"issuing-cardholders":                 "/v1/issuing/cardholders",
		"issuing-disputes":                    "/v1/issuing/disputes",
		"issuing-personalization-designs":     "/v1/issuing/personalization_designs",
		"issuing-physical-bundles":            "/v1/issuing/physical_bundles",
		"issuing-transactions":                "/v1/issuing/transactions",
		"payment-intents":                     "/v1/payment_intents",
		"payment-links":                       "/v1/payment_links",
		"payment-method-configurations":       "/v1/payment_method_configurations",
		"payment-method-domains":              "/v1/payment_method_domains",
		"payment-methods":                     "/v1/payment_methods",
		"payouts":                             "/v1/payouts",
		"plans":                               "/v1/plans",
		"prices":                              "/v1/prices",
		"products":                            "/v1/products",
		"promotion-codes":                     "/v1/promotion_codes",
		"quotes":                              "/v1/quotes",
		"radar":                               "/v1/radar/value_lists",
		"radar-early-fraud-warnings":          "/v1/radar/early_fraud_warnings",
		"refunds":                             "/v1/refunds",
		"reporting":                           "/v1/reporting/report_runs",
		"reporting-report-types":              "/v1/reporting/report_types",
		"reviews":                             "/v1/reviews",
		"setup-intents":                       "/v1/setup_intents",
		"shipping-rates":                      "/v1/shipping_rates",
		"sigma":                               "/v1/sigma/scheduled_query_runs",
		"subscription-schedules":              "/v1/subscription_schedules",
		"subscriptions":                       "/v1/subscriptions",
		"tax":                                 "/v1/tax/registrations",
		"tax-codes":                           "/v1/tax_codes",
		"tax-ids":                             "/v1/tax_ids",
		"tax-rates":                           "/v1/tax_rates",
		"terminal":                            "/v1/terminal/readers",
		"terminal-configurations":             "/v1/terminal/configurations",
		"terminal-locations":                  "/v1/terminal/locations",
		"test-helpers":                        "/v1/test_helpers/test_clocks",
		"topups":                              "/v1/topups",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "amount_details_line_items", ParentTable: "payment-intents", ParentIDParam: "intent", PathTemplate: "/v1/payment_intents/{intent}/amount_details_line_items"},
		{Name: "application_fees_refunds", ParentTable: "application-fees", ParentIDParam: "id", PathTemplate: "/v1/application_fees/{id}/refunds"},
		{Name: "cash_balance_transactions", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/cash_balance_transactions"},
		{Name: "charges_refunds", ParentTable: "charges", ParentIDParam: "charge", PathTemplate: "/v1/charges/{charge}/refunds"},
		{Name: "computed_upfront_line_items", ParentTable: "quotes", ParentIDParam: "quote", PathTemplate: "/v1/quotes/{quote}/computed_upfront_line_items"},
		{Name: "credit_notes_lines", ParentTable: "credit-notes", ParentIDParam: "credit_note", PathTemplate: "/v1/credit_notes/{credit_note}/lines"},
		{Name: "customers_balance_transactions", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/balance_transactions"},
		{Name: "customers_payment_methods", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/payment_methods"},
		{Name: "customers_sources", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/sources"},
		{Name: "customers_tax_ids", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/tax_ids"},
		{Name: "external_accounts", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/accounts/{account}/external_accounts"},
		{Name: "features", ParentTable: "products", ParentIDParam: "product", PathTemplate: "/v1/products/{product}/features"},
		{Name: "financial_connections", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/financial_connections/accounts/{account}/owners"},
		{Name: "invoices_lines", ParentTable: "invoices", ParentIDParam: "invoice", PathTemplate: "/v1/invoices/{invoice}/lines"},
		{Name: "payment_links_line_items", ParentTable: "payment-links", ParentIDParam: "payment_link", PathTemplate: "/v1/payment_links/{payment_link}/line_items"},
		{Name: "persons", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/accounts/{account}/persons"},
		{Name: "quotes_line_items", ParentTable: "quotes", ParentIDParam: "quote", PathTemplate: "/v1/quotes/{quote}/line_items"},
		{Name: "reversals", ParentTable: "transfers", ParentIDParam: "id", PathTemplate: "/v1/transfers/{id}/reversals"},
	}
}
