...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/payments/stripe/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "stripe-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
