...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("VAGARO_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("VAGARO_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "vagaro-pp-cli", "config.toml"), nil
}
