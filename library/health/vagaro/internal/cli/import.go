...
but do not stop the import.`,
  ...
  vagaro-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  vagaro-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | vagaro-pp-cli import <resource> --input -`,
