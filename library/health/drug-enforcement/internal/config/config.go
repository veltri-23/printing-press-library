...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("DRUG_ENFORCEMENT_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("DRUG_ENFORCEMENT_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "drug-enforcement-pp-cli", "config.toml"), nil
}
