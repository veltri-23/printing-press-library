...
native streaming instead of polling.`,
  ...
  drug-enforcement-pp-cli tail --interval 10s

  # Tail a specific resource
  drug-enforcement-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  drug-enforcement-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
