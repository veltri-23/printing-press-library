...
but do not stop the import.`,
  ...
  drug-enforcement-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  drug-enforcement-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | drug-enforcement-pp-cli import <resource> --input -`,
