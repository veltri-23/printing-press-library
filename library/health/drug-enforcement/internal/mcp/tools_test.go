...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("DRUG_ENFORCEMENT_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "drug-enforcement-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "drug-enforcement-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		...
		"DRUG_ENFORCEMENT_CONFIG_DIR",
		"DRUG_ENFORCEMENT_DATA_DIR",
		"DRUG_ENFORCEMENT_STATE_DIR",
		"DRUG_ENFORCEMENT_CACHE_DIR",
		"DRUG_ENFORCEMENT_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
