...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  janeapp-pp-cli which "stale tickets"
  janeapp-pp-cli which "bottleneck"
  janeapp-pp-cli which --limit 1 "send message"
  janeapp-pp-cli which                                # list the full capability index`,
