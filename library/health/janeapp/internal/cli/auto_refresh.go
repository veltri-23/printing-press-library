...
var readCommandResources = map[string][]string{
	...
	"janeapp-pp-cli disciplines search":  {"disciplines"},
	"janeapp-pp-cli locations":           {"locations"},
	"janeapp-pp-cli locations list":      {"locations"},
	"janeapp-pp-cli locations get":       {"locations"},
	"janeapp-pp-cli locations search":    {"locations"},
	"janeapp-pp-cli openings":            {"openings"},
	"janeapp-pp-cli openings list":       {"openings"},
	"janeapp-pp-cli openings get":        {"openings"},
	"janeapp-pp-cli openings search":     {"openings"},
	"janeapp-pp-cli staff":               {"staff"},
	"janeapp-pp-cli staff list":          {"staff"},
	"janeapp-pp-cli staff get":           {"staff"},
	"janeapp-pp-cli staff search":        {"staff"},
	"janeapp-pp-cli treatments":          {"treatments"},
	"janeapp-pp-cli treatments list":     {"treatments"},
	"janeapp-pp-cli treatments get":      {"treatments"},
	"janeapp-pp-cli treatments search":   {"treatments"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "JANEAPP_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale janeapp-pp-cli cache (refresh failed: %v)\n", err)
