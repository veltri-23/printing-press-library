...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://REPLACE.janeapp.com",
	}
	...
	if v := os.Getenv("JANEAPP_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("JANEAPP_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "janeapp-pp-cli", "config.toml"), nil
}
