...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "oura-pp-cli",
		Short: "Manage oura resources via the oura API",
		Long: `Manage oura resources via the oura API.
...
Run 'oura-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("oura-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'oura-pp-cli profile list')")
	...
	rootCmd.AddCommand(newUsercollectionCmd(flags))
