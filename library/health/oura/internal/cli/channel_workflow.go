...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  oura-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  oura-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"sandbox", "sandbox-usercollection-daily-activity", "sandbox-usercollection-daily-cardiovascular-age", "sandbox-usercollection-daily-readiness", "sandbox-usercollection-daily-resilience", "sandbox-usercollection-daily-sleep", "sandbox-usercollection-daily-spo2", "sandbox-usercollection-daily-stress", "sandbox-usercollection-enhanced-tag", "sandbox-usercollection-heartrate", "sandbox-usercollection-rest-mode-period", "sandbox-usercollection-ring-battery-level", "sandbox-usercollection-ring-configuration", "sandbox-usercollection-session", "sandbox-usercollection-sleep", "sandbox-usercollection-sleep-time", "sandbox-usercollection-v-o2-max", "sandbox-usercollection-workout", "usercollection", "usercollection-daily-activity", "usercollection-daily-cardiovascular-age", "usercollection-daily-readiness", "usercollection-daily-resilience", "usercollection-daily-sleep", "usercollection-daily-spo2", "usercollection-daily-stress", "usercollection-enhanced-tag", "usercollection-heartrate", "usercollection-rest-mode-period", "usercollection-ring-battery-level", "usercollection-ring-configuration", "usercollection-session", "usercollection-sleep", "usercollection-sleep-time", "usercollection-v-o2-max", "usercollection-workout", "webhook"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  oura-pp-cli workflow status

  # Show status as JSON
  oura-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("oura-pp-cli")
			}
