...
import (
	...
	"errors"
	"fmt"
	"github.com/mvanhorn/printing-press-library/library/health/oura/internal/client"
	"github.com/mvanhorn/printing-press-library/library/health/oura/internal/cliutil"
	"github.com/mvanhorn/printing-press-library/library/health/oura/internal/store"
...
Resource scoping:
  ...
  oura-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  oura-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  oura-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  oura-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  oura-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/oura-pp-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "sandbox":
		return true
	case "sandbox-usercollection-daily-activity":
		return true
	case "sandbox-usercollection-daily-cardiovascular-age":
		return true
	case "sandbox-usercollection-daily-readiness":
		return true
	case "sandbox-usercollection-daily-resilience":
		return true
	case "sandbox-usercollection-daily-sleep":
		return true
	case "sandbox-usercollection-daily-spo2":
		return true
	case "sandbox-usercollection-daily-stress":
		return true
	case "sandbox-usercollection-enhanced-tag":
		return true
	case "sandbox-usercollection-heartrate":
		return true
	case "sandbox-usercollection-rest-mode-period":
		return true
	case "sandbox-usercollection-ring-battery-level":
		return true
	case "sandbox-usercollection-ring-configuration":
		return true
	case "sandbox-usercollection-session":
		return true
	case "sandbox-usercollection-sleep":
		return true
	case "sandbox-usercollection-sleep-time":
		return true
	case "sandbox-usercollection-v-o2-max":
		return true
	case "sandbox-usercollection-workout":
		return true
	case "usercollection":
		return true
	case "usercollection-daily-activity":
		return true
	case "usercollection-daily-cardiovascular-age":
		return true
	case "usercollection-daily-readiness":
		return true
	case "usercollection-daily-resilience":
		return true
	case "usercollection-daily-sleep":
		return true
	case "usercollection-daily-spo2":
		return true
	case "usercollection-daily-stress":
		return true
	case "usercollection-enhanced-tag":
		return true
	case "usercollection-heartrate":
		return true
	case "usercollection-rest-mode-period":
		return true
	case "usercollection-ring-battery-level":
		return true
	case "usercollection-ring-configuration":
		return true
	case "usercollection-session":
		return true
	case "usercollection-sleep":
		return true
	case "usercollection-sleep-time":
		return true
	case "usercollection-v-o2-max":
		return true
	case "usercollection-workout":
		return true
	}
	return false
}
...
func syncResourceSinceParamFormat(resource string) string {
	switch syncResourceSinceParam(resource) {
	case "start_date":
		return "date"
	case "start_datetime":
		return "datetime"
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "sandbox":
		return db.UpsertSandbox(data)
	case "usercollection":
		return db.UpsertUsercollection(data)
	case "webhook":
...
func defaultSyncResources() []string {
	return []string{
		"sandbox",
		"sandbox-usercollection-daily-activity",
		"sandbox-usercollection-daily-cardiovascular-age",
		"sandbox-usercollection-daily-readiness",
		"sandbox-usercollection-daily-resilience",
		"sandbox-usercollection-daily-sleep",
		"sandbox-usercollection-daily-spo2",
		"sandbox-usercollection-daily-stress",
		"sandbox-usercollection-enhanced-tag",
		"sandbox-usercollection-heartrate",
		"sandbox-usercollection-rest-mode-period",
		"sandbox-usercollection-ring-battery-level",
		"sandbox-usercollection-ring-configuration",
		"sandbox-usercollection-session",
		"sandbox-usercollection-sleep",
		"sandbox-usercollection-sleep-time",
		"sandbox-usercollection-v-o2-max",
		"sandbox-usercollection-workout",
		"usercollection",
		"usercollection-daily-activity",
		"usercollection-daily-cardiovascular-age",
		"usercollection-daily-readiness",
		"usercollection-daily-resilience",
		"usercollection-daily-sleep",
		"usercollection-daily-spo2",
		"usercollection-daily-stress",
		"usercollection-enhanced-tag",
		"usercollection-heartrate",
		"usercollection-rest-mode-period",
		"usercollection-ring-battery-level",
		"usercollection-ring-configuration",
		"usercollection-session",
		"usercollection-sleep",
		"usercollection-sleep-time",
		"usercollection-v-o2-max",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"sandbox":                               "/v2/sandbox/usercollection/tag",
		"sandbox-usercollection-daily-activity": "/v2/sandbox/usercollection/daily_activity",
		"sandbox-usercollection-daily-cardiovascular-age": "/v2/sandbox/usercollection/daily_cardiovascular_age",
		"sandbox-usercollection-daily-readiness":          "/v2/sandbox/usercollection/daily_readiness",
		"sandbox-usercollection-daily-resilience":         "/v2/sandbox/usercollection/daily_resilience",
		"sandbox-usercollection-daily-sleep":              "/v2/sandbox/usercollection/daily_sleep",
		"sandbox-usercollection-daily-spo2":               "/v2/sandbox/usercollection/daily_spo2",
		"sandbox-usercollection-daily-stress":             "/v2/sandbox/usercollection/daily_stress",
		"sandbox-usercollection-enhanced-tag":             "/v2/sandbox/usercollection/enhanced_tag",
		"sandbox-usercollection-heartrate":                "/v2/sandbox/usercollection/heartrate",
		"sandbox-usercollection-rest-mode-period":         "/v2/sandbox/usercollection/rest_mode_period",
		"sandbox-usercollection-ring-battery-level":       "/v2/sandbox/usercollection/ring_battery_level",
		"sandbox-usercollection-ring-configuration":       "/v2/sandbox/usercollection/ring_configuration",
		"sandbox-usercollection-session":                  "/v2/sandbox/usercollection/session",
		"sandbox-usercollection-sleep":                    "/v2/sandbox/usercollection/sleep",
		"sandbox-usercollection-sleep-time":               "/v2/sandbox/usercollection/sleep_time",
		"sandbox-usercollection-v-o2-max":                 "/v2/sandbox/usercollection/vO2_max",
		"sandbox-usercollection-workout":                  "/v2/sandbox/usercollection/workout",
		"usercollection":                                  "/v2/usercollection/tag",
		"usercollection-daily-activity":                   "/v2/usercollection/daily_activity",
		"usercollection-daily-cardiovascular-age":         "/v2/usercollection/daily_cardiovascular_age",
		"usercollection-daily-readiness":                  "/v2/usercollection/daily_readiness",
		"usercollection-daily-resilience":                 "/v2/usercollection/daily_resilience",
		"usercollection-daily-sleep":                      "/v2/usercollection/daily_sleep",
		"usercollection-daily-spo2":                       "/v2/usercollection/daily_spo2",
		"usercollection-daily-stress":                     "/v2/usercollection/daily_stress",
		"usercollection-enhanced-tag":                     "/v2/usercollection/enhanced_tag",
		"usercollection-heartrate":                        "/v2/usercollection/heartrate",
		"usercollection-rest-mode-period":                 "/v2/usercollection/rest_mode_period",
		"usercollection-ring-battery-level":               "/v2/usercollection/ring_battery_level",
		"usercollection-ring-configuration":               "/v2/usercollection/ring_configuration",
		"usercollection-session":                          "/v2/usercollection/session",
		"usercollection-sleep":                            "/v2/usercollection/sleep",
		"usercollection-sleep-time":                       "/v2/usercollection/sleep_time",
		"usercollection-v-o2-max":                         "/v2/usercollection/vO2_max",
		"usercollection-workout":                          "/v2/usercollection/workout",
		"webhook":                                         "/v2/webhook/subscription",
	}
