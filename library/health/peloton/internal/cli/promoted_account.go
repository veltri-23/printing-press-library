...
func newAccountPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "account",
		Short:       "Show the current profile fact.",
		Long:        "Show the current profile fact.",
		Example:     "  peloton-pp-cli account",
		Annotations: map[string]string{"pp:endpoint": "account.show", "pp:method": "GET", "pp:path": "/api/me", "mcp:read-only": "true"},
