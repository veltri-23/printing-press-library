...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  peloton-pp-cli which "stale tickets"
  peloton-pp-cli which "bottleneck"
  peloton-pp-cli which --limit 1 "send message"
  peloton-pp-cli which                                # list the full capability index`,
