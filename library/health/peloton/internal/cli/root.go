...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "peloton-pp-cli",
		Short: "Manage peloton resources via the peloton API",
		Long: `Manage peloton resources via the peloton API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'peloton-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("peloton-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'peloton-pp-cli profile list')")
	...
	rootCmd.AddCommand(newStrengthPromotedCmd(flags))
