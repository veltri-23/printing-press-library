...
func newHelpCenterListCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "list",
		Short:       "You can list all Help Centers by making a GET request to `https://api.intercom.io/help_center/help_centers`.",
