...
func newConversationsRedactCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "redact",
		Short:       "You can redact a conversation part or the source message of a conversation (as seen in the source object).",
		Example:     "  intercom-pp-cli conversations redact",
		Annotations: map[string]string{"pp:endpoint": "conversations.redact", "pp:method": "POST", "pp:path": "/conversations/redact"},
