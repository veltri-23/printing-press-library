...
func newAiListContentImportSourcesCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "list-content-import-sources",
		Aliases:     []string{"list"},
		Short:       "You can retrieve a list of all content import sources for a workspace.",
