...
func newContactsSubscriptionsAttachTypeToContactCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyConsentType, "consent-type", "", "The consent_type of a subscription, opt_out or opt_in.")
	cmd.Flags().StringVar(&bodyId, "id", "", "The unique identifier for the subscription which is given by Intercom")
