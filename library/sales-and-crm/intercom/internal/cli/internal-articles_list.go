...
func newInternalArticlesListCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "list",
		Short:       "You can fetch a list of all internal articles by making a GET request to `https://api.intercom.io/internal_articles`.",
