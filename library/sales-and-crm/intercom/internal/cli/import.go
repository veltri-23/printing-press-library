...
but do not stop the import.`,
  ...
  intercom-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  intercom-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | intercom-pp-cli import <resource> --input -`,
