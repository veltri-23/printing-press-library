...
func newConversationsCustomersAttachContactToConversationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyAdminId, "admin-id", "", "The `id` of the admin who is adding the new participant.")
	cmd.Flags().StringVar(&bodyCustomer, "customer", "", "Customer")
