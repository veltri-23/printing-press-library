...
func newConversationsConvertConversationToTicketCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyAttributes, "attributes", "", "The attributes set on the ticket.")
	cmd.Flags().StringVar(&bodyTicketTypeId, "ticket-type-id", "", "The ID of the type of ticket you want to convert the conversation to")
