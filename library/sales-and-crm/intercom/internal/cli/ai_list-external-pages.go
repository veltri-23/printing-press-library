...
func newAiListExternalPagesCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "list-external-pages",
		Short:       "You can retrieve a list of all external pages for a workspace.",
