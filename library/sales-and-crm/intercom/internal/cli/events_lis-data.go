...
func newEventsLisDataCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagType, "type", "", "The value must be user")
	cmd.Flags().BoolVar(&flagSummary, "summary", false, "summary flag")
