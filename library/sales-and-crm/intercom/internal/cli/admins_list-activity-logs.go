...
func newAdminsListActivityLogsCmd(flags *rootFlags) *cobra.Command {
	var flagCreatedAtAfter string
	var flagCreatedAtBefore string
	...
	cmd.Flags().StringVar(&flagCreatedAtBefore, "created-at-before", "", "The end date that you request data for. It must be formatted as a UNIX timestamp.")
