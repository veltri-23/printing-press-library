...
func newCompaniesScrollOverAllCmd(flags *rootFlags) *cobra.Command {
	var flagScrollParam string

	cmd := &cobra.Command{
		Use:         "scroll-over-all",
		Short:       "The `list all companies` functionality does not work well for huge datasets",
