...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  intercom-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  intercom-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"admins", "ai", "ai-content-import-sources", "articles", "companies", "companies-scroll", "contacts", "conversations", "data-attributes", "help-center", "help-center-help-centers", "internal-articles", "news", "news-news-items", "segments", "subscription-types", "tags", "teams", "ticket-states", "ticket-types"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  intercom-pp-cli workflow status

  # Show status as JSON
  intercom-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("intercom-pp-cli")
			}
