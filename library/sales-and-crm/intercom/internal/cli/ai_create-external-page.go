...
func newAiCreateExternalPageCmd(flags *rootFlags) *cobra.Command {
	var bodyAiAgentAvailability bool
	var bodyAiCopilotAvailability bool
	...
	cmd.Flags().BoolVar(&bodyAiAgentAvailability, "ai-agent-availability", false, "Whether the external page should be used to answer questions by AI Agent.")
	cmd.Flags().BoolVar(&bodyAiCopilotAvailability, "ai-copilot-availability", false, "Whether the external page should be used to answer questions by AI Copilot.")
