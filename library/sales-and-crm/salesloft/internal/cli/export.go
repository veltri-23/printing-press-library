...
large datasets as it has no memory pressure.`,
  ...
  salesloft-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  salesloft-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  salesloft-pp-cli export <resource> --format jsonl | jq '.id'`,
