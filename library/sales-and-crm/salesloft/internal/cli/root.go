...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "salesloft-pp-cli",
		Short: "Manage salesloft resources via the salesloft API",
		Long: `Manage salesloft resources via the salesloft API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'salesloft-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("salesloft-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'salesloft-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCadencesCmd(flags))
