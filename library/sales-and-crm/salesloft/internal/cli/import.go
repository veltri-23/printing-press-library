...
but do not stop the import.`,
  ...
  salesloft-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  salesloft-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | salesloft-pp-cli import <resource> --input -`,
