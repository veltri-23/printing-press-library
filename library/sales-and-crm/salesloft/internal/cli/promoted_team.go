...
func newTeamPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "team",
		Short:       "Get the authenticated user's Salesloft team.",
		Long:        "Get the authenticated user's Salesloft team.",
		Example:     "  salesloft-pp-cli team",
		Annotations: map[string]string{"pp:endpoint": "team.get", "pp:method": "GET", "pp:path": "/team", "mcp:read-only": "true"},
