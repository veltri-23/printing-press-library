...
func newMeetingsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "meetings",
		Short:       "List Salesloft meetings.",
		Long:        "List Salesloft meetings.",
		Example:     "  salesloft-pp-cli meetings",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/meetings"
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "meetings", path, map[string]string{
