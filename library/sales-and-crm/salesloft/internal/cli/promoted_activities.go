...
func newActivitiesPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "activities",
		Short:       "List recent Salesloft activities.",
		Long:        "List recent Salesloft activities.",
		Example:     "  salesloft-pp-cli activities",
		Annotations: map[string]string{"pp:endpoint": "activities.list", "pp:method": "GET", "pp:path": "/activities", "mcp:read-only": "true"},
