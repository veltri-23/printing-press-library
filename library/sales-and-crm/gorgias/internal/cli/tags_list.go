...
func newTagsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List all tags in the account, optionally filtered by name.",
		Example:     "  gorgias-pp-cli tags list",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "tags", true, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagSearch, "search", "", "Substring search across tag names.")
