...
func newSatisfactionSurveysUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "update <id>",
		Short:       "Update a satisfaction-survey instance (`id`).",
		Example:     "  gorgias-pp-cli satisfaction-surveys update 123456789",
		Annotations: map[string]string{"pp:endpoint": "satisfaction-surveys.update", "pp:method": "PUT", "pp:path": "/satisfaction-surveys/{id}"},
