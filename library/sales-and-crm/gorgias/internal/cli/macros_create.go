...
func newMacrosCreateCmd(flags *rootFlags) *cobra.Command {
	var bodyName string
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create a new macro: a reusable reply/action template.",
		Example:     "  gorgias-pp-cli macros create --name example-resource",
		Annotations: map[string]string{"pp:endpoint": "macros.create", "pp:method": "POST", "pp:path": "/macros"},
