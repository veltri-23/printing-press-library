...
func newTicketsCustomFieldsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "List every custom field value on ticket (`id`).",
		Example:     "  gorgias-pp-cli tickets custom-fields-list 123456789",
		Annotations: map[string]string{"pp:endpoint": "tickets.custom-fields-list", "pp:method": "GET", "pp:path": "/tickets/{id}/custom-fields", "mcp:read-only": "true"},
