...
func newWidgetsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create a new agent-facing sidebar widget shown inside the Gorgias helpdesk.",
		Example:     "  gorgias-pp-cli widgets create --type example-value",
		Annotations: map[string]string{"pp:endpoint": "widgets.create", "pp:method": "POST", "pp:path": "/widgets"},
