...
func newCustomersCustomFieldsListCmd(flags *rootFlags) *cobra.Command {
	var flagCursor string
	var flagOrderBy string
	var flagLimit int

	cmd := &cobra.Command{
		Use:         "custom-fields-list <id>",
		Short:       "List every custom field value attached to a single customer (`id`).",
		Example:     "  gorgias-pp-cli customers custom-fields-list 123456789",
		Annotations: map[string]string{"pp:endpoint": "customers.custom-fields-list", "pp:method": "GET", "pp:path": "/customers/{id}/custom-fields", "mcp:read-only": "true"},
