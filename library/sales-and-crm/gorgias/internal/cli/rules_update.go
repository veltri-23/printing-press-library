...
func newRulesUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "update <id>",
		Short:       "Update an automation rule (`id`) — edit conditions, actions, or enabled flag.",
		Example:     "  gorgias-pp-cli rules update 123456789",
		Annotations: map[string]string{"pp:endpoint": "rules.update", "pp:method": "PUT", "pp:path": "/rules/{id}"},
