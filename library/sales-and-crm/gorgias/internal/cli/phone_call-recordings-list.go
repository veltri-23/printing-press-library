...
func newPhoneCallRecordingsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "call-recordings-list",
		Short:       "List voice-call recordings.",
		Example:     "  gorgias-pp-cli phone call-recordings-list",
		Annotations: map[string]string{"pp:endpoint": "phone.call-recordings-list", "pp:method": "GET", "pp:path": "/phone/voice-call-recordings", "mcp:read-only": "true"},
	...
	cmd.Flags().StringVar(&flagCallId, "call-id", "", "Filter recordings to a single call.")
