...
func newExportCmd(flags *rootFlags) *cobra.Command {
  ...
  gorgias-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  gorgias-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  gorgias-pp-cli export <resource> --format jsonl | jq '.id'`,
