...
func newTicketsTagsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "tags-list <id>",
		Short:       "List the tags currently attached to ticket (`id`).",
		Example:     "  gorgias-pp-cli tickets tags-list 123456789",
		Annotations: map[string]string{"pp:endpoint": "tickets.tags-list", "pp:method": "GET", "pp:path": "/tickets/{id}/tags", "mcp:read-only": "true"},
