...
func newStaleCmd(flags *rootFlags) *cobra.Command {
  ...
  gorgias-pp-cli stale

  # Find items not updated in 14 days
  gorgias-pp-cli stale --days 14

  # Filter by team (use a real team name from 'gorgias-pp-cli teams list')
  gorgias-pp-cli stale --days 7 --team support

  # Output as JSON
  gorgias-pp-cli stale --days 30 --json`,
