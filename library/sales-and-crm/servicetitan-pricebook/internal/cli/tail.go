...
native streaming instead of polling.`,
  ...
  servicetitan-pricebook-pp-cli tail --interval 10s

  # Tail a specific resource
  servicetitan-pricebook-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  servicetitan-pricebook-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
