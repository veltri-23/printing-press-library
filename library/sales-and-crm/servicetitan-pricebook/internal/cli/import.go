...
but do not stop the import.`,
  ...
  servicetitan-pricebook-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  servicetitan-pricebook-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | servicetitan-pricebook-pp-cli import <resource> --input -`,
