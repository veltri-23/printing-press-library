...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/sales-and-crm/servicetitan-pricebook/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "servicetitan-pricebook-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
