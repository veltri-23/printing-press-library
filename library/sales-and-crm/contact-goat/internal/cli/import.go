...
but do not stop the import.`,
  ...
  contact-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  contact-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | contact-goat-pp-cli import <resource> --input -`,
