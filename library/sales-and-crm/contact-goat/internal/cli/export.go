...
large datasets as it has no memory pressure.`,
  ...
  contact-goat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  contact-goat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  contact-goat-pp-cli export <resource> --format jsonl | jq '.id'`,
