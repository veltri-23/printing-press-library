...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("COPPER_API_KEY"); v != "" {
		cfg.CopperApiKey = v
		cfg.markEnvOverride("CopperApiKey")
		cfg.AuthSource = "env:COPPER_API_KEY"
		cfg.CredentialSource = "env:COPPER_API_KEY"
	}
	...
	if v := os.Getenv("COPPER_USER_EMAIL"); v != "" {
		cfg.CopperUserEmail = v
		cfg.markEnvOverride("CopperUserEmail")
	}
	...
	if v := os.Getenv("COPPER_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("COPPER_CONFIG"); path != "" {
...
func (c *Config) AuthHeader() string {
	...
	replacements := map[string]string{
		"token":          token,
		"api_key":        c.CopperApiKey,
		"COPPER_API_KEY": c.CopperApiKey,
	}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		CopperApiKey:    c.CopperApiKey,
		CopperUserEmail: c.CopperUserEmail,
	}
}
...
func (c *Config) SaveCredential(token string) error {
	...
	c.updateFileConfigField("AccessToken")
	c.CopperApiKey = token
	delete(c.envOverrides, "CopperApiKey")
	c.updateFileConfigField("CopperApiKey")
	if err := c.saveCredentialsFirst(); err != nil {
		return err
	}
	return c.save()
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("CopperApiKey")
	c.CopperUserEmail = ""
	delete(c.envOverrides, "CopperUserEmail")
	c.updateFileConfigField("CopperUserEmail")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["CopperApiKey"] {
			out.CopperApiKey = c.fileConfig.CopperApiKey
		}
		if c.envOverrides["CopperUserEmail"] {
			out.CopperUserEmail = c.fileConfig.CopperUserEmail
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "CopperApiKey":
		c.fileConfig.CopperApiKey = c.CopperApiKey
	case "CopperUserEmail":
		c.fileConfig.CopperUserEmail = c.CopperUserEmail
	}
}
