...
but do not stop the import.`,
  ...
  copper-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  copper-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | copper-pp-cli import <resource> --input -`,
