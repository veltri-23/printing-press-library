...
large datasets as it has no memory pressure.`,
  ...
  copper-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  copper-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  copper-pp-cli export <resource> --format jsonl | jq '.id'`,
