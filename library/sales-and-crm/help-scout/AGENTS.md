# Help Scout Printed CLI Agent Guide

This directory is a generated `help-scout-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
help-scout-pp-cli doctor --json
help-scout-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
help-scout-pp-cli which "<capability>" --json
help-scout-pp-cli <command> --help
```
...
```bash
help-scout-pp-cli <command> --agent
```
...
```bash
help-scout-pp-cli <command> --help
help-scout-pp-cli <command> --dry-run --agent
```
