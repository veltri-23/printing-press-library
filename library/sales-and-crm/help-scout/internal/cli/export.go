...
large datasets as it has no memory pressure.`,
  ...
  help-scout-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  help-scout-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  help-scout-pp-cli export <resource> --format jsonl | jq '.id'`,
