...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "help-scout-pp-cli",
		Short: "Manage help-scout resources via the help-scout API",
		Long: `Manage help-scout resources via the help-scout API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'help-scout-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("help-scout-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'help-scout-pp-cli profile list')")
