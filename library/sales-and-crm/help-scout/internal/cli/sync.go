...
import (
	...
	"errors"
	"fmt"
	"github.com/mvanhorn/printing-press-library/library/sales-and-crm/help-scout/internal/client"
	"github.com/mvanhorn/printing-press-library/library/sales-and-crm/help-scout/internal/cliutil"
	"github.com/mvanhorn/printing-press-library/library/sales-and-crm/help-scout/internal/store"
...
Resource scoping:
  ...
  help-scout-pp-cli sync

  # Sync specific resources only
  help-scout-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  help-scout-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  help-scout-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  help-scout-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  help-scout-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("help-scout-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/github.com/mvanhorn/printing-press-library/library/sales-and-crm/help-scout/data.db)")
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "fields", ParentTable: "mailboxes", ParentIDParam: "mailboxId", PathTemplate: "/mailboxes/{mailboxId}/fields", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "mailboxId", Field: "id"},
		}},
		{Name: "folders", ParentTable: "mailboxes", ParentIDParam: "mailboxId", PathTemplate: "/mailboxes/{mailboxId}/folders", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "mailboxId", Field: "id"},
		}},
		{Name: "members", ParentTable: "teams", ParentIDParam: "teamId", PathTemplate: "/teams/{teamId}/members", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "teamId", Field: "id"},
		}},
		{Name: "threads", ParentTable: "conversations", ParentIDParam: "conversationId", PathTemplate: "/conversations/{conversationId}/threads", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "conversationId", Field: "id"},
		}},
		{Name: "threads", ParentTable: "conversations", ParentIDParam: "conversationId", PathTemplate: "/v3/conversations/{conversationId}/threads", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "conversationId", Field: "id"},
		}},
	}
}
