...
func newMailboxesFoldersListMailboxCmd(flags *rootFlags) *cobra.Command {
	var flagPage string
	var flagAll bool
	...
	cmd := &cobra.Command{
		...
		Example:     "  help-scout-pp-cli mailboxes folders list-mailbox 42",
		Annotations: map[string]string{"pp:endpoint": "folders.list-mailbox", "pp:method": "GET", "pp:path": "/mailboxes/{mailboxId}/folders", "mcp:read-only": "true"},
