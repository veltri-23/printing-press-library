...
func newCustomersGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  help-scout-pp-cli customers get 42",
		Annotations: map[string]string{"pp:endpoint": "customers.get", "pp:method": "GET", "pp:path": "/customers/{customerId}", "mcp:read-only": "true"},
