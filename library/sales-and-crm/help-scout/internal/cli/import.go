...
but do not stop the import.`,
  ...
  help-scout-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  help-scout-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | help-scout-pp-cli import <resource> --input -`,
