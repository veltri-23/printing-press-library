...
func newTasksPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "tasks",
		Short:       "List Gladly tasks.",
		Long:        "List Gladly tasks.",
		Example:     "  gladly-pp-cli tasks",
		Annotations: map[string]string{"pp:endpoint": "tasks.list", "pp:method": "GET", "pp:path": "/api/v1/tasks", "mcp:read-only": "true"},
