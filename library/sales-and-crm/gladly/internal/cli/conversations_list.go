...
func newConversationsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List customer conversations.",
		Example:     "  gladly-pp-cli conversations list",
		Annotations: map[string]string{"pp:endpoint": "conversations.list", "pp:method": "GET", "pp:path": "/api/v1/conversations", "mcp:read-only": "true"},
