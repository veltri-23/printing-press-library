...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "gladly-pp-cli",
		Short: "Manage gladly resources via the gladly API",
		Long: `Manage gladly resources via the gladly API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'gladly-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("gladly-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'gladly-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAgentsPromotedCmd(flags))
	rootCmd.AddCommand(newAnswersPromotedCmd(flags))
	rootCmd.AddCommand(newConversationItemsPromotedCmd(flags))
	rootCmd.AddCommand(newInboxesPromotedCmd(flags))
