...
func newCustomersListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List Gladly customers.",
		Example:     "  gladly-pp-cli customers list",
		Annotations: map[string]string{"pp:endpoint": "customers.list", "pp:method": "GET", "pp:path": "/api/v1/customers", "mcp:read-only": "true"},
