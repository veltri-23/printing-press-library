...
but do not stop the import.`,
  ...
  gladly-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  gladly-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | gladly-pp-cli import <resource> --input -`,
