...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/sales-and-crm/conduyt-crm/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "conduyt-crm-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
