...
func newBulkDeleteContactsCmd(flags *rootFlags) *cobra.Command {
	var bodyIds string
	var stdinBody bool
	...
	cmd := &cobra.Command{
		...
		Example:     "  conduyt-crm-pp-cli bulk delete-contacts",
		Annotations: map[string]string{"pp:endpoint": "bulk.delete-contacts", "pp:method": "POST", "pp:path": "/bulk/contacts/delete"},
