...
func newBulkUpdateDealsCmd(flags *rootFlags) *cobra.Command {
	var bodyData string
	var bodyIds string
	var stdinBody bool
	...
	cmd := &cobra.Command{
		Use:         "update-deals",
		Short:       "Bulk update deals",
		Example:     "  conduyt-crm-pp-cli bulk update-deals",
		Annotations: map[string]string{"pp:endpoint": "bulk.update-deals", "pp:method": "POST", "pp:path": "/bulk/deals/update"},
