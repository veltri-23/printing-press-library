...
func newConduytAuthResetPasswordCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  conduyt-crm-pp-cli conduyt-auth reset-password --password example-value",
		Annotations: map[string]string{"pp:endpoint": "conduyt-auth.reset-password", "pp:method": "POST", "pp:path": "/auth/reset-password"},
