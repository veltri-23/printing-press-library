...
func newNotificationsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  conduyt-crm-pp-cli notifications create --message example-value",
		Annotations: map[string]string{"pp:endpoint": "notifications.create", "pp:method": "POST", "pp:path": "/notifications"},
