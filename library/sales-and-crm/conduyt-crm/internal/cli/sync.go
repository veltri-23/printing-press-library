...
Exit codes & warnings:
  ...
  conduyt-crm-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  conduyt-crm-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  conduyt-crm-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  conduyt-crm-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  conduyt-crm-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/conduyt-crm-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "bulk_enroll":
		return db.UpsertBulkEnroll(data)
	case "dry_run":
		return db.UpsertDryRun(data)
	case "node_stats":
		return db.UpsertNodeStats(data)
	case "publish":
		return db.UpsertPublish(data)
	case "step_logs":
		return db.UpsertStepLogs(data)
	case "booking_pages_availability":
		return db.UpsertBookingPagesAvailability(data)
	case "calendars_appointments":
		return db.UpsertCalendarsAppointments(data)
	case "score":
		return db.UpsertScore(data)
	case "contacts_tags":
	...
	case "process":
		return db.UpsertProcess(data)
	case "payment_link":
		return db.UpsertPaymentLink(data)
	case "payments":
	...
	case "deactivate":
		return db.UpsertDeactivate(data)
	case "runs":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"automations-condition-fields":  "/automations/condition-fields",
		"automations-events":            "/automations/events",
		"automations-templates":         "/automations/templates",
		"booking-pages":                 "/booking-pages",
		"calendar":                      "/calendar/events",
		"calendar-callback-google":      "/calendar/callback/google",
		"calendar-callback-microsoft":   "/calendar/callback/microsoft",
		"calendar-connections":          "/calendar/connections",
		"calendars":                     "/calendars",
		"calls":                         "/calls",
		"chat":                          "/chat/channels",
		"companies":                     "/companies",
		"conduyt-auth":                  "/auth/me",
		"contacts":                      "/contacts",
		"contacts-duplicates":           "/contacts/duplicates",
		"contacts-smart-views":          "/contacts/smart-views",
		...
		"emails":                        "/emails",
		"emails-sequences":              "/emails/sequences",
		"emails-templates":              "/emails/templates",
		"files":                         "/files",
		"forms":                         "/forms",
		"imports":                       "/imports",
		"integrations":                  "/integrations",
		"integrations-zapier-subscribe": "/integrations/zapier/subscribe",
		"invoices":                      "/invoices",
		"messages":                      "/messages",
		"notes":                         "/notes",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "calendars_appointments", ParentTable: "calendars", ParentIDParam: "id", PathTemplate: "/calendars/{id}/appointments"},
		{Name: "runs", ParentTable: "workflows", ParentIDParam: "id", PathTemplate: "/workflows/{id}/runs"},
		{Name: "step_logs", ParentTable: "automations", ParentIDParam: "id", PathTemplate: "/automations/{id}/step-logs"},
		{Name: "submissions", ParentTable: "forms", ParentIDParam: "id", PathTemplate: "/forms/{id}/submissions"},
	}
}
