...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Smartlead CLI — Every SmartLead API feature, plus a local mirror that answers campaign-health, silent-lead, and cross-campaign dedupe q…`,
		Long: `Smartlead CLI — Every SmartLead API feature, plus a local mirror that answers campaign-health, silent-lead, and cross-campaign dedupe q…
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	// Transcendence commands — cross-entity views the SmartLead API cannot
	// answer in one call, computed from the local mirror or composed live.
	rootCmd.AddCommand(newHealthCmd(flags))
	rootCmd.AddCommand(newSilentCmd(flags))
	rootCmd.AddCommand(newDupesCmd(flags))
	rootCmd.AddCommand(newSenderHealthCmd(flags))
	rootCmd.AddCommand(newWarmupGateCmd(flags))
