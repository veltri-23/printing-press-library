...
func newContactsBulkUpdateTagsCmd(flags *rootFlags) *cobra.Command {
	var bodyIds string
	var bodyTags string
	var bodyType string
	var stdinBody bool
	...
	cmd := &cobra.Command{
		Use:         "bulk-update-tags",
		Short:       "Bulk add/remove tags across many contacts",
		Example:     "  gohighlevel-pp-cli contacts bulk-update-tags",
		Annotations: map[string]string{"pp:endpoint": "contacts.bulk-update-tags", "pp:method": "POST", "pp:path": "/contacts/tags/bulk"},
