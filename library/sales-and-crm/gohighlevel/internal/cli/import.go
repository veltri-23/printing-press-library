...
but do not stop the import.`,
  ...
  gohighlevel-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  gohighlevel-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | gohighlevel-pp-cli import <resource> --input -`,
