...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "gainsight-pp-cli",
		Short: "Manage gainsight resources via the gainsight API",
		Long: `Manage gainsight resources via the gainsight API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'gainsight-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("gainsight-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'gainsight-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCockpitPromotedCmd(flags))
	rootCmd.AddCommand(newDataPromotedCmd(flags))
	rootCmd.AddCommand(newHealthscoresPromotedCmd(flags))
	rootCmd.AddCommand(newSuccessplansPromotedCmd(flags))
	rootCmd.AddCommand(newTimelinePromotedCmd(flags))
