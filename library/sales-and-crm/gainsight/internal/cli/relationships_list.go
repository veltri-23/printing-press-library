...
func newRelationshipsListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	...
	cmd := &cobra.Command{
		...
		Example:     "  gainsight-pp-cli relationships list",
		Annotations: map[string]string{"pp:endpoint": "relationships.list", "pp:method": "GET", "pp:path": "/v1/relationships", "mcp:read-only": "true"},
