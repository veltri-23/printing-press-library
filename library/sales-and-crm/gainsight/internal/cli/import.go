...
but do not stop the import.`,
  ...
  gainsight-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  gainsight-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | gainsight-pp-cli import <resource> --input -`,
