...
func newCompaniesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List Gainsight companies.",
		Example:     "  gainsight-pp-cli companies list",
		Annotations: map[string]string{"pp:endpoint": "companies.list", "pp:method": "GET", "pp:path": "/v1/companies", "mcp:read-only": "true"},
