...
func newTimelinePromotedCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	...
	cmd := &cobra.Command{
		Use:         "timeline",
		Short:       "List Timeline activities.",
		Long:        "List Timeline activities.",
		Example:     "  gainsight-pp-cli timeline",
		Annotations: map[string]string{"pp:endpoint": "timeline.list-activities", "pp:method": "GET", "pp:path": "/v1/timeline/activities", "mcp:read-only": "true"},
