...
but do not stop the import.`,
  ...
  eu-tenders-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  eu-tenders-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | eu-tenders-pp-cli import <resource> --input -`,
