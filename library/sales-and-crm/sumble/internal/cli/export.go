...
large datasets as it has no memory pressure.`,
  ...
  sumble-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  sumble-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  sumble-pp-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.MinimumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				"contact-lists":      true,
				"organization-lists": true,
			}
