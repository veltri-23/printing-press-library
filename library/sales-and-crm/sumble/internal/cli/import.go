...
but do not stop the import.`,
  ...
  sumble-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sumble-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sumble-pp-cli import <resource> --input -`,
