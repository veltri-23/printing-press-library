...
func newProjectsGetBoardsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-boards",
		Short:       "Returns all projects boards that are not deleted.",
		Example:     "  pipedrive-pp-cli projects get-boards",
		Annotations: map[string]string{"pp:endpoint": "projects.get-boards", "pp:method": "GET", "pp:path": "/projects/boards", "mcp:read-only": "true"},
