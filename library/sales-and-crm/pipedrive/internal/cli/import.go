...
but do not stop the import.`,
  ...
  pipedrive-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pipedrive-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pipedrive-pp-cli import <resource> --input -`,
