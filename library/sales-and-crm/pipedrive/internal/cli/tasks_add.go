...
func newTasksAddCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  pipedrive-pp-cli tasks add --title example-resource",
		Annotations: map[string]string{"pp:endpoint": "tasks.add", "pp:method": "POST", "pp:path": "/tasks"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				if bodyAssigneeIds != "" {
					...
					body["assignee_ids"] = parsedAssigneeIds
				}
				if bodyDescription != "" {
	...
	cmd.Flags().Float64Var(&bodyAssigneeId, "assignee-id", 0.0, "The ID of the user assigned to the task.")
	cmd.Flags().StringVar(&bodyAssigneeIds, "assignee-ids", "", "The IDs of users assigned to the task.")
	cmd.Flags().StringVar(&bodyDescription, "description", "", "The description of the task")
	cmd.Flags().Float64Var(&bodyDone, "done", 0.0, "Whether the task is done or not. 0 = Not done, 1 = Done.")
