...
large datasets as it has no memory pressure.`,
  ...
  pipedrive-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pipedrive-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pipedrive-pp-cli export <resource> --format jsonl | jq '.id'`,
