...
func newCallLogsGetUserCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-user",
		Aliases:     []string{"list"},
		Short:       "Returns all call logs assigned to a particular user.",
		Example:     "  pipedrive-pp-cli call-logs get-user",
		Annotations: map[string]string{"pp:endpoint": "call-logs.get-user", "pp:method": "GET", "pp:path": "/callLogs", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/callLogs"
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "call-logs", path, map[string]string{
