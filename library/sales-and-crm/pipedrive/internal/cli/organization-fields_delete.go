...
func newOrganizationFieldsDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  pipedrive-pp-cli organization-fields delete --ids example-value",
		Annotations: map[string]string{"pp:endpoint": "organization-fields.delete", "pp:method": "DELETE", "pp:path": "/organizationFields"},
