...
func newOauthGetTokensCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "After the customer has confirmed the app installation",
		Example:     "  pipedrive-pp-cli oauth get-tokens",
		Annotations: map[string]string{"pp:endpoint": "oauth.get-tokens", "pp:method": "POST", "pp:path": "https://oauth.pipedrive.com/oauth/token"},
