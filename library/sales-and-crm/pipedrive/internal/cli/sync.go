...
Resource scoping:
  ...
  pipedrive-pp-cli sync

  # Sync specific resources only
  pipedrive-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  pipedrive-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  pipedrive-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  pipedrive-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  pipedrive-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("pipedrive-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/github.com/mvanhorn/printing-press-library/library/sales-and-crm/pipedrive/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "activity-types":
		return db.UpsertActivityTypes(data)
	case "call-logs":
		return db.UpsertCallLogs(data)
	case "recordings":
	...
	case "deal-fields":
		return db.UpsertDealFields(data)
	case "deals":
		return db.UpsertDeals(data)
	case "deals_changelog":
		return db.UpsertDealsChangelog(data)
	case "duplicate":
		return db.UpsertDuplicate(data)
	case "deals_files":
		return db.UpsertDealsFiles(data)
	case "deals_flow":
		return db.UpsertDealsFlow(data)
	case "deals_followers":
		return db.UpsertDealsFollowers(data)
	case "deals_mail_messages":
		return db.UpsertDealsMailMessages(data)
	case "deals_merge":
		return db.UpsertDealsMerge(data)
	case "participants":
		return db.UpsertParticipants(data)
	case "participants_changelog":
		return db.UpsertParticipantsChangelog(data)
	case "deals_permitted_users":
		return db.UpsertDealsPermittedUsers(data)
	case "files":
	...
	case "lead-labels":
		return db.UpsertLeadLabels(data)
	case "lead-sources":
		return db.UpsertLeadSources(data)
	case "leads":
		return db.UpsertLeads(data)
	case "leads_permitted_users":
		return db.UpsertLeadsPermittedUsers(data)
	case "legacy-teams":
		return db.UpsertLegacyTeams(data)
	case "legacy_teams_users":
		return db.UpsertLegacyTeamsUsers(data)
	case "mailbox":
		return db.UpsertMailbox(data)
	case "meetings":
	...
	case "organization-fields":
		return db.UpsertOrganizationFields(data)
	case "organization-relationships":
		return db.UpsertOrganizationRelationships(data)
	case "organizations_changelog":
		return db.UpsertOrganizationsChangelog(data)
	case "organizations_files":
		return db.UpsertOrganizationsFiles(data)
	case "organizations_flow":
		return db.UpsertOrganizationsFlow(data)
	case "organizations_followers":
		return db.UpsertOrganizationsFollowers(data)
	case "organizations_mail_messages":
		return db.UpsertOrganizationsMailMessages(data)
	case "organizations_merge":
		return db.UpsertOrganizationsMerge(data)
	case "organizations_permitted_users":
		return db.UpsertOrganizationsPermittedUsers(data)
	case "permission-sets":
		return db.UpsertPermissionSets(data)
	case "permission_sets_assignments":
		return db.UpsertPermissionSetsAssignments(data)
	case "person-fields":
		return db.UpsertPersonFields(data)
	case "persons_changelog":
		return db.UpsertPersonsChangelog(data)
	case "persons_files":
		return db.UpsertPersonsFiles(data)
	case "persons_flow":
		return db.UpsertPersonsFlow(data)
	case "persons_followers":
		return db.UpsertPersonsFollowers(data)
	case "persons_mail_messages":
		return db.UpsertPersonsMailMessages(data)
	case "persons_merge":
		return db.UpsertPersonsMerge(data)
	case "persons_permitted_users":
		return db.UpsertPersonsPermittedUsers(data)
	case "picture":
		return db.UpsertPicture(data)
	case "persons_products":
		return db.UpsertPersonsProducts(data)
	case "conversion_statistics":
		return db.UpsertConversionStatistics(data)
	case "pipelines_deals":
		return db.UpsertPipelinesDeals(data)
	case "movement_statistics":
		return db.UpsertMovementStatistics(data)
	case "product-fields":
		return db.UpsertProductFields(data)
	case "products_deals":
		return db.UpsertProductsDeals(data)
	case "products_files":
		return db.UpsertProductsFiles(data)
	case "products_followers":
		return db.UpsertProductsFollowers(data)
	case "products_permitted_users":
		return db.UpsertProductsPermittedUsers(data)
	case "project-templates":
		return db.UpsertProjectTemplates(data)
	case "projects":
	...
	case "roles_assignments":
		return db.UpsertRolesAssignments(data)
	case "roles_pipelines":
		return db.UpsertRolesPipelines(data)
	case "settings":
		return db.UpsertSettings(data)
	case "stages_deals":
		return db.UpsertStagesDeals(data)
	case "tasks":
	...
	case "role_settings":
		return db.UpsertRoleSettings(data)
	case "webhooks":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"billing":             "/billing/subscriptions/addons",
		"call-logs":           "/callLogs",
		"currencies":          "/currencies",
		"deal-fields":         "/dealFields",
		"deals":               "/deals/archived",
		"files":               "/files",
		"filters":             "/filters",
		"filters-helpers":     "/filters/helpers",
		"lead-fields":         "/leadFields",
		"lead-labels":         "/leadLabels",
		"lead-sources":        "/leadSources",
		"leads":               "/leads",
		"leads-archived":      "/leads/archived",
		"legacy-teams":        "/legacyTeams",
		"mailbox":             "/mailbox/mailThreads",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "comments", ParentTable: "notes", ParentIDParam: "id", PathTemplate: "/notes/{id}/comments", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "deals_changelog", ParentTable: "deals", ParentIDParam: "id", PathTemplate: "/deals/{id}/changelog", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "deals_files", ParentTable: "deals", ParentIDParam: "id", PathTemplate: "/deals/{id}/files", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "deals_flow", ParentTable: "deals", ParentIDParam: "id", PathTemplate: "/deals/{id}/flow", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "deals_mail_messages", ParentTable: "deals", ParentIDParam: "id", PathTemplate: "/deals/{id}/mailMessages", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "participants", ParentTable: "deals", ParentIDParam: "id", PathTemplate: "/deals/{id}/participants", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "participants_changelog", ParentTable: "deals", ParentIDParam: "id", PathTemplate: "/deals/{id}/participantsChangelog", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "permission_sets_assignments", ParentTable: "permission-sets", ParentIDParam: "id", PathTemplate: "/permissionSets/{id}/assignments", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "role_assignments", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/users/{id}/roleAssignments", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "roles_assignments", ParentTable: "roles", ParentIDParam: "id", PathTemplate: "/roles/{id}/assignments", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
	}
}
