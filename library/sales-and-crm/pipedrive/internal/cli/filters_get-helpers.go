...
func newFiltersGetHelpersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-helpers",
		Short:       "Returns all supported filter helpers.",
		Example:     "  pipedrive-pp-cli filters get-helpers",
		Annotations: map[string]string{"pp:endpoint": "filters.get-helpers", "pp:method": "GET", "pp:path": "/filters/helpers", "mcp:read-only": "true"},
