...
func newLeadFieldsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagStart int
	var flagLimit int
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:         "lead-fields",
		Short:       "Returns data about all lead fields.",
		Long:        "Returns data about all lead fields.",
		Example:     "  pipedrive-pp-cli lead-fields",
		Annotations: map[string]string{"pp:endpoint": "lead-fields.get", "pp:method": "GET", "pp:path": "/leadFields", "mcp:read-only": "true"},
