...
func newProjectTemplatesGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Aliases:     []string{"list"},
		Short:       "Returns all not deleted project templates. This is a cursor-paginated endpoint.",
		Example:     "  pipedrive-pp-cli project-templates get",
		Annotations: map[string]string{"pp:endpoint": "project-templates.get", "pp:method": "GET", "pp:path": "/projectTemplates", "mcp:read-only": "true"},
