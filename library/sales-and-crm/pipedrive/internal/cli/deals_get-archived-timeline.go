...
func newDealsGetArchivedTimelineCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Returns archived open and won deals, grouped by a defined interval of time set in a date-type dealField (`field_key`)",
		Example:     "  pipedrive-pp-cli deals get-archived-timeline --start-date 2026-01-15 --interval day --amount 42 --field-key your-token-here",
		Annotations: map[string]string{"pp:endpoint": "deals.get-archived-timeline", "pp:method": "GET", "pp:path": "/deals/timeline/archived", "mcp:read-only": "true"},
