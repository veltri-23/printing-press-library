...
func newOauthRefreshTokensCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "refresh-tokens",
		Short:       "The `access_token` has a lifetime.",
		Example:     "  pipedrive-pp-cli oauth refresh-tokens",
		Annotations: map[string]string{"pp:endpoint": "oauth.refresh-tokens", "pp:method": "POST", "pp:path": "https://oauth.pipedrive.com/oauth/token/"},
