...
func newPersonFieldsDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  pipedrive-pp-cli person-fields delete --ids example-value",
		Annotations: map[string]string{"pp:endpoint": "person-fields.delete", "pp:method": "DELETE", "pp:path": "/personFields"},
