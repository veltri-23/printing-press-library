...
large datasets as it has no memory pressure.`,
  ...
  pypi-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pypi-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pypi-pp-cli export <resource> --format jsonl | jq '.id'`,
