...
func newCorporateAnnualReportsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagSymbol, "symbol", "", "NSE stock symbol to fetch annual reports for")
