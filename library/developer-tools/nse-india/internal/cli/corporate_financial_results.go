...
func newCorporateFinancialResultsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagSymbol, "symbol", "", "NSE stock symbol to fetch financial results for")
	cmd.Flags().StringVar(&flagPeriod, "period", "Quarterly", "Period type: 'Quarterly' or 'Annual'")
