...
but do not stop the import.`,
  ...
  nse-india-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  nse-india-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | nse-india-pp-cli import <resource> --input -`,
