...
Exit codes & warnings:
  ...
  nse-india-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  nse-india-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  nse-india-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  nse-india-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  nse-india-pp-cli sync --latest-only`,
