...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "nvd-pp-cli",
		Short: "Manage nvd resources via the nvd API",
		Long: `Manage nvd resources via the nvd API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'nvd-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("nvd-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'nvd-pp-cli profile list')")
	...
	rootCmd.AddCommand(newJsonCmd(flags))
