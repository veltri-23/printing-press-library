...
large datasets as it has no memory pressure.`,
  ...
  nvd-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  nvd-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  nvd-pp-cli export <resource> --format jsonl | jq '.id'`,
