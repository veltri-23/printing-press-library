...
large datasets as it has no memory pressure.`,
  ...
  framer-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  framer-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  framer-pp-cli export <resource> --format jsonl | jq '.id'`,
