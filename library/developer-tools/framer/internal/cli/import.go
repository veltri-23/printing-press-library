...
but do not stop the import.`,
  ...
  framer-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  framer-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | framer-pp-cli import <resource> --input -`,
