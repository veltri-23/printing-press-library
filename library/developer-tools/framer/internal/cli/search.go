...
In local mode: searches locally synced data only.`,
  ...
  framer-pp-cli search "error timeout"

  # Force local search only
  framer-pp-cli search "payment failed" --data-source local

  # Search a specific resource type locally
  framer-pp-cli search "critical" --type transactions --data-source local

  # JSON output for piping
  framer-pp-cli search "critical" --json --limit 20`,
