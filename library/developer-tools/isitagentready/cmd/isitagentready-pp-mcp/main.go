...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/isitagentready/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "isitagentready-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
