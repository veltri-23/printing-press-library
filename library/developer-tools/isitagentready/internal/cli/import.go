...
but do not stop the import.`,
  ...
  isitagentready-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  isitagentready-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | isitagentready-pp-cli import <resource> --input -`,
