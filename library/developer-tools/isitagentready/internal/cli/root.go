...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "isitagentready-pp-cli",
		Short: `Isitagentready CLI — The terminal scanner for AI-agent readiness: every check the web tool runs, plus copy-paste fixes, CI gating, scan hist…`,
		Long: `Isitagentready CLI — The terminal scanner for AI-agent readiness: every check the web tool runs, plus copy-paste fixes, CI gating, scan hist…
...
Health check: run 'isitagentready-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("isitagentready-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newAdviceCmd(flags))
	rootCmd.AddCommand(newGuideCmd(flags))
