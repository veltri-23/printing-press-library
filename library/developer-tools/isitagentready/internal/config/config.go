...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://isitagentready.com",
	}
	...
	if v := os.Getenv("ISITAGENTREADY_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("ISITAGENTREADY_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "isitagentready-pp-cli", "config.toml"), nil
}
