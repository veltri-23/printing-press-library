...
but do not stop the import.`,
  ...
  sec-edgar-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sec-edgar-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sec-edgar-pp-cli import <resource> --input -`,
