...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/godaddy/internal/cli"
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/godaddy/internal/mcp/cobratree"
...
func newMCPClient() (*client.Client, error) {
	...
	cfgPath := filepath.Join(home, ".config", "godaddy-pp-cli", "config.toml")
...
func dbPath() string {
	home, _ := os.UserHomeDir()
	return filepath.Join(home, ".local", "share", "godaddy-pp-cli", "data.db")
}
...
func handleContext(_ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	ctx := map[string]any{
		...
		"resources": []map[string]any{
			{
				"name":        "abuse",
				"description": "Manage abuse",
				"endpoints":   []string{"create-ticket", "create-ticket-v2", "get-ticket-info", "get-ticket-info-v2", "get-tickets", "get-tickets-v2"},
				"syncable":    true,
				"searchable":  true,
			},
			{
				"name":        "aftermarket",
				"description": "Manage aftermarket",
				"endpoints":   []string{"add-expiry-listings", "delete-listings"},
			},
			{
				"name":        "agents",
				"description": "Manage agents",
				"endpoints":   []string{"get", "get-events", "register", "resolve-ansname", "search-ansname"},
				"syncable":    true,
				"searchable":  true,
			},
			{
			...
			{
				"name":        "auctions-aftermarket",
				"description": "Manage aftermarket",
				"endpoints":   []string{"place-bids"},
			},
			{
				"name":        "certificates",
				"description": "Manage certificates",
				"endpoints":   []string{"create", "create-endpoint", "download-entitlement", "get", "get-entitlement", "retrieve-ssl-by-domain-reseller", "retrieve-ssl-by-domain-subscription-reseller", "validate"},
				"syncable":    true,
				"searchable":  true,
			},
			{
			...
			},
			{
				...
				"endpoints":   []string{"available", "available-bulk", "cancel", "contacts-validate", "get", "get-agreement", "get-maintenances", "get-usage", "list", "list-maintenances", "purchase", "schema", "suggest", "tlds", "update", "validate"},
				"syncable":    true,
				"searchable":  true,
			},
			{
				"name":        "domains-customers",
				"description": "Manage customers",
				"endpoints":   []string{},
			},
			{
			...
			},
			{
				...
				"endpoints":   []string{"get-metrics", "get-metrics-by-domain"},
				"searchable":  true,
			},
			{
				"name":        "shoppers",
				"description": "Manage shoppers",
				"endpoints":   []string{"create-subaccount", "delete", "get", "update"},
				"searchable":  true,
			},
			{
				"name":        "subscriptions",
				"description": "Manage subscriptions",
				"endpoints":   []string{"cancel", "get", "list", "product-groups", "update"},
				"syncable":    true,
				"searchable":  true,
			},
		},
