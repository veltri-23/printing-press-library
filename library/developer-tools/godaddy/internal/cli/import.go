...
but do not stop the import.`,
  ...
  godaddy-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  godaddy-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | godaddy-pp-cli import <resource> --input -`,
