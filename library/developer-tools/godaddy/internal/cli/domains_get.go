...
func newDomainsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  godaddy-pp-cli domains get example-value",
		Annotations: map[string]string{"pp:endpoint": "domains.get", "pp:method": "GET", "pp:path": "/v1/domains/{domain}", "mcp:read-only": "true"},
