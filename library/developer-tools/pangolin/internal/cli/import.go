...
but do not stop the import.`,
  ...
  pangolin-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pangolin-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pangolin-pp-cli import <resource> --input -`,
