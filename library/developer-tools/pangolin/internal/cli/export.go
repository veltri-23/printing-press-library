...
large datasets as it has no memory pressure.`,
  ...
  pangolin-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pangolin-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pangolin-pp-cli export <resource> --format jsonl | jq '.id'`,
