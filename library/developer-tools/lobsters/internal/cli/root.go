...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "lobsters-pp-cli",
		Short: "Manage lobsters resources via the lobsters API",
		Long: `Manage lobsters resources via the lobsters API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'lobsters-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("lobsters-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'lobsters-pp-cli profile list')")
	...
	rootCmd.AddCommand(newHottestJsonPromotedCmd(flags))
	rootCmd.AddCommand(newNewestPromotedCmd(flags))
	rootCmd.AddCommand(newPagePromotedCmd(flags))
	rootCmd.AddCommand(newSPromotedCmd(flags))
	rootCmd.AddCommand(newTPromotedCmd(flags))
