...
but do not stop the import.`,
  ...
  firecrawl-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  firecrawl-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | firecrawl-pp-cli import <resource> --input -`,
