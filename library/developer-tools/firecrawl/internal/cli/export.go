...
large datasets as it has no memory pressure.`,
  ...
  firecrawl-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  firecrawl-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  firecrawl-pp-cli export <resource> --format jsonl | jq '.id'`,
