...
but do not stop the import.`,
  ...
  yeswehack-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  yeswehack-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | yeswehack-pp-cli import <resource> --input -`,
