...
large datasets as it has no memory pressure.`,
  ...
  yeswehack-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  yeswehack-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  yeswehack-pp-cli export <resource> --format jsonl | jq '.id'`,
