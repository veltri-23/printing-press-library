...
large datasets as it has no memory pressure.`,
  ...
  postman-explore-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  postman-explore-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  postman-explore-pp-cli export <resource> --format jsonl | jq '.id'`,
