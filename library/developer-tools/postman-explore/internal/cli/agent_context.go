...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://postman.com/explore",
		EntryCount:    24,
		APIEntryCount: 17,
		Reachability:  "browser_http (95% confidence)",
		Protocols: []string{
			"rest_json (60% confidence)",
			"rpc_envelope (95% confidence)",
		},
		AuthCandidates: []string{
			"none",
		},
		Protections: []string{
			"cloudflare_html_challenge (95% confidence)",
		},
		GenerationHints: []string{
			"client_pattern:proxy-envelope",
			"uses_browser_http_transport",
			"no_auth_required",
