...
but do not stop the import.`,
  ...
  postman-explore-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  postman-explore-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | postman-explore-pp-cli import <resource> --input -`,
