...
but do not stop the import.`,
  ...
  domain-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  domain-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | domain-goat-pp-cli import <resource> --input -`,
