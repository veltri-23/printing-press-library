...
large datasets as it has no memory pressure.`,
  ...
  github-intel-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  github-intel-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  github-intel-pp-cli export <resource> --format jsonl | jq '.id'`,
