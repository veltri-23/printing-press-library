...
but do not stop the import.`,
  ...
  github-intel-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  github-intel-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | github-intel-pp-cli import <resource> --input -`,
