...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "github-intel-pp-cli",
		Short: "Manage github-intel resources via the github-intel API",
		Long: `Manage github-intel resources via the github-intel API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'github-intel-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("github-intel-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'github-intel-pp-cli profile list')")
	...
	rootCmd.AddCommand(newReleasesIntelCmd(flags))
	rootCmd.AddCommand(newAdvisoriesIntelCmd(flags))
	rootCmd.AddCommand(newRepoHealthCmd(flags))
	rootCmd.AddCommand(newCompareCmd(flags))
	rootCmd.AddCommand(newGithubCurrentIntelligenceSearchPromotedCmd(flags))
	rootCmd.AddCommand(newReposPromotedCmd(flags))
