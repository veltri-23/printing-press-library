...
Resource scoping:
  ...
  github-intel-pp-cli sync

  # Sync specific resources only
  github-intel-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  github-intel-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  github-intel-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  github-intel-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  github-intel-pp-cli sync --latest-only`,
