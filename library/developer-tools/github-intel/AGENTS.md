# Github Intel Printed CLI Agent Guide

This directory is a generated `github-intel-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
github-intel-pp-cli doctor --json
github-intel-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
github-intel-pp-cli which "<capability>" --json
github-intel-pp-cli <command> --help
```
...
```bash
github-intel-pp-cli <command> --agent
```
...
```bash
github-intel-pp-cli <command> --help
github-intel-pp-cli <command> --dry-run --agent
```
