...
Exit codes & warnings:
  ...
  trigger-dev-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "concurrency":
		return db.UpsertConcurrency(data)
	case "pause":
	...
	case "replay":
		return db.UpsertReplay(data)
	case "reschedule":
		return db.UpsertReschedule(data)
	case "result":
		return db.UpsertResult(data)
	case "tags":
		return db.UpsertTags(data)
	case "trace":
		return db.UpsertTrace(data)
	case "schedules":
	...
	case "waitpoints":
		return db.UpsertWaitpoints(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"query":       "/api/v1/query/schema",
		"queues":      "/api/v1/queues",
		"runs":        "/api/v1/runs",
		"schedules":   "/api/v1/schedules",
		"timezones":   "/api/v1/timezones",
		"waitpoints":  "/api/v1/waitpoints/tokens",
	}
