...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/airflow-admin/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "airflow-admin-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
