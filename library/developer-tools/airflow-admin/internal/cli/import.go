...
but do not stop the import.`,
  ...
  airflow-admin-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  airflow-admin-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | airflow-admin-pp-cli import <resource> --input -`,
