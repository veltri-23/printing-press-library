...
func resetCredentialEnv(t *testing.T) (home, configPath string) {
	...
	for _, name := range []string{
		"GITHUB_CONTENTS_CONFIG",
		"GITHUB_CONTENTS_CONFIG_DIR",
		"GITHUB_CONTENTS_DATA_DIR",
		"GITHUB_CONTENTS_STATE_DIR",
		"GITHUB_CONTENTS_CACHE_DIR",
		"GITHUB_CONTENTS_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
	...
	return home, filepath.Join(home, ".config", "github-contents-pp-cli", "config.toml")
}
...
func TestCorruptCredentialsFallsBackToLegacyConfig(t *testing.T) {
	...
	credentialsPath := filepath.Join(home, ".local", "share", "github-contents-pp-cli", "credentials.toml")
...
func TestAuthWriteScrubsLegacyConfigWhenRelocated(t *testing.T) {
	...
	activeConfigPath := filepath.Join(newConfigDir, "github-contents-pp-cli", "config.toml")
	...
	credsPath := filepath.Join(newDataDir, "github-contents-pp-cli", "credentials.toml")
