...
const (
	journalSessionEnvVar   = "GITHUB_CONTENTS_LEARN_SESSION"
	journalNoLearnEnvVar   = "GITHUB_CONTENTS_NO_LEARN"
	journalNoCaptureEnvVar = "GITHUB_CONTENTS_LEARN_NO_CAPTURE"
)
