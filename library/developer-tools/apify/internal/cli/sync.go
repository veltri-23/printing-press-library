...
Resource scoping:
  ...
  apify-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  apify-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  apify-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  apify-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  apify-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("apify-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/apify-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "actor_builds_abort":
		return db.UpsertActorBuildsAbort(data)
	case "actor_builds_log":
		return db.UpsertActorBuildsLog(data)
	case "openapi_json":
		return db.UpsertOpenapiJson(data)
	case "actor_runs_abort":
		return db.UpsertActorRunsAbort(data)
	case "charge":
		return db.UpsertCharge(data)
	case "dataset":
		return db.UpsertDataset(data)
	case "key_value_store":
		return db.UpsertKeyValueStore(data)
	case "actor_runs_log":
		return db.UpsertActorRunsLog(data)
	case "metamorph":
		return db.UpsertMetamorph(data)
	case "reboot":
		return db.UpsertReboot(data)
	case "request_queue":
		return db.UpsertRequestQueue(data)
	case "resurrect":
		return db.UpsertResurrect(data)
	case "input":
		return db.UpsertInput(data)
	case "actor_tasks_run_sync":
		return db.UpsertActorTasksRunSync(data)
	case "actor_tasks_run_sync_get_dataset_items":
		return db.UpsertActorTasksRunSyncGetDatasetItems(data)
	case "actor_tasks_runs":
		return db.UpsertActorTasksRuns(data)
	case "actor_tasks_webhooks":
		return db.UpsertActorTasksWebhooks(data)
	case "builds":
		return db.UpsertBuilds(data)
	case "acts_run_sync":
		return db.UpsertActsRunSync(data)
	case "acts_run_sync_get_dataset_items":
		return db.UpsertActsRunSyncGetDatasetItems(data)
	case "acts_runs":
		return db.UpsertActsRuns(data)
	case "validate_input":
		return db.UpsertValidateInput(data)
	case "versions":
		return db.UpsertVersions(data)
	case "acts_webhooks":
		return db.UpsertActsWebhooks(data)
	case "browser-info":
		return db.UpsertBrowserInfo(data)
	case "items":
	...
	case "head":
		return db.UpsertHead(data)
	case "requests":
		return db.UpsertRequests(data)
	case "schedules_log":
		return db.UpsertSchedulesLog(data)
	case "dispatches":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"actor-builds":           "/v2/actor-builds",
		"actor-runs":             "/v2/actor-runs",
		"actor-tasks":            "/v2/actor-tasks",
		"acts":                   "/v2/acts",
		"browser-info":           "/v2/browser-info",
		"datasets":               "/v2/datasets",
		"key-value-stores":       "/v2/key-value-stores",
		"request-queues":         "/v2/request-queues",
		"schedules":              "/v2/schedules",
		"store":                  "/v2/store",
		"users":                  "/v2/users/me",
		"users-me-limits":        "/v2/users/me/limits",
		"users-me-usage-monthly": "/v2/users/me/usage/monthly",
		"webhook-dispatches":     "/v2/webhook-dispatches",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "actor_tasks_run_sync_get_dataset_items", ParentTable: "actor-tasks", ParentIDParam: "actorTaskId", PathTemplate: "/v2/actor-tasks/{actorTaskId}/run-sync-get-dataset-items", KeyField: ""},
		{Name: "actor_tasks_runs", ParentTable: "actor-tasks", ParentIDParam: "actorTaskId", PathTemplate: "/v2/actor-tasks/{actorTaskId}/runs/last/request-queue/head", KeyField: ""},
		{Name: "actor_tasks_webhooks", ParentTable: "actor-tasks", ParentIDParam: "actorTaskId", PathTemplate: "/v2/actor-tasks/{actorTaskId}/webhooks", KeyField: ""},
		{Name: "acts_run_sync_get_dataset_items", ParentTable: "acts", ParentIDParam: "actorId", PathTemplate: "/v2/acts/{actorId}/run-sync-get-dataset-items", KeyField: ""},
		{Name: "acts_runs", ParentTable: "acts", ParentIDParam: "actorId", PathTemplate: "/v2/acts/{actorId}/runs/last/request-queue/requests", KeyField: ""},
		{Name: "acts_webhooks", ParentTable: "acts", ParentIDParam: "actorId", PathTemplate: "/v2/acts/{actorId}/webhooks", KeyField: ""},
		{Name: "builds", ParentTable: "acts", ParentIDParam: "actorId", PathTemplate: "/v2/acts/{actorId}/builds", KeyField: ""},
		{Name: "dataset", ParentTable: "actor-runs", ParentIDParam: "runId", PathTemplate: "/v2/actor-runs/{runId}/dataset/items", KeyField: ""},
		{Name: "head", ParentTable: "request-queues", ParentIDParam: "queueId", PathTemplate: "/v2/request-queues/{queueId}/head", KeyField: ""},
		{Name: "items", ParentTable: "datasets", ParentIDParam: "datasetId", PathTemplate: "/v2/datasets/{datasetId}/items", KeyField: ""},
		{Name: "key_value_store", ParentTable: "actor-runs", ParentIDParam: "runId", PathTemplate: "/v2/actor-runs/{runId}/key-value-store/keys", KeyField: ""},
		{Name: "keys", ParentTable: "key-value-stores", ParentIDParam: "storeId", PathTemplate: "/v2/key-value-stores/{storeId}/keys", KeyField: ""},
		{Name: "request_queue", ParentTable: "actor-runs", ParentIDParam: "runId", PathTemplate: "/v2/actor-runs/{runId}/request-queue/head", KeyField: ""},
		{Name: "requests", ParentTable: "request-queues", ParentIDParam: "queueId", PathTemplate: "/v2/request-queues/{queueId}/requests", KeyField: ""},
	}
}
