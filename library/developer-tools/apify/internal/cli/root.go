...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "apify-pp-cli",
		Short: `Apify CLI — Every Apify platform feature, plus a local SQLite store, cross-Actor search, novelty diffing, cost-aware runs, and news…`,
		Long: `Apify CLI — Every Apify platform feature, plus a local SQLite store, cross-Actor search, novelty diffing, cost-aware runs, and news…
...
Health check: run 'apify-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("apify-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'apify-pp-cli profile list')")
	...
	rootCmd.AddCommand(newActorBuildsCmd(flags))
	rootCmd.AddCommand(newActorRunsCmd(flags))
	rootCmd.AddCommand(newActorTasksCmd(flags))
	rootCmd.AddCommand(newActsCmd(flags))
	rootCmd.AddCommand(newBrowserInfoCmd(flags))
	rootCmd.AddCommand(newDatasetsCmd(flags))
	rootCmd.AddCommand(newKeyValueStoresCmd(flags))
	rootCmd.AddCommand(newRequestQueuesCmd(flags))
	// Schedules: capture so we can attach the novel apply/diff subcommands.
	schedulesCmd := newSchedulesCmd(flags)
	schedulesCmd.AddCommand(newSchedulesApplyCmd(flags))
	schedulesCmd.AddCommand(newSchedulesDiffCmd(flags))
	rootCmd.AddCommand(schedulesCmd)
	rootCmd.AddCommand(newToolsCmd(flags))
	rootCmd.AddCommand(newUsersCmd(flags))
	rootCmd.AddCommand(newWebhookDispatchesCmd(flags))
	...
	// Search: capture so we can attach the novel `items` subcommand.
	searchCmd := newSearchCmd(flags)
	searchCmd.AddCommand(newSearchItemsCmd(flags))
	rootCmd.AddCommand(searchCmd)
	rootCmd.AddCommand(newSyncCmd(flags))
	rootCmd.AddCommand(newTailCmd(flags))
	rootCmd.AddCommand(newAnalyticsCmd(flags))
	// Workflow: capture so we can attach the novel `run` subcommand.
	workflowCmd := newWorkflowCmd(flags)
	workflowCmd.AddCommand(newWorkflowRunCmd(flags))
	rootCmd.AddCommand(workflowCmd)
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newLogsPromotedCmd(flags))
	rootCmd.AddCommand(newStorePromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())
	rootCmd.AddCommand(newRunCmd(flags))
	rootCmd.AddCommand(newDigestCmd(flags))
	rootCmd.AddCommand(newCostCmd(flags))
	rootCmd.AddCommand(newPresetCmd(flags))
	rootCmd.AddCommand(newABCmd(flags))
