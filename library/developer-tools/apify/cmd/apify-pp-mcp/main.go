...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/apify/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "apify-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
