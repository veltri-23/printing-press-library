...
type rootFlags struct {
	...
	team    string // Azure DevOps team name (optional, for team-scoped commands)
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "azure-devops-pp-cli",
		Short: `Azure DevOps CLI with offline-first search, sprint analytics, and CI/CD visibility`,
		Long: `Azure DevOps CLI with offline-first search, sprint analytics, and CI/CD visibility
...
Health check: run 'azure-devops-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("azure-devops-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newApisCmd(flags))
	rootCmd.AddCommand(newBuildApisCmd(flags))
	rootCmd.AddCommand(newGitApisCmd(flags))
	rootCmd.AddCommand(newPipelinesApisCmd(flags))
	rootCmd.AddCommand(newReleaseApisCmd(flags))
	rootCmd.AddCommand(newWikiApisCmd(flags))
	rootCmd.AddCommand(newWorkApisCmd(flags))
	rootCmd.AddCommand(newWorkitemtrackingApisCmd(flags))
	...
	rootCmd.AddCommand(newNovelBranchesCmd(flags))
	rootCmd.AddCommand(newNovelBuildsCmd(flags))
	rootCmd.AddCommand(newNovelGitCmd(flags))
	rootCmd.AddCommand(newNovelPipelineCmd(flags))
	rootCmd.AddCommand(newNovelPrCmd(flags))
	rootCmd.AddCommand(newNovelReleaseCmd(flags))
	rootCmd.AddCommand(newNovelStandupCmd(flags))
	rootCmd.AddCommand(newNovelVelocityCmd(flags))
	rootCmd.AddCommand(newNovelWitCmd(flags))
	rootCmd.AddCommand(newNovelWorkCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newSearchApisPromotedCmd(flags))
