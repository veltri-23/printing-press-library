...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  azure-devops-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  azure-devops-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  azure-devops-pp-cli workflow status

  # Show status as JSON
  azure-devops-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("azure-devops-pp-cli")
			}
