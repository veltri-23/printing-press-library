...
but do not stop the import.`,
  ...
  azure-devops-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  azure-devops-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | azure-devops-pp-cli import <resource> --input -`,
