...
but do not stop the import.`,
  ...
  uspto-tsdr-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  uspto-tsdr-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | uspto-tsdr-pp-cli import <resource> --input -`,
