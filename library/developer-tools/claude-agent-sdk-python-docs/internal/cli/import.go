...
but do not stop the import.`,
  ...
  claude-agent-sdk-python-docs-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  claude-agent-sdk-python-docs-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | claude-agent-sdk-python-docs-pp-cli import <resource> --input -`,
