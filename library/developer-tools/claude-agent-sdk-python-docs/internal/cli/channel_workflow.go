...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  claude-agent-sdk-python-docs-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  claude-agent-sdk-python-docs-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  claude-agent-sdk-python-docs-pp-cli workflow status

  # Show status as JSON
  claude-agent-sdk-python-docs-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("claude-agent-sdk-python-docs-pp-cli")
			}
