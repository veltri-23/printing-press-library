...
var readCommandResources = map[string][]string{
	"claude-agent-sdk-python-docs-pp-cli pages":        {"pages"},
	"claude-agent-sdk-python-docs-pp-cli pages list":   {"pages"},
	"claude-agent-sdk-python-docs-pp-cli pages get":    {"pages"},
	"claude-agent-sdk-python-docs-pp-cli pages search": {"pages"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "CLAUDE_AGENT_SDK_PYTHON_DOCS_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale claude-agent-sdk-python-docs-pp-cli cache (refresh failed: %v)\n", err)
