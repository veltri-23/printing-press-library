...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "claude-agent-sdk-python-docs-pp-cli",
		Short: `Explore, read, and verify against the Claude Agent SDK Python docs.`,
		Long: `Explore, read, and verify against the Claude Agent SDK Python docs.
...
Health check: run 'claude-agent-sdk-python-docs-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("claude-agent-sdk-python-docs-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'claude-agent-sdk-python-docs-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDocsReadCmd(flags))
	rootCmd.AddCommand(newDocsSearchCmd(flags))
	rootCmd.AddCommand(newDocsSymbolCmd(flags))
	rootCmd.AddCommand(newDocsExamplesCmd(flags))
	rootCmd.AddCommand(newDocsGuideCmd(flags))
	...
	rootCmd.AddCommand(newNovelAuditLinksCmd(flags))
	rootCmd.AddCommand(newNovelContextCmd(flags))
	rootCmd.AddCommand(newNovelCoverageCmd(flags))
	rootCmd.AddCommand(newNovelDiffCmd(flags))
	rootCmd.AddCommand(newNovelMapCmd(flags))
	rootCmd.AddCommand(newNovelRecipeCmd(flags))
