# Claude Agent SDK Python Docs Printed CLI Agent Guide

This directory is a generated `claude-agent-sdk-python-docs-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
claude-agent-sdk-python-docs-pp-cli doctor --json
claude-agent-sdk-python-docs-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
claude-agent-sdk-python-docs-pp-cli which "<capability>" --json
...
```bash
claude-agent-sdk-python-docs-pp-cli <command> --agent
```
...
```bash
claude-agent-sdk-python-docs-pp-cli <command> --help
claude-agent-sdk-python-docs-pp-cli <command> --dry-run --agent
```
