...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("SCRAPECREATORS_API_KEY"); v != "" {
		cfg.ScrapecreatorsApiKey = v
		cfg.markEnvOverride("ScrapecreatorsApiKey")
		cfg.AuthSource = "env:SCRAPECREATORS_API_KEY"
		cfg.CredentialSource = "env:SCRAPECREATORS_API_KEY"
	}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("SCRAPE_CREATORS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "scrape-creators-pp-cli", "config.toml"), nil
}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		ScrapecreatorsApiKey: c.ScrapecreatorsApiKey,
	}
}
...
func (c *Config) SaveCredential(token string) error {
	...
	c.updateFileConfigField("AccessToken")
	c.ScrapecreatorsApiKey = token
	delete(c.envOverrides, "ScrapecreatorsApiKey")
	c.updateFileConfigField("ScrapecreatorsApiKey")
	if err := c.saveCredentialsFirst(); err != nil {
		return err
	}
	return c.save()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["ScrapecreatorsApiKey"] {
			out.ScrapecreatorsApiKey = c.fileConfig.ScrapecreatorsApiKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "ScrapecreatorsApiKey":
		c.fileConfig.ScrapecreatorsApiKey = c.ScrapecreatorsApiKey
	}
}
