...
func newTiktokListVideo2Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list-video-2",
		Short:       "Fetches comments on a TikTok video by URL — useful for reading audience reactions, replies, and engagement.",
		Example:     "  scrape-creators-pp-cli tiktok list-video-2 --url https://example.com/resource",
		Annotations: map[string]string{"pp:endpoint": "tiktok.list-video-2", "pp:method": "GET", "pp:path": "/v1/tiktok/video/comments", "mcp:read-only": "true"},
