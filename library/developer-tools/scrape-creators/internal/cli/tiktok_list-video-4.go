...
func newTiktokListVideo4Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list-video-4",
		Short:       "Fetches replies to a specific TikTok comment by its ID.",
		Example:     "  scrape-creators-pp-cli tiktok list-video-4 --comment-id 7623828115408274207 --url https://example.com/resource",
		Annotations: map[string]string{"pp:endpoint": "tiktok.list-video-4", "pp:method": "GET", "pp:path": "/v1/tiktok/video/comment/replies", "mcp:read-only": "true"},
