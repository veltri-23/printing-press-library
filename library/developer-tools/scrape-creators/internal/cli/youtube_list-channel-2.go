...
func newYoutubeListChannel2Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  scrape-creators-pp-cli youtube list-channel-2 --handle @mkbhd",
		Annotations: map[string]string{"pp:endpoint": "youtube.list-channel-2", "pp:method": "GET", "pp:path": "/v1/youtube/channel/lives", "mcp:read-only": "true"},
