...
func newFacebookListProfile5Cmd(flags *rootFlags) *cobra.Command {
	var flagUrl string
	...
	cmd := &cobra.Command{
		Use:         "list-profile-5",
		Short:       "Fetches up to 10 reels per request from a public Facebook page.",
		Example:     "  scrape-creators-pp-cli facebook list-profile-5 --url https://www.facebook.com/pacemorby",
		Annotations: map[string]string{"pp:endpoint": "facebook.list-profile-5", "pp:method": "GET", "pp:path": "/v1/facebook/profile/reels", "mcp:read-only": "true"},
