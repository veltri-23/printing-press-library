...
func newTwitchListProfileCmd(flags *rootFlags) *cobra.Command {
	var flagHandle string

	cmd := &cobra.Command{
		Use:         "list-profile",
		Short:       "Retrieves a Twitch user's public profile by handle, including identity, social links, and content.",
		Example:     "  scrape-creators-pp-cli twitch list-profile --handle ishowspeed",
		Annotations: map[string]string{"pp:endpoint": "twitch.list-profile", "pp:method": "GET", "pp:path": "/v1/twitch/profile", "mcp:read-only": "true"},
