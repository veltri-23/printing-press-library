...
func newThreadsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  scrape-creators-pp-cli threads list --url https://www.threads.net/@zuck/post/DE83eO-Jl27",
		Annotations: map[string]string{"pp:endpoint": "threads.list", "pp:method": "GET", "pp:path": "/v1/threads/post", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "threads", true, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
