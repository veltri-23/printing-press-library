...
func newTiktokListUser2Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  scrape-creators-pp-cli tiktok list-user-2 --handle mrbeast",
		Annotations: map[string]string{"pp:endpoint": "tiktok.list-user-2", "pp:method": "GET", "pp:path": "/v1/tiktok/user/followers", "mcp:read-only": "true"},
