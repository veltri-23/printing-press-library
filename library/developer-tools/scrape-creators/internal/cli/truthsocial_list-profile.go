...
func newTruthsocialListProfileCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  scrape-creators-pp-cli truthsocial list-profile --handle realDonaldTrump",
		Annotations: map[string]string{"pp:endpoint": "truthsocial.list-profile", "pp:method": "GET", "pp:path": "/v1/truthsocial/profile", "mcp:read-only": "true"},
