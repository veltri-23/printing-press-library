...
func newYoutubeListShortsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list-shorts",
		Short:       "Fetches approximately 48 currently trending YouTube Shorts (viral/popular short-form videos) per call",
		Example:     "  scrape-creators-pp-cli youtube list-shorts",
		Annotations: map[string]string{"pp:endpoint": "youtube.list-shorts", "pp:method": "GET", "pp:path": "/v1/youtube/shorts/trending", "mcp:read-only": "true"},
