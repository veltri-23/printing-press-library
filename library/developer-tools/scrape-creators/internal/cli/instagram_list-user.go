...
func newInstagramListUserCmd(flags *rootFlags) *cobra.Command {
	var flagHandle string

	cmd := &cobra.Command{
		Use:         "list-user",
		Short:       "Returns the raw HTML embed snippet for an Instagram user's profile widget.",
		Example:     "  scrape-creators-pp-cli instagram list-user --handle jane",
		Annotations: map[string]string{"pp:endpoint": "instagram.list-user", "pp:method": "GET", "pp:path": "/v1/instagram/user/embed", "mcp:read-only": "true"},
