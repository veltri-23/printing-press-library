...
func newYoutubeListVideo5Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  scrape-creators-pp-cli youtube list-video-5 --continuation-token Eg0SC2RRdzR3OVdnWGNRGAYygwEaUBIa...",
		Annotations: map[string]string{"pp:endpoint": "youtube.list-video-5", "pp:method": "GET", "pp:path": "/v1/youtube/video/comment/replies", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !cmd.Flags().Changed("continuation-token") && !flags.dryRun {
				return fmt.Errorf("required flag \"%s\" not set", "continuation-token")
			}
