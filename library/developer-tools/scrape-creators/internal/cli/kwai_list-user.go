...
func newKwaiListUserCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "kwai", path, map[string]string{
	...
	cmd.Flags().StringVar(&flagCursor, "cursor", "", "Cursor from the previous response for the next page")
	cmd.Flags().Float64Var(&flagCount, "count", 0.0, "Number of posts to return, max 50")
