...
func newTiktokListSearch5Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "list-search-5",
		Short: "Searches for TikTok users by keyword or name — useful for finding creators or accounts matching a query.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  scrape-creators-pp-cli tiktok list-search-5 --query example-value",
		Annotations: map[string]string{"pp:endpoint": "tiktok.list-search-5", "pp:method": "GET", "pp:path": "/v1/tiktok/search/users", "mcp:read-only": "true"},
