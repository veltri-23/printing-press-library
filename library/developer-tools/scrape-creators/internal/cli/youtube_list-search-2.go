...
func newYoutubeListSearch2Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  scrape-creators-pp-cli youtube list-search-2 --hashtag funny",
		Annotations: map[string]string{"pp:endpoint": "youtube.list-search-2", "pp:method": "GET", "pp:path": "/v1/youtube/search/hashtag", "mcp:read-only": "true"},
