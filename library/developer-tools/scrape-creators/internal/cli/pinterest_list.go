...
func newPinterestListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  scrape-creators-pp-cli pinterest list --url https://www.pinterest.com/lizmrodgers/moms-night/",
		Annotations: map[string]string{"pp:endpoint": "pinterest.list", "pp:method": "GET", "pp:path": "/v1/pinterest/board", "mcp:read-only": "true"},
