...
func newSpotifyListPodcast2Cmd(flags *rootFlags) *cobra.Command {
	var flagId string
	var flagUrl string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "spotify", path, map[string]string{
	...
	cmd.Flags().StringVar(&flagCursor, "cursor", "", "Cursor returned by the previous response. Omit for the first page.")
