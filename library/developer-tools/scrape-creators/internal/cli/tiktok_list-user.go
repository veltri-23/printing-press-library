...
func newTiktokListUserCmd(flags *rootFlags) *cobra.Command {
	var flagHandle string

	cmd := &cobra.Command{
		Use:         "list-user",
		Short:       "Retrieves audience demographic data for a TikTok user, showing where their followers are located by country.",
		Example:     "  scrape-creators-pp-cli tiktok list-user --handle shakira",
		Annotations: map[string]string{"pp:endpoint": "tiktok.list-user", "pp:method": "GET", "pp:path": "/v1/tiktok/user/audience", "mcp:read-only": "true"},
