...
func newThreadsListUserCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  scrape-creators-pp-cli threads list-user --handle trendspider",
		Annotations: map[string]string{"pp:endpoint": "threads.list-user", "pp:method": "GET", "pp:path": "/v1/threads/user/posts", "mcp:read-only": "true"},
