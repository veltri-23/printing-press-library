...
but do not stop the import.`,
  ...
  openipa-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  openipa-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | openipa-pp-cli import <resource> --input -`,
