...
func newUoGetCmd(flags *rootFlags) *cobra.Command {
	var bodyCODUNIOU string
	var stdinBody bool
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			if !stdinBody {
				if !cmd.Flags().Changed("codice-uni") && !flags.dryRun {
					return fmt.Errorf("required flag \"%s\" not set", "codice-uni")
				}
			}
	...
	cmd.Flags().StringVar(&bodyCODUNIOU, "codice-uni", "", "Codice univoco dell'Unità Organizzativa (es. '4D3J7X')")
