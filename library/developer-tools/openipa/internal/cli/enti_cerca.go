...
func newEntiCercaCmd(flags *rootFlags) *cobra.Command {
	var bodyDESCR string
	var stdinBody bool
	...
	cmd.Flags().StringVar(&bodyDESCR, "nome", "", "Parte del nome dell'ente da cercare (es. 'comune di Roma')")
