...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  openipa-pp-cli doctor
  openipa-pp-cli doctor --json
  openipa-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export IPA_auth_id=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("IPA_auth_id") != "" {
				authEnvSet = append(authEnvSet, "IPA_auth_id")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "IPA_auth_id")
			}
			switch {
