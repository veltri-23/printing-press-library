...
func (l *AdaptiveLimiter) Wait() {
	...
	// Prenota lo slot futuro con la lock: elimina la TOCTOU tra lettura e
	// scrittura di lastRequest che permetteva a goroutine concorrenti di
	// bypassare il gate insieme.
