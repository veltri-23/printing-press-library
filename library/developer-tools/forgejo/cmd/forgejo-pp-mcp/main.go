...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/forgejo/internal/mcp"
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "forgejo-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
