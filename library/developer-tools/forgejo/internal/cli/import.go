...
but do not stop the import.`,
  ...
  forgejo-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  forgejo-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | forgejo-pp-cli import <resource> --input -`,
