...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "fj",
		Short: `Forgejo CLI — The 'gh' for Forgejo — works with any instance, stores your data locally, and speaks Forgejo natively.`,
		Long: `Forgejo CLI — The 'gh' for Forgejo — works with any instance, stores your data locally, and speaks Forgejo natively.
...
Health check: run 'forgejo-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("fj {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'forgejo-pp-cli profile list')")
	...
	rootCmd.AddCommand(newActivitypubCmd(flags))
	rootCmd.AddCommand(newAdminCmd(flags))
	rootCmd.AddCommand(newGitignoreCmd(flags))
	rootCmd.AddCommand(newLabelCmd(flags))
	rootCmd.AddCommand(newLicensesCmd(flags))
	rootCmd.AddCommand(newMarkdownCmd(flags))
	...
	rootCmd.AddCommand(newCICmd(flags))
	rootCmd.AddCommand(newForgejoVersionPromotedCmd(flags))
	rootCmd.AddCommand(newMarkupPromotedCmd(flags))
	rootCmd.AddCommand(newNodeinfoPromotedCmd(flags))
	rootCmd.AddCommand(newRepositoriesPromotedCmd(flags))
	rootCmd.AddCommand(newSigningKeyGpgPromotedCmd(flags))
	rootCmd.AddCommand(newSigningKeySshPromotedCmd(flags))
