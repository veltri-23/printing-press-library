...
large datasets as it has no memory pressure.`,
  ...
  forgejo-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  forgejo-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  forgejo-pp-cli export <resource> --format jsonl | jq '.id'`,
