...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/scrape-do/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "scrape-do-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
