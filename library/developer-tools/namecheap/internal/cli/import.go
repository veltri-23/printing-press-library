...
but do not stop the import.`,
  ...
  namecheap-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  namecheap-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | namecheap-pp-cli import <resource> --input -`,
