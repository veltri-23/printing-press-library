...
func newDomainsGetInfoCmd(flags *rootFlags) *cobra.Command {
	var flagDomainName string

	cmd := &cobra.Command{
		Use:         "get-info",
		Short:       "Runs `namecheap.domains.getInfo` for a domain.",
		Example:     "  namecheap-pp-cli domains get-info",
		Annotations: map[string]string{"pp:endpoint": "domains.get-info", "pp:method": "GET", "pp:path": "/domains/get-info", "mcp:read-only": "true"},
