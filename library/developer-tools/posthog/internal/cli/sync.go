...
Exit codes & warnings:
  ...
  posthog-pp-cli sync --dates 20250101-20250131`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			for i := 0; i < concurrency; i++ {
				...
				go func() {
					...
					for resource := range work {
						res := syncResource(c, db, resource, sinceTS, full, maxPages, effectiveLatestOnly, syncDates, userParams)
						results <- res
					}
				}()
			}
			...
			depResults := syncDependentResources(c, db, sinceTS, full, maxPages, effectiveLatestOnly, parentFilter, syncDates, userParams)
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/posthog-pp-cli/data.db)")
...
func syncResource(c interface {
	...
	RateLimit() float64
}, db *store.Store, resource, sinceTS string, full bool, maxPages int, latestOnly bool, dates string, userParams *syncUserParams) syncResult {
	started := time.Now()
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "environments_dashboards":
		return db.UpsertEnvironmentsDashboards(data)
	case "environments_data_color_themes":
		return db.UpsertEnvironmentsDataColorThemes(data)
	case "environments_data_modeling_jobs":
		return db.UpsertEnvironmentsDataModelingJobs(data)
	case "environments_data_warehouse":
		return db.UpsertEnvironmentsDataWarehouse(data)
	case "environments_dataset_items":
		return db.UpsertEnvironmentsDatasetItems(data)
	case "environments_datasets":
		return db.UpsertEnvironmentsDatasets(data)
	case "desktop_recordings":
		return db.UpsertDesktopRecordings(data)
	case "environments_elements":
		return db.UpsertEnvironmentsElements(data)
	case "environments_endpoints":
		return db.UpsertEnvironmentsEndpoints(data)
	case "environments_error_tracking":
		return db.UpsertEnvironmentsErrorTracking(data)
	case "evaluation_runs":
		return db.UpsertEvaluationRuns(data)
	case "evaluations":
		return db.UpsertEvaluations(data)
	case "event_filter":
		return db.UpsertEventFilter(data)
	case "environments_events":
		return db.UpsertEnvironmentsEvents(data)
	case "environments_exports":
		return db.UpsertEnvironmentsExports(data)
	case "environments_external_data_schemas":
		return db.UpsertEnvironmentsExternalDataSchemas(data)
	case "environments_external_data_sources":
		return db.UpsertEnvironmentsExternalDataSources(data)
	case "environments_file_system":
		return db.UpsertEnvironmentsFileSystem(data)
	case "environments_file_system_shortcut":
		return db.UpsertEnvironmentsFileSystemShortcut(data)
	case "environments_groups":
		return db.UpsertEnvironmentsGroups(data)
	case "health_issues":
		return db.UpsertHealthIssues(data)
	case "environments_heatmap_screenshots":
		return db.UpsertEnvironmentsHeatmapScreenshots(data)
	case "environments_heatmaps":
		return db.UpsertEnvironmentsHeatmaps(data)
	case "environments_hog_flows":
		return db.UpsertEnvironmentsHogFlows(data)
	case "environments_hog_functions":
		return db.UpsertEnvironmentsHogFunctions(data)
	case "environments_insight_variables":
		return db.UpsertEnvironmentsInsightVariables(data)
	case "environments_insights":
		return db.UpsertEnvironmentsInsights(data)
	case "environments_integrations":
		return db.UpsertEnvironmentsIntegrations(data)
	case "lineage":
		return db.UpsertLineage(data)
	case "llm_analytics":
	...
	case "environments_logs":
		return db.UpsertEnvironmentsLogs(data)
	case "managed_viewsets":
		return db.UpsertManagedViewsets(data)
	case "max_tools":
		return db.UpsertMaxTools(data)
	...
	case "environments_persisted_folder":
		return db.UpsertEnvironmentsPersistedFolder(data)
	case "environments_persons":
		return db.UpsertEnvironmentsPersons(data)
	case "environments_plugin_configs":
		return db.UpsertEnvironmentsPluginConfigs(data)
	case "environments_project_secret_api_keys":
		return db.UpsertEnvironmentsProjectSecretApiKeys(data)
	case "environments_query":
		return db.UpsertEnvironmentsQuery(data)
	case "environments_saved":
		return db.UpsertEnvironmentsSaved(data)
	case "environments_session_recording_playlists":
		return db.UpsertEnvironmentsSessionRecordingPlaylists(data)
	case "environments_session_recordings":
		return db.UpsertEnvironmentsSessionRecordings(data)
	case "session_summaries":
		return db.UpsertSessionSummaries(data)
	case "environments_sessions":
		return db.UpsertEnvironmentsSessions(data)
	case "environments_subscriptions":
		return db.UpsertEnvironmentsSubscriptions(data)
	case "taggers":
	...
	case "environments_warehouse_saved_queries":
		return db.UpsertEnvironmentsWarehouseSavedQueries(data)
	case "environments_warehouse_saved_query_folders":
		return db.UpsertEnvironmentsWarehouseSavedQueryFolders(data)
	case "environments_warehouse_tables":
		return db.UpsertEnvironmentsWarehouseTables(data)
	case "environments_warehouse_view_link":
		return db.UpsertEnvironmentsWarehouseViewLink(data)
	case "environments_warehouse_view_links":
		return db.UpsertEnvironmentsWarehouseViewLinks(data)
	case "web_analytics":
		return db.UpsertWebAnalytics(data)
	case "web_vitals":
		return db.UpsertWebVitals(data)
	case "organizations":
	...
	case "organizations_projects":
		return db.UpsertOrganizationsProjects(data)
	case "proxy_records":
	...
	case "projects_exports":
		return db.UpsertProjectsExports(data)
	case "projects_external_data_schemas":
		return db.UpsertProjectsExternalDataSchemas(data)
	case "projects_external_data_sources":
		return db.UpsertProjectsExternalDataSources(data)
	case "feature_flags":
		return db.UpsertFeatureFlags(data)
	case "projects_file_system":
		return db.UpsertProjectsFileSystem(data)
	case "projects_file_system_shortcut":
		return db.UpsertProjectsFileSystemShortcut(data)
	case "flag_value":
		return db.UpsertFlagValue(data)
	case "projects_groups":
		return db.UpsertProjectsGroups(data)
	case "groups_types":
		return db.UpsertGroupsTypes(data)
	case "projects_heatmap_screenshots":
		return db.UpsertProjectsHeatmapScreenshots(data)
	case "projects_heatmaps":
		return db.UpsertProjectsHeatmaps(data)
	case "projects_hog_flows":
		return db.UpsertProjectsHogFlows(data)
	case "hog_function_templates":
		return db.UpsertHogFunctionTemplates(data)
	case "projects_hog_functions":
		return db.UpsertProjectsHogFunctions(data)
	case "projects_insight_variables":
		return db.UpsertProjectsInsightVariables(data)
	case "projects_insights":
		return db.UpsertProjectsInsights(data)
	case "projects_integrations":
		return db.UpsertProjectsIntegrations(data)
	case "js_snippet":
		return db.UpsertJsSnippet(data)
	case "live_debugger_breakpoints":
		return db.UpsertLiveDebuggerBreakpoints(data)
	case "projects_logs":
		return db.UpsertProjectsLogs(data)
	case "notebooks":
	...
	case "uploaded_media":
		return db.UpsertUploadedMedia(data)
	case "visual_review":
		return db.UpsertVisualReview(data)
	case "warehouse_dag":
		return db.UpsertWarehouseDag(data)
	case "warehouse_model_paths":
		return db.UpsertWarehouseModelPaths(data)
	case "projects_warehouse_saved_queries":
		return db.UpsertProjectsWarehouseSavedQueries(data)
	case "projects_warehouse_saved_query_folders":
		return db.UpsertProjectsWarehouseSavedQueryFolders(data)
	case "projects_warehouse_tables":
		return db.UpsertProjectsWarehouseTables(data)
	case "projects_warehouse_view_link":
		return db.UpsertProjectsWarehouseViewLink(data)
	case "projects_warehouse_view_links":
		return db.UpsertProjectsWarehouseViewLinks(data)
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "cimd_verification_tokens", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/cimd_verification_tokens/", KeyField: ""},
		{Name: "domains", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/domains/", KeyField: ""},
		{Name: "invites", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/invites/", KeyField: ""},
		{Name: "legal_documents", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/legal_documents/", KeyField: ""},
		{Name: "members", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/members/", KeyField: ""},
		{Name: "oauth_applications", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/oauth_applications/", KeyField: ""},
		{Name: "organizations_advanced_activity_logs", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/advanced_activity_logs/", KeyField: ""},
		{Name: "organizations_batch_exports", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/batch_exports/", KeyField: ""},
		{Name: "organizations_integrations", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/integrations/", KeyField: ""},
		{Name: "organizations_projects", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/projects/", KeyField: ""},
		{Name: "role_external_references", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/role_external_references/", KeyField: ""},
		{Name: "roles", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/api/organizations/{organization_id}/roles/", KeyField: ""},
		{Name: "users_integrations", ParentTable: "users", ParentIDParam: "uuid", PathTemplate: "/api/users/{uuid}/integrations/", KeyField: ""},
		// Project-scoped resources — parent: organizations_projects (integer id = project_id)
		{Name: "feature_flags", ParentTable: "organizations_projects", ParentIDParam: "project_id", PathTemplate: "/api/projects/{project_id}/feature_flags/", KeyField: ""},
		{Name: "experiments", ParentTable: "organizations_projects", ParentIDParam: "project_id", PathTemplate: "/api/projects/{project_id}/experiments/", KeyField: ""},
		{Name: "surveys", ParentTable: "organizations_projects", ParentIDParam: "project_id", PathTemplate: "/api/projects/{project_id}/surveys/", KeyField: ""},
		{Name: "cohorts", ParentTable: "organizations_projects", ParentIDParam: "project_id", PathTemplate: "/api/projects/{project_id}/cohorts/", KeyField: ""},
		{Name: "projects_dashboards", ParentTable: "organizations_projects", ParentIDParam: "project_id", PathTemplate: "/api/projects/{project_id}/dashboards/", KeyField: ""},
		{Name: "projects_insights", ParentTable: "organizations_projects", ParentIDParam: "project_id", PathTemplate: "/api/projects/{project_id}/insights/", KeyField: ""},
		{Name: "projects_error_tracking", ParentTable: "organizations_projects", ParentIDParam: "project_id", PathTemplate: "/api/projects/{project_id}/error_tracking/", KeyField: ""},
		{Name: "projects_persons", ParentTable: "organizations_projects", ParentIDParam: "project_id", PathTemplate: "/api/projects/{project_id}/persons/", KeyField: ""},
	}
}
...
func syncDependentResources(c interface {
	Get(string, map[string]string) (json.RawMessage, error)
	RateLimit() float64
}, db *store.Store, sinceTS string, full bool, maxPages int, latestOnly bool, parentFilter []string, dates string, userParams *syncUserParams) []syncResult {
	...
	for _, dep := range dependentResourceDefs() {
		...
		res := syncDependentResource(c, db, dep, sinceTS, full, maxPages, latestOnly, dates, userParams)
...
func syncDependentResource(c interface {
	Get(string, map[string]string) (json.RawMessage, error)
	RateLimit() float64
}, db *store.Store, dep dependentResourceDef, sinceTS string, full bool, maxPages int, latestOnly bool, dates string, userParams *syncUserParams) syncResult {
	started := time.Now()
...
var resourceIDFieldOverrides = map[string]string{
	...
	"surveys":                              "id",
	"cohorts":                              "id",
	"projects_dashboards":                  "id",
	"projects_insights":                    "id",
	"projects_error_tracking":              "id",
	"projects_persons":                     "id",
