...
func newUsersListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List",
		Example:     "  posthog-pp-cli users list",
		Annotations: map[string]string{"pp:endpoint": "users.list", "pp:method": "GET", "pp:path": "/api/users/", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "users", path, map[string]string{
				...
				"is_staff": fmt.Sprintf("%v", flagIsStaff),
	...
	cmd.Flags().BoolVar(&flagIsStaff, "is-staff", false, "Is staff")
