...
but do not stop the import.`,
  ...
  posthog-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  posthog-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | posthog-pp-cli import <resource> --input -`,
