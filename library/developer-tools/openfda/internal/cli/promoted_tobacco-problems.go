...
func newTobaccoProblemsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "tobacco-problems", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagProductType, "type", "", "Product type (cigarettes, e-cigarettes, etc.)")
