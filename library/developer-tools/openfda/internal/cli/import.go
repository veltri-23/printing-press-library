...
but do not stop the import.`,
  ...
  openfda-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  openfda-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | openfda-pp-cli import <resource> --input -`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if pathErr != nil {
				return fmt.Errorf("unknown resource %q: %w", resource, pathErr)
			}
