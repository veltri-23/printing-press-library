...
func newSubstancePromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "substance", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagSubstanceName, "name", "", "Substance name")
