...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  docker-hub-pp-cli which "stale tickets"
  docker-hub-pp-cli which "bottleneck"
  docker-hub-pp-cli which --limit 1 "send message"
  docker-hub-pp-cli which                                # list the full capability index`,
