...
but do not stop the import.`,
  ...
  docker-hub-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  docker-hub-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | docker-hub-pp-cli import <resource> --input -`,
