...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "docker-hub-pp-cli",
		Short: "Manage docker-hub resources via the docker-hub API",
		Long: `Manage docker-hub resources via the docker-hub API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'docker-hub-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("docker-hub-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'docker-hub-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDockerHubSearchPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("docker-hub-pp-cli %s\n", version)
		},
	}
}
