...
large datasets as it has no memory pressure.`,
  ...
  docker-hub-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  docker-hub-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  docker-hub-pp-cli export <resource> --format jsonl | jq '.id'`,
