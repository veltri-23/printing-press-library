...
Resource scoping:
  ...
  pdok-location-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  pdok-location-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  pdok-location-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  pdok-location-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  pdok-location-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/pdok-location-pp-cli/data.db)")
...
func defaultSyncResources() []string {
	return []string{
		"collections",
		"collections-adres",
		"collections-functioneel-gebied",
		"collections-gebouw",
		"collections-gemeentegebied",
		"collections-geografisch-gebied",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"collections":                    "/kadaster/location-api/v1/collections",
		"collections-adres":              "/kadaster/location-api/v1/collections/adres",
		"collections-functioneel-gebied": "/kadaster/location-api/v1/collections/functioneel_gebied",
		"collections-gebouw":             "/kadaster/location-api/v1/collections/gebouw",
		"collections-gemeentegebied":     "/kadaster/location-api/v1/collections/gemeentegebied",
		"collections-geografisch-gebied": "/kadaster/location-api/v1/collections/geografisch_gebied",
		"collections-inrichtingselement": "/kadaster/location-api/v1/collections/inrichtingselement",
		"collections-perceel":            "/kadaster/location-api/v1/collections/perceel",
		"collections-plaats":             "/kadaster/location-api/v1/collections/plaats",
		"collections-provinciegebied":    "/kadaster/location-api/v1/collections/provinciegebied",
		"collections-spoorbaandeel":      "/kadaster/location-api/v1/collections/spoorbaandeel",
		"collections-waterdeel":          "/kadaster/location-api/v1/collections/waterdeel",
		"collections-wegdeel":            "/kadaster/location-api/v1/collections/wegdeel",
		"collections-woonplaats":         "/kadaster/location-api/v1/collections/woonplaats",
		"free":                           "/bzk/locatieserver/search/v3_1/free",
		"reverse":                        "/bzk/locatieserver/search/v3_1/reverse",
	}
