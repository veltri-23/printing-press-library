...
but do not stop the import.`,
  ...
  pdok-location-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pdok-location-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pdok-location-pp-cli import <resource> --input -`,
