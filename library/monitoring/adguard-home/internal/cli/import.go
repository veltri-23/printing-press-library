...
but do not stop the import.`,
  ...
  adguard-home-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  adguard-home-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | adguard-home-pp-cli import <resource> --input -`,
