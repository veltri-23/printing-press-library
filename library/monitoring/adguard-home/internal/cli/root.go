...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "adguard-home-pp-cli",
		Short: "Manage adguard-home resources via the adguard-home API",
		Long: `Manage adguard-home resources via the adguard-home API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'adguard-home-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("adguard-home-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'adguard-home-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAccessCmd(flags))
	rootCmd.AddCommand(newAdguardHomeProfileCmd(flags))
	rootCmd.AddCommand(newAppleCmd(flags))
	rootCmd.AddCommand(newBlockedServicesCmd(flags))
	rootCmd.AddCommand(newClientsCmd(flags))
	rootCmd.AddCommand(newDhcpCmd(flags))
	rootCmd.AddCommand(newFilteringCmd(flags))
	rootCmd.AddCommand(newI18nCmd(flags))
	rootCmd.AddCommand(newInstallCmd(flags))
	rootCmd.AddCommand(newParentalCmd(flags))
	rootCmd.AddCommand(newQuerylogCmd(flags))
	rootCmd.AddCommand(newRewriteCmd(flags))
	rootCmd.AddCommand(newSafebrowsingCmd(flags))
	rootCmd.AddCommand(newSafesearchCmd(flags))
	rootCmd.AddCommand(newStatsCmd(flags))
	rootCmd.AddCommand(newTlsCmd(flags))
	...
	rootCmd.AddCommand(newCacheClearPromotedCmd(flags))
	rootCmd.AddCommand(newDnsConfigPromotedCmd(flags))
	rootCmd.AddCommand(newDnsInfoPromotedCmd(flags))
	rootCmd.AddCommand(newLoginPromotedCmd(flags))
	rootCmd.AddCommand(newLogoutPromotedCmd(flags))
	rootCmd.AddCommand(newProtectionPromotedCmd(flags))
	rootCmd.AddCommand(newQuerylogClearPromotedCmd(flags))
	rootCmd.AddCommand(newQuerylogConfigPromotedCmd(flags))
	rootCmd.AddCommand(newQuerylogInfoPromotedCmd(flags))
	rootCmd.AddCommand(newStatsConfigPromotedCmd(flags))
	rootCmd.AddCommand(newStatsInfoPromotedCmd(flags))
	rootCmd.AddCommand(newStatsResetPromotedCmd(flags))
	rootCmd.AddCommand(newStatusPromotedCmd(flags))
	rootCmd.AddCommand(newTestUpstreamDnsPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("adguard-home-pp-cli %s\n", version)
		},
	}
}
