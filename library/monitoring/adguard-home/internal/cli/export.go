...
large datasets as it has no memory pressure.`,
  ...
  adguard-home-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  adguard-home-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  adguard-home-pp-cli export <resource> --format jsonl | jq '.id'`,
