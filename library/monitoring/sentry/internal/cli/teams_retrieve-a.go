...
func newTeamsRetrieveACmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagExpand, "expand", "", "List of strings to opt in to additional data. Supports `projects`, `externalTeams`.")
	cmd.Flags().StringVar(&flagCollapse, "collapse", "", "List of strings to opt out of certain pieces of data. Supports `organization`.")
