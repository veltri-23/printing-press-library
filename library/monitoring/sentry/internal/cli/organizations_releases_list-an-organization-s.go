...
func newOrganizationsReleasesListAnOrganizationSCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagQuery, "query", "", "This parameter can be used to create a 'starts with' filter for the version.")
