...
func newProjectsSymbolSourcesRetrieveAProjectSCmd(flags *rootFlags) *cobra.Command {
	var flagId string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "symbol-sources", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagId, "id", "", "The ID of the source to look up. If this is not provided, all sources are returned.")
