...
var whichIndex = []whichEntry{
	...
	{Command: "export", Description: "Export Sentry resources for incident reports, audits, and handoff packets.", Group: "Local incident memory", WhyItMatters: "Use this when incident evidence needs to move between tools without additional API calls."},
	{Command: "sync", Description: "Populate local SQLite state that powers repeated search, analytics, and export workflows.", Group: "Local incident memory", WhyItMatters: "Use this before offline or repeated incident triage queries."},
}
