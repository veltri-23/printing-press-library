...
but do not stop the import.`,
  ...
  sentry-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sentry-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sentry-pp-cli import <resource> --input -`,
