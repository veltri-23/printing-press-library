...
func newOrganizationsScimProvisionANewTeamCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyDisplayName, "display-name", "", "The slug of the team that is shown in the UI.")
