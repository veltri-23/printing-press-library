...
large datasets as it has no memory pressure.`,
  ...
  sentry-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  sentry-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  sentry-pp-cli export <resource> --format jsonl | jq '.id'`,
