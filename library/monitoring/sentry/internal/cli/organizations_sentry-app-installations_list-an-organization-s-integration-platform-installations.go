...
func newOrganizationsSentryAppInstallationsListAnOrganizationSIntegrationPlatformInstallationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "sentry-app-installations", path, map[string]string{
