...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  hayward-omnilogic-pp-cli doctor
  hayward-omnilogic-pp-cli doctor --json
  hayward-omnilogic-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Check OmniLogic auth: env vars + cached token + live login probe.
			doctorOmnilogicAuth(report, flags)
