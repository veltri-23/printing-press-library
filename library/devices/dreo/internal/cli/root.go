...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "dreo-pp-cli",
		Short: `Control Dreo smart fans, heaters, air purifiers, humidifiers, and ACs from the command line.`,
		Long: `Control Dreo smart fans, heaters, air purifiers, humidifiers, and ACs from the command line.
...
Health check: run 'dreo-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("dreo-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'dreo-pp-cli profile list')")
	...
	rootCmd.AddCommand(newFirmwarePromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	// Novel features (hand-written) — see internal/cli/*.go (set, bulk, watch, sensors, alerts, scene, rooms).
	rootCmd.AddCommand(newSetCmd(flags))
	rootCmd.AddCommand(newBulkCmd(flags))
	rootCmd.AddCommand(newWatchCmd(flags))
	rootCmd.AddCommand(newSensorsCmd(flags))
