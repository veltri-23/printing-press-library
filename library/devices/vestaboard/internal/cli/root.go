...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "vestaboard-pp-cli",
		Short: `Vestaboard CLI — Read, render, and write your Vestaboard from the terminal — with a board preview and character-code table no other Vest…`,
		Long: `Vestaboard CLI — Read, render, and write your Vestaboard from the terminal — with a board preview and character-code table no other Vest…
...
Health check: run 'vestaboard-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("vestaboard-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'vestaboard-pp-cli profile list')")
	...
	rootCmd.AddCommand(newTransitionCmd(flags))
	...
	rootCmd.AddCommand(newNovelCharactersCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newVbmlPromotedCmd(flags))
