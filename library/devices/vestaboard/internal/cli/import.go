...
but do not stop the import.`,
  ...
  vestaboard-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  vestaboard-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | vestaboard-pp-cli import <resource> --input -`,
