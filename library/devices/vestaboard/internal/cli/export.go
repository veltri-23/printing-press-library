...
large datasets as it has no memory pressure.`,
  ...
  vestaboard-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  vestaboard-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  vestaboard-pp-cli export <resource> --format jsonl | jq '.id'`,
