...
but do not stop the import.`,
  ...
  adminbyrequest-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  adminbyrequest-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | adminbyrequest-pp-cli import <resource> --input -`,
