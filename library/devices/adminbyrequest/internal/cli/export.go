...
large datasets as it has no memory pressure.`,
  ...
  adminbyrequest-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  adminbyrequest-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  adminbyrequest-pp-cli export <resource> --format jsonl | jq '.id'`,
