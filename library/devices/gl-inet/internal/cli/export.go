...
large datasets as it has no memory pressure.`,
  ...
  gl-inet-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  gl-inet-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  gl-inet-pp-cli export <resource> --format jsonl | jq '.id'`,
