...
but do not stop the import.`,
  ...
  gl-inet-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  gl-inet-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | gl-inet-pp-cli import <resource> --input -`,
