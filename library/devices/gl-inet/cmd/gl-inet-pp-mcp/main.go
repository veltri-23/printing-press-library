...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/devices/gl-inet/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "gl-inet-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
