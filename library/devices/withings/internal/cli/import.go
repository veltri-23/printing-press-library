...
but do not stop the import.`,
  ...
  withings-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  withings-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | withings-pp-cli import <resource> --input -`,
