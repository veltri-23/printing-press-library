...
large datasets as it has no memory pressure.`,
  ...
  food52-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  food52-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  food52-pp-cli export <resource> --format jsonl | jq '.id'`,
