...
func newArticlesGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <slug>",
		Short:       "Get a Food52 article (story) by slug",
		Example:     "  food52-pp-cli articles get example-value",
		Annotations: map[string]string{"pp:endpoint": "articles.get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun {
				data, err = extractHTMLResponse(data, htmlExtractionOptions{
					...
					JSONPath:       "props.pageProps.blogPost",
				})
				if err != nil {
					return err
				}
