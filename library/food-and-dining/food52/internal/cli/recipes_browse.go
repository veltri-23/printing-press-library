...
func newRecipesBrowseCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  food52-pp-cli recipes browse example-value",
		Annotations: map[string]string{"pp:endpoint": "recipes.browse", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun {
				data, err = extractHTMLResponse(data, htmlExtractionOptions{
					...
					JSONPath:       "props.pageProps.recipesByTag",
				})
				if err != nil {
					return err
				}
