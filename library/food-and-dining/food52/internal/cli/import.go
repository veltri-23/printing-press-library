...
but do not stop the import.`,
  ...
  food52-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  food52-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | food52-pp-cli import <resource> --input -`,
