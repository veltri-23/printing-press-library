...
but do not stop the import.`,
  ...
  recipe-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  recipe-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | recipe-goat-pp-cli import <resource> --input -`,
