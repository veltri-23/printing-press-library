...
large datasets as it has no memory pressure.`,
  ...
  recipe-goat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  recipe-goat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  recipe-goat-pp-cli export <resource> --format jsonl | jq '.id'`,
