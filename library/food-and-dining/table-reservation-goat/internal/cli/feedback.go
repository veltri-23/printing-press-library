...
func FeedbackEndpointConfigured() bool {
	return os.Getenv("TABLE_RESERVATION_GOAT_FEEDBACK_ENDPOINT") != ""
}
...
func feedbackAutoSend() bool {
	v := strings.ToLower(strings.TrimSpace(os.Getenv("TABLE_RESERVATION_GOAT_FEEDBACK_AUTO_SEND")))
...
maintainer sees it.`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			entry := FeedbackEntry{
				Text:      text,
				CLI:       "table-reservation-goat-pp-cli",
				Version:   version,
