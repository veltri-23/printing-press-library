...
var readCommandResources = map[string][]string{
	"pagliacci-pp-cli address":         {"address"},
	"pagliacci-pp-cli address list":    {"address"},
	"pagliacci-pp-cli address get":     {"address"},
	"pagliacci-pp-cli address search":  {"address"},
	"pagliacci-pp-cli credit":          {"credit"},
	"pagliacci-pp-cli credit list":     {"credit"},
	"pagliacci-pp-cli credit get":      {"credit"},
	"pagliacci-pp-cli credit search":   {"credit"},
	"pagliacci-pp-cli customer":        {"customer"},
	"pagliacci-pp-cli customer list":   {"customer"},
	"pagliacci-pp-cli customer get":    {"customer"},
	"pagliacci-pp-cli customer search": {"customer"},
	"pagliacci-pp-cli gifts":           {"gifts"},
	"pagliacci-pp-cli gifts list":      {"gifts"},
	"pagliacci-pp-cli gifts get":       {"gifts"},
	"pagliacci-pp-cli gifts search":    {"gifts"},
	"pagliacci-pp-cli orders":          {"orders"},
	"pagliacci-pp-cli orders list":     {"orders"},
	"pagliacci-pp-cli orders get":      {"orders"},
	"pagliacci-pp-cli orders search":   {"orders"},
	"pagliacci-pp-cli store":           {"store"},
	"pagliacci-pp-cli store list":      {"store"},
	"pagliacci-pp-cli store get":       {"store"},
	"pagliacci-pp-cli store search":    {"store"},
}
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	dbPath := defaultDBPath("pagliacci-pp-cli")
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale pagliacci-pp-cli cache (refresh failed: %v)\n", err)
