...
but do not stop the import.`,
  ...
  pagliacci-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pagliacci-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pagliacci-pp-cli import <resource> --input -`,
