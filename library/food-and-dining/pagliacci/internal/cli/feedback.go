...
func feedbackFilePath() (string, error) {
	...
	dir := filepath.Join(home, ".pagliacci-pp-cli")
...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "pagliacci-pp-cli/feedback")
...
func newFeedbackCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Feedback is captured locally first at ~/.pagliacci-pp-cli/feedback.jsonl.
