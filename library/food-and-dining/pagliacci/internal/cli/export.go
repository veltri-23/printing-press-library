...
large datasets as it has no memory pressure.`,
  ...
  pagliacci-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pagliacci-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pagliacci-pp-cli export <resource> --format jsonl | jq '.id'`,
