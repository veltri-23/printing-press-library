...
type rootFlags struct {
	...
	// invocation. Mirrors the JIMMY_JOHNS_NO_LEARN env var.
	noLearn bool
...
Run 'jimmy-johns-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("jimmy-johns-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'jimmy-johns-pp-cli profile list')")
