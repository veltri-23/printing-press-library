...
large datasets as it has no memory pressure.`,
  ...
  jimmy-johns-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  jimmy-johns-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  jimmy-johns-pp-cli export <resource> --format jsonl | jq '.id'`,
