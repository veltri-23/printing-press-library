...
but do not stop the import.`,
  ...
  jimmy-johns-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  jimmy-johns-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | jimmy-johns-pp-cli import <resource> --input -`,
