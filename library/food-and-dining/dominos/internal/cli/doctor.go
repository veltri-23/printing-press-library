...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  dominos-pp-cli doctor
  dominos-pp-cli doctor --json
  dominos-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export DOMINOS_USERNAME=<your-key>"
				} else {
			...
			if os.Getenv("DOMINOS_USERNAME") != "" {
				authEnvSet = append(authEnvSet, "DOMINOS_USERNAME")
			} else {
				authEnvInfo = append(authEnvInfo, "DOMINOS_USERNAME set during auth login")
			}
			if os.Getenv("DOMINOS_PASSWORD") != "" {
				authEnvSet = append(authEnvSet, "DOMINOS_PASSWORD")
			} else {
				authEnvInfo = append(authEnvInfo, "DOMINOS_PASSWORD set during auth login")
			}
			if os.Getenv("DOMINOS_TOKEN") != "" || (cfg != nil && cfg.AuthHeader() != "") {
				authEnvSet = append(authEnvSet, "DOMINOS_TOKEN")
			} else {
