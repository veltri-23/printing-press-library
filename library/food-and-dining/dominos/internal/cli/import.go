...
but do not stop the import.`,
  ...
  dominos-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  dominos-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | dominos-pp-cli import <resource> --input -`,
