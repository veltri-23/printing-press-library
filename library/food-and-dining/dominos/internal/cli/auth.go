	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !authed {
				...
				fmt.Fprintln(w, "  export DOMINOS_USERNAME=\"your-token-here\"")
				fmt.Fprintln(w, "  export DOMINOS_PASSWORD=\"your-token-here\"")
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("DOMINOS_USERNAME") != "" {
				envStillSet = "DOMINOS_USERNAME"
			}
			if envStillSet == "" && os.Getenv("DOMINOS_PASSWORD") != "" {
				envStillSet = "DOMINOS_PASSWORD"
			}
			if envStillSet == "" && os.Getenv("DOMINOS_TOKEN") != "" {
				envStillSet = "DOMINOS_TOKEN"
			}
