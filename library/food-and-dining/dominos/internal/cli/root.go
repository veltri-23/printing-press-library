...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "dominos-pp-cli",
		Short: `Order pizza, browse menus, optimize deals, and track delivery from your terminal — with a local SQLite store that powers reorder, price comparison, and deal stacking no other Domino's tool offers.`,
		Long: `Order pizza, browse menus, optimize deals, and track delivery from your terminal — with a local SQLite store that powers reorder, price comparison, and deal stacking no other Domino's tool offers.
...
Health check: run 'dominos-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'dominos-pp-cli profile list')")
	...
	rootCmd.AddCommand(newMenuPromotedCmd(flags))
	rootCmd.AddCommand(newTrackingPromotedCmd(flags))
	...
	rootCmd.AddCommand(newOrderQuickCmd(flags))
