...
but do not stop the import.`,
  ...
  coffee-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  coffee-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | coffee-goat-pp-cli import <resource> --input -`,
