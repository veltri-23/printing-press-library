...
large datasets as it has no memory pressure.`,
  ...
  coffee-goat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  coffee-goat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  coffee-goat-pp-cli export <resource> --format jsonl | jq '.id'`,
