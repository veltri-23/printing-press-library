...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "coffee-goat-pp-cli",
		Short: `The third-wave coffee terminal — search across roasters, lookup Hoffmann/Hedrick clips, map your SCA flavor wheel, recommend bags for friends, and let the God cup recommender pick your next pour.`,
		Long: `The third-wave coffee terminal — search across roasters, lookup Hoffmann/Hedrick clips, map your SCA flavor wheel, recommend bags for friends, and let the God cup recommender pick your next pour.
...
Health check: run 'coffee-goat-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("coffee-goat-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'coffee-goat-pp-cli profile list')")
	...
	// Coffee-goat novel commands
	rootCmd.AddCommand(newSearchCmd(flags))
	rootCmd.AddCommand(newWatchCmd(flags))
	rootCmd.AddCommand(newTwinCmd(flags))
	rootCmd.AddCommand(newCreatorReviewCmd(flags))
	rootCmd.AddCommand(newFlavorWheelCmd(flags))
	rootCmd.AddCommand(newFriendPickCmd(flags))
	rootCmd.AddCommand(newGodCupCmd(flags))
	rootCmd.AddCommand(newBrewsCmd(flags))
	rootCmd.AddCommand(newCompareCmd(flags))
	rootCmd.AddCommand(newProducerCmd(flags))
	rootCmd.AddCommand(newTranscriptSearchCmd(flags))
	rootCmd.AddCommand(newShelfCmd(flags))
	rootCmd.AddCommand(newDialInCmd(flags))
	rootCmd.AddCommand(newWhatsNextCmd(flags))
	rootCmd.AddCommand(newDriftCmd(flags))
	rootCmd.AddCommand(newBagLifeCmd(flags))
	rootCmd.AddCommand(newRefillPlanCmd(flags))
	rootCmd.AddCommand(newBlindCupCmd(flags))
	rootCmd.AddCommand(newPalateMapCmd(flags))
	rootCmd.AddCommand(newFXCmd(flags))
	rootCmd.AddCommand(newRecipeReplayCmd(flags))
	rootCmd.AddCommand(newBudgetCmd(flags))
	rootCmd.AddCommand(newCoffeeMapCmd(flags))
	rootCmd.AddCommand(newPredictRatingCmd(flags))
	rootCmd.AddCommand(newCuppingCmd(flags))
	rootCmd.AddCommand(newChampionReplayCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("coffee-goat-pp-cli %s\n", version)
		},
	}
}
