...
func newRestaurantsShowCmd(flags *rootFlags) *cobra.Command {
	var flagSlug string
	...
	cmd.Flags().StringVar(&flagSlug, "slug", "", "Restaurant short slug (e.g. mixsushibarlin)")
