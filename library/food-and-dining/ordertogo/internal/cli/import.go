...
but do not stop the import.`,
  ...
  ordertogo-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ordertogo-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ordertogo-pp-cli import <resource> --input -`,
