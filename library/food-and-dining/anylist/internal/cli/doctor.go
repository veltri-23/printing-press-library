...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  anylist-pp-cli doctor
  anylist-pp-cli doctor --json
  anylist-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export ANYLIST_ACCESS_TOKEN=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("ANYLIST_ACCESS_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "ANYLIST_ACCESS_TOKEN")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "ANYLIST_ACCESS_TOKEN")
			}
			switch {
			...
			if cfg != nil {
				report["cache"] = collectCacheReport(cfg)
			}
