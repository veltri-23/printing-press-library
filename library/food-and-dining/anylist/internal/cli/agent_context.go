...
type agentContext struct {
	...
	CacheStats                 *agentContextCacheStats `json:"cache_stats,omitempty"`
}
...
type agentContextCacheStats struct {
...
func buildAgentContext(rootCmd *cobra.Command) agentContext {
	...
	return agentContext{
		...
		CacheStats:                 loadAgentContextCacheStats(),
	}
}

// loadAgentContextCacheStats reads the local SQLite store and returns a
// summary of available cached data for agents to know what is queryable
// offline without an additional sync call.
func loadAgentContextCacheStats() *agentContextCacheStats {
	...
	if err != nil {
		return &agentContextCacheStats{Status: "unavailable"}
	}
	defer st.Close()
