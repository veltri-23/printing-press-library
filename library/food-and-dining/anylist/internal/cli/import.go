...
but do not stop the import.`,
  ...
  anylist-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  anylist-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | anylist-pp-cli import <resource> --input -`,
