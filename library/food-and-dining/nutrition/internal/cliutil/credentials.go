...
type Credentials struct {
	...
	FdcApiKey     string    `toml:"api_key,omitempty"`
	// UsdaApiKey is the USDA_API_KEY env alias; it must not share the persisted
	// "api_key" key with FdcApiKey. A duplicate toml tag made credentials.toml
	// decode land the on-disk api_key in UsdaApiKey (FdcApiKey left empty) and
	// risked duplicate-key emission on write. FdcApiKey is the sole persisted
	// field; nothing writes UsdaApiKey into a Credentials record.
