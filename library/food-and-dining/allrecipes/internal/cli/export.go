...
large datasets as it has no memory pressure.`,
  ...
  allrecipes-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  allrecipes-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  allrecipes-pp-cli export <resource> --format jsonl | jq '.id'`,
