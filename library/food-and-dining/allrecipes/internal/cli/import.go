...
but do not stop the import.`,
  ...
  allrecipes-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  allrecipes-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | allrecipes-pp-cli import <resource> --input -`,
