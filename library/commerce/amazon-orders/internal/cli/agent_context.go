...
func buildAgentContext(rootCmd *cobra.Command) agentContext {
	...
	return agentContext{
		...
		CLI: agentContextCLI{
			...
			Description: "Walk your Amazon order history offline — every order, item, shipment, and dollar in a local SQLite store no other...",
...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://www.amazon.com/gp/your-account/order-history",
		EntryCount:    6,
		APIEntryCount: 6,
		Reachability:  "standard_http (95% confidence)",
		Protocols: []string{
			"html_cookie (85% confidence)",
		},
