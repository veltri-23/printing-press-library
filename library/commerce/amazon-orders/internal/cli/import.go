...
but do not stop the import.`,
  ...
  amazon-orders-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  amazon-orders-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | amazon-orders-pp-cli import <resource> --input -`,
