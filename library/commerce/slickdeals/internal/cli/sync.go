...
Exit codes & warnings:
  ...
  slickdeals-pp-cli sync

  # Sync specific resources only
  slickdeals-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  slickdeals-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  slickdeals-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  slickdeals-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  slickdeals-pp-cli sync --latest-only`,
...
func defaultSyncResources() []string {
	return []string{
		"ajax",
		"frontpage",
		"frontpage-recommendation-carousel-recommendations",
		"web-api",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"ajax":      "/ajax/bSubNavPlacement.php",
		"frontpage": "/frontpage/promoted-content/json",
		"frontpage-recommendation-carousel-recommendations": "/frontpage/recommendation-carousel/recommendations",
		"web-api": "/web-api/frontpage/missed-deals/",
	}
