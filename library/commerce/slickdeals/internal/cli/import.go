...
but do not stop the import.`,
  ...
  slickdeals-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  slickdeals-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | slickdeals-pp-cli import <resource> --input -`,
