...
but do not stop the import.`,
  ...
  craigslist-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  craigslist-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | craigslist-pp-cli import <resource> --input -`,
