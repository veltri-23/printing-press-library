...
large datasets as it has no memory pressure.`,
  ...
  craigslist-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  craigslist-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  craigslist-pp-cli export <resource> --format jsonl | jq '.id'`,
