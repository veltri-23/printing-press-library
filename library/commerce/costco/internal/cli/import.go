...
but do not stop the import.`,
  ...
  costco-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  costco-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | costco-pp-cli import <resource> --input -`,
