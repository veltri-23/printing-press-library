...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "worten-pp-cli",
		Short: "Manage worten resources via the worten API",
		Long: `Manage worten resources via the worten API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'worten-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("worten-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'worten-pp-cli profile list')")
	...
	rootCmd.AddCommand(newWortenApiCmd(flags))
