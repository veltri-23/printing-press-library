...
but do not stop the import.`,
  ...
  worten-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  worten-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | worten-pp-cli import <resource> --input -`,
