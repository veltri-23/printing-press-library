...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/commerce/worten/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "worten-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
