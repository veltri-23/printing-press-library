...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "restaurant365-odata-pp-cli",
		Short: "Inspect and export Restaurant365 OData reporting views",
		Long: `Inspect and export Restaurant365 OData reporting views.

Add --agent to any command for JSON output + non-interactive mode.
Run 'restaurant365-odata-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("restaurant365-odata-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'restaurant365-odata-pp-cli profile list')")
	...
	rootCmd.AddCommand(newR365ListViewsCmd(flags))
	rootCmd.AddCommand(newR365DescribeViewCmd(flags))
	rootCmd.AddCommand(newR365SampleCmd(flags))
	rootCmd.AddCommand(newR365BackfillPlanCmd(flags))
	rootCmd.AddCommand(newR365DeletedRecordsCmd(flags))
	rootCmd.AddCommand(newR365ExportCmd(flags))
	rootCmd.AddCommand(newWorkflowCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newCompanyPromotedCmd(flags))
	rootCmd.AddCommand(newEmployeePromotedCmd(flags))
	rootCmd.AddCommand(newEntityDeletedPromotedCmd(flags))
	rootCmd.AddCommand(newGlAccountPromotedCmd(flags))
	rootCmd.AddCommand(newGlaccountPromotedCmd(flags))
	rootCmd.AddCommand(newItemPromotedCmd(flags))
	rootCmd.AddCommand(newJobTitlePromotedCmd(flags))
	rootCmd.AddCommand(newLaborDetailPromotedCmd(flags))
	rootCmd.AddCommand(newLocationPromotedCmd(flags))
	rootCmd.AddCommand(newMetadataPromotedCmd(flags))
	rootCmd.AddCommand(newPayrollSummaryPromotedCmd(flags))
	rootCmd.AddCommand(newPosemployeePromotedCmd(flags))
	rootCmd.AddCommand(newSalesDetailPromotedCmd(flags))
	rootCmd.AddCommand(newSalesEmployeePromotedCmd(flags))
	rootCmd.AddCommand(newSalesPaymentPromotedCmd(flags))
	rootCmd.AddCommand(newTransactionPromotedCmd(flags))
	rootCmd.AddCommand(newTransactionDetailPromotedCmd(flags))
