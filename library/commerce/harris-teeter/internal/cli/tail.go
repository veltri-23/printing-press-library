...
native streaming instead of polling.`,
  ...
  harris-teeter-pp-cli tail --interval 10s

  # Tail a specific resource
  harris-teeter-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  harris-teeter-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
