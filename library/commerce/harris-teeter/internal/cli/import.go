...
but do not stop the import.`,
  ...
  harris-teeter-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  harris-teeter-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | harris-teeter-pp-cli import <resource> --input -`,
