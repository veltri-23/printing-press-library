...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "harris-teeter-pp-cli",
		Short: "Manage harris-teeter resources via the harris-teeter API",
		Long: `Manage harris-teeter resources via the harris-teeter API.
...
Run 'harris-teeter-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("harris-teeter-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'harris-teeter-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCartPromotedCmd(flags))
	rootCmd.AddCommand(newCouponsPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("harris-teeter-pp-cli %s\n", version)
		},
	}
}
