...
Exit codes & warnings:
  ...
  harris-teeter-pp-cli sync

  # Sync specific resources only
  harris-teeter-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  harris-teeter-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  harris-teeter-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  harris-teeter-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  harris-teeter-pp-cli sync --latest-only`,
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"cart":     "/atlas/v1/carts",
		"coupons":  "/atlas/v1/savings-coupons/v1/coupons",
		"lists":    "/atlas/v1/shopping-list/v1/shopping-lists",
		"products": "/atlas/v1/search/v1/products-search",
	}
