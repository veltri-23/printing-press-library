...
native streaming instead of polling.`,
  ...
  amazon-seller-pp-cli tail --interval 10s

  # Tail a specific resource
  amazon-seller-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  amazon-seller-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
