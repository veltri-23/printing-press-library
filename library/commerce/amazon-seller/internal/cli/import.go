...
but do not stop the import.`,
  ...
  amazon-seller-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  amazon-seller-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | amazon-seller-pp-cli import <resource> --input -`,
