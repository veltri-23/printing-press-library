...
var whichIndex = []whichEntry{
	{Command: "catalog get", Description: "Get one catalog item by ASIN.", Group: "catalog"},
	{Command: "catalog search", Description: "Search catalog items. Provide marketplaceIds plus one valid search mode such as keywords or identifiers with identifiersType.", Group: "catalog"},
	{Command: "fba-inventory list", Description: "List FBA inventory summaries. For North America marketplace-level inventory, pass granularityType=Marketplace, granularityId=ATVPDKIKX0DER, and marketplaceIds=ATVPDKIKX0DER.", Group: "fba-inventory"},
	{Command: "listings get", Description: "Get one listing item by seller ID and SKU.", Group: "listings"},
	{Command: "listings search", Description: "Search listing items for a seller.", Group: "listings"},
	{Command: "orders get", Description: "Get one Orders API v2026-01-01 order.", Group: "orders"},
	{Command: "orders search", Description: "Search orders. Provide exactly one of createdAfter or lastUpdatedAfter; Amazon returns 400 for invalid combinations.", Group: "orders"},
	{Command: "reports create", Description: "Create a report request. Prefer --stdin for JSON bodies so marketplaceIds remains a JSON array and reportOptions remains a JSON object.", Group: "reports"},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  amazon-seller-pp-cli which "stale tickets"
  amazon-seller-pp-cli which "bottleneck"
  amazon-seller-pp-cli which --limit 1 "send message"
  amazon-seller-pp-cli which                                # list the full capability index`,
