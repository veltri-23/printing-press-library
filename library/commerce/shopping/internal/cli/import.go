...
but do not stop the import.`,
  ...
  shopping-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  shopping-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | shopping-pp-cli import <resource> --input -`,
