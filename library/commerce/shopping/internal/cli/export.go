...
large datasets as it has no memory pressure.`,
  ...
  shopping-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  shopping-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  shopping-pp-cli export <resource> --format jsonl | jq '.id'`,
