...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "1688-pp-cli",
		Short: `1688 CLI — The free, offline, agent-native 1688 wholesale sourcing CLI — keyword search with the signals the web UI buries (回头率 re…`,
		Long: `1688 CLI — The free, offline, agent-native 1688 wholesale sourcing CLI — keyword search with the signals the web UI buries (回头率 re…
...
Health check: run '1688-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("1688-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see '1688-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelFactoryFindCmd(flags))
	rootCmd.AddCommand(newNovelRegionSpreadCmd(flags))
	rootCmd.AddCommand(newNovelRepurchaseTopCmd(flags))
	rootCmd.AddCommand(newNovelSupplierReportCmd(flags))
	rootCmd.AddCommand(newNovelWatchCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newOffersPromotedCmd(flags))
