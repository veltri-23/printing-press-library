...
but do not stop the import.`,
  ...
  blacklane-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  blacklane-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | blacklane-pp-cli import <resource> --input -`,
