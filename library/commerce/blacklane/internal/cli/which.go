...
var whichIndex = []whichEntry{
	{Command: "watch", Description: "Track a saved route's price over time and flag drops.", Group: "Local state that compounds", WhyItMatters: "Reach for this to catch chauffeur price drops before a trip."},
	{Command: "compare", Description: "Quote one route across many departure times to find the cheapest.", Group: "Local state that compounds", WhyItMatters: "Use when the pickup time is flexible and price matters."},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  blacklane-pp-cli which "stale tickets"
  blacklane-pp-cli which "bottleneck"
  blacklane-pp-cli which --limit 1 "send message"
  blacklane-pp-cli which                                # list the full capability index`,
