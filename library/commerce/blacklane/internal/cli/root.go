...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "blacklane-pp-cli",
		Short: `Blacklane CLI — Upfront chauffeur quotes from the terminal — transfer and hourly, with a local price history no other tool has.`,
		Long: `Blacklane CLI — Upfront chauffeur quotes from the terminal — transfer and hourly, with a local price history no other tool has.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("blacklane-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'blacklane-pp-cli profile list')")
