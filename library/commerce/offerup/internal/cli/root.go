...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "offerup-pp-cli",
		Short: `Offerup CLI — Search local OfferUp listings from your terminal, keep them in a local database, and spot underpriced deals before anyo…`,
		Long: `Offerup CLI — Search local OfferUp listings from your terminal, keep them in a local database, and spot underpriced deals before anyo…
...
Health check: run 'offerup-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("offerup-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'offerup-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelNewSinceCmd(flags))
