...
but do not stop the import.`,
  ...
  offerup-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  offerup-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | offerup-pp-cli import <resource> --input -`,
