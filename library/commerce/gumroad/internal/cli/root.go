...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "gumroad-pp-cli",
		Short: `Gumroad CLI — Gumroad's seller API as an agent-ready CLI and MCP server.`,
		Long: `Gumroad CLI — Gumroad's seller API as an agent-ready CLI and MCP server.
...
Health check: run 'gumroad-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("gumroad-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'gumroad-pp-cli profile list')")
	...
	rootCmd.AddCommand(newResourceSubscriptionsCmd(flags))
	...
	rootCmd.AddCommand(newSubscribersPromotedCmd(flags))
	rootCmd.AddCommand(newTaxFormsPromotedCmd(flags))
