...
func newTaxFormsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagYear int
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "tax-forms", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().IntVar(&flagYear, "year", 0, "Optional four-digit tax year.")
