...
but do not stop the import.`,
  ...
  gumroad-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  gumroad-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | gumroad-pp-cli import <resource> --input -`,
