...
large datasets as it has no memory pressure.`,
  ...
  gumroad-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  gumroad-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  gumroad-pp-cli export <resource> --format jsonl | jq '.id'`,
