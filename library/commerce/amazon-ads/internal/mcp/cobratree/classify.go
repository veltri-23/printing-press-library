...
const (
	...
	// DestructiveAnnotation marks a runtime-mirrored command as capable of
	// changing external state. Hosts can use this to require explicit approval.
	DestructiveAnnotation = "mcp:destructive"
	// OpenWorldAnnotation marks a runtime-mirrored command as interacting with
	// external systems rather than only local, closed-world data.
