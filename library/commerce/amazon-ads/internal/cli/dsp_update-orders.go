...
func newDspUpdateOrdersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  amazon-ads-pp-cli dsp update-orders",
		Annotations: map[string]string{"pp:endpoint": "dsp.update-orders", "pp:method": "PUT", "pp:path": "/dsp/orders/"},
