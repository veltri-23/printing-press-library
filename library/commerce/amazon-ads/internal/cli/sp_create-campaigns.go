...
func newSpCreateCampaignsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-campaigns",
		Short:       "Creates one or more campaigns. [PLANNED DEPRECATION 6/30/2023]",
		Example:     "  amazon-ads-pp-cli sp create-campaigns",
		Annotations: map[string]string{"pp:endpoint": "sp.create-campaigns", "pp:method": "POST", "pp:path": "/v2/sp/campaigns"},
