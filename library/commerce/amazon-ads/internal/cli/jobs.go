...
// to ~/.amazon-ads-pp-cli/jobs.jsonl; the latest row for a given JobID wins
...
func isJobTerminal(body map[string]any) bool {
	...
	case "done", "complete", "completed", "success", "succeeded", "finished",
		"failure", "failed", "errored", "cancelled", "canceled":
		return true
	}
	return false
}
...
~/.amazon-ads-pp-cli/jobs.jsonl. This command lists, inspects, and prunes them.
