...
but do not stop the import.`,
  ...
  amazon-ads-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  amazon-ads-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | amazon-ads-pp-cli import <resource> --input -`,
