...
func newSdDeleteBrandSafetyDenyListCmd(flags *rootFlags) *cobra.Command {
	var flagWait bool
	var flagWaitTimeout time.Duration
	var flagWaitInterval time.Duration

	cmd := &cobra.Command{
		Use:         "delete-brand-safety-deny-list",
		Short:       "Archives all of the domains in the Brand Safety Deny List.",
		Example:     "  amazon-ads-pp-cli sd delete-brand-safety-deny-list",
		Annotations: map[string]string{"pp:endpoint": "sd.delete-brand-safety-deny-list", "pp:method": "DELETE", "pp:path": "/sd/brandSafety/deny"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if asyncJobID := ExtractJobID(data, "requestId"); asyncJobID != "" {
				_ = RecordJob(JobRow{
					JobID:          asyncJobID,
					Resource:       "sd",
					Endpoint:       "delete-brand-safety-deny-list",
					Status:         "submitted",
					StatusResource: "sd",
					StatusEndpoint: "get",
				})
