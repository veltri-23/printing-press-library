...
func newSbUpdateCampaignsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Mutable fields",
		Example:     "  amazon-ads-pp-cli sb update-campaigns",
		Annotations: map[string]string{"pp:endpoint": "sb.update-campaigns", "pp:method": "PUT", "pp:path": "/sb/campaigns"},
