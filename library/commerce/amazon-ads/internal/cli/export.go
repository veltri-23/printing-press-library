...
large datasets as it has no memory pressure.`,
  ...
  amazon-ads-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  amazon-ads-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  amazon-ads-pp-cli export <resource> --format jsonl | jq '.id'`,
