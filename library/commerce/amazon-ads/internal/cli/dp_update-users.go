...
func newDpUpdateUsersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "update-users",
		Short:       "Deletes user data originally sourced from the client. The API call rate is limited to 1 transactions per second (TPS).",
		Example:     "  amazon-ads-pp-cli dp update-users",
		Annotations: map[string]string{"pp:endpoint": "dp.update-users", "pp:method": "PATCH", "pp:path": "/v2/dp/users"},
