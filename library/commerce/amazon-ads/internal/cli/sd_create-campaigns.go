...
func newSdCreateCampaignsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-campaigns",
		Short:       "Creates one or more campaigns.",
		Example:     "  amazon-ads-pp-cli sd create-campaigns",
		Annotations: map[string]string{"pp:endpoint": "sd.create-campaigns", "pp:method": "POST", "pp:path": "/sd/campaigns"},
