...
Resource scoping:
  ...
  amazon-ads-pp-cli sync

  # Sync specific resources only
  amazon-ads-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  amazon-ads-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  amazon-ads-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  amazon-ads-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  amazon-ads-pp-cli sync --latest-only`,
...
func resourceSupportsPagination(resource string) bool {
	...
	case "amazon-ads-dsp-dsp":
		return true
	case "amazon_mobile_display":
		return true
	case "dsp":
		return true
	case "dsp-apps":
		return true
	case "dsp-domain-lists":
		return true
	case "dsp-geo-locations":
		return true
	case "dsp-iab-content-categories":
		return true
	case "dsp-pre-bid-targeting-oracle-data-cloud-custom-predicts":
		return true
	case "dsp-product-categories":
		return true
	case "dsp-supply-sources":
		return true
	case "invoices":
		return true
	case "measurement":
	...
	case "measurement-dsp":
		return true
	case "measurement-dsp-audience-research":
		return true
	case "measurement-dsp-creative-testing":
		return true
	case "measurement-dsp-omnichannel-metrics":
		return true
	case "measurement-studies-surveys":
		return true
	case "measurement-vendor-products-policies":
		return true
	case "measurement-vendor-products-survey-question-templates":
		return true
	case "overlapping-audiences":
		return true
	case "sb":
		return true
	case "sb-campaigns":
		return true
	case "sb-drafts-campaigns":
		return true
	case "sb-keywords":
		return true
	case "sb-negative-keywords":
		return true
	case "sd":
		return true
	case "sd-ad-groups":
		return true
	case "sd-ad-groups-extended":
		return true
	case "sd-brand-safety-deny":
		return true
	case "sd-campaigns":
		return true
	case "sd-campaigns-extended":
		return true
	case "sd-creatives":
		return true
	case "sd-moderation-creatives":
		return true
	case "sd-negative-targets":
		return true
	case "sd-negative-targets-extended":
		return true
	case "sd-optimization-rules":
		return true
	case "sd-product-ads":
		return true
	case "sd-product-ads-extended":
		return true
	case "sd-targets":
		return true
	case "sd-targets-extended":
		return true
	case "sp":
		return true
	case "sp-ad-groups":
		return true
	case "sp-ad-groups-extended":
		return true
	case "sp-campaign-negative-keywords":
		return true
	case "sp-campaign-negative-keywords-extended":
		return true
	case "sp-campaigns":
		return true
	case "sp-campaigns-extended":
		return true
	case "sp-keywords":
		return true
	case "sp-keywords-extended":
		return true
	case "sp-negative-keywords":
		return true
	case "sp-negative-keywords-extended":
		return true
	case "sp-negative-targets":
		return true
	case "sp-negative-targets-extended":
		return true
	case "sp-product-ads":
		return true
	case "sp-product-ads-extended":
		return true
	case "sp-targets-extended":
		return true
	case "sponsored-brands-sb":
		return true
	case "sponsored-display-sd":
		return true
	case "sponsored-display-sd-deny":
		return true
	case "sponsored-products-sp":
		return true
	case "sponsored-products-sp-recommendations":
		return true
...
func syncResourceFieldSelector(resource string) (string, string) {
	...
	case "amazon-ads-profiles-profiles":
		return "validPaymentMethodFilter", "accountInfo.id,countryCode,currencyCode,dailyBudget,profileId,timezone"
	case "sponsored-brands-sb-categories":
		return "nextToken", "categoryRefinementId,isTargetable,name,parentCategoryRefinementId,translatedName"
	case "sponsored-brands-sb-recommendations":
		return "nextToken", "brandRefinementId,name"
	case "stores":
		return "brandEntityId", "assetID,mediaType,name,url"
	}
	return "", ""
}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "amazon-ads-dsp-dsp":
		return db.UpsertAmazonAdsDspDsp(data)
	case "amazon-ads-profiles-profiles":
		return db.UpsertAmazonAdsProfilesProfiles(data)
	case "amazon-ads-sponsored-reports":
		return db.UpsertAmazonAdsSponsoredReports(data)
	case "amazon_ads_sponsored_reports_download":
		return db.UpsertAmazonAdsSponsoredReportsDownload(data)
	case "audiences":
		return db.UpsertAudiences(data)
	case "benchmarks":
		return db.UpsertBenchmarks(data)
	case "dp":
		return db.UpsertDp(data)
	case "dsp":
		return db.UpsertDsp(data)
	case "dsp-reports-dsp":
		return db.UpsertDspReportsDsp(data)
	case "hsa_report":
		return db.UpsertHsaReport(data)
	case "invoices":
		return db.UpsertInvoices(data)
	case "associate":
		return db.UpsertAssociate(data)
	case "disassociate":
		return db.UpsertDisassociate(data)
	case "measurement":
		return db.UpsertMeasurement(data)
	case "measurement-dsp":
		return db.UpsertMeasurementDsp(data)
	case "media":
		return db.UpsertMedia(data)
	case "pre-moderation":
		return db.UpsertPreModeration(data)
	case "reports_download":
		return db.UpsertReportsDownload(data)
	case "sb":
		return db.UpsertSb(data)
	case "sd":
		return db.UpsertSd(data)
	case "sd_report":
		return db.UpsertSdReport(data)
	case "sd_snapshot":
		return db.UpsertSdSnapshot(data)
	case "sp":
		return db.UpsertSp(data)
	case "sp_report":
		return db.UpsertSpReport(data)
	case "sp_snapshot":
		return db.UpsertSpSnapshot(data)
	case "sponsored-brands-sb":
		return db.UpsertSponsoredBrandsSb(data)
	case "sponsored-display-sd":
		return db.UpsertSponsoredDisplaySd(data)
	case "sponsored_display_sd_snapshot":
		return db.UpsertSponsoredDisplaySdSnapshot(data)
	case "sponsored-products-sp":
		return db.UpsertSponsoredProductsSp(data)
	case "stores":
		return db.UpsertStores(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"dsp-domain-lists",
		"dsp-geo-locations",
		"dsp-iab-content-categories",
		"dsp-pre-bid-targeting-oracle-data-cloud-custom-predicts",
		"dsp-product-categories",
		"dsp-supply-sources",
		"invoices",
		"measurement",
		"measurement-dsp",
		"measurement-dsp-audience-research",
		"measurement-dsp-creative-testing",
		"measurement-dsp-omnichannel-metrics",
		"measurement-studies-surveys",
		"measurement-vendor-products-policies",
		"measurement-vendor-products-survey-question-templates",
		...
		"sd",
		"sd-ad-groups",
		"sd-ad-groups-extended",
		"sd-brand-safety-deny",
		"sd-brand-safety-status",
		"sd-campaigns",
		"sd-campaigns-extended",
		"sd-creatives",
		"sd-moderation-creatives",
		"sd-negative-targets",
		"sd-negative-targets-extended",
		"sd-optimization-rules",
		"sd-product-ads",
		"sd-product-ads-extended",
		"sd-targets",
		"sd-targets-extended",
		"sp",
		"sp-ad-groups",
		"sp-ad-groups-extended",
		"sp-campaign-negative-keywords",
		"sp-campaign-negative-keywords-extended",
		"sp-campaigns",
		"sp-campaigns-extended",
		"sp-keywords",
		"sp-keywords-extended",
		"sp-negative-keywords",
		"sp-negative-keywords-extended",
		"sp-negative-targets",
		"sp-negative-targets-extended",
		"sp-product-ads",
		"sp-product-ads-extended",
		"sp-targets-extended",
		"sponsored-brands-sb",
		"sponsored-brands-sb-categories",
		"sponsored-brands-sb-recommendations",
		"sponsored-display-sd",
		"sponsored-display-sd-deny",
		"sponsored-display-sd-status",
		"sponsored-products-sp",
		"sponsored-products-sp-recommendations",
		"standard_display",
		"stores",
		"video",
	}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"aap_mobile_app":               "/dsp/supplySources?lineItemType=AAP_MOBILE_APP",
		"amazon-ads-dsp-dsp":           "/dsp/advertisers",
		"amazon-ads-profiles-profiles": "/v2/profiles",
		"amazon_mobile_display":        "/dsp/supplySources?lineItemType=AMAZON_MOBILE_DISPLAY",
		"attribution":                  "/attribution/publishers",
		"attribution-advertisers":      "/attribution/advertisers",
		"benchmarks":                   "/benchmarks/brands",
		"brands":                       "/brands",
		"dsp":                          "/insights/audiences/{audienceId}/overlappingAudiences?adType=DSP",
		"dsp-apps":                     "/dsp/apps",
		"dsp-domain-lists":             "/dsp/domainLists",
		"dsp-geo-locations":            "/dsp/geoLocations",
		"dsp-iab-content-categories":   "/dsp/iabContentCategories",
		"dsp-pre-bid-targeting-oracle-data-cloud-custom-predicts": "/dsp/preBidTargeting/oracleDataCloud/customPredicts",
		"dsp-product-categories":                                  "/dsp/productCategories",
		"dsp-supply-sources":                                      "/dsp/supplySources",
		"invoices":                                                "/invoices",
		"measurement":                                             "/measurement/studies",
		"measurement-dsp":                                         "/dsp/measurement/studies/brandLift",
		"measurement-dsp-audience-research":                       "/dsp/measurement/studies/audienceResearch",
		"measurement-dsp-creative-testing":                        "/dsp/measurement/studies/creativeTesting",
		"measurement-dsp-omnichannel-metrics":                     "/dsp/measurement/studies/omnichannelMetrics",
		"measurement-studies-surveys":                             "/measurement/studies/surveys",
		"measurement-vendor-products-policies":                    "/measurement/vendorProducts/policies",
		"measurement-vendor-products-survey-question-templates":   "/measurement/vendorProducts/surveyQuestionTemplates",
		"overlapping-audiences":                                   "/insights/audiences/{audienceId}/overlappingAudiences",
		"profiles":                                                "/v2/profiles",
		"sb":                                                      "/sb/adGroups",
		"sb-campaigns":                                            "/sb/campaigns",
		"sb-drafts-campaigns":                                     "/sb/drafts/campaigns",
		"sb-keywords":                                             "/sb/keywords",
		"sb-negative-keywords":                                    "/sb/negativeKeywords",
		"sd":                                                      "/insights/audiences/{audienceId}/overlappingAudiences?adType=SD",
		"sd-ad-groups":                                            "/sd/adGroups",
		"sd-ad-groups-extended":                                   "/sd/adGroups/extended",
		"sd-brand-safety-deny":                                    "/sd/brandSafety/deny",
		"sd-brand-safety-status":                                  "/sd/brandSafety/status",
		"sd-campaigns":                                            "/sd/campaigns",
		"sd-campaigns-extended":                                   "/sd/campaigns/extended",
		"sd-creatives":                                            "/sd/creatives",
		"sd-moderation-creatives":                                 "/sd/moderation/creatives",
		"sd-negative-targets":                                     "/sd/negativeTargets",
		"sd-negative-targets-extended":                            "/sd/negativeTargets/extended",
		"sd-optimization-rules":                                   "/sd/optimizationRules",
		"sd-product-ads":                                          "/sd/productAds",
		"sd-product-ads-extended":                                 "/sd/productAds/extended",
		"sd-targets":                                              "/sd/targets",
		"sd-targets-extended":                                     "/sd/targets/extended",
		"sp":                                                      "/v2/sp/targets",
		"sp-ad-groups":                                            "/v2/sp/adGroups",
		"sp-ad-groups-extended":                                   "/v2/sp/adGroups/extended",
		"sp-campaign-negative-keywords":                           "/v2/sp/campaignNegativeKeywords",
		"sp-campaign-negative-keywords-extended":                  "/v2/sp/campaignNegativeKeywords/extended",
		"sp-campaigns":                                            "/v2/sp/campaigns",
		"sp-campaigns-extended":                                   "/v2/sp/campaigns/extended",
		"sp-keywords":                                             "/v2/sp/keywords",
		"sp-keywords-extended":                                    "/v2/sp/keywords/extended",
		"sp-negative-keywords":                                    "/v2/sp/negativeKeywords",
		"sp-negative-keywords-extended":                           "/v2/sp/negativeKeywords/extended",
		"sp-negative-targets":                                     "/v2/sp/negativeTargets",
		"sp-negative-targets-extended":                            "/v2/sp/negativeTargets/extended",
		"sp-product-ads":                                          "/v2/sp/productAds",
		"sp-product-ads-extended":                                 "/v2/sp/productAds/extended",
		"sp-targets-extended":                                     "/v2/sp/targets/extended",
		"sponsored-brands-sb":                                     "/sb/budgetRules",
		"sponsored-brands-sb-categories":                          "/sb/targets/categories",
		"sponsored-brands-sb-recommendations":                     "/sb/negativeTargets/brands/recommendations",
		"sponsored-display-sd":                                    "/sd/budgetRules",
		"sponsored-display-sd-deny":                               "/sd/brandSafety/deny",
		"sponsored-display-sd-status":                             "/sd/brandSafety/status",
		"sponsored-products-sp":                                   "/sp/budgetRules",
		"sponsored-products-sp-recommendations":                   "/sp/campaign/recommendations",
		"standard_display":                                        "/dsp/supplySources?lineItemType=STANDARD_DISPLAY",
		"stores":                                                  "/stores/assets",
		"video":                                                   "/dsp/supplySources?lineItemType=VIDEO",
	}
