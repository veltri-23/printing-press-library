...
but do not stop the import.`,
  ...
  shopper-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  shopper-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | shopper-pp-cli import <resource> --input -`,
