...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  shopper-pp-cli which "stale tickets"
  shopper-pp-cli which "bottleneck"
  shopper-pp-cli which --limit 1 "send message"
  shopper-pp-cli which                                # list the full capability index`,
