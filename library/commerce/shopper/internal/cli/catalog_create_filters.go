...
func newCatalogCreateFiltersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "filters",
		Short:       "List filters and facets available for a catalog search",
		Example:     "  shopper-pp-cli catalog filters",
		Annotations: map[string]string{"pp:endpoint": "catalog.create_filters", "pp:method": "POST", "pp:path": "/catalog/search/filters"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				if !cmd.Flags().Changed("brands") && !flags.dryRun {
					return fmt.Errorf("required flag \"%s\" not set", "brands")
				}
