...
Resource scoping:
  ...
  shopper-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  shopper-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  shopper-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  shopper-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  shopper-pp-cli sync --latest-only`,
...
func defaultSyncResources() []string {
	return []string{
		...
		"catalog",
		"catalog-departments",
		"catalog-products-news",
		"catalog-search-suggest",
		"delivery",
		"delivery-v2-calendar",
		"features",
		"features-timer-tick",
		"features-toggle",
		"session",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"catalog-departments":    "/catalog/departments",
		"catalog-products-news":  "/catalog/products/news",
		"catalog-search-suggest": "/catalog/search/suggest",
		"delivery":               "/delivery/summary",
		"delivery-v2-calendar":   "/delivery/v2/calendar",
		"features":               "/features/stores",
		"features-timer-tick":    "/features/timer/tick",
		"features-toggle":        "/features/toggle",
		"session":                "/auth/validation/social",
	}
