...
but do not stop the import.`,
  ...
  doordash-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  doordash-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | doordash-pp-cli import <resource> --input -`,
