...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		Source:        "traffic-analysis+curated-graphql-spec",
		TargetURL:     "https://www.doordash.com/graphql/autocompleteFacetFeed",
		EntryCount:    19,
		APIEntryCount: 19,
		...
		CandidateCommands: []string{
			"create_addCartItem — Curated from DoorDash GraphQL spec; POST /graphql/addCartItem.",
			"create_autocompleteFacetFeed — Curated from DoorDash GraphQL spec; POST /graphql/autocompleteFacetFeed.",
			"create_checkout — Curated from DoorDash GraphQL spec; POST /graphql/checkout.",
			"create_consumerOrderCart — Curated from DoorDash GraphQL spec; POST /graphql/consumerOrderCart.",
			"create_convenienceSearchQuery — Curated from DoorDash GraphQL spec; POST /graphql/convenienceSearchQuery.",
			"create_createOrderFromCart — Curated from DoorDash GraphQL spec; POST /graphql/createOrderFromCart.",
			"create_deleteCart — Curated from DoorDash GraphQL spec; POST /graphql/deleteCart.",
			"create_detailedCartItems — Curated from DoorDash GraphQL spec; POST /graphql/detailedCartItems.",
			"create_getHasNewNotifications — Curated from DoorDash GraphQL spec; POST /graphql/getHasNewNotifications.",
			"create_getOpenCartsCount — Curated from DoorDash GraphQL spec; POST /graphql/getOpenCartsCount.",
			"create_itemPage — Curated from DoorDash GraphQL spec; POST /graphql/itemPage.",
			"create_listCarts — Curated from DoorDash GraphQL spec; POST /graphql/listCarts.",
			"create_pollOrderPaymentStatus — Curated from DoorDash GraphQL spec; POST /graphql/pollOrderPaymentStatus.",
			"create_promoStickyFooter — Curated from DoorDash GraphQL spec; POST /graphql/promoStickyFooter.",
			"create_removeCartItemV2 — Curated from DoorDash GraphQL spec; POST /graphql/removeCartItemV2.",
			"create_storepageFeed — Curated from DoorDash GraphQL spec; POST /graphql/storepageFeed.",
			"create_totalFeeTally — Curated from DoorDash GraphQL spec; POST /graphql/totalFeeTally.",
			"create_updateCartItemV2 — Curated from DoorDash GraphQL spec; POST /graphql/updateCartItemV2.",
			"create_validateConsumerAddressWithAddressLinkId — Curated from DoorDash GraphQL spec; POST /graphql/validateConsumerAddressWithAddressLinkId.",
		},
	}
}
