...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/commerce/shopify/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "shopify-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
