...
but do not stop the import.`,
  ...
  shopify-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  shopify-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | shopify-pp-cli import <resource> --input -`,
