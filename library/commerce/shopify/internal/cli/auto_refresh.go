...
var readCommandResources = map[string][]string{
	...
	"shopify-pp-cli abandoned-checkouts get":    {"abandoned-checkouts"},
	"shopify-pp-cli abandoned-checkouts search": {"abandoned-checkouts"},
