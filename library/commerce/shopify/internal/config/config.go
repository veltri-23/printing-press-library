...
func Load(configPath string) (*Config, error) {
	...
	if v := strings.TrimSpace(os.Getenv("SHOPIFY_SHOP")); v != "" {
		cfg.TemplateVars["shop"] = v
	} else if verifyMode {
		cfg.TemplateVars["shop"] = "shop_placeholder"
	}
	if v := strings.TrimSpace(os.Getenv("SHOPIFY_API_VERSION")); v != "" {
		cfg.TemplateVars["api_version"] = v
	} else if verifyMode {
		cfg.TemplateVars["api_version"] = "api_version_placeholder"
	}
	return cfg, nil
}
