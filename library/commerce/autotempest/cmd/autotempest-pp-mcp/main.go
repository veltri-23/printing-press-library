...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/commerce/autotempest/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "autotempest-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
