...
but do not stop the import.`,
  ...
  grubhub-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  grubhub-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | grubhub-pp-cli import <resource> --input -`,
