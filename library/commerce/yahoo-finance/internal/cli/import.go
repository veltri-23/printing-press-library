...
but do not stop the import.`,
  ...
  yahoo-finance-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  yahoo-finance-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | yahoo-finance-pp-cli import <resource> --input -`,
