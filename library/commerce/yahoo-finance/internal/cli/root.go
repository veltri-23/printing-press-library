...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "yahoo-finance-pp-cli",
		Short: `Yahoo Finance CLI — Every Yahoo Finance endpoint plus a SQLite portfolio, covered-call screener, and Chrome-cookie fallback the libraries d…`,
		Long: `Yahoo Finance CLI — Every Yahoo Finance endpoint plus a SQLite portfolio, covered-call screener, and Chrome-cookie fallback the libraries d…
...
Health check: run 'yahoo-finance-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("yahoo-finance-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'yahoo-finance-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAutocompletePromotedCmd(flags))
	rootCmd.AddCommand(newChartPromotedCmd(flags))
	rootCmd.AddCommand(newFundamentalsPromotedCmd(flags))
	rootCmd.AddCommand(newInsightsPromotedCmd(flags))
	rootCmd.AddCommand(newLookupPromotedCmd(flags))
	rootCmd.AddCommand(newOptionsPromotedCmd(flags))
	rootCmd.AddCommand(newRecommendationsPromotedCmd(flags))
	rootCmd.AddCommand(newScreenerPromotedCmd(flags))
	rootCmd.AddCommand(newTrendingPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	// Hand-authored novel commands (preserve across regen)
	...
	rootCmd.AddCommand(newSparklineCmd(flags))
	rootCmd.AddCommand(newSQLCmd(flags))
	rootCmd.AddCommand(newFXCmd(flags))
	rootCmd.AddCommand(newOptionsChainCmd(flags))
	rootCmd.AddCommand(newAuthCmd(flags))
	rootCmd.AddCommand(newScreenLocalCmd(flags))
	rootCmd.AddCommand(newInsidersExtCmd(flags))
	rootCmd.AddCommand(newOptionsCoveredCallsCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("yahoo-finance-pp-cli %s\n", version)
		},
	}
}
