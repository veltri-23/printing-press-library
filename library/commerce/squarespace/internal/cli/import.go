...
but do not stop the import.`,
  ...
  squarespace-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  squarespace-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | squarespace-pp-cli import <resource> --input -`,
