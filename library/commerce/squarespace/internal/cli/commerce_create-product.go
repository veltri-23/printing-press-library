...
func newCommerceCreateProductCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-product",
		Short:       "Creates a product with appropriate subresources based on product type.",
		Example:     "  squarespace-pp-cli commerce create-product",
		Annotations: map[string]string{"pp:endpoint": "commerce.create-product", "pp:method": "POST", "pp:path": "/v2/commerce/products"},
