...
large datasets as it has no memory pressure.`,
  ...
  ebay-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  ebay-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  ebay-pp-cli export <resource> --format jsonl | jq '.id'`,
