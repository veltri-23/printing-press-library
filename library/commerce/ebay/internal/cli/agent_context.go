...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		Protocols: []string{
			"html_scraping (95% confidence)",
			"rest_json (90% confidence)",
		},
		AuthCandidates: []string{
			"— cookies: cid, s, nonsession, dp1, ebaysid, ds1, ds2, shs, npii",
		},
		Protections: []string{
			"akamai_bot_manager (90% confidence)",
			"forter_fraud (90% confidence)",
			"csrf_signed_request_token (95% confidence)",
		},
		GenerationHints: []string{
			"requires_browser_auth",
			"requires_protected_client",
			"uses_chrome_cookie_import",
			"has_per_request_csrf",
