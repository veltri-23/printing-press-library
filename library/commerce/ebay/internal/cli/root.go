...
#known-limitations.`,
	...
	rootCmd.SetVersionTemplate("ebay-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ebay-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBidCmd(flags))
	...
	rootCmd.AddCommand(newDealPromotedCmd(flags))
	rootCmd.AddCommand(newItemPromotedCmd(flags))
	rootCmd.AddCommand(newListingsPromotedCmd(flags))
	rootCmd.AddCommand(newSoldPromotedCmd(flags))
	rootCmd.AddCommand(newWatchPromotedCmd(flags))
	// Novel transcendence commands (T1-T7).
	rootCmd.AddCommand(newCompCmd(flags))
	rootCmd.AddCommand(newSnipeCmd(flags))
	rootCmd.AddCommand(newAuctionsCmd(flags))
	rootCmd.AddCommand(newBidGroupCmd(flags))
	rootCmd.AddCommand(newFeedCmd(flags))
	rootCmd.AddCommand(newOfferHunterCmd(flags))
	rootCmd.AddCommand(newHistoryCmd(flags))
	rootCmd.AddCommand(newSavedSearchCmd(flags))
