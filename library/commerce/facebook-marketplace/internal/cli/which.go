...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  facebook-marketplace-pp-cli which "stale tickets"
  facebook-marketplace-pp-cli which "bottleneck"
  facebook-marketplace-pp-cli which --limit 1 "send message"
  facebook-marketplace-pp-cli which                                # list the full capability index`,
