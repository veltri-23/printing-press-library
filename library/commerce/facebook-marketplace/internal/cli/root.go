...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "facebook-marketplace-pp-cli",
		Short: `Search, publish, mirror, and manage Facebook Marketplace seller workflows with explicit write checkpoints.`,
		Long: `Search, publish, mirror, and manage Facebook Marketplace seller workflows with explicit write checkpoints.
...
Health check: run 'facebook-marketplace-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("facebook-marketplace-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().BoolVar(&flags.write, "write", false, "Allow mutating Facebook Marketplace requests after a recent passing doctor check")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'facebook-marketplace-pp-cli profile list')")
	...
	rootCmd.AddCommand(newComposerCmd(flags))
	...
	rootCmd.AddCommand(newMarketplaceSearchPromotedCmd(flags))
	rootCmd.AddCommand(newDraftCmd(flags))
	rootCmd.AddCommand(newWatchCmd(flags))
	rootCmd.AddCommand(newMatchesCmd(flags))
	rootCmd.AddCommand(newStaleCmd(flags))
	rootCmd.AddCommand(newSyncCmd(flags))
	rootCmd.AddCommand(newReplyCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("facebook-marketplace-pp-cli %s\n", version)
		},
	}
}
