...
but do not stop the import.`,
  ...
  facebook-marketplace-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  facebook-marketplace-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | facebook-marketplace-pp-cli import <resource> --input -`,
