...
but do not stop the import.`,
  ...
  reno-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  reno-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | reno-goat-pp-cli import <resource> --input -`,
