...
Run 'reno-goat-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("reno-goat-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'reno-goat-pp-cli profile list')")
	...
	rootCmd.AddCommand(newProductSearchCmd(flags))
	...
	rootCmd.AddCommand(newComparePromotedCmd(flags))
