...
large datasets as it has no memory pressure.`,
  ...
  reno-goat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  reno-goat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  reno-goat-pp-cli export <resource> --format jsonl | jq '.id'`,
