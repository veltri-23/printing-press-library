...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/ai/surgegraph/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "surgegraph-facade-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
