...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  surgegraph-pp-cli doctor
  surgegraph-pp-cli doctor --json
  surgegraph-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export SURGEGRAPH_TOKEN=<your-key>"
					report["auth_key_url"] = "https://mcp.surgegraph.io/token"
				} else {
					authConfigured = true
			...
			if os.Getenv("SURGEGRAPH_TOKEN") != "" || authHeader != "" {
				authEnvSet = append(authEnvSet, "SURGEGRAPH_TOKEN")
			} else {
				authEnvInfo = append(authEnvInfo, "SURGEGRAPH_TOKEN set with auth set-token")
			}
			switch {
