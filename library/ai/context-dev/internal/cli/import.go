...
but do not stop the import.`,
  ...
  context-dev-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  context-dev-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | context-dev-pp-cli import <resource> --input -`,
