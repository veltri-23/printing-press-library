...
func newBrandCreateAi2Cmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-ai-2",
		Short:       "Extract product information from a brand's website.",
		Example:     "  context-dev-pp-cli brand create-ai-2",
		Annotations: map[string]string{"pp:endpoint": "brand.create-ai-2", "pp:method": "POST", "pp:path": "/brand/ai/products"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "brand", data, "products")
			}
