...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  context-dev-pp-cli which "stale tickets"
  context-dev-pp-cli which "bottleneck"
  context-dev-pp-cli which --limit 1 "send message"
  context-dev-pp-cli which                                # list the full capability index`,
