...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "elevenlabs-pp-cli",
		Short: "Manage elevenlabs resources via the elevenlabs API",
		Long: `Manage elevenlabs resources via the elevenlabs API.
...
Run 'elevenlabs-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("elevenlabs-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'elevenlabs-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAudioIsolationCmd(flags))
	rootCmd.AddCommand(newAudioNativeCmd(flags))
	rootCmd.AddCommand(newConvaiCmd(flags))
	rootCmd.AddCommand(newDubbingCmd(flags))
	rootCmd.AddCommand(newHistoryCmd(flags))
	rootCmd.AddCommand(newMusicCmd(flags))
	rootCmd.AddCommand(newPronunciationDictionariesCmd(flags))
	rootCmd.AddCommand(newSpeechEngineCmd(flags))
	rootCmd.AddCommand(newSpeechToTextCmd(flags))
	rootCmd.AddCommand(newStudioCmd(flags))
	rootCmd.AddCommand(newTextToDialogueCmd(flags))
	rootCmd.AddCommand(newTextToVoiceCmd(flags))
	rootCmd.AddCommand(newVoiceCmd(flags))
	rootCmd.AddCommand(newTTSCmd(flags))
	rootCmd.AddCommand(newDialogueCmd(flags))
	rootCmd.AddCommand(newUserCmd(flags))
	rootCmd.AddCommand(newVoicesCmd(flags))
	...
	rootCmd.AddCommand(newForcedAlignmentPromotedCmd(flags))
	rootCmd.AddCommand(newModelsPromotedCmd(flags))
	rootCmd.AddCommand(newServiceAccountsPromotedCmd(flags))
	rootCmd.AddCommand(newSharedVoicesPromotedCmd(flags))
	rootCmd.AddCommand(newSimilarVoicesPromotedCmd(flags))
	rootCmd.AddCommand(newSingleUseTokenPromotedCmd(flags))
	rootCmd.AddCommand(newSoundGenerationPromotedCmd(flags))
	rootCmd.AddCommand(newSpeechToSpeechPromotedCmd(flags))
	rootCmd.AddCommand(newTextToSpeechPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("elevenlabs-pp-cli %s\n", version)
		},
	}
}
