...
func newWorkspaceCreateAuthConnectionCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-auth-connection",
		Short:       "Create a new OAuth2 auth connection for the workspace",
		Example:     "  elevenlabs-pp-cli workspace create-auth-connection",
		Annotations: map[string]string{"pp:endpoint": "workspace.create-auth-connection", "pp:method": "POST", "pp:path": "/v1/workspace/auth-connections"},
