...
but do not stop the import.`,
  ...
  elevenlabs-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  elevenlabs-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | elevenlabs-pp-cli import <resource> --input -`,
