...
func newConvaiCreateAgentResponseTestRouteCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-agent-response-test-route",
		Short:       "Creates a new agent response test.",
		Example:     "  elevenlabs-pp-cli convai create-agent-response-test-route",
		Annotations: map[string]string{"pp:endpoint": "convai.create-agent-response-test-route", "pp:method": "POST", "pp:path": "/v1/convai/agent-testing/create"},
