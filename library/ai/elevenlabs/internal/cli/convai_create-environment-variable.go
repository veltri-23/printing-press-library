...
func newConvaiCreateEnvironmentVariableCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-environment-variable",
		Short:       "Create a new environment variable for the workspace",
		Example:     "  elevenlabs-pp-cli convai create-environment-variable",
		Annotations: map[string]string{"pp:endpoint": "convai.create-environment-variable", "pp:method": "POST", "pp:path": "/v1/convai/environment-variables"},
