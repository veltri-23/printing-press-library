...
Exit codes & warnings:
  ...
  elevenlabs-pp-cli sync

  # Sync specific resources only
  elevenlabs-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  elevenlabs-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  elevenlabs-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  elevenlabs-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  elevenlabs-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("elevenlabs-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/elevenlabs-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "audio-isolation":
		return db.UpsertAudioIsolation(data)
	case "audio-native":
		return db.UpsertAudioNative(data)
	case "content":
		return db.UpsertContent(data)
	case "audio_native_settings":
		return db.UpsertAudioNativeSettings(data)
	case "convai":
		return db.UpsertConvai(data)
	case "dubbing":
		return db.UpsertDubbing(data)
	case "dubbing_audio":
		return db.UpsertDubbingAudio(data)
	case "transcript":
	...
	case "history_audio":
		return db.UpsertHistoryAudio(data)
	case "models":
		return db.UpsertModels(data)
	case "music":
		return db.UpsertMusic(data)
	case "pronunciation-dictionaries":
		return db.UpsertPronunciationDictionaries(data)
	case "add_rules":
		return db.UpsertAddRules(data)
	case "download":
		return db.UpsertDownload(data)
	case "remove_rules":
		return db.UpsertRemoveRules(data)
	case "set_rules":
		return db.UpsertSetRules(data)
	case "api_keys":
		return db.UpsertApiKeys(data)
	case "shared-voices":
		return db.UpsertSharedVoices(data)
	case "similar-voices":
		return db.UpsertSimilarVoices(data)
	case "speech-engine":
		return db.UpsertSpeechEngine(data)
	case "speech_to_speech_stream":
		return db.UpsertSpeechToSpeechStream(data)
	case "studio":
		return db.UpsertStudio(data)
	case "text-to-dialogue":
		return db.UpsertTextToDialogue(data)
	case "text_to_speech_stream":
		return db.UpsertTextToSpeechStream(data)
	case "with_timestamps":
		return db.UpsertWithTimestamps(data)
	case "text-to-voice":
		return db.UpsertTextToVoice(data)
	case "remix":
		return db.UpsertRemix(data)
	case "text_to_voice_stream":
		return db.UpsertTextToVoiceStream(data)
	case "user":
		return db.UpsertUser(data)
	case "voices":
		return db.UpsertVoices(data)
	case "edit":
		return db.UpsertEdit(data)
	case "samples":
		return db.UpsertSamples(data)
	case "voices_settings":
		return db.UpsertVoicesSettings(data)
	case "workspace":
...
func defaultSyncResources() []string {
	return []string{
		...
		"convai-agents",
		"convai-analytics-live-count",
		"convai-api-integrations-docs",
		"convai-batch-calling-workspace",
		"convai-conversations",
		"convai-environment-variables",
		"convai-knowledge-base",
		"convai-knowledge-base-rag-index",
		"convai-mcp-servers",
		"convai-phone-numbers",
		"convai-secrets",
		"convai-settings",
		"convai-settings-dashboard",
		"convai-test-invocations",
		"convai-tools",
		"convai-users",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"audio-isolation":                 "/v1/audio-isolation/history",
		"convai":                          "/v1/convai/tags",
		"convai-agent-testing":            "/v1/convai/agent-testing",
		"convai-agents":                   "/v1/convai/agents",
		"convai-analytics-live-count":     "/v1/convai/analytics/live-count",
		"convai-api-integrations-docs":    "/v1/convai/api-integrations/docs",
		"convai-batch-calling-workspace":  "/v1/convai/batch-calling/workspace",
		"convai-conversations":            "/v1/convai/conversations",
		"convai-environment-variables":    "/v1/convai/environment-variables",
		"convai-knowledge-base":           "/v1/convai/knowledge-base",
		"convai-knowledge-base-rag-index": "/v1/convai/knowledge-base/rag-index",
		"convai-mcp-servers":              "/v1/convai/mcp-servers",
		"convai-phone-numbers":            "/v1/convai/phone-numbers",
		"convai-secrets":                  "/v1/convai/secrets",
		"convai-settings":                 "/v1/convai/settings",
		"convai-settings-dashboard":       "/v1/convai/settings/dashboard",
		"convai-test-invocations":         "/v1/convai/test-invocations",
		"convai-tools":                    "/v1/convai/tools",
		"convai-users":                    "/v1/convai/users",
		"convai-whatsapp-accounts":        "/v1/convai/whatsapp-accounts",
		"dubbing":                         "/v1/dubbing",
		"history":                         "/v1/history",
		"models":                          "/v1/models",
		"pronunciation-dictionaries":      "/v1/pronunciation-dictionaries",
		"service-accounts":                "/v1/service-accounts",
		"shared-voices":                   "/v1/shared-voices",
		"speech-engine":                   "/v1/speech-engine",
		"studio":                          "/v1/studio/projects",
		"user":                            "/v1/user",
		"user-subscription":               "/v1/user/subscription",
		"voices":                          "/v1/voices",
		"voices-settings-default":         "/v1/voices/settings/default",
		"workspace":                       "/v1/workspace/groups",
		"workspace-audit-logs":            "/v1/workspace/audit-logs",
		"workspace-auth-connections":      "/v1/workspace/auth-connections",
		"workspace-webhooks":              "/v1/workspace/webhooks",
	}
