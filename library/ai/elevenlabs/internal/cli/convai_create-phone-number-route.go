...
func newConvaiCreatePhoneNumberRouteCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-phone-number-route",
		Short:       "Import Phone Number from provider configuration (Twilio or SIP trunk)",
		Example:     "  elevenlabs-pp-cli convai create-phone-number-route",
		Annotations: map[string]string{"pp:endpoint": "convai.create-phone-number-route", "pp:method": "POST", "pp:path": "/v1/convai/phone-numbers"},
