...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "xai-pp-cli",
		Short: "Manage xAI resources via the xAI API",
		Long: `Manage xAI resources via the xAI API.
...
Run 'xai-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("xai-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'xai-pp-cli profile list')")
	...
	rootCmd.AddCommand(newEmbeddingModelsCmd(flags))
	rootCmd.AddCommand(newFilesCmd(flags))
	rootCmd.AddCommand(newImageGenerationModelsCmd(flags))
	rootCmd.AddCommand(newImagesCmd(flags))
	rootCmd.AddCommand(newLanguageModelsCmd(flags))
	rootCmd.AddCommand(newModelsCmd(flags))
	rootCmd.AddCommand(newResponsesCmd(flags))
	rootCmd.AddCommand(newSkillsCmd(flags))
	rootCmd.AddCommand(newVideoGenerationModelsCmd(flags))
	...
	rootCmd.AddCommand(newModelPickerCmd(flags))
	rootCmd.AddCommand(newCostPreviewCmd(flags))
	rootCmd.AddCommand(newModelCapabilitiesCmd(flags))
	rootCmd.AddCommand(newSmokeChatCmd(flags))
	rootCmd.AddCommand(newApiKeyPromotedCmd(flags))
	rootCmd.AddCommand(newCompletePromotedCmd(flags))
	rootCmd.AddCommand(newCompletionsPromotedCmd(flags))
	...
	rootCmd.AddCommand(newTokenizeTextPromotedCmd(flags))
