...
but do not stop the import.`,
  ...
  ollama-cloud-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ollama-cloud-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ollama-cloud-pp-cli import <resource> --input -`,
