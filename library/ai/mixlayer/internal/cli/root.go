...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "mixlayer-pp-cli",
		Short: "Manage mixlayer resources via the mixlayer API",
		Long: `Manage mixlayer resources via the mixlayer API.
...
Run 'mixlayer-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("mixlayer-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'mixlayer-pp-cli profile list')")
	...
	rootCmd.AddCommand(newChatPromotedCmd(flags))
	...
	rootCmd.AddCommand(newShieldCmd(flags))
	rootCmd.AddCommand(newVaultCmd(flags))
	rootCmd.AddCommand(newLadderCmd(flags))
	rootCmd.AddCommand(newEscalateCmd(flags))
	rootCmd.AddCommand(newCouncilCmd(flags))
	rootCmd.AddCommand(newSavingsCmd(flags))
