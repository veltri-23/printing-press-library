...
large datasets as it has no memory pressure.`,
  ...
  mixlayer-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  mixlayer-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  mixlayer-pp-cli export <resource> --format jsonl | jq '.id'`,
