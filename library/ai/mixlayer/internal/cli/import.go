...
but do not stop the import.`,
  ...
  mixlayer-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  mixlayer-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | mixlayer-pp-cli import <resource> --input -`,
