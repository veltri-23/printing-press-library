...
func newModelsListCountCmd(flags *rootFlags) *cobra.Command {
	var flagOutputModalities string

	cmd := &cobra.Command{
		Use:         "list-count",
		Short:       "Get total count of available models",
		Example:     "  openrouter-pp-cli models list-count",
		Annotations: map[string]string{"pp:endpoint": "models.list-count", "pp:method": "GET", "pp:path": "/models/count", "mcp:read-only": "true"},
