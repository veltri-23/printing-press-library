...
but do not stop the import.`,
  ...
  midjourney-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  midjourney-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | midjourney-pp-cli import <resource> --input -`,
