...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "midjourney-pp-cli",
		Short: `Inspect Midjourney jobs, queue, folders, and discovery feeds from the terminal`,
		Long: `Inspect Midjourney jobs, queue, folders, and discovery feeds from the terminal

Add --agent to any command for JSON output + non-interactive mode.
Run 'midjourney-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("midjourney-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'midjourney-pp-cli profile list')")
	...
	rootCmd.AddCommand(newGenerationsCmd(flags))
	...
	rootCmd.AddCommand(newImagineCmd(flags))
	rootCmd.AddCommand(newRerunCmd(flags))
	rootCmd.AddCommand(newDownloadCmd(flags))
	rootCmd.AddCommand(newFoldersPromotedCmd(flags))
	rootCmd.AddCommand(newMoodboardsPromotedCmd(flags))
	rootCmd.AddCommand(newQueuePromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("midjourney-pp-cli %s\n", version)
		},
	}
}
