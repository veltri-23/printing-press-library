...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://www.midjourney.com/api/imagine",
		EntryCount:    62,
		APIEntryCount: 62,
		...
		CandidateCommands: []string{
			"list_contests_ranking_count — Derived from observed GET /api/contests-ranking-count traffic.",
			"list_editor_sessions_sync — Derived from observed GET /api/editor-sessions-sync traffic.",
			"list_explore — Derived from observed GET /api/explore traffic.",
			"list_explore_styles_likes — Derived from observed GET /api/explore-styles-likes traffic.",
			"list_folders — Derived from observed GET /api/folders traffic.",
			"list_following_for_user — Derived from observed GET /api/following-for-user traffic.",
			"list_get_user_country — Derived from observed GET /api/get-user-country traffic.",
			"list_imagine — Derived from observed GET /api/imagine traffic.",
		},
	}
}
