...
Resource scoping:
  ...
  midjourney-pp-cli sync

  # Sync specific resources only
  midjourney-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  midjourney-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  midjourney-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  midjourney-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  midjourney-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/midjourney-pp-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "generations":
		return true
	case "generations-imagine-update":
		return true
	}
	return false
}
...
func defaultSyncResources() []string {
	return []string{
		"explore",
		"explore-explore-styles-likes",
		"folders",
		"generations",
		"generations-imagine-update",
		"moodboards",
		"profiles",
		"profiles-personalized-profiles",
		"rankings",
		"rankings-contests-ranking-count",
		"storage",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"explore":                         "/api/explore",
		"explore-explore-styles-likes":    "/api/explore-styles-likes",
		"folders":                         "/api/folders",
		"generations":                     "/api/imagine",
		"generations-imagine-update":      "/api/imagine-update",
		"moodboards":                      "/api/moodboards",
		"profiles":                        "/api/following-for-user",
		"profiles-personalized-profiles":  "/api/personalized-profiles",
		"rankings":                        "/api/model-ratings",
		"rankings-contests-ranking-count": "/api/contests-ranking-count",
		"storage":                         "/api/storage",
	}
