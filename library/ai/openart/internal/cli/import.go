...
but do not stop the import.`,
  ...
  openart-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  openart-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | openart-pp-cli import <resource> --input -`,
