...
large datasets as it has no memory pressure.`,
  ...
  openart-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  openart-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  openart-pp-cli export <resource> --format jsonl | jq '.id'`,
