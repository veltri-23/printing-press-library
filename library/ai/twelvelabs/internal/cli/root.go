...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "twelvelabs-pp-cli",
		Short: "Manage twelvelabs resources via the twelvelabs API",
		Long: `Manage twelvelabs resources via the twelvelabs API.
...
Run 'twelvelabs-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("twelvelabs-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'twelvelabs-pp-cli profile list')")
	...
	rootCmd.AddCommand(newEmbedV2Cmd(flags))
	rootCmd.AddCommand(newEntityCollectionsCmd(flags))
	rootCmd.AddCommand(newIndexesCmd(flags))
	rootCmd.AddCommand(newTasksCmd(flags))
	rootCmd.AddCommand(newVideoSearchCmd(flags))
	rootCmd.AddCommand(newUploadVideoCmd(flags))
	rootCmd.AddCommand(newVideoBriefCmd(flags))
	...
	rootCmd.AddCommand(newAnalyzePromotedCmd(flags))
	rootCmd.AddCommand(newGistPromotedCmd(flags))
	rootCmd.AddCommand(newSummarizePromotedCmd(flags))
