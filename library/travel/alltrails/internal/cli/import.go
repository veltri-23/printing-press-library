...
but do not stop the import.`,
  ...
  alltrails-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  alltrails-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | alltrails-pp-cli import <resource> --input -`,
