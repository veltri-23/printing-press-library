...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://registry.faa.gov",
	}
	...
	if v := os.Getenv("FAA_REGISTRY_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("FAA_REGISTRY_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "faa-registry-pp-cli", "config.toml"), nil
}
