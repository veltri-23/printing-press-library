...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("FAA_REGISTRY_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "faa-registry-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "faa-registry-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"FAA_REGISTRY_CONFIG",
		"FAA_REGISTRY_CONFIG_DIR",
		"FAA_REGISTRY_DATA_DIR",
		"FAA_REGISTRY_STATE_DIR",
		"FAA_REGISTRY_CACHE_DIR",
		"FAA_REGISTRY_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("faa-registry", "test")
	RegisterTools(s)
