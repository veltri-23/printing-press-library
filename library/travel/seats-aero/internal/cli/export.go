...
large datasets as it has no memory pressure.`,
  ...
  seats-aero-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  seats-aero-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  seats-aero-pp-cli export <resource> --format jsonl | jq '.id'`,
