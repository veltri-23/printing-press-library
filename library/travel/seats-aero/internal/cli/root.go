...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "seats-aero-pp-cli",
		Short: "Manage seats-aero resources via the seats-aero API",
		Long: `Manage seats-aero resources via the seats-aero API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'seats-aero-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("seats-aero-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'seats-aero-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAvailabilityPromotedCmd(flags))
	rootCmd.AddCommand(newRoutesPromotedCmd(flags))
	rootCmd.AddCommand(newSeatsAeroPartnerSearchPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("seats-aero-pp-cli %s\n", version)
		},
	}
}
