...
but do not stop the import.`,
  ...
  seats-aero-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  seats-aero-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | seats-aero-pp-cli import <resource> --input -`,
