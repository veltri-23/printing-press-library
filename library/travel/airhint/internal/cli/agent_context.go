...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://region1.analytics.google.com/g/collect",
		EntryCount:    16,
		APIEntryCount: 8,
		...
		CandidateCommands: []string{
			"create_airport_names — Derived from observed POST /airport-names traffic.",
			"get_DUB — Derived from observed GET /cheapest-deal-month/one-way/STN/DUB/{dub_id} traffic.",
			"get_search — Derived from observed GET /search/{search_id} traffic.",
			"list_2026_08_16 — Derived from observed GET /predict/FR/STN/DUB/2026-08-16 traffic.",
			"list_airport_autocomplete — Derived from observed GET /airport-autocomplete traffic.",
			"list_inline_ads — Derived from observed GET /inline-ads traffic.",
			"list_kayak_location_lookup — Derived from observed GET /kayak-location-lookup traffic.",
		},
	}
}
