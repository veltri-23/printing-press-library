...
but do not stop the import.`,
  ...
  airhint-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  airhint-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | airhint-pp-cli import <resource> --input -`,
