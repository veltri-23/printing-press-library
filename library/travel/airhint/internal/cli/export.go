...
large datasets as it has no memory pressure.`,
  ...
  airhint-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  airhint-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  airhint-pp-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.MinimumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				"airport-autocomplete": true,
			}
