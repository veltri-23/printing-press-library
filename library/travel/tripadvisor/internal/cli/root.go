...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "tripadvisor-pp-cli",
		Short: `Tripadvisor CLI — Every Tripadvisor Content API endpoint, plus a local store and ranked compare/best/drift commands no other Tripadvisor …`,
		Long: `Tripadvisor CLI — Every Tripadvisor Content API endpoint, plus a local store and ranked compare/best/drift commands no other Tripadvisor …
...
Health check: run 'tripadvisor-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("tripadvisor-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'tripadvisor-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelNearbyBestCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newFindPromotedCmd(flags))
	rootCmd.AddCommand(newNearPromotedCmd(flags))
