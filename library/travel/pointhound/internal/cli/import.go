...
but do not stop the import.`,
  ...
  pointhound-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pointhound-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pointhound-pp-cli import <resource> --input -`,
