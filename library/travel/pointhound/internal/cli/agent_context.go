...
func buildAgentContext(rootCmd *cobra.Command) agentContext {
	...
	return agentContext{
		...
		CLI: agentContextCLI{
			Name:        "pointhound-pp-cli",
			Description: "Every Pointhound flight search, plus a local SQLite of every deal you've ever seen, balance-aware reachability, and...",
...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://www.pointhound.com",
		EntryCount:    134,
		APIEntryCount: 30,
		...
		AuthCandidates: []string{
			"none",
			"cookie — cookies: cf_clearance, ph_session",
		},
		Protections: []string{
		...
		CandidateCommands: []string{
			"— Primary read endpoint; verified replayable anonymously.",
			"— Filter facets for a given search session; verified replayable anonymously.",
			"— Airport/city autocomplete with deal-aware ranking (cross-domain — hand-written novel command).",
		},
	}
}
