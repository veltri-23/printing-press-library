...
Resource scoping:
  ...
  sncf-connect-pp-cli sync

  # Sync specific resources only
  sncf-connect-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  sncf-connect-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  sncf-connect-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  sncf-connect-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  sncf-connect-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if len(resources) == 0 {
				if humanFriendly {
					fmt.Fprintln(os.Stderr, "sncf-connect-pp-cli sync: no bulk-list endpoints in spec; populate the store via single-fetch commands instead.")
				} else {
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "coord":
		return db.UpsertCoord(data)
	case "coord_access_points":
		return db.UpsertCoordAccessPoints(data)
	case "coord_equipment_reports":
		return db.UpsertCoordEquipmentReports(data)
	case "coord_freefloatings_nearby":
		return db.UpsertCoordFreefloatingsNearby(data)
	case "coord_obstacles_nearby":
		return db.UpsertCoordObstaclesNearby(data)
	case "coord_places_nearby":
		return db.UpsertCoordPlacesNearby(data)
	case "coord_vehicle_positions":
		return db.UpsertCoordVehiclePositions(data)
	case "coords":
		return db.UpsertCoords(data)
	case "coords_access_points":
		return db.UpsertCoordsAccessPoints(data)
	case "coords_equipment_reports":
		return db.UpsertCoordsEquipmentReports(data)
	case "coords_freefloatings_nearby":
		return db.UpsertCoordsFreefloatingsNearby(data)
	case "coords_obstacles_nearby":
		return db.UpsertCoordsObstaclesNearby(data)
	case "coords_places_nearby":
		return db.UpsertCoordsPlacesNearby(data)
	case "coords_vehicle_positions":
		return db.UpsertCoordsVehiclePositions(data)
	case "coverage_access_points":
		return db.UpsertCoverageAccessPoints(data)
	case "addresses":
		return db.UpsertAddresses(data)
	case "arrivals":
		return db.UpsertArrivals(data)
	case "calendars":
		return db.UpsertCalendars(data)
	case "commercial_modes":
		return db.UpsertCommercialModes(data)
	case "companies":
		return db.UpsertCompanies(data)
	case "contributors":
		return db.UpsertContributors(data)
	case "coverage_coord":
		return db.UpsertCoverageCoord(data)
	case "coverage_coords":
		return db.UpsertCoverageCoords(data)
	case "datasets":
		return db.UpsertDatasets(data)
	case "departures":
		return db.UpsertDepartures(data)
	case "direct_stop_points":
		return db.UpsertDirectStopPoints(data)
	case "disruptions":
		return db.UpsertDisruptions(data)
	case "coverage_elevations":
		return db.UpsertCoverageElevations(data)
	case "coverage_equipment_reports":
		return db.UpsertCoverageEquipmentReports(data)
	case "coverage_freefloatings_nearby":
		return db.UpsertCoverageFreefloatingsNearby(data)
	case "geo_status":
		return db.UpsertGeoStatus(data)
	case "heat_maps":
		return db.UpsertHeatMaps(data)
	case "isochrones":
		return db.UpsertIsochrones(data)
	case "journey_pattern_points":
		return db.UpsertJourneyPatternPoints(data)
	case "journey_patterns":
		return db.UpsertJourneyPatterns(data)
	case "coverage_journeys":
		return db.UpsertCoverageJourneys(data)
	case "coverage_line_groups":
		return db.UpsertCoverageLineGroups(data)
	case "line_reports":
		return db.UpsertLineReports(data)
	case "coverage_lines":
		return db.UpsertCoverageLines(data)
	case "coverage_networks":
		return db.UpsertCoverageNetworks(data)
	case "coverage_obstacles_nearby":
		return db.UpsertCoverageObstaclesNearby(data)
	case "physical_modes":
		return db.UpsertPhysicalModes(data)
	case "coverage_places":
		return db.UpsertCoveragePlaces(data)
	case "coverage_places_nearby":
		return db.UpsertCoveragePlacesNearby(data)
	case "poi_types":
		return db.UpsertPoiTypes(data)
	case "pois":
		return db.UpsertPois(data)
	case "pt_objects":
		return db.UpsertPtObjects(data)
	case "coverage_route_schedules":
		return db.UpsertCoverageRouteSchedules(data)
	case "coverage_routes":
		return db.UpsertCoverageRoutes(data)
	case "coverage_stop_areas":
		return db.UpsertCoverageStopAreas(data)
	case "coverage_stop_points":
		return db.UpsertCoverageStopPoints(data)
	case "coverage_stop_schedules":
		return db.UpsertCoverageStopSchedules(data)
	case "coverage_terminus_schedules":
		return db.UpsertCoverageTerminusSchedules(data)
	case "traffic_reports":
		return db.UpsertTrafficReports(data)
	case "trips":
		return db.UpsertTrips(data)
	case "coverage_vehicle_journeys":
		return db.UpsertCoverageVehicleJourneys(data)
	case "coverage_vehicle_positions":
		return db.UpsertCoverageVehiclePositions(data)
	default:
