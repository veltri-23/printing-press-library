...
but do not stop the import.`,
  ...
  sncf-connect-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sncf-connect-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sncf-connect-pp-cli import <resource> --input -`,
