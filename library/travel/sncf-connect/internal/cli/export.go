...
large datasets as it has no memory pressure.`,
  ...
  sncf-connect-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  sncf-connect-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  sncf-connect-pp-cli export <resource> --format jsonl | jq '.id'`,
