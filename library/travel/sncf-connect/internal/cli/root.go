...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "sncf-connect-pp-cli",
		Short: "Manage navitia resources via the navitia API",
		Long: `Manage navitia resources via the navitia API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'sncf-connect-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("sncf-connect-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'sncf-connect-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCoordPromotedCmd(flags))
	rootCmd.AddCommand(newCoordsPromotedCmd(flags))
	rootCmd.AddCommand(newElevationsPromotedCmd(flags))
	rootCmd.AddCommand(newJourneysPromotedCmd(flags))
	rootCmd.AddCommand(newLineGroupsPromotedCmd(flags))
	rootCmd.AddCommand(newLinesPromotedCmd(flags))
	rootCmd.AddCommand(newNetworksPromotedCmd(flags))
	rootCmd.AddCommand(newRouteSchedulesPromotedCmd(flags))
	rootCmd.AddCommand(newRoutesPromotedCmd(flags))
	rootCmd.AddCommand(newStopAreasPromotedCmd(flags))
	rootCmd.AddCommand(newStopPointsPromotedCmd(flags))
	rootCmd.AddCommand(newStopSchedulesPromotedCmd(flags))
	rootCmd.AddCommand(newTerminusSchedulesPromotedCmd(flags))
	rootCmd.AddCommand(newVehicleJourneysPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())
	rootCmd.AddCommand(newCommuteCmd(flags))
	rootCmd.AddCommand(newDisruptionsCmd(flags))
	rootCmd.AddCommand(newIsochroneCmd(flags))
	rootCmd.AddCommand(newJourneyCmd(flags))
	rootCmd.AddCommand(newTimetableCmd(flags))
	rootCmd.AddCommand(newBoardCmd(flags))
	rootCmd.AddCommand(newVehicleCmd(flags))
	rootCmd.AddCommand(newStopsCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("sncf-connect-pp-cli %s\n", version)
		},
	}
}
