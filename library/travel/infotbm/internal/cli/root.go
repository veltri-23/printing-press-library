...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "infotbm-pp-cli",
		Short: `Infotbm CLI — Every Bordeaux tram, bus, and ferry schedule offline in SQLite, plus real-time arrivals, ghost service detection, and j…`,
		Long: `Infotbm CLI — Every Bordeaux tram, bus, and ferry schedule offline in SQLite, plus real-time arrivals, ghost service detection, and j…
...
Health check: run 'infotbm-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("infotbm-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'infotbm-pp-cli profile list')")
	...
	rootCmd.AddCommand(newRealtimeCmd(flags))
	rootCmd.AddCommand(newSiriCmd(flags))
	...
	rootCmd.AddCommand(newNovelLinesCmd(flags))
	rootCmd.AddCommand(newNovelScheduleCmd(flags))
	rootCmd.AddCommand(newNovelTripsCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAgenciesPromotedCmd(flags))
	alertsCmd := newAlertsPromotedCmd(flags)
	alertsCmd.Short = "Service alerts and disruption impact analysis"
	alertsCmd.AddCommand(newNovelAlertsImpactCmd(flags))
	rootCmd.AddCommand(alertsCmd)
	rootCmd.AddCommand(newFaresPromotedCmd(flags))
	rootCmd.AddCommand(newFeedInfoPromotedCmd(flags))
	rootCmd.AddCommand(newKmlPromotedCmd(flags))
	rootCmd.AddCommand(newRoutesPromotedCmd(flags))
	rootCmd.AddCommand(newServerInfoPromotedCmd(flags))
	rootCmd.AddCommand(newStopsPromotedCmd(flags))
