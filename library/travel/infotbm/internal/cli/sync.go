...
Resource scoping:
  ...
  infotbm-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  infotbm-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  infotbm-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  infotbm-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  infotbm-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/infotbm-pp-cli/data.db)")
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"agencies": "/gtfs/agencies/bordeaux",
		"alerts":   "/alerts/active/bordeaux",
		"fares":    "/gtfs/fares/bordeaux",
		"routes":   "/gtfs/routes/bordeaux",
		"stops":    "/gtfs/stops/bordeaux",
	}
