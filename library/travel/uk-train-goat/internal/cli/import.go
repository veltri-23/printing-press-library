...
but do not stop the import.`,
  ...
  uk-train-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  uk-train-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | uk-train-goat-pp-cli import <resource> --input -`,
