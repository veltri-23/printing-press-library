...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "hotel-goat-pp-cli",
		Short: `Hotel Goat CLI — Every Google Hotels feature, plus per-OTA price breakdown, local price-drift history, brand-loyalty filters, and date-f…`,
		Long: `Hotel Goat CLI — Every Google Hotels feature, plus per-OTA price breakdown, local price-drift history, brand-loyalty filters, and date-f…
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("hotel-goat-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'hotel-goat-pp-cli profile list')")
	...
	rootCmd.PersistentPreRunE = func(cmd *cobra.Command, args []string) error {
		...
		parser.SetRateLimit(flags.rateLimit)
		return nil
	}
	...
	rootCmd.AddCommand(newHotelParentCmd(flags))
	rootCmd.AddCommand(newWishlistCmd(flags))
	rootCmd.AddCommand(newDatesCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "version",
		Short: "Print the hotel-goat-pp-cli build version",
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("hotel-goat-pp-cli %s\n", version)
		},
	}
}
