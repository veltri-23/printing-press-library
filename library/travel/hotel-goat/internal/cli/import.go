...
but do not stop the import.`,
  ...
  hotel-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  hotel-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | hotel-goat-pp-cli import <resource> --input -`,
