...
func newCategoriesPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "categories <slug>",
		Short:       "List place links in a category (e.g. cemeteries, caves, ruins)",
		Long:        "List place links in a category (e.g. cemeteries, caves, ruins)",
		Example:     "  atlas-obscura-pp-cli categories example-value",
		Annotations: map[string]string{"pp:endpoint": "categories.places", "pp:method": "GET", "pp:path": "/categories/{slug}", "mcp:read-only": "true"},
