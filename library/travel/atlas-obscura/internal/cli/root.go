...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "atlas-obscura-pp-cli",
		Short: `Atlas Obscura CLI — Every Atlas Obscura search, plus a local database, road-trip corridor routing, and saved trips no other Atlas Obscura t…`,
		Long: `Atlas Obscura CLI — Every Atlas Obscura search, plus a local database, road-trip corridor routing, and saved trips no other Atlas Obscura t…
...
Health check: run 'atlas-obscura-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("atlas-obscura-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'atlas-obscura-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelClusterCmd(flags))
	rootCmd.AddCommand(newNovelExportCmd(flags))
	rootCmd.AddCommand(newNovelGapsCmd(flags))
	rootCmd.AddCommand(newNovelRouteCmd(flags))
	rootCmd.AddCommand(newNovelSurpriseCmd(flags))
	rootCmd.AddCommand(newNovelTripCmd(flags))
	rootCmd.AddCommand(newNovelVisitedCmd(flags))
	...
	rootCmd.AddCommand(newDestinationsPromotedCmd(flags))
	rootCmd.AddCommand(newPlacesPromotedCmd(flags))
