...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  roadside-america-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  roadside-america-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  roadside-america-pp-cli workflow status

  # Show status as JSON
  roadside-america-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("roadside-america-pp-cli")
			}
