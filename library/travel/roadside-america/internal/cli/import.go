...
but do not stop the import.`,
  ...
  roadside-america-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  roadside-america-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | roadside-america-pp-cli import <resource> --input -`,
