...
but do not stop the import.`,
  ...
  delta-trip-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  delta-trip-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | delta-trip-pp-cli import <resource> --input -`,
