...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "visit-detroit-blog-pp-cli",
		Short: `Detroit's official "Inside the D" blog as a CLI — every article searchable offline, sliced across category and neighborhood at once.`,
		Long: `Detroit's official "Inside the D" blog as a CLI — every article searchable offline, sliced across category and neighborhood at once.
...
Health check: run 'visit-detroit-blog-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("visit-detroit-blog-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'visit-detroit-blog-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("visit-detroit-blog-pp-cli %s\n", version)
		},
	}
}
