...
but do not stop the import.`,
  ...
  visit-detroit-blog-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  visit-detroit-blog-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | visit-detroit-blog-pp-cli import <resource> --input -`,
