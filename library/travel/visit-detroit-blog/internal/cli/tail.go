...
native streaming instead of polling.`,
  ...
  visit-detroit-blog-pp-cli tail --interval 10s

  # Tail a specific resource
  visit-detroit-blog-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  visit-detroit-blog-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
