...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  hotel-tonight-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  hotel-tonight-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  hotel-tonight-pp-cli workflow status

  # Show status as JSON
  hotel-tonight-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("hotel-tonight-pp-cli")
			}
