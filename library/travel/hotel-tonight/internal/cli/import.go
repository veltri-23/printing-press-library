...
but do not stop the import.`,
  ...
  hotel-tonight-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  hotel-tonight-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | hotel-tonight-pp-cli import <resource> --input -`,
