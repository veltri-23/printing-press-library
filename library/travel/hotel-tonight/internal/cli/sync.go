...
Resource scoping:
  ...
  hotel-tonight-pp-cli sync

  # Sync specific resources only
  hotel-tonight-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  hotel-tonight-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  hotel-tonight-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  hotel-tonight-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  hotel-tonight-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/hotel-tonight-pp-cli/data.db)")
