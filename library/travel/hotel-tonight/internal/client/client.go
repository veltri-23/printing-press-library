...
func New(cfg *config.Config, timeout time.Duration, rateLimit float64) *Client {
	...
	cacheDir := filepath.Join(homeDir, ".cache", "hotel-tonight-pp-cli", "http")
...
func (c *Client) doInternal(method, path string, params map[string]string, body any, headerOverrides map[string]string, readOnlyIntent bool) (json.RawMessage, int, error) {
	...
	for attempt := 0; attempt <= maxRetries; attempt++ {
		...
		req.Header.Set("X-App-Platform", "iphone")
		req.Header.Set("X-App-Version", "2024.40")
		req.Header.Set("X-App-Country", "US")
		req.Header.Set("X-App-Currency", "USD")
		req.Header.Set("X-App-Device", "iPhone")
		req.Header.Set("X-App-Time-Zone", "America/Los_Angeles")
		if c.Config != nil {
		...
		if req.Header.Get("User-Agent") == "" {
			req.Header.Set("User-Agent", "hotel-tonight-pp-cli/0.1.0")
		}
