...
func newFlightsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <ident>",
		Short:       "Returns the flight info status summary for a registration, ident, or fa_flight_id. If a fa_flight_id is specified...",
		Example:     "  flight-goat-pp-cli flights get example-value",
		Annotations: map[string]string{"pp:endpoint": "flights.get", "mcp:read-only": "true"},
