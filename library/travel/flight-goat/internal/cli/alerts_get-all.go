...
func newAlertsGetAllCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().IntVar(&flagMaxPages, "max-pages", 0, "Maximum number of pages to fetch. This is an upper limit and not a guarantee of how many pages will be returned....")
