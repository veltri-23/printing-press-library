...
but do not stop the import.`,
  ...
  flight-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  flight-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | flight-goat-pp-cli import <resource> --input -`,
