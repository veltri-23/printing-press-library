...
but do not stop the import.`,
  ...
  alaska-airlines-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  alaska-airlines-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | alaska-airlines-pp-cli import <resource> --input -`,
