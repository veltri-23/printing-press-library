...
native streaming instead of polling.`,
  ...
  alaska-airlines-pp-cli tail --interval 10s

  # Tail a specific resource
  alaska-airlines-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  alaska-airlines-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
