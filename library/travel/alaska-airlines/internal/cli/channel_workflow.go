...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  alaska-airlines-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  alaska-airlines-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  alaska-airlines-pp-cli workflow status

  # Show status as JSON
  alaska-airlines-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("alaska-airlines-pp-cli")
			}
