...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "alaska-airlines-pp-cli",
		Short: `Alaska Airlines flight search and Atmos Rewards from the terminal, with offline-cached airports and agent-native JSON output.`,
		Long: `Alaska Airlines flight search and Atmos Rewards from the terminal, with offline-cached airports and agent-native JSON output.
...
Health check: run 'alaska-airlines-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("alaska-airlines-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'alaska-airlines-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAtmosRewardsCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("alaska-airlines-pp-cli %s\n", version)
		},
	}
}
