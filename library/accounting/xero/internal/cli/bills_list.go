...
func newBillsListCmd() *cobra.Command {
	var fixture string
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List Xero purchase invoices / bills from a fixture.",
		Args:  cobra.ArbitraryArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
			return printXeroRead("bills", fixture, "/Invoices?where=Type==%22ACCPAY%22", tokenFile, tenantID, baseURL)
		},
	}
