...
func newReportsBalanceSheetCmd() *cobra.Command {
	var fixture string
	...
	cmd := &cobra.Command{
		Use:   "balance-sheet",
		Short: "Read XERO BalanceSheet report fixture.",
		Args:  cobra.ArbitraryArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
			return printXeroRead("balance-sheet", fixture, "/Reports/BalanceSheet", tokenFile, tenantID, baseURL)
		},
	}
