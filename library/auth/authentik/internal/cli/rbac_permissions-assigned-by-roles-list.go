...
func newRbacPermissionsAssignedByRolesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "permissions-assigned-by-roles-list",
		Short:       "Get assigned object permissions for a single object",
		Example:     "  authentik-pp-cli rbac permissions-assigned-by-roles-list --model authentik_blueprints.blueprintinstance",
		Annotations: map[string]string{"pp:endpoint": "rbac.permissions-assigned-by-roles-list", "pp:method": "GET", "pp:path": "/rbac/permissions/assigned_by_roles/", "mcp:read-only": "true"},
