...
func newRbacInitialPermissionsCreateCmd(flags *rootFlags) *cobra.Command {
	var bodyMode string
	var bodyName string
	...
	cmd := &cobra.Command{
		Use:         "initial-permissions-create",
		Aliases:     []string{"create"},
		Short:       "InitialPermissions viewset",
		Example:     "  authentik-pp-cli rbac initial-permissions-create --mode user",
		Annotations: map[string]string{"pp:endpoint": "rbac.initial-permissions-create", "pp:method": "POST", "pp:path": "/rbac/initial_permissions/"},
