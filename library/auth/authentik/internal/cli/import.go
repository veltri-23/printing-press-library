...
but do not stop the import.`,
  ...
  authentik-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  authentik-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | authentik-pp-cli import <resource> --input -`,
