...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/auth/1password/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "1password-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
