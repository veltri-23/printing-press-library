...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "1password-pp-cli",
		Short: "Manage 1password resources via the 1password API",
		Long: `1Password CLI
...
Health check: run '1password-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("1password-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newNovelAccessCmd(flags))
	rootCmd.AddCommand(newNovelAgentCmd(flags))
	rootCmd.AddCommand(newNovelAuditCmd(flags))
	rootCmd.AddCommand(newNovelCardsCmd(flags))
	rootCmd.AddCommand(newNovelDocumentsCmd(flags))
	rootCmd.AddCommand(newNovelEnvCmd(flags))
	rootCmd.AddCommand(newNovelItemsCmd(flags))
	rootCmd.AddCommand(newNovelPolicyCmd(flags))
	rootCmd.AddCommand(newNovelRateLimitCmd(flags))
	rootCmd.AddCommand(newNovelRunCmd(flags))
	rootCmd.AddCommand(newNovelSecretsCmd(flags))
	rootCmd.AddCommand(newNovelShareCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newOpPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCmd())
	attachOpAgentExamples(rootCmd)
