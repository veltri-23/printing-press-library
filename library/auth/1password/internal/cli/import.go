...
but do not stop the import.`,
  ...
  1password-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  1password-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | 1password-pp-cli import <resource> --input -`,
